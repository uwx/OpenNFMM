...
public class Mod extends Module {
   ...
   public void loadMod(InputStream inputstream) throws IOException {
      ...
      for(_ex = 0; _ex < samples; ++_ex) {
         this.insts[_ex] = readInstrument(datainputstream);
      }
      ...
      try {
         for(_ex = 0; _ex < samples; ++_ex) {
            readSampleData(datainputstream, this.insts[_ex]);
         }
   ...
   static {
      voice_31_list = new int[]{voice_mk, voice_mk2, voice_mk3, voice_flt4, voice_flt8, voice_8chn, voice_6chn, voice_10ch, voice_12ch, voice_14ch, voice_16ch, voice_18ch, voice_20ch, voice_22ch, voice_24ch, voice_26ch, voice_28ch, voice_30ch, voice_32ch, voice_11ch, voice_13ch, voice_15ch, voice_tdz1, voice_tdz2, voice_tdz3, voice_5chn, voice_7chn, voice_9chn};
   }
}
