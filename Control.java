		...
		if ((checkpoints).stage != 19 && (checkpoints).stage != 26) {
			for (int i_0_ = 0; i_0_ < (checkpoints).fn; i_0_++) {
				...
				for (int i_2_ = 0; i_2_ < (checkpoints).n; i_2_++)
					if (py((checkpoints).fx[i_0_] / 100, (checkpoints).x[i_2_] / 100, (checkpoints).fz[i_0_] / 100,
							(checkpoints).z[i_2_] / 100) < i_1_ || i_1_ == -10) {
						i_1_ = py((checkpoints).fx[i_0_] / 100, (checkpoints).x[i_2_] / 100,
								(checkpoints).fz[i_0_] / 100, (checkpoints).z[i_2_] / 100);
						fpnt[i_0_] = i_2_;
					}
			}
		...
		if (!(mad).dest) {
			if ((mad).mtouch)
				if (stcnt > statusque) {
					...
					if (cntrn == 0) {
						...
						if (attack != 0) {
							...
							if ((checkpoints).stage == 9 || (checkpoints).stage == 10 || (checkpoints).stage == 19
									|| (checkpoints).stage == 21 || (checkpoints).stage == 23
									|| (checkpoints).stage == 27)
								turntyp = (int) (m.random() * 3.0F);
							if ((checkpoints).stage == 26
									&& ((((checkpoints).clear[(mad).im]) - (checkpoints).clear[0]) >= 5))
								turntyp = 0;
						}
						if ((checkpoints).stage == 6) {
							turntyp = 1;
						...
						for (int i_6_ = 0; i_6_ < 7; i_6_++)
							if (i_6_ != (mad).im && ((checkpoints).clear[i_6_] != -1)) {
								...
								if (((checkpoints).opx[i_6_] - (conto).x) >= 0)
									i_8_ = 180;
								int i_9_;
								for (i_9_ = (int) (90 + i_8_
										+ ((Math.atan((double) (((checkpoints).opz[i_6_]) - (conto).z)
												/ (double) (((checkpoints).opx[i_6_]) - ((conto).x))))
										/ 0.017453292519943295)); i_9_ < 0; i_9_ += 360) {
									/* empty */
								}
								...
								if (((checkpoints).stage == 6 || (checkpoints).stage == 9) && bulistc)
									i_11_ = 6000;
								if ((checkpoints).stage == 3 && (mad).cn == 6 && (checkpoints).wasted < 2
										&& i_11_ > 4000)
									i_11_ = 4000;
								...
								if ((checkpoints).stage == 19
										&& ((mad).pcleared == 13 || (mad).pcleared == 33 || bool_4_) && i_11_ < 12000)
									i_11_ = 12000;
								if ((checkpoints).stage == 21)
									if (bulistc) {
										i_11_ = 8000;
								...
								if (i_10_ < i_12_
										&& py((conto).x / 100, ((checkpoints).opx[i_6_]) / 100, (conto).z / 100,
												((checkpoints).opz[i_6_]) / 100) < i_11_
										&& afta && (mad).power > i_5_) {
									float f_13_ = 35 - (Math.abs(((checkpoints).clear[i_6_]) - ((mad).clear)) * 10);
									if (f_13_ < 1.0F)
										f_13_ = 1.0F;
									float f_14_ = ((((checkpoints).pos[(mad).im]) + 1) * (5 - ((checkpoints).pos[i_6_]))
											/ f_13_);
									if ((checkpoints).stage != 27 && f_14_ > 0.7)
										f_14_ = 0.7F;
									...
									if ((checkpoints).stage == 9 && bulistc)
										if (i_6_ == 0)
											...
											f_14_ = 0.0F;
									if ((checkpoints).stage == 9
											&& (((checkpoints).pos[i_6_]) == 4 || ((checkpoints).pos[i_6_]) == 3))
										f_14_ = 0.0F;
									if ((checkpoints).stage == 13)
									...
									if ((checkpoints).stage == 21 && bulistc && i_6_ == 0)
										f_14_ = 1.0F;
									if ((checkpoints).stage == 22) {
									...
									if ((checkpoints).stage == 26) {
										...
										if (((checkpoints).pos[(mad).im]) == 0
											...
											f_14_ = 0.0F;
										if ((((checkpoints).clear[(mad).im]) - ((checkpoints).clear[0])) >= 5
												&& i_6_ == 0)
											f_14_ = 1.0F;
									...
									if (m.random() < f_14_) {
										attack = (40 * (Math.abs(((checkpoints).clear[i_6_]) - (mad).clear) + 1));
										if (attack > 500)
											attack = 500;
										aim = 0.0F;
										...
										if (((checkpoints).stage == 19)
												&& ((mad).pcleared == 13 || (mad).pcleared == 33))
											aim = 1.0F;
										if ((checkpoints).stage == 21)
											if (bulistc) {
												aim = 0.7F;
										...
										if ((checkpoints).stage == 26)
											if ((mad).cn == 13) {
												...
												aim = m.random() * 1.5F;
												if (Math.abs(((checkpoints).clear[i_6_]) - ((mad).clear)) <= 2
														|| (mad).cn == 14)
													attack = (attack) / 3;
											}
										if (((checkpoints).stage == -1) && (m.random() > m.random()))
					...
					if (trfix != 3) {
						...
						if ((checkpoints).stage == 26)
							i_15_ = 40;
						if ((100.0F * (mad).hitmag / (((mad).cd).maxmag[(mad).cn])) > i_15_)
							trfix = 1;
						if (!bool) {
							int i_16_ = 80;
							if ((checkpoints).stage == 18 && (mad).cn != 11)
							...
							if ((checkpoints).stage == 26
									...
									&& (mad).cn != 10 && (mad).cn != 12)
								i_16_ = 50;
							if ((100.0F * (mad).hitmag / (((mad).cd).maxmag[(mad).cn])) > i_16_)
								trfix = 2;
						}
					} else {
						upwait = 0;
					...
					if (!bulistc) {
						...
						if ((checkpoints).stage == 9 && afta
								&& (((checkpoints).pos[(mad).im]) == 4 || ((checkpoints).pos[(mad).im]) == 3)
								&& (mad).cn != 15 && trfix != 0)
							bulistc = true;
			...
			if (bool) {
				...
				if (attack == 0) {
					...
					if ((checkpoints).stage == 26)
						i_17_ = 20;
					if (!bulistc || trfix == 2 || trfix == 3 || trfix == 4 || (mad).power < i_17_) {
						...
						if (m.random() > skiplev) {
							...
							while ((checkpoints).typ[i_19_] == 0 || ((checkpoints).typ[i_19_] == -1)
									|| ((checkpoints).typ[i_19_] == -3) || bool_20_) {
								i = i_19_;
						...
						if ((checkpoints).stage == 25) {
							if (oupnt == -1) {
								...
								for (int i_31_ = 0; i_31_ < (checkpoints).n; i_31_++)
									if ((((checkpoints).typ[i_31_]) == -2 || ((checkpoints).typ[i_31_]) == -4)
											&& (i_31_ < 50 || i_31_ > 54)
											&& (py((conto).x / 100, ((checkpoints).x[i_31_]) / 100, (conto).z / 100,
													((checkpoints).z[i_31_]) / 100) < i_30_ || i_30_ == -10)) {
										i_30_ = py((conto).x / 100, ((checkpoints).x[i_31_]) / 100, (conto).z / 100,
												((checkpoints).z[i_31_]) / 100);
										oupnt = i_31_;
									}
								oupnt--;
								if (i < 0)
						...
						if ((checkpoints).stage == 26) {
							...
							if ((mad).cn == 13) {
								...
								if (gowait) {
									...
									if (((checkpoints).pcleared == oupnt) && (py(((checkpoints).opx[0]) / 100,
											frx / 100, ((checkpoints).opz[0]) / 100, frz / 100) < frad)) {
										runbul = 0;
										afta = true;
										gowait = false;
									}
							...
							if (bool_32_) {
								if (oupnt == -1) {
									...
									for (int i_34_ = 0; i_34_ < (checkpoints).n; i_34_++)
										if (((checkpoints).typ[i_34_]) == -4
												&& ((py((conto).x / 100, ((checkpoints).x[i_34_] / 100),
														(conto).z / 100, ((checkpoints).z[i_34_] / 100)) < i_33_
														&& (m.random() > 0.6)) || i_33_ == -10)) {
											i_33_ = py((conto).x / 100, ((checkpoints).x[i_34_] / 100), (conto).z / 100,
													((checkpoints).z[i_34_] / 100));
											oupnt = i_34_;
										}
									oupnt--;
									if (i < 0)
						...
						if (((mad).missedcp == 0 || forget || trfix == 4) && trfix != 0) {
							...
							if (trfix == 2) {
								...
								for (int i_38_ = i_35_; i_38_ < (checkpoints).fn; i_38_++)
									if (py((conto).x / 100, (((checkpoints).x[fpnt[i_38_]]) / 100), (conto).z / 100,
											(((checkpoints).z[fpnt[i_38_]]) / 100)) < i_36_ || i_36_ == -10) {
										i_36_ = py((conto).x / 100, ((checkpoints).x[(fpnt[i_38_])]) / 100,
												(conto).z / 100, ((checkpoints).z[(fpnt[i_38_])]) / 100);
										i_37_ = i_38_;
									}
							...
							for (int i_39_ = i_35_; i_39_ < (checkpoints).fn; i_39_++)
								if (py((conto).x / 100, ((checkpoints).x[fpnt[i_39_]]) / 100, (conto).z / 100,
										((checkpoints).z[fpnt[i_39_]]) / 100) < 2000) {
									forget = false;
									actwait = 0;
									upwait = 0;
									turntyp = 2;
					...
					if (turncnt > randtcnt) {
						if (!gowait) {
							...
							if (((checkpoints).x[i] - (conto).x) >= 0)
								i_40_ = 180;
							pan = (int) (90 + i_40_ + ((Math.atan((double) ((checkpoints).z[i] - (conto).z)
					...
					up = true;
					int i = 0;
					final int i_42_ = (int) (pys((conto).x, ((checkpoints).opx[acr]), (conto).z,
							((checkpoints).opz[acr])) / 2.0F * aim);
					final int i_43_ = (int) (((checkpoints).opx[acr]) - (i_42_ * m.sin((checkpoints).omxz[(acr)])));
					final int i_44_ = (int) (((checkpoints).opz[acr]) + (i_42_ * m.cos((checkpoints).omxz[(acr)])));
					if (i_43_ - (conto).x >= 0)
						i = 180;
					pan = (int) (90 + i + (Math.atan((double) (i_44_ - (conto).z) / (double) (i_43_ - (conto).x))
							/ 0.017453292519943295));
					attack--;
					if (attack <= 0)
						attack = 0;
				...
				if (hold == 0)
					if (Math.abs(i - pan) < 180) {
						if (Math.abs(i - pan) > clrnce) {
							...
							if (Math.abs(i - pan) > 50 && ((mad).speed > (((mad).cd).swits[(mad).cn][0]))
									&& turntyp != 0) {
								if (turntyp == 1)
									down = true;
								if (turntyp == 2)
						...
						if (Math.abs(i - pan) < 310 && ((mad).speed > (((mad).cd).swits[(mad).cn][0]))
								&& turntyp != 0) {
							if (turntyp == 1)
								down = true;
							if (turntyp == 2)
				...
				if (trickfase == 0) {
					...
					if ((checkpoints).stage == 25)
						i_46_ = 10;
					if (i > 7 && ((m.random() > trickprf / i_46_) || stuntf == 4 || stuntf == 3 || stuntf == 5
				...
				if (trickfase == 1) {
					...
					if ((((mad).scy[0] + (mad).scy[1] + (mad).scy[2] + (mad).scy[3]) * 100.0F
							/ ((conto).y - 300)) < -saftey) {
						onceu = false;
						onced = false;
						oncel = false;
