        ...
        if (!mad.dest) {
                    ...
                    if (attack == 0) {
                        ...
                        for (int i_6_ = 0; i_6_ < 7; i_6_++)
                            if (i_6_ != mad.im && checkpoints.clear[i_6_] != -1) {
                                ...
                                int i_9_;
                                for (i_9_ = (int) (90 + i_8_ + Math.atan((double) (checkpoints.opz[i_6_] - conto.z) / (double) (checkpoints.opx[i_6_] - conto.x)) / 0.017453292519943295); i_9_ < 0; i_9_ += 360) {
                                    /* empty */
                                }
                                ...
                                if (i_10_ < i_12_ && py(conto.x / 100, checkpoints.opx[i_6_] / 100, conto.z / 100, checkpoints.opz[i_6_] / 100) < i_11_ && afta && mad.power > i_5_) {
                                ...
                                if (bool && i_10_ > 100 && py(conto.x / 100, checkpoints.opx[i_6_] / 100, conto.z / 100, checkpoints.opz[i_6_] / 100) < 300 && m.random() > 0.6 - checkpoints.pos[mad.im] / 10.0F) {
                                    clrnce = 0;
                                    acuracy = 0;
                                }
                            }
            ...
            if (bool) {
                ...
                if (attack == 0) {
                    ...
                    if (!bulistc || trfix == 2 || trfix == 3 || trfix == 4 || mad.power < i_17_) {
                        ...
                        if (checkpoints.stage == 26) {
                            ...
                            if (checkpoints.clear[mad.im] - checkpoints.clear[0] >= 2 && py(conto.x / 100, checkpoints.opx[0] / 100, conto.z / 100, checkpoints.opz[0] / 100) < 1000 + avoidnlev) {
                                ...
                                int i_27_;
                                for (i_27_ = (int) (90 + i_26_ + Math.atan((double) (checkpoints.opz[0] - conto.z) / (double) (checkpoints.opx[0] - conto.x)) / 0.017453292519943295); i_27_ < 0; i_27_ += 360) {
                                    /* empty */
                                }
                            ...
                            if (bool_32_) {
                                if (oupnt == -1) {
                                    ...
                                    for (int i_34_ = 0; i_34_ < checkpoints.n; i_34_++)
                                        if (checkpoints.typ[i_34_] == -4 && (py(conto.x / 100, checkpoints.x[i_34_] / 100, conto.z / 100, checkpoints.z[i_34_] / 100) < i_33_ && m.random() > 0.6 || i_33_ == -10)) {
                    ...
                    if (turncnt > randtcnt) {
                        if (!gowait) {
                            ...
                            pan = (int) (90 + i_40_ + Math.atan((double) (checkpoints.z[i] - conto.z) / (double) (checkpoints.x[i] - conto.x)) / 0.017453292519943295);
                        } else {
                            int i_41_ = 0;
                            if (wtx - conto.x >= 0) {
                                i_41_ = 180;
                            }
                            pan = (int) (90 + i_41_ + Math.atan((double) (wtz - conto.z) / (double) (wtx - conto.x)) / 0.017453292519943295);
                        }
                        turncnt = 0;
                    ...
                    up = true;
                    int i = 0;
                    final int i_42_ = (int) (pys(conto.x, checkpoints.opx[acr], conto.z, checkpoints.opz[acr]) / 2.0F * aim);
                    ...
                    pan = (int) (90 + i + Math.atan((double) (i_44_ - conto.z) / (double) (i_43_ - conto.x)) / 0.017453292519943295);
                    attack--;
                    if (attack <= 0) {
                        attack = 0;
                    }
                ...
                if (trickfase == 0) {
                    ...
                    if (i > 7 && (m.random() > trickprf / i_46_ || stuntf == 4 || stuntf == 3 || stuntf == 5 || stuntf == 6 || checkpoints.stage == 26)) {
                        oxy = mad.pxy;
                        ozy = mad.pzy;
                        flycnt = 0;
                        uddirect = 0;
