...
public class Plane
{
	...
	if (i_3_ == 1) {
		...
		this.c[i_21_]
		    = ((((this.m).csky[i_21_]
			 * (this.m).fade[0] * 2)
			+ (this.m).cfade[i_21_] * 3000)
		       / ((this.m).fade[0] * 2 + 3000));
	}
	if (i_3_ == 2) {
	    for (int i_22_ = 0; i_22_ < 3; i_22_++)
		this.c[i_22_]
		    = (int) ((float) (this.m).crgrnd[i_22_]
			     * 0.925F);
	}
	if (i_3_ == 3) {
	...
	this.bfase = i_10_;
	this.glass = i_3_;
	Color.RGBtoHSB(this.c[0], this.c[1],
		       this.c[2], this.hsb);
	...
	if (!this.nocol && this.glass != 1) {
	    if (this.bfase > 20
		&& (double) this.hsb[1] > 0.25)
		this.hsb[1] = 0.25F;
	    if (this.bfase > 25
		&& (double) this.hsb[2] > 0.7)
		this.hsb[2] = 0.7F;
	    if (this.bfase > 30
		&& (double) this.hsb[1] > 0.15)
		this.hsb[1] = 0.15F;
	    if (this.bfase > 35
		&& (double) this.hsb[2] > 0.6)
		this.hsb[2] = 0.6F;
	    if (this.bfase > 40)
		this.hsb[0] = 0.075F;
	    if (this.bfase > 50
		&& (double) this.hsb[2] > 0.5)
		this.hsb[2] = 0.5F;
	    if (this.bfase > 60)
		this.hsb[0] = 0.05F;
	}
	...
	if (this.embos == 0) {
	    ...
	    if (this.embos <= 11
		&& (double) this.m.random() > 0.5
		&& this.glass != 1) {
		for (int i_41_ = 0; i_41_ < this.n; i_41_++) {
		    is[i_41_]
			= (int) ((float) (this.ox[i_41_] + i)
				 + (15.0F
				    - this.m.random() * 30.0F));
		    is_38_[i_41_]
			= (int) ((float) (this.oy[i_41_] + i_29_)
				 + (15.0F
				    - this.m.random() * 30.0F));
		    is_37_[i_41_]
			= (int) ((float) (this.oz[i_41_] + i_30_)
				 + (15.0F
				    - this.m.random() * 30.0F));
		}
		...
		rot(is, is_37_, (this.m).cx,
		    (this.m).cz,
		    (this.m).xz, this.n);
		rot(is_38_, is_37_, (this.m).cy,
		    (this.m).cz,
		    (this.m).zy, this.n);
	    ...
	    if (this.embos == 16) {
		this.pa = (int) (this.m.random()
					   * (float) this.n);
		for (this.pb = (int) (this.m.random()
						* (float) this.n);
		     this.pa == this.pb;
		     this.pb = (int) (this.m.random()
						* (float) this.n)) {
		    /* empty */
		}
	    }
		...
		if (this.typ == 1)
		    is[i_59_] = (int) ((float) this.ox[i_59_] * f
				       + (float) i);
		else
		    is[i_59_] = this.ox[i_59_] + i;
		if (this.typ == 2)
		    is_38_[i_59_] = (int) ((float) this.oy[i_59_] * f
					   + (float) i_29_);
		else
		    is_38_[i_59_] = this.oy[i_59_] + i_29_;
		if (this.typ == 3)
		    is_37_[i_59_] = (int) ((float) this.oz[i_59_] * f
					   + (float) i_30_);
		else
	...
	if (this.wz != 0)
	    rot(is_38_, is_37_, this.wy + i_29_,
		this.wz + i_30_, i_35_, this.n);
	if (this.wx != 0)
	    rot(is, is_37_, this.wx + i, this.wz + i_30_,
		i_34_, this.n);
	if (this.chip == 1
	...
	if (this.chip != 0) {
		...
		this.chip = 19;
	    rot(is_61_, is_62_, (this.m).cx,
		(this.m).cz, (this.m).xz,
		3);
	    rot(is_63_, is_62_, (this.m).cy,
		(this.m).cz, (this.m).zy,
		3);
		...
		if (i_69_ == 0)
		    graphics2d.setColor(new Color
					    ...
					    .darker());
		if (i_69_ == 1)
		    graphics2d.setColor(new Color(this.c[0],
						  this.c[1],
						  this.c[2]));
		if (i_69_ == 2)
		    graphics2d.setColor(new Color
		...
		graphics2d.setColor(Color.getHSBColor(this.hsb[0],
						      this.hsb[1],
						      this.hsb[2]));
	...
	for (int i_92_ = 0; i_92_ < this.n; i_92_++) {
	    ...
	    if (is_86_[i_92_] < (this.m).ih
		|| is_37_[i_92_] < 10)
		i_87_++;
	    if (is_86_[i_92_] > (this.m).h
		|| is_37_[i_92_] < 10)
		i_88_++;
	    if (is_85_[i_92_] < (this.m).iw
		|| is_37_[i_92_] < 10)
		i_89_++;
	    if (is_85_[i_92_] > (this.m).w
		|| is_37_[i_92_] < 10)
		i_90_++;
	    if (is_37_[i_92_] < 10)
		i_91_++;
	}
	if (i_89_ == this.n || i_87_ == this.n
	    || i_88_ == this.n || i_90_ == this.n)
	    bool_84_ = false;
	if (((this.m).trk == 1
	     || (this.m).trk == 4)
	    && (i_89_ != 0 || i_87_ != 0 || i_88_ != 0 || i_90_ != 0))
	    bool_84_ = false;
	if ((this.m).trk == 3 && i_91_ != 0)
	    bool_84_ = false;
	if (i_91_ != 0)
	    bool = true;
	if (bool_84_ && i_36_ != -1) {
	...
	if (bool_84_) {
	    ...
	    this.av
		= (int) Math.sqrt((double) ((((this.m).cy
					      - i_110_)
					     * ((this.m).cy
						- i_110_))
					    + (((this.m).cx
	    ...
	    if (this.gr == -13
		&& (!(this.m).lastcheck || i_36_ != -1))
		bool_84_ = false;
	    if (this.master == 2 && this.av > 1500
		&& !(this.m).crs)
		bool_84_ = false;
	    if ((this.gr == -14 || this.gr == -15
		 || this.gr == -12)
		&& (this.av > 11000 || bool_72_ || i_97_ == -111
		    || (this.m).resdown == 2)
		&& (this.m).trk != 2
		&& (this.m).trk != 3)
		bool_84_ = false;
	    if (this.gr == -11 && this.av > 11000
		&& (this.m).trk != 2
		&& (this.m).trk != 3)
		bool_84_ = false;
	    if (this.glass == 2
		...
		bool_84_ = false;
	    if (this.flx != 0
		&& (double) this.m.random() > 0.3
		&& this.flx != 77)
		bool_84_ = false;
	}
	if (bool_84_) {
	    float f = (float) ((double) (this.projf
					 / this.deltaf)
			       + 0.3);
	    if (bool && !this.solo) {
		...
		if (this.gr == -4)
		    f = 0.74F;
		if (this.gr != -7
		    && (this.m).trk == 0 && bool_72_)
		    f = 0.32F;
		if (this.gr == -8 || this.gr == -14
		    || this.gr == -15)
		    f = 1.0F;
		if (this.gr == -11 || this.gr == -12) {
		    f = 0.6F;
	    ...
	    Color color = Color.getHSBColor(this.hsb[0],
					    this.hsb[1],
					    this.hsb[2] * f);
	    if ((this.m).trk == 1) {
		float[] fs = new float[3];
		Color.RGBtoHSB(this.oc[0], this.oc[1],
			       this.oc[2], fs);
		fs[0] = 0.15F;
		fs[1] = 0.3F;
		...
		for (int i_117_ = 0; i_117_ < 16; i_117_++) {
		    if (this.av
			> (this.m).fade[i_117_]) {
			i_114_ = ((i_114_ * (this.m).fogd
				   + (this.m).cfade[0])
				  / ((this.m).fogd + 1));
			i_115_ = ((i_115_ * (this.m).fogd
				   + (this.m).cfade[1])
				  / ((this.m).fogd + 1));
			i_116_ = ((i_116_ * (this.m).fogd
				   + (this.m).cfade[2])
				  / ((this.m).fogd + 1));
		    }
		}
	    ...
	    } else if (this.road && this.av <= 3000
		       && (this.m).trk == 0
		       && (this.m).fade[0] > 4000) {
		i_114_ -= 10;
		if (i_114_ < 0)
	...
	if (i_125_ == 0) {
	    ...
	    if (i_146_ < 0)
		i_146_ = 0;
	    for (int i_147_ = ((this.t).sect[i_145_]
			       [i_146_]).length - 1;
		 i_147_ >= 0; i_147_--) {
		int i_148_ = ((this.t).sect[i_145_]
			      [i_146_][i_147_]);
		int i_149_ = 0;
		if (Math.abs((this.t).zy[i_148_]) != 90
		    && Math.abs((this.t).xy[i_148_]) != 90
		    && (this.t).rady[i_148_] != 801
		    && (Math.abs(i_143_
				 - ((this.t).x[i_148_]
				    - (this.m).x))
			< (this.t).radx[i_148_])
	...
	if (i_125_ == 2) {
	    ...
	    for (int i_153_ = 0; i_153_ < (this.m).nsp;
		 i_153_++) {
	...
	if (bool) {
	    rot(is, is_126_, (this.m).cx,
		(this.m).cz, (this.m).xz,
		this.n);
	    rot(is_127_, is_126_, (this.m).cy,
		(this.m).cz, (this.m).zy,
		this.n);
	    int i_155_ = 0;
	    int i_156_ = 0;
		...
		if (is_152_[i_159_] < (this.m).ih
		    || is_126_[i_159_] < 10)
		    i_155_++;
		if (is_152_[i_159_] > (this.m).h
		    || is_126_[i_159_] < 10)
		    i_156_++;
		if (is_151_[i_159_] < (this.m).iw
		    || is_126_[i_159_] < 10)
		    i_157_++;
		if (is_151_[i_159_] > (this.m).w
		    || is_126_[i_159_] < 10)
		    i_158_++;
	    }
	    if (i_157_ == this.n || i_155_ == this.n
		|| i_156_ == this.n || i_158_ == this.n)
		bool = false;
	}
	if (bool) {
		...
		if (this.av
		    > (this.m).fade[i_160_]) {
		    i_129_ = ((i_129_ * (this.m).fogd
			       + (this.m).cfade[0])
			      / ((this.m).fogd + 1));
		    i_130_ = ((i_130_ * (this.m).fogd
			       + (this.m).cfade[1])
			      / ((this.m).fogd + 1));
		    i_131_ = ((i_131_ * (this.m).fogd
			       + (this.m).cfade[2])
			      / ((this.m).fogd + 1));
		}
	    }
	...
	if (i_161_ < (this.m).cz)
	    i_161_ = (this.m).cz;
	return (((i_161_ - (this.m).focus_point)
		 * ((this.m).cx - i) / i_161_)
		+ i);
    }
	...
	if (i_162_ < (this.m).cz)
	    i_162_ = (this.m).cz;
	return (((i_162_ - (this.m).focus_point)
		 * ((this.m).cy - i) / i_162_)
		+ i);
    }
	...
	return (int) Math.sqrt((double) (((i - (this.m).cx)
					  * (i
					     - (this.m).cx))
					 + i_170_ * i_170_));
    }
