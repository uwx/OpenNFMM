...
public class Wheels {
    ...
    public void make(final Medium medium, final Trackers trackers, final Plane[] planes, int i, final int i_4_, final int i_5_, final int i_6_, final int i_7_, final int i_8_, final int i_9_, final int i_10_) {
        ...
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 20, is_13_, 0, i_10_, 0, i_14_, i_5_, i_6_, 7, 0, false, 0, false, false, false, false, 1, 0, 0, 10);
        planes[i].master = 1;
        i++;
        ...
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3, rc, 0, i_18_, 0, i_14_, i_5_, i_6_, 7, 0, false, 0, false, false, false, false, 1, 0, 0, 10);
        if (depth / size < 7.0F) {
            planes[i].master = 2;
        }
        i++;
        ...
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 4, is_13_, 0, i_10_, -1 * i_16_, i_14_, i_5_, i_6_, 7, 0, false, 0, true, false, false, false, 1, 0, 0, 10);
        i++;
        is[0] = (int) (i_4_ - 4.0F * f);
        is_11_[0] = (int) (i_5_ - 9.1923F * f_15_);
        is_12_[0] = (int) (i_6_ - 9.1923F * f_15_);
