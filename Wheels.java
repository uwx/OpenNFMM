...
public class Wheels
{
	...
	rc[1] = i_0_;
	rc[2] = i_1_;
	size = (float) i_2_ / 10.0F;
	if (size < 0.0F)
	    size = 0.0F;
	depth = (float) i_3_ / 10.0F;
	if (depth / size > 41.0F)
	    depth = size * 41.0F;
	if (depth / size < -25.0F)
	    depth = -(size * 25.0F);
	...
	ground = (int) ((float) i_5_ + 13.0F * f_15_);
	int i_16_ = -1;
	if (i_4_ < 0)
	    i_16_ = 1;
	...
	is_11_[12] = i_5_;
	is_12_[12] = (int) ((float) i_6_ + 10.0F * size);
	is_11_[13]
	    = (int) ((double) i_5_ + 8.66 * (double) size);
	is_12_[13] = (int) ((float) i_6_ + 5.0F * size);
	is_11_[14]
	    = (int) ((double) i_5_ + 8.66 * (double) size);
	is_12_[14] = (int) ((float) i_6_ - 5.0F * size);
	is_11_[15] = i_5_;
	is_12_[15] = (int) ((float) i_6_ - 10.0F * size);
	is_11_[16]
	    = (int) ((double) i_5_ - 8.66 * (double) size);
	is_12_[16] = (int) ((float) i_6_ - 5.0F * size);
	is_11_[17]
	    = (int) ((double) i_5_ - 8.66 * (double) size);
	is_12_[17] = (int) ((float) i_6_ + 5.0F * size);
	is_11_[18] = i_5_;
	is_12_[18] = (int) ((float) i_6_ + 10.0F * size);
	...
	if (i_18_ < -16)
	    i_18_ = -16;
	is_11_[0] = i_5_;
	is_12_[0] = (int) ((float) i_6_ + 10.0F * size);
	is_11_[1]
	    = (int) ((double) i_5_ + 8.66 * (double) size);
	is_12_[1] = (int) ((float) i_6_ + 5.0F * size);
	planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3,
			      rc, 0, i_18_, 0, i_14_, i_5_,
	...
	is_11_[0]
	    = (int) ((double) i_5_ + 8.66 * (double) size);
	is_12_[0] = (int) ((float) i_6_ + 5.0F * size);
	is_11_[1]
	    = (int) ((double) i_5_ + 8.66 * (double) size);
	is_12_[1] = (int) ((float) i_6_ - 5.0F * size);
	planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3,
	...
	is_12_[0] = (int) ((float) i_6_ - 5.0F * size);
	is_11_[1] = i_5_;
	is_12_[1] = (int) ((float) i_6_ - 10.0F * size);
	planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3,
			      rc, 0, i_18_, 0, i_14_, i_5_,
			      i_6_, 7, 0, false, 0, false);
	if (depth / size < 7.0F)
