...
public class Login implements Runnable {
    ...
    public Login(final Medium medium, final Graphics2D graphics2d, final xtGraphics var_xtGraphics, final GameSparker gamesparker) {
        m = medium;
        rd = graphics2d;
        xt = var_xtGraphics;
        gs = gamesparker;
            ...
            if (i_49_ == 2) {
                ...
                if (nflk == 0) {
                    ...
                    for (/**/ ; i_55_ < string.length(); i_55_++) {
                        final String string_57_ = new StringBuilder().append("").append(string.charAt(i_55_)).toString();
    ...
    public void fixtext(final JTextField JTextField) {
        ...
        for (/**/ ; i < string.length(); i++) {
            ...
            if (string_67_.equals("|") || string_67_.equals(",") || string_67_.equals("(") || string_67_.equals(")") || string_67_.equals("#") || string_67_.equals(string_64_) || string_67_.equals("!") || string_67_.equals("?") || string_67_.equals(" ") || string_67_.equals("~") || string_67_.equals("$") || string_67_.equals("%") || string_67_.equals("^") || string_67_.equals("&") || string_67_.equals("*") || string_67_.equals("+") || string_67_.equals("=") || string_67_.equals(">") || string_67_.equals("<") || string_67_.equals("/") || string_67_.equals("'") || string_67_.equals(";") || string_67_.equals(":") || string_67_.equals("\u00a0")) {
                i_66_ = i;
            } else {
    ...
    public void multimode(final ContO[] contos) {
        ...
        if (flipo > 10) {
            rd.drawImage(xt.logomadnes, 96 + (int) (2.0 - Math.random() * 4.0), 11 + (int) (2.0 - Math.random() * 4.0), null);
        } else {
