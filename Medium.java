...
public class Medium
{
	...
	if (this.td) {
	    this.y = (int) ((float) ((conto).y - 300)
				       - 1100.0F * random());
	    this.x
		= ((conto).x
		   + (int) ((float) ((conto).x + 400
				     - (conto).x) * cos(i)
			    - (float) ((conto).z + 5000
				       - (conto).z) * sin(i)));
	    this.z
	...
	if ((conto).y - this.y - this.cy < 0)
	    i_0_ = -180;
	int i_2_ = (int) Math.sqrt((double) ((((conto).z
					       - this.z)
					      * ((conto).z
						 - this.z))
					     + (((conto).x
	...
	if ((int) Math.sqrt((double) ((((conto).z - this.z)
				       * ((conto).z
					  - this.z))
				      + (((conto).x - this.x
					  - this.cx)
	...
	this.y = -this.hit;
	this.x = (this.cx + (int) this.trx
			     + (int) (17000.0F * cos(this.vxz)));
	this.z
	    = (int) this.trz + (int) (17000.0F
						 * sin(this.vxz));
	if (this.hit > 5000) {
	    if (this.hit == 45000) {
		this.fo = 1.0F;
		this.zy = 67;
		this.atrx = ((long) (checkpoints).x[0]
					- this.trx) / 116L;
		this.atrz = ((long) (checkpoints).z[0]
					- this.trz) / 116L;
	    ...
	    if ((double) Math.abs(this.fo - this.gofo)
		> 0.005) {
	...
	if (this.y > 10)
	    this.vert = false;
	this.x
	    = (conto).x + (int) ((float) ((conto).x - i
						  - (conto).x)
					 * cos(this.vxz));
	this.z
	    = (conto).z + (int) ((float) ((conto).x - i
						  - (conto).x)
					 * sin(this.vxz));
	if (!bool)
	    this.vxz += 2;
	...
	if ((conto).y - i_5_ - this.cy < 0)
	    i_4_ = -180;
	int i_6_
	    = (int) Math.sqrt((double) ((((conto).z - this.z
					  + this.cz)
					 * ((conto).z
					    - this.z
					    + this.cz))
	...
	int i_9_ = (conto).x + (int) ((float) ((conto).x - i
						       - (conto).x)
					      * cos(this.vxz));
	int i_10_ = (conto).z + (int) ((float) ((conto).x - i
							- (conto).x)
					       * sin(this.vxz));
	int i_11_ = 0;
	...
	if ((Math.abs(i_12_ - i_14_) < 30 || Math.abs(i_12_ - i_14_) > 330)
	    && i_11_ == 3) {
	    if (Math.abs(i_12_ - this.xz) > 7
		&& Math.abs(i_12_ - this.xz) < 353) {
		...
		this.xz = i_12_;
	} else if (Math.abs(i_14_ - this.xz) > 6
		   && Math.abs(i_14_ - this.xz) < 354) {
	...
	int i_19_
	    = ((conto).x * (20 - i) + (conto_18_).x * i) / 20;
	int i_20_
	    = ((conto).y * (20 - i) + (conto_18_).y * i) / 20;
	int i_21_
	    = ((conto).z * (20 - i) + (conto_18_).z * i) / 20;
	if (!this.vert)
	    this.adv += 2;
	else
	    this.adv -= 2;
	...
	if (this.y > 10)
	    this.vert = false;
	this.x = i_19_ + (int) ((float) (i_19_ - i_22_ - i_19_)
					   * cos(this.vxz));
	this.z = i_21_ + (int) ((float) (i_19_ - i_22_ - i_19_)
					   * sin(this.vxz));
	this.vxz += 2;
	int i_23_ = 0;
	int i_24_ = this.y;
	...
	if (i_20_ - i_24_ - this.cy < 0)
	    i_23_ = -180;
	int i_25_ = (int) Math.sqrt((double) (((i_21_ - this.z
						+ this.cz)
					       * (i_21_ - this.z
						  + this.cz))
					      + ((i_19_ - this.x
	...
	Random random = new Random((long) ((i_38_ + this.cgrnd[0]
					    + this.cgrnd[1]
					    + this.cgrnd[2])
					   * 1671));
	...
	this.pcv = null;
	this.ogpx
	    = new int[this.nrw * this.ncl][8];
	this.ogpz
	    = new int[this.nrw * this.ncl][8];
	this.pvr
	    = new float[this.nrw * this.ncl][8];
	this.cgpx
	    = new int[this.nrw * this.ncl];
	this.cgpz
	    = new int[this.nrw * this.ncl];
	this.pmx
	    = new int[this.nrw * this.ncl];
	this.pcv
	    = new float[this.nrw * this.ncl];
	int i_39_ = 0;
	int i_40_ = 0;
	for (int i_41_ = 0; i_41_ < this.nrw * this.ncl;
	     i_41_++) {
	    this.cgpx[i_41_]
		= (this.sgpx + i_39_ * 1200
		   + (int) (random.nextDouble() * 1000.0 - 500.0));
	    this.cgpz[i_41_]
		= (this.sgpz + i_40_ * 1200
		   + (int) (random.nextDouble() * 1000.0 - 500.0));
	    if (trackers != null) {
		for (int i_42_ = 0; i_42_ < (trackers).nt;
		     i_42_++) {
		    if ((trackers).zy[i_42_] == 0
			&& (trackers).xy[i_42_] == 0) {
			if (((trackers).radx[i_42_]
			     < (trackers).radz[i_42_])
			    && (Math.abs(this.cgpz[i_41_]
					 - (trackers).z[i_42_])
				< (trackers).radz[i_42_])) {
			    for (/**/;
				 (Math.abs(this.cgpx[i_41_]
					   - (trackers).x[i_42_])
				  < (trackers).radx[i_42_]);
				 this.cgpx[i_41_]
				     += ((random.nextDouble()
					  * (double) ((trackers)
						      .radx[i_42_])
					  * 2.0)
					 - (double) ((trackers).radx
						     [i_42_]))) {
				/* empty */
			    }
			}
			if (((trackers).radz[i_42_]
			     < (trackers).radx[i_42_])
			    && (Math.abs(this.cgpx[i_41_]
					 - (trackers).x[i_42_])
				< (trackers).radx[i_42_])) {
	...
	for (int i_43_ = 0; i_43_ < this.nrw * this.ncl;
	     i_43_++) {
		...
		if (i_46_ == 8)
		    i_46_ = 0;
		this.ogpx[i_43_][i_44_]
		    = ((this.ogpx[i_43_][i_45_]
			+ this.ogpx[i_43_][i_46_]) / 2
		       + this.ogpx[i_43_][i_44_]) / 2;
		this.ogpz[i_43_][i_44_]
		    = ((this.ogpz[i_43_][i_45_]
			+ this.ogpz[i_43_][i_46_]) / 2
		       + this.ogpz[i_43_][i_44_]) / 2;
		this.pvr[i_43_][i_44_]
		    = (float) (1.1 + random.nextDouble() * 0.8);
		int i_47_
		    = (int) (Math.sqrt
			     ((double) (int) (((float) ((this.ogpx
							 [i_43_][i_44_])
							* (this.ogpx
							   [i_43_][i_44_]))
					       * (this.pvr[i_43_]
	...
	for (int i_51_ = i; i_51_ < i_48_; i_51_++) {
		...
		if (this.resdown < 2 || i_53_ % 2 == 0) {
		    int i_54_
			= (this.cx
			   + (int) (((float) (this.cgpx[i_53_]
					      - this.x
					      - this.cx)
				     * cos(this.xz))
				    - ((float) (this.cgpz[i_53_]
						- this.z
						- this.cz)
				       * sin(this.xz))));
		    int i_55_
		    ...
		    int i_56_
			= (this.cz
			   + (int) (((float) (250 - this.y
					      - this.cy)
				     * sin(this.zy))
				    + ((float) (i_55_ - this.cz)
				       * cos(this.zy))));
		    if (xs(i_54_ + this.pmx[i_53_], i_56_) > 0
			&& (xs(i_54_ - this.pmx[i_53_], i_56_)
			    < this.w)
			&& i_56_ > -this.pmx[i_53_]
			&& i_56_ < this.fade[2]) {
			...
			for (int i_60_ = 0; i_60_ < 8; i_60_++) {
			    is_57_[i_60_]
				= (int) (((float) (this.ogpx[i_53_]
						   [i_60_])
					  * this.pvr[i_53_][i_60_])
					 + (float) this.cgpx[i_53_]
					 - (float) this.x);
			    is_58_[i_60_]
				= (int) (((float) (this.ogpz[i_53_]
						   [i_60_])
					  * this.pvr[i_53_][i_60_])
					 + (float) this.cgpz[i_53_]
					 - (float) this.z);
			...
			rot(is_57_, is_58_, this.cx,
			    this.cz, this.xz, 8);
			rot(is_59_, is_58_, this.cy,
			    this.cz, this.zy, 8);
			...
			for (int i_67_ = 0; i_67_ < 8; i_67_++) {
				...
				i_63_++;
			    if (is_62_[i_67_] > this.h
				|| is_58_[i_67_] < 10)
				i_64_++;
			    if (is_61_[i_67_] < 0 || is_58_[i_67_] < 10)
				i_65_++;
			    if (is_61_[i_67_] > this.w
				|| is_58_[i_67_] < 10)
				i_66_++;
			}
			...
			if (bool) {
			    int i_68_
				= (int) ((((float) this.cpol[0]
					   * this.pcv[i_53_])
					  + (float) this.cgrnd[0])
					 / 2.0F);
			    int i_69_
				= (int) ((((float) this.cpol[1]
					   * this.pcv[i_53_])
					  + (float) this.cgrnd[1])
					 / 2.0F);
			    int i_70_
				= (int) ((((float) this.cpol[2]
					   * this.pcv[i_53_])
					  + (float) this.cgrnd[2])
					 / 2.0F);
			    if (i_56_ - this.pmx[i_53_]
				> this.fade[0]) {
				i_68_ = ((i_68_ * 7 + this.cfade[0])
					 / 8);
				i_69_ = ((i_69_ * 7 + this.cfade[1])
					 / 8);
				i_70_ = ((i_70_ * 7 + this.cfade[2])
					 / 8);
			    }
			    if (i_56_ - this.pmx[i_53_]
				> this.fade[1]) {
	...
	for (int i_71_ = i; i_71_ < i_48_; i_71_++) {
		...
		if (is[i_71_ - i][i_72_ - i_49_] != 0) {
			...
			is_74_[i_77_] = (this.ogpx[i_73_][i_77_]
					 + this.cgpx[i_73_]
					 - this.x);
			is_75_[i_77_] = (this.ogpz[i_73_][i_77_]
					 + this.cgpz[i_73_]
					 - this.z);
			is_76_[i_77_] = this.ground;
		    }
		    rot(is_74_, is_75_, this.cx, this.cz,
			this.xz, 8);
		    rot(is_76_, is_75_, this.cy, this.cz,
			this.zy, 8);
			...
			if (is_79_[i_84_] < 0 || is_75_[i_84_] < 10)
			    i_80_++;
			if (is_79_[i_84_] > this.h
			    || is_75_[i_84_] < 10)
			    i_81_++;
			if (is_78_[i_84_] < 0 || is_75_[i_84_] < 10)
			    i_82_++;
			if (is_78_[i_84_] > this.w
			    || is_75_[i_84_] < 10)
			    i_83_++;
		    }
			...
			bool = false;
		    if (bool) {
			int i_85_ = (int) ((float) this.cpol[0]
					   * this.pcv[i_73_]);
			int i_86_ = (int) ((float) this.cpol[1]
					   * this.pcv[i_73_]);
			int i_87_ = (int) ((float) this.cpol[2]
					   * this.pcv[i_73_]);
	...
	for (int i_91_ = 0; i_91_ < this.noc; i_91_++) {
		...
		= (int) ((25.0 - Math.random() * 50.0) * (double) f);
	    f_92_ = (float) ((200.0 + Math.random() * 700.0) * (double) f);
	    this.clax[i_91_][0][10]
		= -(int) ((double) f_92_ * 0.7071);
	    this.claz[i_91_][0][10]
		= (int) ((double) f_92_ * 0.7071);
	    this.clay[i_91_][0][10]
		= (int) ((25.0 - Math.random() * 50.0) * (double) f);
	    f_92_ = (float) ((200.0 + Math.random() * 700.0) * (double) f);
	    this.clax[i_91_][0][11]
		= -(int) ((double) f_92_ * 0.3826);
	    this.claz[i_91_][0][11]
		= (int) ((double) f_92_ * 0.9238);
	    this.clay[i_91_][0][11]
		= (int) ((25.0 - Math.random() * 50.0) * (double) f);
		...
		if (i_95_ == 12)
		    i_95_ = 0;
		this.clax[i_91_][0][i_93_]
		    = ((this.clax[i_91_][0][i_94_]
			+ this.clax[i_91_][0][i_95_]) / 2
		       + this.clax[i_91_][0][i_93_]) / 2;
		this.clay[i_91_][0][i_93_]
		    = ((this.clay[i_91_][0][i_94_]
			+ this.clay[i_91_][0][i_95_]) / 2
		       + this.clay[i_91_][0][i_93_]) / 2;
		this.claz[i_91_][0][i_93_]
		    = ((this.claz[i_91_][0][i_94_]
			+ this.claz[i_91_][0][i_95_]) / 2
		       + this.claz[i_91_][0][i_93_]) / 2;
	    }
	    for (int i_96_ = 0; i_96_ < 12; i_96_++) {
		f_92_ = (float) (1.2 + 0.6 * Math.random());
		this.clax[i_91_][1][i_96_]
		    = (int) ((float) this.clax[i_91_][0][i_96_]
			     * f_92_);
		this.claz[i_91_][1][i_96_]
		    = (int) ((float) this.claz[i_91_][0][i_96_]
			     * f_92_);
		this.clay[i_91_][1][i_96_]
		    = (int) ((double) this.clay[i_91_][0][i_96_]
			     - 100.0 * Math.random());
		f_92_ = (float) (1.1 + 0.3 * Math.random());
		this.clax[i_91_][2][i_96_]
		    = (int) ((float) this.clax[i_91_][1][i_96_]
			     * f_92_);
		this.claz[i_91_][2][i_96_]
		    = (int) ((float) this.claz[i_91_][1][i_96_]
			     * f_92_);
		this.clay[i_91_][2][i_96_]
		    = (int) ((double) this.clay[i_91_][1][i_96_]
			     - 240.0 * Math.random());
	    }
	    this.cmx[i_91_] = 0;
		...
		if (i_99_ == 12)
		    i_99_ = 0;
		this.clay[i_91_][1][i_97_]
		    = ((this.clay[i_91_][1][i_98_]
			+ this.clay[i_91_][1][i_99_]) / 2
		       + this.clay[i_91_][1][i_97_]) / 2;
		this.clay[i_91_][2][i_97_]
		    = ((this.clay[i_91_][2][i_98_]
			+ this.clay[i_91_][2][i_99_]) / 2
		       + this.clay[i_91_][2][i_97_]) / 2;
		int i_100_
		    = (int) Math.sqrt((double) (((this.clax[i_91_]
						  [2][i_97_])
						 * (this.clax[i_91_]
						    [2][i_97_]))
						+ ((this.claz[i_91_]
		...
		for (int i_103_ = 0; i_103_ < 3; i_103_++) {
		    f_92_ = ((float) this.clds[i_103_] * 1.05F
			     - (float) this.clds[i_103_]);
		    this.clc[i_91_][0][i_101_][i_103_]
			= (int) ((double) this.clds[i_103_]
				 + (double) f_92_ * d);
		    ...
		    this.clc[i_91_][1][i_101_][i_103_]
			= (int) ((double) ((float) this.clds[i_103_]
					   * 1.05F)
				 + (double) f_92_ * d_102_);
	...
	for (int i = 0; i < this.noc; i++) {
	    ...
	    int i_105_ = (this.cz
			  + (int) (((float) (this.clx[i]
				   ...
				   + ((float) (this.clz[i]
				      ...
				      * cos(this.xz))));
	    int i_106_ = (this.cz
			  + (int) (((float) (this.cldd[4]
					     - this.y / 20
					     - this.cy)
				    * sin(this.zy))
				   + ((float) (i_105_ - this.cz)
				      * cos(this.zy))));
	    int i_107_ = xs(i_104_ + this.cmx[i], i_106_);
	    int i_108_ = xs(i_104_ - this.cmx[i], i_106_);
	    if (i_107_ > 0 && i_108_ < this.w
		&& i_106_ > -this.cmx[i] && i_107_ - i_108_ > 20) {
		int[][] is = new int[3][12];
		...
		for (int i_120_ = 0; i_120_ < 3; i_120_++) {
			...
			is[i_120_][i_121_]
			    = (this.clax[i][i_120_][i_121_]
			       + this.clx[i]
			       - this.x / 20);
			is_110_[i_120_][i_121_]
			    = (this.claz[i][i_120_][i_121_]
			       + this.clz[i]
			       - this.z / 20);
			is_109_[i_120_][i_121_]
			    = (this.clay[i][i_120_][i_121_]
			       + this.cldd[4]
			       - this.y / 20);
		    }
		    rot(is[i_120_], is_110_[i_120_], this.cx,
			this.cz, this.xz, 12);
		    rot(is_109_[i_120_], is_110_[i_120_], this.cy,
			this.cz, this.zy, 12);
		}
		for (int i_122_ = 0; i_122_ < 12; i_122_ += 2) {
			...
			if (is_112_[i_130_] < 0 || is_110_[0][i_130_] < 10)
			    i_123_++;
			if (is_112_[i_130_] > this.h
			    || is_110_[0][i_130_] < 10)
			    i_124_++;
			if (is_111_[i_130_] < 0 || is_110_[0][i_130_] < 10)
			    i_125_++;
			if (is_111_[i_130_] > this.w
			    || is_110_[0][i_130_] < 10)
			    i_126_++;
		    }
			...
			if (i_133_ < this.fade[7]) {
			    int i_134_
				= this.clc[i][1][i_122_ / 2][0];
			    int i_135_
				= this.clc[i][1][i_122_ / 2][1];
			    int i_136_
				= this.clc[i][1][i_122_ / 2][2];
			    for (int i_137_ = 0; i_137_ < 16; i_137_++) {
				if (i_133_ > this.fade[i_137_]) {
				    i_134_ = ((i_134_ * this.fogd
					       + this.cfade[0])
					      / (this.fogd + 1));
				    i_135_ = ((i_135_ * this.fogd
					       + this.cfade[1])
					      / (this.fogd + 1));
				    i_136_ = ((i_136_ * this.fogd
					       + this.cfade[2])
					      / (this.fogd + 1));
				}
			    }
		...
		for (int i_138_ = 0; i_138_ < 12; i_138_ += 2) {
			...
			if (is_112_[i_146_] < 0 || is_110_[0][i_146_] < 10)
			    i_139_++;
			if (is_112_[i_146_] > this.h
			    || is_110_[0][i_146_] < 10)
			    i_140_++;
			if (is_111_[i_146_] < 0 || is_110_[0][i_146_] < 10)
			    i_141_++;
			if (is_111_[i_146_] > this.w
			    || is_110_[0][i_146_] < 10)
			    i_142_++;
		    }
			...
			if (i_149_ < this.fade[7]) {
			    int i_150_
				= this.clc[i][0][i_138_ / 2][0];
			    int i_151_
				= this.clc[i][0][i_138_ / 2][1];
			    int i_152_
				= this.clc[i][0][i_138_ / 2][2];
			    for (int i_153_ = 0; i_153_ < 16; i_153_++) {
				if (i_149_ > this.fade[i_153_]) {
				    i_150_ = ((i_150_ * this.fogd
					       + this.cfade[0])
					      / (this.fogd + 1));
				    i_151_ = ((i_151_ * this.fogd
					       + this.cfade[1])
					      / (this.fogd + 1));
				    i_152_ = ((i_152_ * this.fogd
					       + this.cfade[2])
					      / (this.fogd + 1));
				}
			    }
		...
		for (int i_161_ = 0; i_161_ < 12; i_161_++) {
			...
			i_154_++;
		    if (is_112_[i_161_] > this.h
			|| is_110_[0][i_161_] < 10)
			i_155_++;
		    if (is_111_[i_161_] < 0 || is_110_[0][i_161_] < 10)
			i_156_++;
		    if (is_111_[i_161_] > this.w
			|| is_110_[0][i_161_] < 10)
			i_157_++;
		}
		...
		if (bool_116_) {
			...
			for (int i_166_ = 0; i_166_ < 16; i_166_++) {
				...
				i_163_ = ((i_163_ * this.fogd
					   + this.cfade[0])
					  / (this.fogd + 1));
				i_164_ = ((i_164_ * this.fogd
					   + this.cfade[1])
					  / (this.fogd + 1));
				i_165_ = ((i_165_ * this.fogd
					   + this.cfade[2])
					  / (this.fogd + 1));
			    }
			}
	...
	for (int i_174_ = 0; i_174_ < this.nmt; i_174_++) {
	    ...
	    this.mtx[i_174_]
		= new int[this.nmv[i_174_] * 2];
	    this.mty[i_174_]
		= new int[this.nmv[i_174_] * 2];
	    this.mtz[i_174_]
		= new int[this.nmv[i_174_] * 2];
	    this.mtc[i_174_]
		= new int[this.nmv[i_174_]][3];
	    for (int i_178_ = 0; i_178_ < this.nmv[i_174_];
		 i_178_++) {
		this.mtx[i_174_][i_178_]
		...
		this.mtx[i_174_][(i_178_
		    ...
		    = (int) (((double) (i_178_ * 500)
			      ...
			      - (double) (250
					  * (this.nmv[i_174_] - 1)))
			     * (double) f);
		this.mtx[i_174_][this.nmv[i_174_]]
		    = (int) ((double) this.mtx[i_174_][0]
			     - ((100.0 + random.nextDouble() * 600.0)
				* (double) f));
		this.mtx[i_174_][(this.nmv[i_174_] * 2
					     - 1)]
		    = (int) ((double) (this.mtx[i_174_]
				       [this.nmv[i_174_] - 1])
			     + ((100.0 + random.nextDouble() * 600.0)
				* (double) f));
		if (i_178_ == 0 || i_178_ == this.nmv[i_174_] - 1)
		    this.mty[i_174_][i_178_]
	    ...
	    for (int i_180_ = 1; i_180_ < this.nmv[i_174_] - 1;
		 i_180_++) {
		int i_181_ = i_180_ - 1;
		int i_182_ = i_180_ + 1;
		this.mty[i_174_][i_180_]
		    = ((this.mty[i_174_][i_181_]
			+ this.mty[i_174_][i_182_]) / 2
		       + this.mty[i_174_][i_180_]) / 2;
	    }
	    rot(this.mtx[i_174_], this.mtz[i_174_],
		i_170_, i_171_, i_177_, this.nmv[i_174_] * 2);
	    is_173_[i_174_] = 0;
	}
	for (int i_183_ = 0; i_183_ < this.nmt; i_183_++) {
	    for (int i_184_ = i_183_ + 1; i_184_ < this.nmt;
		 i_184_++) {
	...
	for (int i = 0; i < this.nmt; i++) {
	    ...
	    int i_186_ = (this.cx
			  + (int) (((float) (this.mtx[i_185_][0]
					     - this.x / 30
					     - this.cx)
				    * cos(this.xz))
				   - ((float) (this.mtz[i_185_][0]
					       - this.z / 30
					       - this.cz)
				      * sin(this.xz))));
	    int i_187_ = (this.cz
			  + (int) (((float) (this.mtx[i_185_][0]
				   ...
				   + ((float) (this.mtz[i_185_][0]
				      ...
				      * cos(this.xz))));
	    int i_188_ = (this.cz
			  + (int) (((float) (this.mty[i_185_][0]
					     - this.y / 30
					     - this.cy)
				    * sin(this.zy))
				   + ((float) (i_187_ - this.cz)
				      * cos(this.zy))));
	    int i_189_
		= (this.cx
		   + (int) (((float) ((this.mtx[i_185_]
				       [this.nmv[i_185_] - 1])
				      - this.x / 30
				      - this.cx)
			     * cos(this.xz))
			    - ((float) ((this.mtz[i_185_]
					 [this.nmv[i_185_] - 1])
					- this.z / 30
					- this.cz)
			       * sin(this.xz))));
	    ...
	    int i_191_
		= (this.cz
		   + (int) (((float) ((this.mty[i_185_]
				       [this.nmv[i_185_] - 1])
				      - this.y / 30
				      - this.cy)
			     * sin(this.zy))
			    + ((float) (i_190_ - this.cz)
			       * cos(this.zy))));
	    if (xs(i_189_, i_191_) > 0
		&& xs(i_186_, i_188_) < this.w) {
		int[] is = new int[this.nmv[i_185_] * 2];
		int[] is_192_ = new int[this.nmv[i_185_] * 2];
		int[] is_193_ = new int[this.nmv[i_185_] * 2];
		for (int i_194_ = 0; i_194_ < this.nmv[i_185_] * 2;
		     i_194_++) {
		    is[i_194_] = (this.mtx[i_185_][i_194_]
				  - this.x / 30);
		    is_192_[i_194_] = (this.mty[i_185_][i_194_]
				       - this.y / 30);
		    is_193_[i_194_] = (this.mtz[i_185_][i_194_]
				       - this.z / 30);
		}
		int i_195_
		    = (int) (Math.sqrt
			     ((double) ((is[this.nmv[i_185_] / 4]
					 * is[this.nmv[i_185_] / 4])
					+ ((is_193_
					    [this.nmv[i_185_] / 4])
					   * is_193_[(this.nmv
						      [i_185_]) / 4]))));
		rot(is, is_193_, this.cx, this.cz,
		    this.xz, this.nmv[i_185_] * 2);
		rot(is_192_, is_193_, this.cy, this.cz,
		    this.zy, this.nmv[i_185_] * 2);
		...
		for (int i_202_ = 0; i_202_ < this.nmv[i_185_] - 1;
		     i_202_++) {
		    int i_203_ = 0;
		    int i_204_ = 0;
		    int i_205_ = 0;
			...
			if (is_197_[i_207_] < 0 || is_193_[i_208_] < 10)
			    i_203_++;
			if (is_197_[i_207_] > this.h
			    || is_193_[i_208_] < 10)
			    i_204_++;
			if (is_196_[i_207_] < 0 || is_193_[i_208_] < 10)
			    i_205_++;
			if (is_196_[i_207_] > this.w
			    || is_193_[i_208_] < 10)
			    i_206_++;
		    }
			...
			float f
			    = ((float) i_195_ / 2500.0F
			       + ((8000.0F - (float) this.fade[0])
				  / 1000.0F)
			       - 2.0F
			       - ((float) Math.abs(this.y)
				  - 250.0F) / 5000.0F);
			if (f > 0.0F && f < 10.0F) {
			    if ((double) f < 3.5)
				f = 3.5F;
			    int i_209_
				= (int) (((float) ((this.mtc[i_185_]
						    [i_202_][0])
						   + this.cgrnd[0])
					  + (float) this.csky[0] * f
					  + ((float) this.cfade[0]
	...
	for (int i = 0; i < this.nst; i++) {
	    int i_215_
		= this.cx + (int) (((float) this.stx[i]
					       * cos(this.xz))
					      - ((float) this.stz[i]
						 * sin(this.xz)));
	    int i_216_
		= this.cz + (int) (((float) this.stx[i]
					       * sin(this.xz))
					      + ((float) this.stz[i]
						 * cos(this.xz)));
	    int i_217_
		= (this.cy
		   + (int) (-200.0F * cos(this.zy)
			    - (float) i_216_ * sin(this.zy)));
	    int i_218_
		= (this.cz
		   + (int) (-200.0F * sin(this.zy)
			    + (float) i_216_ * cos(this.zy)));
		...
		if (this.bst[i])
		    i_222_ = 1;
		graphics2d.setColor(new Color(this.stc[i][1][0],
					      this.stc[i][1][1],
					      this.stc[i][1][2]));
		...
		graphics2d.fillRect(i_215_, i_217_ - 1, 1 + i_222_,
				    3 + i_222_);
		graphics2d.setColor(new Color(this.stc[i][0][0],
					      this.stc[i][0][1],
					      this.stc[i][0][2]));
	...
	for (int i_230_ = 0; i_230_ < 16; i_230_++) {
	    ...
	    if (this.zy != 0) {
		i_232_ = (this.cy
			  + (int) (((float) (this.ground
					     - this.cy)
				    * cos(this.zy))
				   - ((float) (this.fade[i_230_]
					       - this.cz)
				      * sin(this.zy))));
		i_231_ = (this.cz
			  + (int) (((float) (this.ground
	...
	for (int i_239_ = 0; i_239_ < 16; i_239_++) {
	    ...
	    if (this.zy != 0) {
		i_241_ = (this.cy
			  + (int) (((float) (this.skyline
					     - this.cy)
				    * cos(this.zy))
				   - ((float) (this.fade[i_239_]
					       - this.cz)
				      * sin(this.zy))));
		i_240_ = (this.cz
			  + (int) (((float) (this.skyline
	...
	if (is_223_[0] < this.h
	    && is_223_[1] > this.ih) {
	    float f = (((float) Math.abs(this.y) - 250.0F)
		       / (float) (this.fade[0] * 2));
	    if (f < 0.0F)
		f = 0.0F;
	    if (f > 1.0F)
	...
	for (int i_251_ = 0; i_251_ < 3; i_251_++) {
	    this.clds[i_251_]
		= ((this.osky[i_251_] * this.cldd[3]
		    + this.cldd[i_251_])
		   / (this.cldd[3] + 1));
	    this.clds[i_251_]
		= (int) ((float) this.clds[i_251_]
			 + ((float) this.clds[i_251_]
			    * ((float) this.snap[i_251_]
			       / 100.0F)));
	...
	this.csky[0]
	    = (int) ((float) i
		     + (float) i * ((float) this.snap[0] / 100.0F));
	if (this.csky[0] > 255)
	    this.csky[0] = 255;
	if (this.csky[0] < 0)
	    this.csky[0] = 0;
	this.csky[1]
	    = (int) ((float) i_249_
		     + (float) i_249_ * ((float) this.snap[1]
					 / 100.0F));
	if (this.csky[1] > 255)
	    this.csky[1] = 255;
	if (this.csky[1] < 0)
	...
	this.csky[2]
	    = (int) ((float) i_250_
		     + (float) i_250_ * ((float) this.snap[2]
					 / 100.0F));
	if (this.csky[2] > 255)
	    this.csky[2] = 255;
	if (this.csky[2] < 0)
	...
	Color.RGBtoHSB(this.csky[0], this.csky[1],
		       this.csky[2], fs);
	if ((double) fs[2] < 0.6)
	    this.darksky = true;
	else
	...
	for (int i_256_ = 0; i_256_ < 3; i_256_++) {
	    this.clds[i_256_]
		= ((this.osky[i_256_] * this.cldd[3]
		    + this.cldd[i_256_])
		   / (this.cldd[3] + 1));
	    this.clds[i_256_]
		= (int) ((float) this.clds[i_256_]
			 + ((float) this.clds[i_256_]
			    * ((float) this.snap[i_256_]
			       / 100.0F)));
	...
	for (int i_259_ = 0; i_259_ < 3; i_259_++) {
	    this.cpol[i_259_]
		= ((this.ogrnd[i_259_] * this.texture[3]
		    + this.texture[i_259_])
		   / (1 + this.texture[3]));
	    this.cpol[i_259_]
		= (int) ((float) this.cpol[i_259_]
			 + ((float) this.cpol[i_259_]
			    * ((float) this.snap[i_259_]
			       / 100.0F)));
	...
	this.cgrnd[1]
	    = (int) ((float) i_257_
		     + (float) i_257_ * ((float) this.snap[1]
					 / 100.0F));
	if (this.cgrnd[1] > 255)
	    this.cgrnd[1] = 255;
	if (this.cgrnd[1] < 0)
	...
	this.cgrnd[2]
	    = (int) ((float) i_258_
		     + (float) i_258_ * ((float) this.snap[2]
					 / 100.0F));
	if (this.cgrnd[2] > 255)
	    this.cgrnd[2] = 255;
	if (this.cgrnd[2] < 0)
	...
	for (int i_260_ = 0; i_260_ < 3; i_260_++)
	    this.crgrnd[i_260_]
		= (int) (((double) this.cpol[i_260_] * 0.99
			  + (double) this.cgrnd[i_260_])
			 / 2.0);
    }
	...
	this.cpol[1]
	    = (int) ((float) i_261_
		     + (float) i_261_ * ((float) this.snap[1]
					 / 100.0F));
	if (this.cpol[1] > 255)
	    this.cpol[1] = 255;
	if (this.cpol[1] < 0)
	...
	this.cpol[2]
	    = (int) ((float) i_262_
		     + (float) i_262_ * ((float) this.snap[2]
					 / 100.0F));
	if (this.cpol[2] > 255)
	    this.cpol[2] = 255;
	if (this.cpol[2] < 0)
	...
	for (int i_264_ = 0; i_264_ < 3; i_264_++)
	    this.crgrnd[i_264_]
		= (int) (((double) this.cpol[i_264_] * 0.99
			  + (double) this.cgrnd[i_264_])
			 / 2.0);
    }
	...
	this.cpol[1]
	    = (int) ((float) i_265_
		     + (float) i_265_ * ((float) this.snap[1]
					 / 100.0F));
	if (this.cpol[1] > 255)
	    this.cpol[1] = 255;
	if (this.cpol[1] < 0)
	...
	this.cpol[2]
	    = (int) ((float) i_266_
		     + (float) i_266_ * ((float) this.snap[2]
					 / 100.0F));
	if (this.cpol[2] > 255)
	    this.cpol[2] = 255;
	if (this.cpol[2] < 0)
	...
	for (int i_267_ = 0; i_267_ < 3; i_267_++)
	    this.crgrnd[i_267_]
		= (int) (((double) this.cpol[i_267_] * 0.99
			  + (double) this.cgrnd[i_267_])
			 / 2.0);
    }
	...
	this.cfade[1]
	    = (int) ((float) i_268_
		     + (float) i_268_ * ((float) this.snap[1]
					 / 100.0F));
	if (this.cfade[1] > 255)
	    this.cfade[1] = 255;
	if (this.cfade[1] < 0)
	...
	this.cfade[2]
	    = (int) ((float) i_269_
		     + (float) i_269_ * ((float) this.snap[2]
					 / 100.0F));
	if (this.cfade[2] > 255)
	    this.cfade[2] = 255;
	if (this.cfade[2] < 0)
	...
	if (i_272_ < this.cz)
	    i_272_ = this.cz;
	return (((i_272_ - this.focus_point)
		 * (this.cx - i) / i_272_)
		+ i);
    }
	...
	if (i_273_ < 10)
	    i_273_ = 10;
	return (((i_273_ - this.focus_point)
		 * (this.cy - i) / i_273_)
		+ i);
    }
