...
public class Medium {
    ...
    public void around(final ContO conto, final boolean bool) {
        ...
        final int i_6_ = (int) Math.sqrt((conto.z - z + cz) * (conto.z - z + cz) + (conto.x - x - cx) * (conto.x - x - cx));
        int i_7_ = (int) (90 + i_4_ - Math.atan((double) i_6_ / (double) (conto.y - i_5_ - cy)) / 0.017453292519943295);
        xz = -vxz + 90;
        if (bool) {
            i_7_ -= 15;
        }
            ...
            if (i_107_ > 0 && i_108_ < w && i_106_ > -cmx[i] && i_107_ - i_108_ > 20) {
                ...
                for (int i_122_ = 0; i_122_ < 12; i_122_ += 2) {
                    ...
                    if (bool_116_) {
                        ...
                        i_127_ /= 6;
                        i_129_ /= 6;
                        final int i_133_ = (int) Math.sqrt((cy - i_127_) * (cy - i_127_) + (cx - i_128_) * (cx - i_128_) + i_129_ * i_129_);
                        if (i_133_ < fade[7]) {
                ...
                for (int i_138_ = 0; i_138_ < 12; i_138_ += 2) {
                    ...
                    if (bool_116_) {
                        ...
                        i_143_ /= 6;
                        i_145_ /= 6;
                        final int i_149_ = (int) Math.sqrt((cy - i_143_) * (cy - i_143_) + (cx - i_144_) * (cx - i_144_) + i_145_ * i_145_);
                        if (i_149_ < fade[7]) {
                ...
                if (bool_116_) {
                    ...
                    i_158_ /= 12;
                    i_160_ /= 12;
                    final int i_162_ = (int) Math.sqrt((cy - i_158_) * (cy - i_158_) + (cx - i_159_) * (cx - i_159_) + i_160_ * i_160_);
                    if (i_162_ < fade[7]) {
                        int i_163_ = clds[0];
                        int i_164_ = clds[1];
                        int i_165_ = clds[2];
    ...
    public void drawmountains(final Graphics2D graphics2d) {
        for (int i = 0; i < nmt; i++) {
            ...
            final int i_186_ = cx + (int) ((mtx[i_185_][0] - x / 30 - cx) * cos(xz) - (mtz[i_185_][0] - z / 30 - cz) * sin(xz));
            final int i_187_ = cz + (int) ((mtx[i_185_][0] - x / 30 - cx) * sin(xz) + (mtz[i_185_][0] - z / 30 - cz) * cos(xz));
            final int i_188_ = cz + (int) ((mty[i_185_][0] - y / 30 - cy) * sin(zy) + (i_187_ - cz) * cos(zy));
            final int i_189_ = cx + (int) ((mtx[i_185_][nmv[i_185_] - 1] - x / 30 - cx) * cos(xz) - (mtz[i_185_][nmv[i_185_] - 1] - z / 30 - cz) * sin(xz));
            final int i_190_ = cz + (int) ((mtx[i_185_][nmv[i_185_] - 1] - x / 30 - cx) * sin(xz) + (mtz[i_185_][nmv[i_185_] - 1] - z / 30 - cz) * cos(xz));
            final int i_191_ = cz + (int) ((mty[i_185_][nmv[i_185_] - 1] - y / 30 - cy) * sin(zy) + (i_190_ - cz) * cos(zy));
            if (xs(i_189_, i_191_) > 0 && xs(i_186_, i_188_) < w) {
                ...
                final int i_195_ = (int) Math.sqrt(is[nmv[i_185_] / 4] * is[nmv[i_185_] / 4] + is_193_[nmv[i_185_] / 4] * is_193_[nmv[i_185_] / 4]);
                ...
                for (int i_202_ = 0; i_202_ < nmv[i_185_] - 1; i_202_++) {
                    ...
                    if (bool_201_) {
                        float f = i_195_ / 2500.0F + (8000.0F - fade[0]) / 1000.0F - 2.0F - (Math.abs(y) - 250.0F) / 5000.0F;
                        if (f > 0.0F && f < 10.0F) {
                            if (f < 3.5) {
                                f = 3.5F;
                            }
                            final int i_209_ = (int) ((mtc[i_185_][i_202_][0] + cgrnd[0] + csky[0] * f + cfade[0] * f) / (2.0F + f * 2.0F));
                            final int i_210_ = (int) ((mtc[i_185_][i_202_][1] + cgrnd[1] + csky[1] * f + cfade[1] * f) / (2.0F + f * 2.0F));
                            final int i_211_ = (int) ((mtc[i_185_][i_202_][2] + cgrnd[2] + csky[2] * f + cfade[2] * f) / (2.0F + f * 2.0F));
    ...
    public void getaround(final ContO conto) {
        ...
        int i_14_ = -(int) (90 + i_13_ + Math.atan((double) (conto.z - z) / (double) (conto.x - x - cx)) / 0.017453292519943295);
        int i_15_ = y;
        i_13_ = 0;
        if (i_15_ > 0) {
            i_15_ = 0;
        ...
        final int i_16_ = (int) Math.sqrt((conto.z - z + cz) * (conto.z - z + cz) + (conto.x - x - cx) * (conto.x - x - cx));
        int i_17_ = 25;
        if (i_16_ != 0) {
            i_17_ = (int) (90 + i_13_ - Math.atan((double) i_16_ / (double) (conto.y - i_15_ - cy)) / 0.017453292519943295);
        }
        ...
        for (int i_51_ = i; i_51_ < i_48_; i_51_++) {
            for (int i_52_ = i_49_; i_52_ < i_50_; i_52_++) {
                ...
                if (resdown < 2 || i_53_ % 2 == 0) {
                    final int i_54_ = cx + (int) ((cgpx[i_53_] - x - cx) * cos(xz) - (cgpz[i_53_] - z - cz) * sin(xz));
                    final int i_55_ = cz + (int) ((cgpx[i_53_] - x - cx) * sin(xz) + (cgpz[i_53_] - z - cz) * cos(xz));
    ...
    public void newclouds(int i, int i_88_, int i_89_, int i_90_) {
        ...
        for (int i_91_ = 0; i_91_ < noc; i_91_++) {
            ...
            for (int i_97_ = 0; i_97_ < 12; i_97_++) {
                ...
                final int i_100_ = (int) Math.sqrt(clax[i_91_][2][i_97_] * clax[i_91_][2][i_97_] + claz[i_91_][2][i_97_] * claz[i_91_][2][i_97_]);
                if (i_100_ > cmx[i_91_]) {
                    cmx[i_91_] = i_100_;
                }
            }
    ...
    public void newmountains(final int i, final int i_167_, final int i_168_, final int i_169_) {
        ...
        for (int i_174_ = 0; i_174_ < nmt; i_174_++) {
            ...
            for (int i_178_ = 0; i_178_ < nmv[i_174_]; i_178_++) {
                mtx[i_174_][i_178_] = (int) ((i_178_ * 500 + (random.nextDouble() * 800.0 - 400.0) - 250 * (nmv[i_174_] - 1)) * f);
                mtx[i_174_][i_178_ + nmv[i_174_]] = (int) ((i_178_ * 500 + (random.nextDouble() * 800.0 - 400.0) - 250 * (nmv[i_174_] - 1)) * f);
                mtx[i_174_][nmv[i_174_]] = (int) (mtx[i_174_][0] - (100.0 + random.nextDouble() * 600.0) * f);
                mtx[i_174_][nmv[i_174_] * 2 - 1] = (int) (mtx[i_174_][nmv[i_174_] - 1] + (100.0 + random.nextDouble() * 600.0) * f);
    ...
    public void newpolys(final int i, final int i_35_, final int i_36_, final int i_37_, final Trackers trackers, final int i_38_) {
                ...
                for (int i_42_ = 0; i_42_ < trackers.nt; i_42_++)
                    if (trackers.zy[i_42_] == 0 && trackers.xy[i_42_] == 0) {
                        if (trackers.radx[i_42_] < trackers.radz[i_42_] && Math.abs(cgpz[i_41_] - trackers.z[i_42_]) < trackers.radz[i_42_]) {
                            for (/**/; Math.abs(cgpx[i_41_] - trackers.x[i_42_]) < trackers.radx[i_42_]; cgpx[i_41_] += random.nextDouble() * trackers.radx[i_42_] * 2.0 - trackers.radx[i_42_]) {
                                /* empty */
                            }
                        }
                        if (trackers.radz[i_42_] < trackers.radx[i_42_] && Math.abs(cgpx[i_41_] - trackers.x[i_42_]) < trackers.radx[i_42_]) {
                            for (/**/; Math.abs(cgpz[i_41_] - trackers.z[i_42_]) < trackers.radz[i_42_]; cgpz[i_41_] += random.nextDouble() * trackers.radz[i_42_] * 2.0 - trackers.radz[i_42_]) {
                                /* empty */
                            }
                        }
                    }
        ...
        for (int i_43_ = 0; i_43_ < nrw * ncl; i_43_++) {
            ...
            for (int i_44_ = 0; i_44_ < 8; i_44_++) {
                ...
                final int i_47_ = (int) Math.sqrt((int) (ogpx[i_43_][i_44_] * ogpx[i_43_][i_44_] * pvr[i_43_][i_44_] * pvr[i_43_][i_44_] + ogpz[i_43_][i_44_] * ogpz[i_43_][i_44_] * pvr[i_43_][i_44_] * pvr[i_43_][i_44_]));
                if (i_47_ > pmx[i_43_]) {
                    pmx[i_43_] = i_47_;
                }
            }
    ...
    public void rot(final int[] is, final int[] is_274_, final int i, final int i_275_, final int i_276_, final int i_277_) {
        if (i_276_ != 0) {
    ...
    public void transaround(final ContO conto, final ContO conto_18_, final int i) {
        ...
        final int i_25_ = (int) Math.sqrt((i_21_ - z + cz) * (i_21_ - z + cz) + (i_19_ - x - cx) * (i_19_ - x - cx));
        final int i_26_ = (int) (90 + i_23_ - Math.atan((double) i_25_ / (double) (i_20_ - i_24_ - cy)) / 0.017453292519943295);
        xz = -vxz + 90;
        zy += (i_26_ - zy) / 10;
    }
    ...
    public void watch(final ContO conto, final int i) {
        ...
        int i_1_ = -(int) (90 + i_0_ + Math.atan((double) (conto.z - z) / (double) (conto.x - x - cx)) / 0.017453292519943295);
        i_0_ = 0;
        if (conto.y - y - cy < 0) {
            i_0_ = -180;
        }
        final int i_2_ = (int) Math.sqrt((conto.z - z) * (conto.z - z) + (conto.x - x - cx) * (conto.x - x - cx));
        final int i_3_ = (int) (90 + i_0_ - Math.atan((double) i_2_ / (double) (conto.y - y - cy)) / 0.017453292519943295);
        for (/**/; i_1_ < 0; i_1_ += 360) {
            /* empty */
        }
