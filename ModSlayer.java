...
public class ModSlayer {
    ...
    final void startplaying(final boolean flag) {
        ...
        if (mod.s3m) {
            for (final ModInstrument inst : mod.insts) {
                final ModInstrument modinstrument = inst;
            ...
            for (final ModInstrument inst : mod.insts) {
                final ModInstrument modinstrument1 = inst;
                modinstrument1.finetune_rate = (int) (0x14b080000000L / (mixspeed * (1536 - modinstrument1.finetune_value)));
