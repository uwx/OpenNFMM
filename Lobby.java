...
public class Lobby implements Runnable {
	...
	GameSparker gamesparker) {
		...
		lg = login;
		gb = globe;
		(gs).cmsg.setBackground(color2k(240, 240,
		240));
		(gs).swait.setBackground(color2k(220, 220,
		220));
		(gs).snpls.setBackground(color2k(220, 220,
		220));
		(gs).snbts.setBackground(color2k(220, 220,
		220));
		(gs).sgame.setBackground(color2k(200, 200,
		200));
		(gs).wgame.setBackground(color2k(200, 200,
		200));
		(gs).pgame.setBackground(color2k(200, 200,
		200));
		(gs).vnpls.setBackground(color2k(200, 200,
		200));
		(gs).vtyp.setBackground(color2k(200, 200,
		200));
		(gs).warb.setBackground(color2k(200, 200,
		200));
		(gs).snfmm.setBackground(color2k(200, 200,
		200));
		(gs).snfm1.setBackground(color2k(200, 200,
		200));
		(gs).snfm2.setBackground(color2k(200, 200,
		200));
		(gs).mstgs.setBackground(color2k(230, 230,
		230));
		(gs).slaps.setBackground(color2k(200, 200,
		200));
		(gs).sclass.setBackground(color2k(220, 220, 220));
		(gs).scars.setBackground(color2k(220, 220,
		220));
		(gs).sfix.setBackground(color2k(220, 220,
		220));
		(gs).mycar.setBackground(color2k(255, 255,
		255));
		(gs).notp.setBackground(color2k(255, 255,
		255));
		(gs).rooms.setBackground(color2k(170, 170,
		170));
		(gs).swait.setForeground(new Color(0, 0,
		0));
		(gs).snpls.setForeground(new Color(0, 0,
		0));
		(gs).snbts.setForeground(new Color(0, 0,
		0));
		(gs).sgame.setForeground(new Color(0, 0,
		0));
		(gs).wgame.setForeground(new Color(0, 0,
		0));
		(gs).pgame.setForeground(new Color(0, 0,
		0));
		(gs).vnpls.setForeground(new Color(0, 0,
		0));
		(gs).vtyp.setForeground(new Color(0, 0,
		0));
		(gs).warb.setForeground(new Color(0, 0,
		0));
		(gs).snfmm.setForeground(new Color(0, 0,
		0));
		(gs).snfm1.setForeground(new Color(0, 0,
		0));
		(gs).slaps.setForeground(new Color(0, 0,
		0));
		(gs).snfm2.setForeground(new Color(0, 0,
		0));
		(gs).mstgs.setForeground(new Color(0, 0,
		0));
		(gs).sclass.setForeground(new Color(0, 0,
		0));
		(gs).scars.setForeground(new Color(0, 0,
		0));
		(gs).sfix.setForeground(new Color(0, 0,
		0));
		(gs).mycar.setForeground(new Color(0, 0,
		0));
		(gs).notp.setForeground(new Color(0, 0,
		0));
		(gs).rooms.setForeground(new Color(0, 0,
		0));
		(gs).sgame.removeAll();
		(gs).sgame.add(rd,
			" NFM Multiplayer ");
	...
	public void inishlobby() {
		...
		(gs).rooms.removeAll();
		(gs).rooms.add(rd,
		new StringBuilder().append("").append((xt).servername).append(" :: ").append((xt).servport - 7070).append("").toString());
		(gs).rooms.select(0);
		gs.requestFocus();
		cd.loadready();
		for (int i = 0; i < 500; i++) {
		...
		while (conon == 1) {
			...
			if ((join >= 0 || pgames[im] != -1) && !regnow) {
				...
				for (int i_2_ = 0; i_2_ < ngm; i_2_++) {
					if (join == gnum[i_2_] || (pgames[im] == gnum[i_2_])) i_1_ = i_2_;
				}
				if (i_1_ != -1) {
					boolean bool = false;
					ontyp = 0;
			...
			if ((xt).sc[0] >= 16) string = new StringBuilder().append("C").append((cd).names[(xt).sc[0]])
				.append("").toString();
			String string_4_ = new StringBuilder().append("1|").append((xt).nickname).append(":").append((xt).nickey).append("|").append((xt).clan).append("|").append((xt).clankey).append("|").append(string).append("|").append(join).append("|").append((int)((xt).arnp[0] * 100.0F))
				.append("|").append((int)((xt).arnp[1] * 100.0F))
				.append("|").append((int)((xt).arnp[2] * 100.0F))
				.append("|").append((int)((xt).arnp[3] * 100.0F))
				.append("|").append((int)((xt).arnp[4] * 100.0F))
				.append("|").append((int)((xt).arnp[5] * 100.0F))
				.append("|").append(ongame).append("|").toString();
			if (!(xt).lan) {
				string_4_ = new StringBuilder().append(string_4_).append("").append(updatec).append("|").toString();
				if (updatec <= -11) {
					for (int i_5_ = 0; i_5_ < -updatec - 10;
					i_5_++)
			...
			if (chalngd == -5 && !fstart) {
				string_4_ = new StringBuilder().append(string_4_).append("11|")
					.append(gstage).append("|").append(gstagename).append("|").append(gstagelaps).append("|").append(gnpls).append("|").append(gwait).append("|").append(pnames[im]).append("|").append(gcars).append("|").append(gclass).append("|").append(gfix).append("|").append(gnotp).append("|").append(gplayers).append("|").toString();
				if ((xt).lan) string_4_ = new StringBuilder().append(string_4_).append("").append(gnbts).append("|").toString();
			}
			...
			if (bool_11_) {
				...
				try {
					socket = new Socket((xt).server, ((xt)
						.servport));
					din = (new BufferedReader(new InputStreamReader(socket.getInputStream())));
					dout = new PrintWriter(socket.getOutputStream(),
					true);
			...
			for (int i_12_ = 0; i_12_ < npo; i_12_++) {
				...
				if (string_13_.startsWith("C")) {
					...
					if (!pcarnames[i_12_].equals("")) {
						...
						if (i_14_ == 0) {
							...
							i_17_ < (cd).nl;
							i_17_++) {
								if (pcarnames[i_12_].equals((cd).loadnames[i_17_])) bool_16_ = true;
							}
				...
				pcols[i_12_][0] = (float) getvalue(string_10_, 6 + i_12_ * 10) / 100.0F;
				if (pcols[i_12_][0] == -1.0F)
				pcols[i_12_][0] = 0.0F;
				pcols[i_12_][1] = (float) getvalue(string_10_, 7 + i_12_ * 10) / 100.0F;
				if (pcols[i_12_][1] == -1.0F)
				pcols[i_12_][1] = 0.0F;
				pcols[i_12_][2] = (float) getvalue(string_10_, 8 + i_12_ * 10) / 100.0F;
				if (pcols[i_12_][2] == -1.0F)
				pcols[i_12_][2] = 0.0F;
				pcols[i_12_][3] = (float) getvalue(string_10_, 9 + i_12_ * 10) / 100.0F;
				if (pcols[i_12_][3] == -1.0F)
				pcols[i_12_][3] = 0.0F;
				pcols[i_12_][4] = (float) getvalue(string_10_, 10 + i_12_ * 10) / 100.0F;
				if (pcols[i_12_][4] == -1.0F)
				pcols[i_12_][4] = 0.0F;
				pcols[i_12_][5] = (float) getvalue(string_10_, 11 + i_12_ * 10) / 100.0F;
			...
			if (ongame != -1) {
				...
				for (int i_25_ = 0; i_25_ < ngm; i_25_++) {
					if (ongame == gnum[i_25_]) bool_24_ = true;
				}
				if (!bool_24_)
				britchl = -1;
			}
			if (join > -1) {
				...
				for (int i_27_ = 0; i_27_ < ngm; i_27_++) {
					if (join == gnum[i_27_]) bool_26_ = true;
				}
				if (!bool_26_)
				join = -1;
			}
			for (int i_28_ = 0; i_28_ < npo; i_28_++) {
				if (pgames[i_28_] != -1) {
					...
					for (int i_30_ = 0; i_30_ < ngm; i_30_++) {
						if (pgames[i_28_] == gnum[i_30_]) bool_29_ = true;
					}
					if (!bool_29_)
					pgames[i_28_] = -1;
				}
			}
			if ((xt).lan) i_18_ += 14 + (ngm - 1) * 13;
			else i_18_ += 13 + (ngm - 1) * 12;
			if (!(xt).lan) {
				...
				if (ongame != -1) {
					...
					for (int i_35_ = 0; i_35_ < ngm; i_35_++) {
						if (ongame == gnum[i_35_] && wait[i_35_] <= 0) bool_34_ = true;
					}
					if (bool_34_) {
						...
						if (prevloaded == 1) {
							...
							i_18_++;
							for (int i_36_ = 0; i_36_ < prnpo;
							i_36_++) {
								prnames[i_36_] = getSvalue(string_10_, i_18_);
								i_18_++;
							}
							for (int i_37_ = 0; i_37_ < prnpo;
							i_37_++) {
								ppos[i_37_] = getvalue(string_10_, i_18_);
								i_18_++;
							}
							for (int i_38_ = 0; i_38_ < prnpo;
							i_38_++) {
								plap[i_38_] = getvalue(string_10_, i_18_);
								i_18_++;
							}
							for (int i_39_ = 0; i_39_ < prnpo;
							i_39_++) {
								ppow[i_39_] = (int)((float) getvalue(string_10_,
								i_18_) / 9800.0F * 55.0F);
								i_18_++;
							}
							for (int i_40_ = 0; i_40_ < prnpo;
							i_40_++) {
			...
			if (i_43_ != -1) {
				...
				for (int i_45_ = 0; i_45_ < ngm; i_45_++) {
					if (i_43_ == gnum[i_45_]) i_44_ = i_45_;
				}
				boolean bool_46_ = false;
				if (gwarb[i_44_] != 0) {
					if ((xt).clan.toLowerCase()
						.equals(gaclan[i_44_].toLowerCase()) || ((xt).clan.toLowerCase().equals(gvclan[i_44_].toLowerCase()))) bool_46_ = true;
				} else bool_46_ = true;
				if (((pgames[im] != ongame) || ongame == -1) && i_43_ != ongame && chalngd == -1 && join == -1 && fase == 1 && wait[i_44_] > 0 && bool_46_) {
					chalngd = i_43_;
			...
			if (!(xt).lan) {
				...
				for (int i_50_ = 0;
				i_50_ < (lg).nservers; i_50_++) {
					if (!((xt).server.equals((lg).servers[i_50_])) && ((xt).delays[i_50_] < 300)) {
						((gs).rooms)
							.sopts[i_47_] = new StringBuilder().append(":: ").append((lg).snames[i_50_])
							.append("").toString();
						((gs).rooms)
							.opts[i_47_] = "";
						((gs).rooms)
			...
			if (join > -1) {
				...
				for (int i_52_ = 0; i_52_ < ngm; i_52_++) {
					if (join == gnum[i_52_] && wait[i_52_] == 0) bool_51_ = true;
				}
			...
			if (join == -2) {
				...
				for (int i_54_ = 0; i_54_ < ngm; i_54_++) {
					if ((pgames[im] == gnum[i_54_]) && wait[i_54_] == 0) bool_53_ = true;
				}
		...
		if (conon == 2) {
			...
			while (i_57_ != 0) {
				...
				if ((xt).gameport != -1) {
					...
					if ((xt).im != -1) {
						(xt).playingame = i;
						int i_74_ = 0;
						for (int i_75_ = 0; i_75_ < ngm;
						i_75_++) {
							if (i == gnum[i_75_]) i_74_ = i_75_;
						}
						if (gwarb[i_74_] != 0) {
							...
							(i_76_ < (xt).nplayers);
							i_76_++) {
								for (int i_77_ = 0; i_77_ < npo;
								i_77_++) {
									if (((xt)
										.plnames[i_76_].equals(pnames[i_77_])) && pgames[i_77_] == i)
									(xt)
										.pclan[i_76_] = pclan[i_77_];
								}
							}
						} else(xt).clangame = 0;
					} else {
			...
			if ((xt).playingame != -1) {
				if (!(xt).lan && !(xt).logged) {
					(xt).nfreeplays++;
					try {
						socket = new Socket(((lg).servers[0]),
						7061);
						din = (new BufferedReader(new InputStreamReader(socket.getInputStream())));
						dout = new PrintWriter(socket.getOutputStream(),
						true);
						dout.println(new StringBuilder().append("7|").append((
						xt)
							.nfreeplays)
							.append("|").toString());
			...
			while (i_78_ != 0) {
				...
				if ((xt).gameport != -1) {
					...
					if (((xt).im >= (xt).nplayers) && ((xt).im < (xt).nplayers + 3)) {
						...
						int i_95_ = 0;
						for (int i_96_ = 0; i_96_ < ngm;
						i_96_++) {
							if (ongame == gnum[i_96_]) i_95_ = i_96_;
						}
						if (gwarb[i_95_] != 0) {
							(xt).clangame = gwtyp[i_95_];
							(xt).gaclan = gaclan[i_95_];
							if (((xt).clan.toLowerCase().equals(gaclan[i_95_].toLowerCase())) || ((xt).clan.toLowerCase().equals(gvclan[i_95_].toLowerCase())))
							(xt).clanchat = true;
							for (int i_97_ = 0;
							(i_97_ < (xt).nplayers);
							i_97_++) {
								for (int i_98_ = 0; i_98_ < npo;
								i_98_++) {
									if (((xt)
										.plnames[i_97_].equals(pnames[i_98_])) && (pgames[i_98_] == ongame))
									(xt)
										.pclan[i_97_] = pclan[i_98_];
								}
							}
						} else(xt).clangame = 0;
					} else {
		...
		if ((xt).warning == 0 || (xt).warning == 210) {
			if (!regnow) {
				if (onjoin == -1) {
					...
					if (invo) {
						i_102_ = 0;
						for (int i_103_ = 0; i_103_ < npo;
						i_103_++) {
							if (pgames[i_103_] == -1) i_102_++;
						}
						i_102_ += 2;
					}
					int i_104_ = (i_102_ - 11) * 30;
					if (i_104_ < 0) i_104_ = 0;
					int i_105_ = (int)((float)spos / 295.0F * (float) i_104_);
					int i_106_ = 0;
					int i_107_ = -1;
					int i_108_ = -1;
					if (conon == 1) {
						if (!invo) {
							for (int i_109_ = 0; i_109_ < npo;
							i_109_++) {
								if (pgames[i_109_] != -1) {
									int i_110_ = 0;
									for (int i_111_ = 0;
									i_111_ < ngm;
									i_111_++) {
										if (pgames[i_109_] == gnum[i_111_]) i_110_ = i_111_;
									}
									if (wait[i_110_] > 0) {
										if (82 + 30 * i_106_ - i_105_ > 50 && (82 + 30 * (i_106_ - 1) - i_105_ < 415)) {
											...
											if (i > 70 && i < 185 && i_99_ > (52 + 30 * i_106_ - i_105_) && i_99_ < (82 + 30 * i_106_ - i_105_)) {
												if ((pgames[im]) == -1 && (join == -1) && (chalngd >= -1)) {
													...
													} else rd.setColor(color2k(220, 220,
													220));
													rd.fillRect(70, (53 + 30 * i_106_ - i_105_),
													116, 29);
													i_107_ = i_109_;
												}
												bool_112_ = true;
											...
											else rd.setColor(new Color(34, 55, 0));
											boolean bool_113_ = (gb.drawl(rd, (pnames[i_109_]),
											68,
											53 + 30 * i_106_ - i_105_,
											bool_112_));
											...
											rd.drawLine(70, 82 + 30 * i_106_ - i_105_,
											185,
											82 + 30 * i_106_ - i_105_);
										}
										i_106_++;
						...
						int i_114_ = -1;
						if (invo) {
							for (int i_115_ = 0; i_115_ < ngm;
							i_115_++) {
								if (gwarb[i_115_] != 0 && ((pgames[im]) == gnum[i_115_])) i_114_ = i_115_;
							}
							...
							ftm = rd.getFontMetrics();
							if (i_114_ == -1)
							rd.drawString("Free Players",
							127 - (ftm.stringWidth("Free Players") / 2),
							75 - i_105_);
							else rd.drawString("Members of Clans", (127 - (ftm.stringWidth("Members of Clans") / 2)),
							75 - i_105_);
							rd.setFont(new Font("Arial", 0,
							10));
							ftm = rd.getFontMetrics();
							rd.drawString("Click a player to invite:",
							127 - (ftm.stringWidth("Click a player to invite:")) / 2,
							92 - i_105_);
							rd.setColor(color2k(150, 150, 150));
							rd.drawLine(70, 112 - i_105_, 185,
							112 - i_105_);
							i_106_ += 2;
						}
						for (int i_116_ = 0; i_116_ < npo;
						i_116_++) {
							boolean bool_117_ = false;
							if (invo) {
								if (im == i_116_) bool_117_ = true;
								for (int i_118_ = 0; i_118_ < 7; i_118_++) {
									if ((invos[i_118_].equals(pnames[i_116_])) && !bool_117_) bool_117_ = true;
								}
								if (i_114_ != -1 && !(pclan[i_116_].toLowerCase().equals(gaclan[i_114_].toLowerCase())) && !(pclan[i_116_].toLowerCase().equals(gvclan[i_114_].toLowerCase()))) bool_117_ = true;
							}
							if (pgames[i_116_] == -1 && !bool_117_) {
								if (82 + 30 * i_106_ - i_105_ > 50 && 82 + 30 * (i_106_ - 1) - i_105_ < 415) {
									...
									boolean bool_122_ = (gb.drawl(rd, pnames[i_116_], 68,
									53 + 30 * i_106_ - i_105_,
									bool_119_));
									if (!bool_119_ || !bool_122_) {
										rd.setFont(new Font("Arial", 1, 12));
										ftm = rd.getFontMetrics();
										rd.drawString(pnames[i_116_],
										127 - (ftm.stringWidth(pnames[i_116_])) / 2,
										66 + 30 * i_106_ - i_105_);
										rd.setFont(new Font("Arial", 0, 10));
										ftm = rd.getFontMetrics();
										rd.drawString(pcarnames[i_116_],
										127 - (ftm.stringWidth(pcarnames[i_116_])) / 2,
										78 + 30 * i_106_ - i_105_);
									}
									rd.setColor(color2k(150, 150, 150));
						...
						if (!invo) {
							...
							i_123_ >= 0; i_123_--) {
								if (pgames[i_123_] != -1) {
									...
									i_125_ < ngm;
									i_125_++) {
										if (pgames[i_123_] == gnum[i_125_]) i_124_ = i_125_;
									}
									if (wait[i_124_] <= 0) {
										...
										i_127_++) {
											if (i_123_ != i_127_ && (pnames[i_123_].equals(pnames[i_127_]))) {
												if ((pgames[i_127_]) == -1) bool_126_ = true;
												else {
													for (int i_128_ = 0;
													(i_128_ < (this
														.ngm));
										...
										if (!bool_126_) {
											if (82 + 30 * i_106_ - i_105_ > 50 && (82 + 30 * (i_106_ - 1) - i_105_) < 415) {
												...
												if ((pgames[im]) == -1 && (join == -1) && (chalngd >= -1)) {
													if ((wait[i_124_]) == 0)
													rd.setColor(new Color(117, 67,
													0));
													else rd.setColor(color2k(0, 28,
													102));
												} else if ((wait[i_124_]) == 0)
												rd.setColor(new Color(82, 47, 0));
												else rd.setColor(color2k(0, 20, 71));
												boolean bool_130_ = (gb.drawl(rd, (pnames[i_123_]),
												...
												if (!bool_129_ || !bool_130_) {
													...
													ftm = (this
														.rd.getFontMetrics());
													rd.drawString((pnames[i_123_]), (127 - (this
														.ftm.stringWidth(this
					...
					if (npo == 0) {
						...
						rd.setFont(new Font("Arial", 1, 12));
						ftm = rd.getFontMetrics();
						rd.drawString("|  Loading Players  |",
						127 - (ftm.stringWidth("|  Loading Players  |") / 2),
						95);
					}
					...
					if (mscro == 131 || i_104_ == 0) {
						if (i_104_ == 0)
						rd.setColor(color2k(205, 205, 205));
						else rd.setColor(color2k(215, 215, 215));
					...
					if (i_104_ != 0 && conon == 1) {
						if (lspos != spos) {
							...
							rd.fillRect(193, (70 + spos),
							17, 31);
						} else {
							if (mscro == 131)
							rd.setColor(color2k(215, 215,
							215));
							rd.fill3DRect(193,
							70 + (this
								.spos),
					...
					if (ongame == -1) {
						if (opengame >= 2) {
							...
							rd.setColor(color2k(i_132_, i_132_,
							i_132_));
							rd.fillRoundRect(225,
							59 - (int)((float)opengame * 2.23F),
							495, 200 + opengame * 8, 20,
							20);
							rd.setColor(new Color(0, 0, 0));
							rd.drawRoundRect(225,
							59 - (int)((float)opengame * 2.23F),
							495, 200 + opengame * 8, 20,
							20);
							if (!(xt).lan) {
								rd.setColor(color2k(217, 217,
								217));
								rd.fillRoundRect(225, 263 + opengame * 7,
								495, 157, 20, 20);
								rd.setColor(new Color(0, 0, 0));
								rd.drawRoundRect(225, 263 + opengame * 7,
								495, 157, 20, 20);
							}
							btn = 0;
							if (prevloaded != -1)
							...
							if (!(xt).lan) {
								...
								if (npo <= 1) {
									...
									1, 13));
									ftm = rd.getFontMetrics();
									rd.drawString("You have played the allowed 3 LAN games per day!", (472 - ((ftm.stringWidth("You have played the allowed 3 LAN games per day!")) / 2)),
									295);
									rd.setColor(color2k(70, 70,
									70));
									rd.drawString("There needs to be at least one of the LAN players in the lobby with a registered",
									225, 325);
									rd.drawString("account to be able to play LAN unlimitedly...",
									225, 345);
									rd.drawString("Just one registered user allows everyone in the LAN game to play unlimitedly!",
									225, 365);
									...
									rd.drawString(new StringBuilder().append("[  ")
										...
										.toString(),
									472 - (ftm.stringWidth(new StringBuilder().append("[  ").append(i_106_).append(" Players Connected  ]")
										.toString())) / 2,
									295);
									drawSbutton((
									xt).cgame,
							...
							if ((control).enter && !(gs).cmsg.getText().equals("Type here...") && !(gs).cmsg.getText().equals("")) {
								...
								if ((string.toLowerCase().indexOf((gs)
							...
							if (chalngd == -1) {
								rd.setColor(color2k(230, 230,
								230));
								rd.fillRoundRect(225, 59, 495,
								200, 20, 20);
								rd.setColor(new Color(0, 0, 0));
								rd.drawRoundRect(225, 59, 495,
								200, 20, 20);
								if (britchl != 0)
								britchl = 0;
								i_104_ = (ngm - 5) * 24;
								if (i_104_ < 0) i_104_ = 0;
								i_105_ = (int)(((float)spos2 / 82.0F * (float) i_104_) - 2.0F);
								int[] is = new int[ngm];
								int[] is_137_ = new int[ngm];
								for (int i_138_ = 0;
								i_138_ < ngm; i_138_++)
								is[i_138_] = 0;
								for (int i_139_ = 0;
									...
									i_140_++) {
										if (wait[i_139_] != wait[i_140_]) {
											if ((wait[i_139_] <= 0) && (wait[i_140_] <= 0)) {
												if (wait[i_139_] < (wait[i_140_])) is[i_139_]++;
												else is[i_140_]++;
											} else if ((((wait[i_139_]) > (wait[i_140_])) || (wait[i_139_]) <= 0) && (wait[i_140_]) > 0) is[i_139_]++;
											else is[i_140_]++;
								...
								if ((control).down) {
									...
									((80 + 24 * opselect - i_105_) > 202 && !bool_141_);
								...
								if ((control).up) {
									...
									((80 + 24 * opselect - i_105_) < 80 && !bool_142_);
									i_105_ = (int)(((float)(this
										.spos2) / 82.0F * (float) i_104_) - 2.0F)) {
										spos2--;
										if (spos2 > 82) {
								...
								if (mousonp != -1) {
									...
									i_145_ < ngm;
									i_145_++) {
										if ((pgames[mousonp]) == gnum[i_145_]) i_144_ = i_145_;
									}
								...
								i_149_ < ngm; i_149_++) {
									if (80 + 24 * i_149_ - i_105_ < 224 && 80 + 24 * i_149_ - i_105_ > 56) {
										...
										if (opselect == i_149_) {
											...
											} else rd.setColor(color2k(255, 255, 255));
											rd.fillRect(241,
											92 + 24 * i_149_ - i_105_,
											451, 18);
											if (bool_150_) {
										...
										if ((wait[is_137_[i_149_]]) > 0) {
											rd.drawString(new StringBuilder().append("").append(npls[is_137_[i_149_]])
												.append(" / ").append(mnpls[is_137_[i_149_]])
												.append("").toString(), (556 - (ftm.stringWidth(new StringBuilder()
												.append("").append(npls[is_137_[i_149_]])
												.append(" / ").append(mnpls[is_137_[i_149_]])
												.append("")
												.toString())) / 2),
											105 + 24 * i_149_ - i_105_);
											...
											if ((gwarb[is_137_[i_149_]]) == 0) {
												if (gplyrs[is_137_[i_149_]].equals("") || ((this
													.gplyrs[is_137_[i_149_]].indexOf(pnames[im])) != -1)) bool_153_ = true;
											} else if (((
											xt)
								...
								if (ngm == 0) {
									if (!lloaded)
									rd.drawString("|  Loading Games  |", (472 - (ftm.stringWidth("|  Loading Games  |")) / 2),
									165);
									else if (!(xt)
										.lan)
									rd.drawString("No Games Created",
									472 - (ftm.stringWidth("No Games Created")) / 2,
									165);
								}
								rd.setColor(color2k(205, 205,
								205));
								...
								rd.setColor(color2k(70, 70,
								70));
								rd.drawString("Stage Name",
								382 - ftm.stringWidth("Stage Name") / 2,
								81);
								rd.drawString("|", 525, 81);
								rd.drawString("Players",
								556 - ftm.stringWidth("Players") / 2,
								81);
								rd.drawString("|", 584, 81);
								rd.drawString("Status",
								641 - ftm.stringWidth("Status") / 2,
								81);
								rd.setColor(color2k(150, 150,
								150));
								...
								if (mscro2 == 141 || i_104_ == 0) {
									...
									rd.fillRect(698, 90, 17,
									17);
								} else {
									rd.setColor(color2k(220, 220, 220));
									rd.fill3DRect(698, 90, 17,
									17, true);
								}
								if (i_104_ != 0)
								rd.drawImage((xt).asu,
								...
								if (mscro2 == 142 || i_104_ == 0) {
									...
									rd.fillRect(698, 220, 17,
									17);
								} else {
									rd.setColor(color2k(220, 220, 220));
									rd.fill3DRect(698, 220, 17,
									17, true);
								}
								if (i_104_ != 0)
								rd.drawImage((xt).asd,
								...
								if (i_104_ != 0) {
									if (lspos2 != spos2) {
										rd.setColor(color2k(215, 215, 215));
										rd.fillRect(698, 107 + spos2,
										17, 31);
									} else {
										if (mscro2 == 141)
										rd.setColor(color2k(215, 215, 215));
										rd.fill3DRect(698, 107 + spos2,
										17, 31, true);
									}
									rd.setColor(color2k(150, 150, 150));
									rd.drawLine(703, 120 + spos2, 709,
									120 + spos2);
									rd.drawLine(703, 122 + spos2, 709,
									122 + spos2);
									rd.drawLine(703, 124 + spos2, 709,
									124 + spos2);
									if (mscro2 > 138 && (lspos2 != spos2))
									lspos2 = spos2;
									if (bool) {
										if (mscro2 == 145 && i > 698 && i < 715 && (i_99_ > 107 + spos2) && (i_99_ < spos2 + 138))
										mscro2 = i_99_ - spos2;
								...
								if (mousonp != -1 && i_143_ != -1) {
									...
									rd.fillPolygon(is_155_,
									is_156_, 4);
									rd.setColor(color2k(150, 150, 150));
									rd.drawLine(185, i_108_,
									241, i_143_);
									rd.drawLine(185,
									i_108_ + 30,
									241,
									i_143_ + 19);
									rd.drawLine(241, i_143_,
									692, i_143_);
									rd.drawLine(241,
									i_143_ + 19,
									692,
								...
								if (chalngd > -1) {
									...
									i_159_ < ngm;
									i_159_++) {
										if (chalngd == gnum[i_159_]) i_158_ = i_159_;
									}
									if (cflk % 4 != 0 || cflk == 0) {
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Arial", 1, 13));
										ftm = rd.getFontMetrics();
										rd.drawString(new StringBuilder().append("You have been invited by ")
											.append(chalby).append(" to join a game!")
											.toString(), (472 - (ftm.stringWidth(new StringBuilder().append("You have been invited by ")
											.append(chalby)
											.append(" to join a game!")
											.toString())) / 2),
										95);
										rd.setColor(new Color(117, 67, 0));
										rd.drawString(chalby, (472 - (ftm.stringWidth(new StringBuilder().append("You have been invited by ")
											.append(chalby)
											.append(" to join a game!")
											.toString())) / 2 + (ftm.stringWidth("You have been invited by "))),
										95);
									}
									if (cflk != 0)
									cflk--;
									...
									1, 12));
									ftm = rd.getFontMetrics();
									rd.drawString(new StringBuilder().append("Stage:  ").append(gstages[i_158_])
										.append(" ,  Laps: ").append(gnlaps[i_158_])
										.append("").toString(),
									472 - (ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_])
										.append(" ,  Laps: ").append(gnlaps[i_158_])
										.append("").toString())) / 2,
									130);
									rd.setColor(new Color(62, 98, 0));
									rd.drawString(gstages[i_158_], (472 - (ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_])
										.append(" ,  Laps: ").append(gnlaps[i_158_])
										.append("").toString())) / 2 + ftm.stringWidth("Stage:  ")),
									130);
									rd.drawString(new StringBuilder().append("").append(gnlaps[i_158_])
										.append("").toString(), (472 - (ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_])
										.append(" ,  Laps: ").append(gnlaps[i_158_])
										.append("").toString())) / 2 + (ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_])
										.append(" ,  Laps: ").toString()))),
									130);
									rd.setColor(new Color(0, 0,
									0));
									rd.drawString(new StringBuilder().append("Players:  ").append(mnpls[i_158_])
										.append("").toString(),
									472 - (ftm.stringWidth(new StringBuilder().append("Players:  ").append(mnpls[i_158_])
										.append("").toString())) / 2,
									150);
									rd.setColor(new Color(62, 98, 0));
									rd.drawString(new StringBuilder().append("").append(mnpls[i_158_])
										.append("").toString(), (472 - (ftm.stringWidth(new StringBuilder().append("Players:  ").append(mnpls[i_158_])
										.append("").toString())) / 2 + ftm.stringWidth("Players:  ")),
									150);
									Date date = new Date();
									long l = date.getTime();
									...
									if (chalngd != -5) stringbutton(" Cancel X ", 669, 85, 2);
									if (chalngd == -6) {
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Arial", 1, 13));
										rd.drawString("This room already has a game that has started.",
										288, 120);
										rd.drawString("Please switch to another room to create a new game.",
										288, 140);
										rd.drawString("Or wait for the game to finish.",
										288, 160);
										rd.drawString("Use the dropdown menu above to change room or server.",
										288, 180);
										int[] is = {
											580, 569, 576, 576, 584,
											584, 591
									...
									if (chalngd == -2) {
										...
										if ((gs)
											...
											gs)
												...
												if (sgflag != 3) {
													...
													xt)
														...
														gs)
															.mstgs.add(rd,
															"You need to have a full account to access ");
														(
														gs)
															.mstgs.select(0);
														(
											...
											gs)
												.sgame.getSelectedIndex() == 0) && (
											gs)
												.snfmm.getSelectedIndex() != 0 && (gstage != ((
											gs)
											...
											gs)
												.sgame.getSelectedIndex() == 1) && (
											gs)
												.snfm2.getSelectedIndex() != 0 && (gstage != ((
											gs)
											...
											gs)
												.sgame.getSelectedIndex() == 2) && (
											gs)
												.snfm1.getSelectedIndex() != 0 && (gstage != ((
											gs)
											...
											gs)
												.sgame.getSelectedIndex() >= 4) && (
											gs)
												.mstgs.getSelectedIndex() != 0 && (gstage != ((
											gs)
												.mstgs.getSelectedIndex() + 100))) {
												loadstage = ((
												gs)
											...
											if (loadstage > 0 && (remstage == 0)) {
												...
												rd.setFont(new Font("Arial", 1, 12));
												ftm = rd.getFontMetrics();
												rd.drawString("Loading stage, please wait...", (472 - ((this
											...
											xt)
												...
												rd.setFont(new Font("Arial", 1, 12));
												ftm = rd.getFontMetrics();
												rd.drawString("You are currently using a trial account.", (472 - ((this
													.ftm.stringWidth("You are currently using a trial account.")) / 2)),
												155);
												rd.drawString("You need to upgrade your account to access and publish custom stages!", (472 - ((this
													.ftm.stringWidth("You need to upgrade your account to access and publish custom stages!")) / 2)),
												175);
												rd.setColor(color2k(200, 200, 200));
												rd.fillRoundRect(382, 185, 180, 50, 20,
												20);
												drawSbutton((
												(this
													.xt)).upgrade,
												...
												if ((loadstage < 0) && (remstage == 0)) {
													...
													ftm = (this
														.rd.getFontMetrics());
													rd.drawString(new StringBuilder().append("").append(this
														.gstagename)
														.append("  -  Laps:              ")
														.toString(), (472 - (this
												...
												if (remstage == 3) {
													...
													ftm = (this
														.rd.getFontMetrics());
													xt.drawlprom(135, 75);
													rd.drawString("Failed to remove stage, server error, please try again later.", (472 - ((this
														.ftm.stringWidth("Failed to remove stage, server error, please try again later.")) / 2)),
													155);
													if (xt.drawcarb(true, null, " OK ",
													451, 175, i, i_99_,
													bool)) {
														remstage = 0;
														(
												...
												if (remstage == 2) {
													...
													ftm = (this
														.rd.getFontMetrics());
													xt.drawlprom(135, 75);
													rd.drawString("Removing stage from your account...", (472 - ((this
												...
												if (remstage == 1) {
													...
													ftm = (this
														.rd.getFontMetrics());
													rd.drawString("Remove this stage from your account?", (472 - ((this
														.ftm.stringWidth("Remove this stage from your account?")) / 2)),
													155);
													if (xt.drawcarb(true, null, " Yes ",
													426, 175, i, i_99_,
													bool)) {
														remstage = 2;
														(
											...
											xt)
												...
												if (!inwab) {
													...
													ftm = (this
														.rd.getFontMetrics());
													rd.drawString("Loading your clan's wars and battles, please wait...", (472 - ((this
															...
															this).gb)
																...
																this).gs)
																	...
																	gb)
																		...
																		.append(" ]")
																		.toString(), (472 - (
																	this).ftm.stringWidth(new StringBuilder().append("[ ").append((gb).gameturndisp).append(" ]").toString()) / 2),
																	155);
																	bool_162_ = true;
																	int i_165_ = (472 - ((
																	...
																	this).xt)
																		...
																		this).gs).vnpls).sel != 0) {
																			...
																			if (cancreate == 2) stringbutton("   Create Game   ", 472, 235, 1);
																		}
																	} else {
																		if ((
																		this).sflk != 0)
																		...
																		(
																		this)
																			.rd.drawString(new StringBuilder().append("Your clan won the last game.  ").append((gb).vclan).append(" must create this game!").toString(),
																		472 - ftm.stringWidth(new StringBuilder().append("Your clan won the last game.  ").append((gb).vclan).append(" must create this game!").toString()) / 2,
																		211);
																	}
																	if ((
																	((
																...
																this).gs)
																	...
																	this).gs)
																		...
																		this).pgamesel != ((gs).pgame).sel) {
																			(
																			this).gstagename = (gb).wbstages[((gs).pgame).sel - 1];
																			(
																			this).cancreate = 0;
																			(
																			this).pgamesel = ((gs).pgame).sel;
																		...
																		this).cancreate == 1)
																		(
																		this).rd.drawString("Loading...", 472 - ftm.stringWidth("Loading...") / 2, 235);
																		if ((
												...
												rd.setFont(new Font("Arial", 1, 12));
												ftm = rd.getFontMetrics();
												rd.drawString("You must join a clan first to play wars and battles!", (472 - ((this
									...
									if (chalngd == -3) {
										...
										ftm = rd.getFontMetrics();
										if (sflk % 4 != 0 || sflk == 0)
										rd.drawString("Select Number of Players", (472 - ((ftm.stringWidth("Select Number of Players")) / 2)),
										85);
										if (sflk != 0)
										sflk--;
										int i_166_ = 0;
										...
										gs)
											.snpls.getSelectedIndex() != gnpls - 1)) {
											gnpls = (
											gs)
										...
										if ((xt)
											...
											if (((
											gs)
												.snbts.getSelectedIndex() != gnbts) || bool_167_) {
												for (gnbts = ((
												gs)
										...
										(gs)
											.swait.move(451, 145);
										if (((gs)
											.swait.getSelectedIndex() + 1) * 60 != gwait)
										gwait = ((
										gs)
										...
										ftm = rd.getFontMetrics();
										rd.drawString("(Maximum time to wait for all players to `join. )", (472 - ((ftm.stringWidth("(Maximum time to wait for all players to join. )")) / 2)),
										179);
									...
									if (chalngd == -4) {
										...
										ftm = rd.getFontMetrics();
										if (sflk % 4 != 0 || sflk == 0)
										rd.drawString("Game Options",
										472 - (ftm.stringWidth("Game Options")) / 2,
										85);
										if (sflk != 0)
										sflk--;
										int i_168_ = 472 - ((
										...
										if ((gs)
											...
											if ((
											gs)
												.sclass.getSelectedIndex() != gclass) {
												gclass = (
												gs)
											...
											if ((
											gs)
												.scars.getSelectedIndex() != gcars)
											gcars = (
											gs)
												.scars.getSelectedIndex();
										}
										if ((gs)
											.sfix.getSelectedIndex() != gfix)
										gfix = (
										gs)
										...
										if (i_169_ < gnpls - 1) {
											rd.setFont(new Font("Arial", 1, 13));
											rd.drawString(new StringBuilder().append("Private Game, only specific players allowed to join?  ")
												.append(i_169_).append("/").append(gnpls - 1)
												.append("").toString(),
											330, 180);
											...
											ftm = rd.getFontMetrics();
											rd.drawString(string, (472 - (ftm.stringWidth(string) / 2)),
											203);
										} else {
											rd.setFont(new Font("Arial", 1, 13));
											ftm = rd.getFontMetrics();
											rd.drawString(new StringBuilder().append("").append(i_169_).append(" Allowed Players Selected")
												.toString(), (472 - (ftm.stringWidth(new StringBuilder()
							...
							if (!(xt).lan) {
								rd.setColor(color2k(230, 230,
								230));
								rd.fillRoundRect(225, 263, 495,
								157, 20, 20);
								rd.setColor(new Color(0, 0, 0));
								rd.drawRoundRect(225, 263, 495,
								157, 20, 20);
								...
								if (updatec != -1) {
									...
									i_176_++) {
										...
										int i_181_ = 0;
										for (/**/ ;
										i_177_ < sentn[i_176_].length();
										i_177_++) {
											String string = new StringBuilder().append("").append(sentn[i_176_].charAt(i_177_))
												.toString();
											if (string.equals(" ")) {
												i_178_ = i_179_;
												i_180_ = i_177_;
									...
									i_104_ = (i_175_ - 6) * 15;
									if (i_104_ < 0) i_104_ = 0;
									i_105_ = (int)((float)spos3 / 28.0F * (float) i_104_);
									String string = "";
									...
									i_186_++) {
										if (!string.equals(strings_173_[i_186_])) {
											...
											rd.drawString(new StringBuilder().append(strings_173_[i_186_])
												.append(":").toString(),
											320 - (this
									...
									i_187_++) {
										...
										rd.drawString(strings[i_187_], 325,
									...
									465 - (ftm.stringWidth("Loading chat...")) / 2,
									325);
								}
								rd.setColor(color2k(205, 205,
								205));
								...
								rd.setFont(new Font("Arial", 1,
								12));
								rd.setColor(color2k(120, 120,
								120));
								rd.drawString("(Room Chat )",
								299, 285);
								rd.setColor(color2k(150, 150,
								150));
								...
								if (mscro3 == 351 || i_104_ == 0) {
									...
									rd.fillRect(698, 294, 17,
									17);
								} else {
									rd.setColor(color2k(220, 220, 220));
									rd.fill3DRect(698, 294, 17,
									17, true);
								}
								if (i_104_ != 0)
								rd.drawImage((xt).asu,
								...
								if (mscro3 == 352 || i_104_ == 0) {
									...
									rd.fillRect(698, 370, 17,
									17);
								} else {
									rd.setColor(color2k(220, 220, 220));
									rd.fill3DRect(698, 370, 17,
									17, true);
								}
								if (i_104_ != 0)
								rd.drawImage((xt).asd,
								...
								if (i_104_ != 0) {
									if (lspos3 != spos3) {
										rd.setColor(color2k(215, 215, 215));
										rd.fillRect(698, 311 + spos3,
										17, 31);
									} else {
										if (mscro3 == 141)
										rd.setColor(color2k(215, 215, 215));
										rd.fill3DRect(698, 311 + spos3,
										17, 31, true);
									}
									rd.setColor(color2k(150, 150, 150));
									rd.drawLine(703, 324 + spos3, 709,
									324 + spos3);
									rd.drawLine(703, 326 + spos3, 709,
									326 + spos3);
									rd.drawLine(703, 328 + spos3, 709,
									328 + spos3);
									if (mscro3 > 342 && (lspos3 != spos3))
									lspos3 = spos3;
									if (bool) {
										if (mscro3 == 345 && i > 698 && i < 715 && (i_99_ > 311 + spos3) && (i_99_ < spos3 + 342))
										mscro3 = i_99_ - spos3;
							...
							if ((chalngd == -1 || chalngd == -6) && (lg).gamec != -1) {
								...
								rd.setComposite(AlphaComposite.getInstance(3, (float)((lg)
									.cntgame) / 10.0F));
								if ((lg).cntgame > 390 && ((lg).cntgame < 400))
								rd.setComposite(AlphaComposite.getInstance(3, (float)(400 - ((
								lg)
									.cntgame)) / 10.0F));
								rd.setColor(color2k(245, 245,
								245));
								rd.fillRoundRect(383, 242, 337,
								46, 20, 20);
								rd.setColor(new Color(0, 0, 0));
								rd.drawRoundRect(383, 242, 337,
								46, 20, 20);
								rd.setFont(new Font("Arial", 1,
								12));
								ftm = rd.getFontMetrics();
								rd.drawString(new StringBuilder().append("").append((lg).gmaker)
									.append(" created a game in ").append((lg).gservern)
									.append(" :: Room ").append((lg).groom)
									.append("").toString(),
								551 - (ftm.stringWidth(new StringBuilder().append("")
									.append((lg)
									.gmaker)
									.append(" created a game in ").append((lg)
									.gservern)
									.append(" :: Room ").append((lg)
									.groom)
									.append("").toString())) / 2,
								260);
								...
								if (!grprsd) {
									rd.setColor(color2k(230, 230, 230));
									rd.fill3DRect(490, 266, 122,
									19, true);
									rd.setColor(new Color(0, 0,
									0));
								} else {
									rd.setColor(color2k(230, 230, 230));
									rd.fillRect(490, 266, 122,
									19);
									rd.setColor(color2k(60, 60,
									60));
								}
								rd.drawString("View / Join Game", (551 - (ftm.stringWidth("View / Join Game") / 2)),
								280);
						...
						rd.setColor(color2k(i_191_, i_191_,
						i_191_));
						rd.fillRoundRect(225,
						59 - (int)((float)opengame * 2.23F),
						495, 200 + opengame * 8, 20, 20);
						rd.setColor(new Color(0, 0, 0));
						rd.drawRoundRect(225,
						59 - (int)((float)opengame * 2.23F),
						495, 200 + opengame * 8, 20, 20);
						if (!(xt).lan) {
							...
							rd.fillRoundRect(225, 263 + opengame * 7, 495,
							157, 20, 20);
							rd.setColor(new Color(0, 0, 0));
							rd.drawRoundRect(225, 263 + opengame * 7, 495,
							157, 20, 20);
						}
						btn = 0;
						if (prevloaded != -1)
						...
						rd.setColor(color2k(255, 255, 255));
						rd.fillRoundRect(225, 1, 495, 417, 20,
						20);
						rd.setColor(new Color(0, 0, 0));
						rd.drawRoundRect(225, 1, 495, 417, 20,
						20);
						if ((join > -1 && (pgames[im] != join)) || join == -2) {
							if (join > -1 && (pgames[im] != join)) {
								...
								13));
								ftm = rd.getFontMetrics();
								rd.drawString(msg, (472 - (ftm.stringWidth(msg) / 2)),
								195);
							...
							int i_193_ = 0;
							for (int i_194_ = 0; i_194_ < ngm;
							i_194_++) {
								if (ongame == gnum[i_194_]) i_193_ = i_194_;
							}
							rd.setFont(new Font("Arial", 1,
							11));
							ftm = rd.getFontMetrics();
							...
							if (gwarb[i_193_] != 0) {
								...
								if (gwarb[i_193_] == 2) string = "Car battle";
								if (gwarb[i_193_] == 3) string = "Stage battle";
								rd.drawString(new StringBuilder().append("").append(string).append(" between ").append(gaclan[i_193_]).append(" and ").append(gvclan[i_193_]).append("").toString(),
								243, 14);
							}
							String string = "";
							String string_197_ = "";
							...
							if (conon == 1) {
								if (wait[i_193_] > 0) {
									if (gwarb[i_193_] == 0) {
										String string_199_ = "";
										if (gplyrs[i_193_].equals("")) string_199_ = "Public Game";
										else string_199_ = "Private Game";
										if (gfx[i_193_] == 1) string_199_ = new StringBuilder().append(string_199_).append(" | 4 Fixes")
											.toString();
										if (gfx[i_193_] == 2) string_199_ = new StringBuilder().append(string_199_).append(" | 3 Fixes")
											.toString();
										if (gfx[i_193_] == 3) string_199_ = new StringBuilder().append(string_199_).append(" | 2 Fixes")
											.toString();
										if (gfx[i_193_] == 4) string_199_ = new StringBuilder().append(string_199_).append(" | 1 Fix").toString();
										if (gfx[i_193_] == 5) string_199_ = new StringBuilder().append(string_199_).append(" | No Fixing")
											.toString();
										String string_200_ = "";
										if (gclss[i_193_] > -2) {
											if (gcrs[i_193_] == 1) string_200_ = "Custom Cars";
											if (gcrs[i_193_] == 2) string_200_ = "Game Cars";
											String string_201_ = "";
											if (gclss[i_193_] == 1) string_201_ = "Class C";
											if (gclss[i_193_] == 2) string_201_ = "Class B & C";
											if (gclss[i_193_] == 3) string_201_ = "Class B";
											if (gclss[i_193_] == 4) string_201_ = "Class A & B";
											if (gclss[i_193_] == 5) string_201_ = "Class A";
										...
										String string_202_ = new StringBuilder().append("Game #").append(gameturn[i_193_])
											.append("").toString();
										if (gcrs[i_193_] == 1) string_202_ = new StringBuilder().append(string_202_).append(" | Clan Cars")
											.toString();
										if (gcrs[i_193_] == 2) string_202_ = new StringBuilder().append(string_202_).append(" | Game Cars")
											.toString();
										if (gclss[i_193_] == 1) string_202_ = new StringBuilder().append(string_202_).append(" | Class C")
											.toString();
										if (gclss[i_193_] == 2) string_202_ = new StringBuilder().append(string_202_).append(" | Class B & C")
											.toString();
										if (gclss[i_193_] == 3) string_202_ = new StringBuilder().append(string_202_).append(" | Class B")
											.toString();
										if (gclss[i_193_] == 4) string_202_ = new StringBuilder().append(string_202_).append(" | Class A & B")
											.toString();
										if (gclss[i_193_] == 5) string_202_ = new StringBuilder().append(string_202_).append(" | Class A")
											.toString();
										if (gfx[i_193_] == 1) string_202_ = new StringBuilder().append(string_202_).append(" | 4 Fixes")
											.toString();
										if (gfx[i_193_] == 2) string_202_ = new StringBuilder().append(string_202_).append(" | 3 Fixes")
											.toString();
										if (gfx[i_193_] == 3) string_202_ = new StringBuilder().append(string_202_).append(" | 2 Fixes")
											.toString();
										if (gfx[i_193_] == 4) string_202_ = new StringBuilder().append(string_202_).append(" | 1 Fix").toString();
										if (gfx[i_193_] == 5) string_202_ = new StringBuilder().append(string_202_).append(" | No Fixing")
											.toString();
										rd.setColor(new Color(80, 128, 0));
								...
								if (wait[i_193_] == 0) {
									...
									rd.setColor(new Color(128, 73, 0));
									if (prevloaded == 0)
									rd.drawString("Starting...", 286 + i_196_,
									i_195_);
									else rd.drawString("Started", 286 + i_196_, i_195_);
								}
								if (wait[i_193_] == -1) {
									rd.drawString("Status:",
									241 + i_196_,
								...
								241 + i_196_,
								i_195_);
								rd.setColor(new Color(128, 73,
								0));
								rd.drawString("Starting...",
								286 + i_196_,
								i_195_);
							}
							if (gwarb[i_193_] == 0) {
								...
								if (wait[i_193_] == -1) {
									...
									i_205_++) {
										...
										i_206_ < npo;
										i_206_++) {
											if ((prnames[i_205_].equals(pnames[i_206_])) && ((pgames[i_206_]) == (gnum[i_193_]))) strings[i_205_] = (pclan[i_206_]);
										}
									}
									for (int i_207_ = 0;
									i_207_ < prnpo;
									...
									if (!string.equals("")) {
										if (gwtyp[i_193_] == 2) {
											...
											i_209_ < prnpo;
											i_209_++) {
												if (!(strings[i_209_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_209_]) < 55 && (pdam[i_209_]) != -17) {
													bool_208_ = true;
													break;
												}
											}
										...
										if (gwtyp[i_193_] == 3) {
											...
											i_211_ < prnpo;
											i_211_++) {
												if (!(strings[i_211_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_211_]) < 55 && (pdam[i_211_]) != -17) {
													bool_210_ = false;
													break;
												}
											}
										...
										if (gwtyp[i_193_] == 4) {
											if (string.toLowerCase().equals(gaclan[i_193_].toLowerCase())) {
												...
												(i_213_ < prnpo);
												i_213_++) {
													if (!(strings[i_213_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_213_]) < 55 && (pdam[i_213_]) != -17) {
														bool_212_ = false;
														break;
													}
												}
												...
												(i_215_ < prnpo);
												i_215_++) {
													if (!(strings[i_215_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_215_]) < 55 && (pdam[i_215_]) != -17) {
														bool_214_ = true;
														break;
													}
												}
										...
										if (gwtyp[i_193_] == 5) {
											if (!string.toLowerCase().equals(gaclan[i_193_].toLowerCase())) {
												...
												(i_217_ < prnpo);
												i_217_++) {
													if (!(strings[i_217_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_217_]) < 55 && (pdam[i_217_]) != -17) {
														bool_216_ = false;
														break;
													}
												}
												...
												(i_219_ < prnpo);
												i_219_++) {
													if (!(strings[i_219_].toLowerCase().equals(string.toLowerCase())) && (pdam[i_219_]) < 55 && (pdam[i_219_]) != -17) {
														bool_218_ = true;
														break;
													}
												}
									...
									if (string.toLowerCase().equals(gaclan[i_193_].toLowerCase())) i_203_ = 1;
									if (string.toLowerCase().equals(gvclan[i_193_].toLowerCase())) i_204_ = 1;
								}
								rd.drawString(new StringBuilder().append("").append(gaclan[i_193_]).append(" : ").append(gascore[i_193_] + i_203_)
									.append("     |     ").append(gvclan[i_193_]).append(" : ").append(gvscore[i_193_] + i_204_)
									.append("").toString(), (474 - (ftm.stringWidth(new StringBuilder().append("").append(gaclan[i_193_])
									.append(" : ").append(gascore[i_193_])
									.append("     |     ").append(gvclan[i_193_])
									.append(" : ").append(gvscore[i_193_])
									.append("").toString())) / 2),
								28);
								if (gwarb[i_193_] == 1) {
									if (gascore[i_193_] + i_203_ >= 5) string_197_ = new StringBuilder().append("").append(gaclan[i_193_])
										.append(" wins the war!")
										.toString();
									if (gvscore[i_193_] + i_204_ >= 5) string_197_ = new StringBuilder().append("").append(gvclan[i_193_])
										.append(" wins the war!")
										.toString();
								} else {
									if (gascore[i_193_] + i_203_ >= 3) string_197_ = new StringBuilder().append("").append(gaclan[i_193_])
										.append(" wins the battle!")
										.toString();
									if (gvscore[i_193_] + i_204_ >= 3) string_197_ = new StringBuilder().append("").append(gvclan[i_193_])
										.append(" wins the battle!")
										.toString();
								}
							}
							...
							if (conon == 1) {
								if (pgames[im] == ongame) stringbutton("Leave Game X", 660, 26, 0);
							...
							i_222_++) {
								if (pgames[i_222_] == ongame) {
									...
									if (gwarb[i_193_] != 0) {
										...
										if (wait[i_193_] == -1 && prevloaded == 1 && (string.toLowerCase().equals(pclan[i_222_].toLowerCase())) && nflk == 0)
										rd.setColor(new Color(0, 0, 0));
									} else if ((wait[i_193_] == -1) && (prevloaded == 1)) {
										for (int i_223_ = 0;
										i_223_ < prnpo;
										i_223_++) {
											if ((pnames[i_222_].equals(prnames[i_223_])) && (ppos[i_223_] == 0) && nflk == 0)
											rd.setColor(new Color(0, 0, 0));
										}
									}
									rd.drawRect(237, (54 + i_220_ * 42),
									170, 40);
									rd.setColor(new Color(0, 0,
									0));
									rd.setFont(new Font("Arial",
									1, 12));
									ftm = rd.getFontMetrics();
									rd.drawString(pnames[i_222_],
									282 - (ftm.stringWidth(pnames[i_222_])) / 2,
									72 + i_220_ * 42);
									rd.setFont(new Font("Arial",
									0, 10));
									ftm = rd.getFontMetrics();
									rd.drawString(pcarnames[i_222_],
									282 - (ftm.stringWidth(pcarnames[i_222_])) / 2,
									84 + i_220_ * 42);
									(m).crs = true;
									(m).x = -335;
									(m).y = 0;
									...
									if (pcars[i_222_] != -1) {
										...
										i_224_++) {
											...
											contos[(pcars[i_222_])])
												...
												((
												contos[(pcars[i_222_])])
													.p[i_224_])).hsb[0] = (pcols[i_222_][0]);
												(
												((
												contos[(pcars[i_222_])])
													.p[i_224_])).hsb[1] = (pcols[i_222_][1]);
												(
												((
												contos[(pcars[i_222_])])
											...
											contos[(pcars[i_222_])])
												...
												((
												contos[(pcars[i_222_])])
													.p[i_224_])).hsb[0] = (pcols[i_222_][3]);
												(
												((
												contos[(pcars[i_222_])])
													.p[i_224_])).hsb[1] = (pcols[i_222_][4]);
												(
												((
												contos[(pcars[i_222_])])
													.p[i_224_])).hsb[2] = 1.0F - (this
							...
							for (int i_232_ = 0; i_232_ < 7; i_232_++) {
								for (int i_233_ = 0;
								i_233_ < npo; i_233_++) {
									if ((pgames[i_233_] == ongame) && (invos[i_232_].equals(pnames[i_233_])) && (dinvi[i_232_].equals(invos[i_232_]))) {
							...
							if (wait[i_193_] > 0) {
								...
								i_236_++) {
									rd.setColor(color2k(200, 200, 200));
									rd.drawRect(237, (54 + i_236_ * 42),
									170, 40);
									boolean bool_237_ = false;
									if ((pgames[im]) == ongame) {
										if (!gplyrs[i_193_].equals("")) bool_237_ = true;
									} else if (gwarb[i_193_] == 0) {
										if (!gplyrs[i_193_].equals("") && (gplyrs[i_193_].indexOf(pnames[im])) == -1) bool_237_ = true;
									} else if (!((
									xt)
										.clan.toLowerCase().equals(gaclan[i_193_].toLowerCase())) && !((
									xt)
										.clan.toLowerCase().equals(gvclan[i_193_].toLowerCase()))) bool_237_ = true;
									if (i > 237 && i < 407 && i_99_ > 54 + i_236_ * 42 && i_99_ < 94 + i_236_ * 42 && !bool_237_) {
										if ((pgames[im]) == ongame) stringbutton("<     Invite Player      ",
										322, 79 + i_236_ * 42, 0);
										...
										ftm = rd.getFontMetrics();
										rd.drawString("Empty",
										322 - (ftm.stringWidth("Empty") / 2),
										72 + i_236_ * 42);
										rd.setFont(new Font("Arial", 0, 10));
										ftm = rd.getFontMetrics();
										rd.drawString("Waiting for player...",
										322 - ((ftm.stringWidth("Waiting for player...")) / 2),
										84 + i_236_ * 42);
										...
										if (nflk != 0) {
											...
											rd.setFont(new Font("Arial", 0, 12));
											ftm = rd.getFontMetrics();
											rd.drawString("Inviting player...", (322 - ((ftm.stringWidth("Inviting player...")) / 2)),
											79 + i_236_ * 42);
										}
									} else {
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Arial", 0, 12));
										ftm = rd.getFontMetrics();
										rd.drawString("Player Invited!",
										322 - (ftm.stringWidth("Player Invited!")) / 2,
										71 + i_236_ * 42);
										rd.setFont(new Font("Arial", 1, 12));
										ftm = rd.getFontMetrics();
										rd.drawString(invos[i_235_],
										322 - (ftm.stringWidth(invos[i_235_])) / 2,
										87 + i_236_ * 42);
									}
									i_235_++;
								}
							...
							if ((xt).lan && mnbts[i_193_] != 0) {
								...
								12));
								ftm = rd.getFontMetrics();
								rd.drawString(new StringBuilder().append("Plus ").append(mnbts[i_193_]).append(" MadBots!").toString(),
							...
							if (dispcar == -1 || conon != 1) {
								...
								if (conon == 1) {
									if (wait[i_193_] > 0) {
										...
										if (gwarb[i_193_] == 0) {
											if ((wait[i_193_] > 30) || (npls[i_193_] <= 1)) {
												...
												if (((mnpls[i_193_]) - (npls[i_193_])) == 1) string_238_ = "";
												rd.drawString(new StringBuilder().append("Waiting for ")
													.append((mnpls[i_193_]) - (this
													.npls[i_193_]))
													.append(" more player")
													.append(string_238_).append(" to join to start.")
													.toString(), (561 - (ftm.stringWidth(new StringBuilder().append("Waiting for ")
													.append((this
													.mnpls[i_193_]) - ((
												this)
													.npls[i_193_]))
												...
												ftm = rd.getFontMetrics();
												int i_239_ = 134;
												if (!(gmaker[i_193_].equals("Coach Insano")) && !(this
													.gmaker[i_193_].equals(pnames[(this
													.im)]))) {
												...
												if (npls[i_193_] > 1) {
													String string_242_ = new StringBuilder().append("").append(this
														...
														.append(" seconds")
														.toString();
													if ((wait[i_193_]) > 60) string_242_ = new StringBuilder().append("").append((float)(int)((float)wait[i_193_] / 60.0F * 100.0F) / 100.0F)
														.append(" minutes")
														.toString();
													rd.drawString(new StringBuilder().append("(Waiting ")
														.append(string_242_)
														.append(" maximum! )")
														.toString(), (561 - (this
											...
											if ((pgames[im]) != ongame) {
												if (gplyrs[i_193_].equals("") || ((this
													.gplyrs[i_193_].indexOf(pnames[im])) != -1)) stringbutton("    Join this Game    ",
												561, 182, 0);
												else {
													rd.setFont(new Font("Arial", 1,
													12));
													...
													rd.setColor(new Color(128, 73,
													0));
													rd.drawString("Private Game, only specific players allowed.", (561 - ((this
												...
												if (npls[i_193_] > 1) {
													if (!fstart) stringbutton("    Start this Game Now!    ",
													561, 182, 0);
													...
													rd.setColor(new Color(128, 73,
													0));
													rd.drawString("You have created this game.", (561 - ((this
												...
												ftm = rd.getFontMetrics();
												rd.setColor(new Color(80, 128, 0));
												rd.drawString("You have joined this game.", (561 - ((this
													.ftm.stringWidth("You have joined this game.")) / 2)),
												180);
											}
										} else {
											String string_243_ = "s";
											if ((mnpls[i_193_] - npls[i_193_]) == 1) string_243_ = "";
											rd.drawString(new StringBuilder().append("Waiting for ").append((mnpls[i_193_]) - (npls[i_193_]))
												.append(" clan member").append(string_243_).append(" to join to start.")
												.toString(), (561 - (ftm.stringWidth(new StringBuilder()
												.append("Waiting for ")
												.append((this
												.mnpls[i_193_]) - (this
												.npls[i_193_]))
											...
											rd.setFont(new Font("Arial", 0, 12));
											ftm = rd.getFontMetrics();
											rd.drawString(new StringBuilder().append("(").append(i_244_).append(" of ").append(gaclan[i_193_])
												.append("  &  ").append(i_245_).append(" of ").append(gvclan[i_193_])
												.append(" )").toString(),
											561 - (ftm.stringWidth(new StringBuilder().append("(").append(i_244_).append(" of ").append(this
												.gaclan[i_193_])
											...
											491 - (ftm.stringWidth(gaclan[i_193_])) / 2,
											125);
											rd.drawString(gvclan[i_193_],
											631 - (ftm.stringWidth(gvclan[i_193_])) / 2,
											125);
											rd.setFont(new Font("Arial", 1, 12));
											ftm = rd.getFontMetrics();
											String string_247_ = "War";
											if (gwarb[i_193_] > 1) string_247_ = "Battle";
											rd.drawString(new StringBuilder().append("").append(string_247_).append(" Score").toString(),
											561 - (ftm.stringWidth(new StringBuilder().append("").append(string_247_)
												.append(" Score")
												.toString())) / 2,
											107);
											rd.drawString(new StringBuilder().append("").append(gascore[i_193_])
												.append("").toString(),
											491 - (ftm.stringWidth(new StringBuilder().append("").append(this
												.gascore[i_193_])
												.append("")
												.toString())) / 2,
											139);
											rd.drawString(new StringBuilder().append("").append(gvscore[i_193_])
												.append("").toString(),
											631 - (ftm.stringWidth(new StringBuilder().append("").append(this
												.gascore[i_193_])
												.append("")
												.toString())) / 2,
											139);
											...
											if ((pgames[im]) != ongame) {
												...
												561, 200, 0);
													...
													rd.setColor(new Color(128, 73,
													0));
													rd.drawString("You must be a member of either clan to join.", (561 - ((this
														.ftm.stringWidth("You must be a member of either clan to join.")) / 2)),
													198);
												}
											} else {
												if ((gmaker[i_193_].equals(pnames[im])) && (npls[i_193_]) > 1) stringbutton("    Start this Game Now!    ",
												561, -1000, 0);
												rd.setColor(new Color(80, 128, 0));
												rd.drawString("You have joined this game.", (561 - ((this
													.ftm.stringWidth("You have joined this game.")) / 2)),
											...
											if (gwtyp[i_193_] == 1) {
												rd.setColor(new Color(0, 0, 0));
												rd.drawString("This is a normal clan game.", (561 - ((this
													.ftm.stringWidth("This is a normal clan game.")) / 2)),
												161);
												rd.setFont(new Font("Arial", 0, 12));
												ftm = rd.getFontMetrics();
												rd.setColor(new Color(0, 0, 0));
												rd.drawString("Any clan can win by racing or wasting.", (561 - ((this
											...
											if (gwtyp[i_193_] == 2) {
												...
												rd.drawString("This is a racing only game!", (561 - ((this
													.ftm.stringWidth("This is a racing only game!")) / 2)),
												161);
												rd.setFont(new Font("Arial", 0, 12));
												ftm = rd.getFontMetrics();
												rd.setColor(new Color(0, 0, 0));
												rd.drawString("A clan can only win by racing.", (561 - ((this
											...
											if (gwtyp[i_193_] == 3) {
												...
												rd.drawString("This is a wasting only game!", (561 - ((this
													.ftm.stringWidth("This is a wasting only game!")) / 2)),
												161);
												rd.setFont(new Font("Arial", 0, 12));
												ftm = rd.getFontMetrics();
												rd.setColor(new Color(0, 0, 0));
												rd.drawString("A clan can only win by wasting.", (561 - ((this
											...
											if (gwtyp[i_193_] == 4) {
												...
												rd.drawString("This is Racers VS Wasters game!", (561 - ((this
													.ftm.stringWidth("This is Racers VS Wasters game!")) / 2)),
												161);
												rd.drawString(new StringBuilder().append("").append(gaclan[i_193_])
										...
										if (wait[i_193_] == 0) {
											rd.setColor(new Color(i_248_, i_249_,
											i_250_));
											rd.setFont(new Font("Arial", 1, 12));
										...
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Tahoma", 1, 11));
										rd.drawString("Player       Position   Laps      Power        Damage",
										439, 69);
										rd.setColor(color2k(200, 200, 200));
										rd.drawLine(489, 61,
										489, 162);
											...
											i_252_++) {
												if (ppos[i_252_] == i_251_) {
													...
													if ((pdam[i_252_]) < 55 && (pdam[i_252_]) != -17) {
														...
														i_248_ = (int)(85.0 + ((double)(float)(rerr * 2) / 1.5));
														if (i_248_ > 255) i_248_ = 255;
														if (i_248_ < 0) i_248_ = 0;
														rd.setColor(color2k(i_248_,
														i_248_,
														i_248_));
														rd.fillRect(490,
														75 + 11 * i_220_,
														213, 9);
														rd.setFont(new Font("Tahoma",
														1, 11));
														ftm = (this
															.rd.getFontMetrics());
														i_248_ = 255 - (((
														...
														if (i_248_ > 255) i_248_ = 255;
														if (i_248_ < 0) i_248_ = 0;
														i_249_ = (int)(155.0 - ((double)(float)(rerr * 2) / 1.645));
														if (i_249_ > 255) i_249_ = 255;
														if (i_249_ < 0) i_249_ = 0;
														i_250_ = (int)(64.0 - ((double)(float)(rerr * 2) / 3.984));
														if (i_250_ > 255) i_250_ = 255;
														if (i_250_ < 0) i_250_ = 0;
														rd.setColor(new Color(i_248_, i_249_,
														i_250_));
										...
										if (wait[i_193_] == 0) stringbutton("    Watch Live Now!    ",
										561, 196, 0);
										else {
											rd.setColor(new Color(0, 0, 0));
											rd.setFont(new Font("Arial", 1, 12));
											...
											if (gwarb[i_193_] == 0) {
												...
												rd.drawString("Game Finished!    Nobody Won!", (561 - ((this
													.ftm.stringWidth("Game Finished!    Nobody Won!")) / 2)),
												i_254_);
												else {
													rd.drawString(new StringBuilder().append("Game Finished!    Winner:  ")
														.append(string_255_)
													...
													rd.drawString(new StringBuilder().append("").append(string_255_)
														.append("").toString(), (561 - (this
														.ftm.stringWidth(new StringBuilder().append("Game Finished!    Winner:  ")
														.append(string_255_)
												...
												if (i_258_ == 2) {
													if (!this
														.stuntname.equals("")) {
														rd.drawString(string_257_, (561 - (((
														this)
															.ftm.stringWidth(string_257_)) / 2)),
														199);
														rd.drawString(new StringBuilder().append("Best stunt: ")
															.append((
														this)
															.stuntname)
															.append("")
														...
														this)
															...
															.toString())) / 2),
														213);
													} else rd.drawString(string_257_, (561 - (((
													this)
														.ftm.stringWidth(string_257_)) / 2)),
													206);
												} else {
													...
													this)
														...
														.append("    ")
														.toString();
													rd.drawString(string_257_, (561 - ((this
														.ftm.stringWidth(string_257_)) / 2)),
													206);
												}
												...
												if (string.equals("")) {
													...
													ftm = (this
														.rd.getFontMetrics());
													rd.drawString(string_198_, (561 - ((this
														.ftm.stringWidth(string_198_)) / 2)),
													206);
												} else {
													rd.drawString(new StringBuilder().append("Game Finished!    ")
													...
													rd.drawString(new StringBuilder().append("").append(string).append("").toString(), (561 - (this
														.ftm.stringWidth(new StringBuilder().append("Game Finished!    ")
														.append(string)
														.append("  Wins!")
														.toString())) / 2 + (this
										...
										if (prevloaded == -1) {
											if (!(
											xt).lan)
											rd.drawString("Loading Info...", (561 - ((this
												.ftm.stringWidth("Loading Info...")) / 2)),
											134);
											else if ((pgames[im]) == ongame)
											rd.drawString("About to Start...", (561 - ((this
												.ftm.stringWidth("About to Start...")) / 2)),
											134);
											else {
												rd.drawString("Game Started",
												561 - ((this
										...
										} else rd.drawString("About to Start...",
										561 - ((ftm.stringWidth("About to Start...")) / 2),
										134);
									}
								} else {
									rd.setColor(new Color(0, 0,
									...
									ftm = rd.getFontMetrics();
									if (conon == 2)
									rd.drawString("Starting Game Now!", (561 - (ftm.stringWidth("Starting Game Now!")) / 2),
									124);
									if (conon == 3)
									rd.drawString("Opening Game Now!",
									561 - (ftm.stringWidth("Opening Game Now!")) / 2,
									124);
									rd.setFont(new Font("Arial",
									0, 12));
									ftm = rd.getFontMetrics();
									rd.drawString("Please Wait...", (561 - (ftm.stringWidth("Please Wait...") / 2)),
									154);
								}
								rd.setColor(color2k(200, 200,
								200));
								...
								10));
								ftm = rd.getFontMetrics();
								rd.drawString(new StringBuilder().append("Laps: ")
									.append(gnlaps[i_193_]).append("").toString(),
								660, 235);
								if (i > 415 && i < 708 && i_99_ > 222 && i_99_ < 262 && (wait[i_193_] > 0 || gstgn[i_193_] < 0) && conon == 1) {
									stringbutton("       Preview Stage       ",
									562, 247, 0);
									pbtn = 2;
								} else {
									if (gstgn[i_193_] > 0) {
										...
										562 - (ftm.stringWidth(new StringBuilder().append("").append(string_259_).append(" - Stage ").append(i_260_).append("").toString())) / 2,
										237);
									} else rd.drawString("Custom Stage",
									562 - (ftm.stringWidth("Custom Stage")) / 2,
									237);
									rd.setFont(new Font("Arial",
									1, 12));
									ftm = rd.getFontMetrics();
									rd.drawString(gstages[i_193_],
									562 - (ftm.stringWidth(gstages[i_193_])) / 2,
									254);
								}
								if (!(xt).lan) {
									int i_261_ = 237;
									...
									rd.setColor(color2k(200, 200, 200));
									rd.drawRect(i_261_, 264,
									i_262_, 124);
									rd.setColor(color2k(240, 240, 240));
									rd.fillRect(i_261_ + 1, 265,
									i_262_ - 1, 21);
									rd.drawImage((xt).gmc,
									i_261_ + 7, 269, null);
									rd.setFont(new Font("Tahoma", 0, 11));
									...
									if (updatec != -1) {
										...
										i_275_++) {
											if (!string_274_.equals(strings_263_[i_275_])) {
												rd.drawString(new StringBuilder().append(strings_263_[i_275_])
													.append(":").toString(), (i_261_ + 84 - (ftm.stringWidth(new StringBuilder().append(strings_263_[i_275_])
													.append(":")
													.toString()))),
												299 + i_275_ * 14);
										...
										i_276_++) {
											...
											strings[i_276_].length()))
												.append("").toString();
											rd.drawString(strings[i_276_], i_261_ + 88,
											299 + i_276_ * 14);
										}
									} else rd.drawString("Loading chat...", (i_261_ + i_262_ / 2 - (ftm.stringWidth("Loading chat...")) / 2),
									315);
									if (conon == 1)
									pre2 = true;
									else hideinputs();
									if ((control).enter && !(gs)
										.cmsg.getText().equals("Type here...") && !(gs)
										.cmsg.getText().equals("")) {
										pessd[(this
											.btn)] = true;
										(control).enter = false;
										String string_277_ = (gs)
											.cmsg.getText().replace('|', ':');
										if ((string_277_.toLowerCase().indexOf((gs)
								...
								if (((pcars[dispcar]) == forcar) && forcar != -1) {
									...
									rd.drawRect(415, 96, 293,
									315);
									rd.setColor(color2k(240, 240, 240));
									rd.fillRect(416, 97, 4,
									314);
									rd.fillRect(704, 97, 4,
									314);
									rd.fillRect(416, 97, 292,
									4);
									rd.fillRect(416, 407, 292,
									4);
									if (flks >= 0) {
									...
									1, 13));
									ftm = rd.getFontMetrics();
									rd.drawString(((cd).names[forcar]), (561 - ((ftm.stringWidth((cd)
										.names[forcar])) / 2)),
									117);
									for (int i_279_ = 0;
									(i_279_ < ((dispco)
									...
									i_279_++) {
										...
										contos[forcar])
											.p[i_279_])).colnum == 1) {
											(
											((dispco).p[i_279_])).hsb[0] = (pcols[dispcar]
											[0]);
											(
											((dispco).p[i_279_])).hsb[1] = (pcols[dispcar]
											[1]);
											(
											((dispco).p[i_279_])).hsb[2] = (1.0F - (pcols[dispcar]
											[2]));
										}
										if ((
										((
									...
									int i_280_ = 424;
									int i_281_ = -55;
									rd.setColor(new Color(0, 63,
									128));
									rd.drawString("Top Speed:",
									30 + i_280_,
									318 + i_281_);
									rd.drawImage(((xt)
										.statb),
									97 + i_280_, 312 + i_281_, null);
									rd.drawString("Acceleration:", 20 + i_280_,
									333 + i_281_);
									rd.drawImage(((xt)
										.statb),
									...
									float f = (float)(((
									cd)
										.swits[forcar][2]) - 220) / 90.0F;
									if ((double) f < 0.2) f = 0.2F;
									rd.fillRect((int)(97.0F + 156.0F * f) + i_280_,
									312 + i_281_, (int)(156.0F * (1.0F - f) + 1.0F),
									7);
									f = (((cd).acelf[forcar][1]) * ((cd)
										.acelf[forcar][0]) * ((cd)
										.acelf[forcar][2]) * ((cd)
										.grip[forcar]) / 7700.0F);
									if (f > 1.0F) f = 1.0F;
									...
									rd.setColor(new Color(0, 63,
									128));
									rd.drawString("Stunts:",
									427 + i_280_,
									318 + i_281_);
									rd.drawImage(((xt)
										.statb),
									471 + i_280_, 312 + i_281_, null);
									rd.drawString("Strength:",
									415 + i_280_,
									333 + i_281_);
									rd.drawImage(((xt)
										.statb),
									471 + i_280_, 327 + i_281_, null);
									rd.drawString("Endurance:",
									405 + i_280_,
									348 + i_281_);
									rd.drawImage(((xt)
										.statb),
									...
									cd)
										.airc[forcar]) * ((cd)
										.airs[forcar]) * ((cd)
										.bounce[forcar])) + 28.0F) / 139.0F;
									if (f > 1.0F) f = 1.0F;
									rd.fillRect((int)(471.0F + 156.0F * f) + i_280_,
									312 + i_281_, (int)(156.0F * (1.0F - f) + 1.0F),
									7);
									float f_282_ = 0.5F;
									f = (((cd)
										.moment[forcar]) + f_282_) / 2.6F;
									if (f > 1.0F) f = 1.0F;
									rd.fillRect((int)(471.0F + 156.0F * f) + i_280_,
									327 + i_281_, (int)(156.0F * (1.0F - f) + 1.0F),
									7);
									...
									if (forcar < 16) {
										rd.setFont(new Font("Arial", 1, 12));
										ftm = rd.getFontMetrics();
										rd.drawString("Created by Radicalplay.com", (561 - ((ftm.stringWidth("Created by Radicalplay.com")) / 2)),
										347);
										String string_283_ = "Game Car";
										if (((cd)
											.cclass[forcar]) == 0) string_283_ = "Class C ,  Game Car";
										if (((cd)
											.cclass[forcar]) == 1) string_283_ = "Class B & C ,  Game Car";
										if (((cd)
											.cclass[forcar]) == 2) string_283_ = "Class B ,  Game Car";
										if (((cd)
											.cclass[forcar]) == 3) string_283_ = "Class A & B ,  Game Car";
										if (((cd)
											.cclass[forcar]) == 4) string_283_ = "Class A ,  Game Car";
										rd.drawString(string_283_, (561 - (ftm.stringWidth(string_283_) / 2)),
										367);
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Arial", 0, 12));
										ftm = rd.getFontMetrics();
										rd.drawString("You already have this car.", (561 - ((ftm.stringWidth("You already have this car.")) / 2)),
										395);
									} else {
										rd.setFont(new Font("Arial", 1, 12));
										ftm = rd.getFontMetrics();
										if (!(cd)
											.createdby[forcar - 16].equals((xt)
											.nickname)) {
											rd.drawString(new StringBuilder().append("Created by :  ").append((
											cd)
												.createdby[(forcar - 16)])
												.append("").toString(), (561 - ((ftm.stringWidth(new StringBuilder()
												.append("Created by :  ")
												.append((
											cd)
												.createdby[(this
												...
												.append("").toString())) / 2)),
											347);
											int i_284_ = (ftm.stringWidth((
											cd)
												.createdby[(forcar - 16)]));
											int i_285_ = (561 - (ftm.stringWidth(new StringBuilder()
												.append("Created by :  ")
												.append((
											cd)
												.createdby[(this
												.forcar) - 16])
												.append("")
												.toString())) / 2 + (ftm.stringWidth(new StringBuilder()
												.append("Created by :  ")
												.append((
											cd)
												.createdby[(this
										...
										} else rd.drawString("Created by You",
										561 - ((ftm.stringWidth("Created by You")) / 2),
										347);
										rd.setColor(new Color(128, 73, 0));
										String string_286_ = "";
										if (((cd)
											.cclass[forcar]) == 0) string_286_ = "Class C ,  ";
										if (((cd)
											.cclass[forcar]) == 1) string_286_ = "Class B & C ,  ";
										if (((cd)
											.cclass[forcar]) == 2) string_286_ = "Class B ,  ";
										if (((cd)
											.cclass[forcar]) == 3) string_286_ = "Class A & B ,  ";
										if (((cd)
											.cclass[forcar]) == 4) string_286_ = "Class A ,  ";
										if (((cd)
											.publish[forcar - 16]) == 0) string_286_ = new StringBuilder().append(string_286_).append("Private Car")
											.toString();
										if (((cd)
											.publish[forcar - 16]) == 1) {
										...
										rd.drawString(string_286_, (561 - (ftm.stringWidth(string_286_) / 2)),
										367);
										rd.setColor(new Color(0, 0, 0));
										rd.setFont(new Font("Arial", 0, 12));
										ftm = rd.getFontMetrics();
										if (((cd)
											.publish[forcar - 16]) == 1 || ((cd)
											.publish[(forcar - 16)]) == 2) {
											if ((
											cd).action == -9)
											rd.drawString("Failed to add car!  Unknown error!", (561 - ((this
												.ftm.stringWidth("Failed to add car!  Unknown error!")) / 2)),
											395);
											if ((
											cd).action == -8)
											rd.drawString("Failed!  You already have 20 cars!", (561 - ((this
											...
											cd)
												...
												.toString(), (561 - (ftm.stringWidth(new StringBuilder().append("").append((
											(this
												.cd))
												.names[((
											(
											...
											if ((
											cd).action == -7)
											rd.drawString("You already have this car.", (561 - ((this
											...
											cd).action == -6) {
												...
												if (waitlink != -1)
												rd.drawLine(i_288_, 396, i_289_,
												396);
												if (i > i_288_ && i < i_289_ && i_99_ > 384 && i_99_ < 397) {
													if (waitlink != -1) i_101_ = 12;
													if (bool && (this
														.waitlink) == 0) {
														gs.editlink((
														(this
											...
											if ((
											cd).action == 0 && (xt.drawcarb(true, null,
												" Add to My Cars ", 503,
											375, i, i_99_, bool))) {
												if ((
												xt)
										...
										} else rd.drawString("Private Car.  Cannot be added to account.", (561 - ((ftm.stringWidth("Private Car.  Cannot be added to account.")) / 2)),
										395);
									}
									if (xt.drawcarb(true, null,
										"X", 682,
									99, i,
									i_99_,
									bool))
					...
					rd.setColor(color2k(255, 255, 255));
					rd.fillRoundRect(155, 148, 490, 127, 20,
					20);
					rd.setColor(new Color(0, 0, 0));
					rd.drawRoundRect(155, 148, 490, 127, 20,
					20);
					if (ontyp != 76) {
						String string = "";
						int i_290_ = 0;
						if (ontyp >= 10) {
							i_290_ = 10;
							string = "Custom Cars";
							if (ontyp > 10) string = new StringBuilder().append(string).append(", ").toString();
						}
						if (ontyp >= 20) {
							i_290_ = 20;
							string = "Game Cars";
							if (ontyp > 20) string = new StringBuilder().append(string).append(", ").toString();
						}
						if (ontyp >= 30) {
							i_290_ = 30;
							string = "Clan Cars";
							if (ontyp > 30) string = new StringBuilder().append(string).append(", ").toString();
						}
						if (ontyp - i_290_ == 1) string = new StringBuilder().append(string).append("Class C").toString();
						if (ontyp - i_290_ == 2) string = new StringBuilder().append(string).append("Class B & C").toString();
						if (ontyp - i_290_ == 3) string = new StringBuilder().append(string).append("Class B").toString();
						if (ontyp - i_290_ == 4) string = new StringBuilder().append(string).append("Class A & B").toString();
						if (ontyp - i_290_ == 5) string = new StringBuilder().append(string).append("Class A").toString();
						if (ontyp <= -2) {
							if (Math.abs(ontyp + 2) == 13) string = new StringBuilder().append(" ").append((cd)
								.names[Math.abs(ontyp + 2)])
								.append("  Game").toString();
							else string = new StringBuilder().append("").append((cd)
								.names[Math.abs(ontyp + 2)])
								.append(" Game").toString();
						}
						rd.setColor(new Color(0, 0, 0));
						...
						400 - (ftm.stringWidth(new StringBuilder().append(": :   ")
							.append(string).append("   : :").toString())) / 2,
						175);
						string = "a";
						if (ontyp - i_290_ == 1) string = "a class C";
						if (ontyp - i_290_ == 2) string = "a class B or C";
						if (ontyp - i_290_ == 3) string = "a class B";
						if (ontyp - i_290_ == 4) string = "a class A or B";
						if (ontyp - i_290_ == 5) string = "a class A";
						...
						rd.drawString(new StringBuilder().append("To join this game you need to have ").append(string).append("!").toString(), (400 - (ftm.stringWidth(new StringBuilder().append("To join this game you need to have ")
							.append(string).append("!").toString())) / 2),
						206);
						...
						175);
						rd.drawString("You need to upgrade to a full account to join this game!", (400 - ((ftm.stringWidth("You need to upgrade to a full account to join this game!")) / 2)),
						202);
						rd.setColor(color2k(200, 200, 200));
						rd.fillRoundRect(310, 215, 180, 50, 20,
						20);
						drawSbutton((xt).upgrade,
						400, 240);
						stringbutton("  Cancel X  ", 593, 259, 2);
					}
				}
				...
				float f = 1.0F - (float)((lg).flipo - 10) / 80.0F;
				if (f > 1.0F) f = 1.0F;
				if (f < 0.0F) f = 0.0F;
				rd.setComposite(AlphaComposite.getInstance(3,
				f));
				if ((lg).flipo > 10)
				rd.drawImage((xt).logomadnes,
				...
				rd.fillRoundRect(115, 57 + i_291_, 570, 307, 20,
				20);
				rd.setComposite(AlphaComposite.getInstance(3, 1.0F));
				rd.setColor(color2k(90, 90, 90));
				rd.drawRoundRect(115, 57 + i_291_, 570, 307, 20,
				20);
				rd.setFont(new Font("Arial", 1, 13));
				ftm = rd.getFontMetrics();
				...
				135, 85 + i_291_);
				rd.drawString("Upgrade your account to a full account to purchase and play the multiplayer game.",
				135, 105 + i_291_);
				drawSbutton((xt).upgrade, 400,
				130 + i_291_);
				rd.setColor(new Color(30, 70, 110));
				rd.drawString("You can upgrade your account by just sharing the game & posting about it online!",
				135, 165 + i_291_);
				rd.drawString("Click 'Upgrade' for more details.", 135, 185 + i_291_);
				rd.drawString("Or try the multiplayer again tomorrow.", 135,
				205 + i_291_);
				rd.setColor(color2k(0, 0, 0));
				rd.drawString("For now to preview and try the multiplayer more, with your trial account you can:",
				135, 245 + i_291_);
				rd.setColor(new Color(30, 70, 110));
				rd.drawString("-  Watch online multiplayer games.", 135, 265 + i_291_);
				rd.drawString("-  Access the multiplayer dome.",
				135, 285 + i_291_);
				rd.drawString("-  Play LAN multiplayer games (unlimitedly).", 135,
				305 + i_291_);
				drawSbutton((xt).exit, 400,
				336 + i_291_);
			}
		} else {
			xt.drawWarning();
	...
	int i_293_, boolean bool) {
		...
		for (int i_296_ = 0; i_296_ < ngm; i_296_++) {
			if (ongame == gnum[i_296_]) i_295_ = i_296_;
		}
		if (chalngd != -2 && ongame != -1) {
			...
			if (wait[i_295_] > 0) {
				if (gwarb[i_295_] == 0) {
					if (wait[i_295_] > 30 || npls[i_295_] <= 1) {
						...
						if (npls[i_295_] > 1) {
							...
							string = new StringBuilder().append(" (waiting ").append(wait[i_295_]).append(" seconds maximum)").toString();
							if (wait[i_295_] > 60) string = new StringBuilder().append(" (waiting ").append((float)(int)((float)((
							this)
						...
						if (!gmaker[i_295_].equals("Coach Insano") && !(gmaker[i_295_].equals(pnames[im]))) {
							...
							for (int i_298_ = 0; i_298_ < npo;
							i_298_++) {
								if ((pgames[i_298_] == ongame) && (gmaker[i_295_].equals(pnames[i_298_]))) bool_297_ = true;
							}
							if (bool_297_)
							rd.drawString(new StringBuilder().append("").append(gmaker[i_295_]).append(" can start this game at anytime (the game creator)...")
								.toString(),
							95, 31);
						}
					} else {
						...
						if ((pgames[im] == ongame) || nflk != 0) {
							rd.drawString(new StringBuilder().append("Game starts in ").append(wait[i_295_]).append(" seconds!").toString(),
							400 - (ftm.stringWidth(new StringBuilder().append("Game starts in ").append(wait[i_295_])
				...
				} else rd.drawString(new StringBuilder().append("Waiting for ").append(mnpls[i_295_] - npls[i_295_])
				...
				if (pgames[im] != ongame) {
					...
					if (gwarb[i_295_] == 0) {
						if (gplyrs[i_295_].equals("") || ((gplyrs[i_295_].indexOf(pnames[im])) != -1)) bool_299_ = true;
					} else if (((xt).clan.toLowerCase().equals(gaclan[i_295_].toLowerCase())) || ((xt).clan.toLowerCase().equals(gvclan[i_295_].toLowerCase()))) bool_299_ = true;
				...
				if (wait[i_295_] == 0)
				rd.drawString("Game Started",
				400 - (ftm.stringWidth("Game Started") / 2),
				20);
				else rd.drawString("Game Finished",
				400 - (ftm.stringWidth("Game Finished") / 2),
				20);
			}
		}
		rd.setFont(new Font("Arial", 1, 11));
		...
		xt.drawcs(85, new StringBuilder().append("Previewing ").append(string).append("  >").toString(), 255, 138, 0, 5);
		xt.drawcs(105,
		new StringBuilder().append("| ").append((checkpoints).name).append(" |").toString(),
		255, 176, 85, 5);
		rd.drawImage(((xt).back[pback]),
		532, 285, null);
		if (plsndt == 0) {
			String string_300_ = "Play Soundtrack >";
			int i_301_ = 562 - ftm.stringWidth(string_300_) / 2;
			int i_302_ = i_301_ + ftm.stringWidth(string_300_);
			rd.setColor(new Color(0, 0, 0));
		...
		if (plsndt == 1)
		xt.drawcs(190, "Loading Soundtrack, please wait...",
		255, 138, 0, 5);
		if ((checkpoints).stage < 0) {
			rd.setColor(new Color(255, 138, 0));
			rd.drawString(new StringBuilder().append("Created by: ").append((checkpoints)
				.maker)
				.append("").toString(),
			85, 413);
			if ((checkpoints).pubt > 0) {
				if ((checkpoints).pubt == 2)
				xt.drawcs(413, "Super Public Stage", 41,
				177, 255, 3);
				else xt.drawcs(413, "Public Stage", 41, 177, 255,
				3);
				if (addstage == 0 && xt.drawcarb(true, null,
				...
				if (addstage == 1) {
					...
					int i_304_ = (400 - ftm.stringWidth(string_303_) / 2);
					int i_305_ = i_304_ + ftm.stringWidth(string_303_);
					rd.drawString(string_303_, i_304_, 435);
					if (waitlink != -1)
					rd.drawLine(i_304_, 437, i_305_, 437);
					if (i > i_304_ && i < i_305_ && i_293_ > 424 && i_293_ < 437) {
						if (waitlink != -1) i_294_ = 12;
						if (bool && waitlink == 0) {
							gs.editlink(((
							xt)
								.nickname),
				...
				193, 106, 0, 3);
			} else xt.drawcs(435, "Private Stage", 193, 106, 0, 3);
		}
	...
	public void ctachm(int i, int i_306_, int i_307_, Control control) {
		...
		if (fase == 1 || fase == 4) {
			for (int i_309_ = 0; i_309_ < btn; i_309_++) {
				if ((Math.abs(i - bx[i_309_]) < bw[i_309_] / 2 + 12) && Math.abs(i_306_ - by[i_309_]) < 14 && (i_307_ == 1 || i_307_ == 11))
				pessd[i_309_] = true;
				else pessd[i_309_] = false;
				if ((Math.abs(i - bx[i_309_]) < bw[i_309_] / 2 + 12) && Math.abs(i_306_ - by[i_309_]) < 14 && i_307_ <= -1) {
					i_308_ = i_309_;
					(gs).mouses = 0;
				}
			}
				...
				if (onjoin == -1) {
					...
					if (fase == 1) {
						if (ongame == -1) {
							...
							if (chalngd > -1) {
									...
									xt)
										...
										gs).warb)
											...
											gs)
												.wgame.getSelectedIndex() == 1) && (((
											(this
												.gs)).vnpls).sel != 0) && (cancreate == 2)) {
												if (i_308_ == 4) {
													if (invo)
													invo = false;
													msg = "| Creating Game |";
													gplayers = new StringBuilder().append("#warb#").append((
													(this
														.gb)).warb)
														.append("#").append((
													(this
								...
								if (chalngd == -4) {
									...
									if (i_308_ == i_312_ - 1) {
										...
										if (i_316_ != 0) {
											gnpls = i_316_ + 1;
											gplayers = new StringBuilder().append("").append(pnames[im])
												.append("#").toString();
											for (int i_318_ = 0;
							...
							if (i_308_ == i_312_ && !(xt).lan && !(gs).cmsg.getText().equals("Type here...") && !(gs).cmsg.getText().equals("")) {
								String string = (gs)
									.cmsg.getText().replace('|', ':');
								if ((string.toLowerCase().indexOf((gs)
									.tpass.getText().toLowerCase())) != -1) string = " ";
							...
							int i_321_ = 0;
							for (int i_322_ = 0; i_322_ < ngm;
							i_322_++) {
								if (ongame == gnum[i_322_]) i_321_ = i_322_;
							}
							boolean bool = false;
							if (gwarb[i_321_] == 0) {
								if (!gplyrs[i_321_].equals("") && (gplyrs[i_321_].indexOf(pnames[im])) == -1) bool = true;
							} else if (!((xt)
								.clan.toLowerCase().equals(gaclan[i_321_].toLowerCase())) && !((xt)
								.clan.toLowerCase().equals(gvclan[i_321_].toLowerCase()))) bool = true;
	...
	public void drawSbutton(Image image, int i, int i_324_) {
		...
		if (!pessd[btn]) {
			rd.drawImage(image, i - bw[btn] / 2,
			i_324_ - image.getHeight(ob) / 2 - 1, null);
			rd.drawImage((xt).bols,
			i - (bw[btn]) / 2 - 15,
			i_324_ - 13, null);
			rd.drawImage((xt).bors,
			i + (bw[btn]) / 2 + 9,
			i_324_ - 13, null);
			rd.drawImage((xt).bot,
			i - bw[btn] / 2 - 9,
			i_324_ - 13, bw[btn] + 18, 3,
			null);
			rd.drawImage((xt).bob,
			i - bw[btn] / 2 - 9,
			i_324_ + 10, bw[btn] + 18, 3,
			null);
		} else {
			rd.drawImage(image, i - bw[btn] / 2 + 1,
			i_324_ - image.getHeight(ob) / 2, null);
			rd.drawImage((xt).bolps,
			i - (bw[btn]) / 2 - 15,
			i_324_ - 13, null);
			rd.drawImage((xt).borps,
			i + (bw[btn]) / 2 + 9,
			i_324_ - 13, null);
			rd.drawImage((xt).bob,
			i - bw[btn] / 2 - 9,
	...
	public void stringbutton(String string, int i, int i_325_, int i_326_) {
		...
		if (!pessd[btn]) {
			rd.setColor(color2k(220, 220, 220));
			rd.fillRect(i - bw[btn] / 2 - 10,
			i_325_ - (17 - i_326_), bw[btn] + 20, 25 - i_326_ * 2);
			rd.setColor(color2k(240, 240, 240));
			rd.drawLine(i - bw[btn] / 2 - 10,
			i_325_ - (17 - i_326_),
			i + bw[btn] / 2 + 10,
			i_325_ - (17 - i_326_));
			rd.drawLine(i - bw[btn] / 2 - 10,
			...
			i + bw[btn] / 2 + 10,
			i_325_ + (7 - i_326_));
			rd.drawLine(i + bw[btn] / 2 + 11,
			i_325_ - (17 - i_326_),
			i + bw[btn] / 2 + 11,
			i_325_ + (7 - i_326_));
			rd.drawLine(i + bw[btn] / 2 + 12,
			i_325_ - (16 - i_326_),
			i + bw[btn] / 2 + 12,
			i_325_ + (6 - i_326_));
			rd.drawLine(i - bw[btn] / 2 - 10,
