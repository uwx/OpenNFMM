...
public class Lobby implements Runnable {
    ...
    public Lobby(final Medium medium, final Graphics2D graphics2d, final Login login/*, final Globe globe*/, final xtGraphics var_xtGraphics, final CarDefine cardefine, final GameSparker gamesparker) {
        m = medium;
        rd = graphics2d;
        xt = var_xtGraphics;
        cd = cardefine;
    ...
    public void ctachm(final int xm, final int ym, final int i_307_, final Control control) {
        ...
        if (fase == 1 || fase == 4) {
            for (int i_309_ = 0; i_309_ < btn; i_309_++) {
                if (Math.abs(xm - bx[i_309_]) < bw[i_309_] / 2 + 12 && Math.abs(ym - by[i_309_]) < 14 && (i_307_ == 1 || i_307_ == 11)) {
                    pessd[i_309_] = true;
                } else {
                    pessd[i_309_] = false;
                }
                if (Math.abs(xm - bx[i_309_]) < bw[i_309_] / 2 + 12 && Math.abs(ym - by[i_309_]) < 14 && i_307_ <= -1) {
                    i_308_ = i_309_;
                    gs.mouses = 0;
                }
            }
                ...
                if (onjoin == -1) {
                    ...
                    if (fase == 1)
                        if (ongame == -1) {
                                    ...
                                    if (i_308_ == i_312_ - 1) {
                                        ...
                                        if (i_316_ != 0) {
                                            ...
                                            for (int i_318_ = 0; i_318_ < i_316_; i_318_++) {
                                                ...
                                                lobby_319_.gplayers = stringbuilder.append(lobby_319_.gplayers).append(invos[i_318_]).append("#").toString();
                                            }
                                        }
                                        gs.sclass.setVisible(false);
                                        gs.scars.setVisible(false);
                            ...
                            } else if (!xt.clan.toLowerCase().equals(gaclan[i_321_].toLowerCase()) && !xt.clan.toLowerCase().equals(gvclan[i_321_].toLowerCase())) {
                                bool = true;
                            }
                            ...
                            if (pbtn == 0) {
                                ...
                                if (i_308_ == 2 && !xt.lan && !gs.cmsg.getText().equals("Type here...") && !gs.cmsg.getText().equals("")) {
                                    String string = gs.cmsg.getText().replace('|', ':');
                                    if (string.toLowerCase().indexOf(gs.tpass.getText().toLowerCase()) != -1) {
                                        string = " ";
                                    }
    ...
    public void drawSbutton(final Image image, final int i, final int i_324_) {
        bx[btn] = i;
        by[btn] = i_324_;
    ...
    public void lobby(int i, int i_99_, boolean bool, final int i_100_, final CheckPoints checkpoints, final Control control, final ContO[] contos) {
        pre1 = false;
        pre2 = false;
        int i_101_ = 0;
        if (xt.warning == 0 || xt.warning == 210) {
            if (!regnow) {
                    ...
                    if (conon == 1) {
                                    ...
                                    if (wait[i_110_] > 0) {
                                        if (82 + 30 * i_106_ - i_105_ > 50 && 82 + 30 * (i_106_ - 1) - i_105_ < 415) {
                                            ...
                                            if (i > 70 && i < 185 && i_99_ > 52 + 30 * i_106_ - i_105_ && i_99_ < 82 + 30 * i_106_ - i_105_) {
                                                ...
                                                bool_112_ = true;
                                                if (control.handb) {
                                                    gs.cmsg.setText(new StringBuilder().append(gs.cmsg.getText()).append("").append(pnames[i_109_]).toString());
                                                    control.handb = false;
                                                }
                                            }
                                            if (pgames[im] == -1 && join == -1 && chalngd >= -1) {
                                            ...
                                            rd.drawString(pnames[i_109_], 127 - ftm.stringWidth(pnames[i_109_]) / 2, 66 + 30 * i_106_ - i_105_);
                                            rd.setFont(new Font("Arial", 0, 10));
                                            ftm = rd.getFontMetrics();
                                            rd.drawString(pcarnames[i_109_], 127 - ftm.stringWidth(pcarnames[i_109_]) / 2, 78 + 30 * i_106_ - i_105_);
                                            //}
                        ...
                        if (invo) {
                            ...
                            if (i_114_ == -1) {
                                ...
                                rd.drawString("Members of Clans", 127 - ftm.stringWidth("Members of Clans") / 2, 75 - i_105_);
                            }
                            rd.setFont(new Font("Arial", 0, 10));
                            ftm = rd.getFontMetrics();
                            rd.drawString("Click a player to invite:", 127 - ftm.stringWidth("Click a player to invite:") / 2, 92 - i_105_);
                            rd.setColor(color2k(150, 150, 150));
                        ...
                        for (int i_116_ = 0; i_116_ < npo; i_116_++) {
                            ...
                            if (invo) {
                                ...
                                if (i_114_ != -1 && !pclan[i_116_].toLowerCase().equals(gaclan[i_114_].toLowerCase()) && !pclan[i_116_].toLowerCase().equals(gvclan[i_114_].toLowerCase())) {
                                    bool_117_ = true;
                                }
                            }
                            if (pgames[i_116_] == -1 && !bool_117_) {
                                if (82 + 30 * i_106_ - i_105_ > 50 && 82 + 30 * (i_106_ - 1) - i_105_ < 415) {
                                    ...
                                    if (i > 70 && i < 185 && i_99_ > 52 + 30 * i_106_ - i_105_ && i_99_ < 82 + 30 * i_106_ - i_105_) {
                                        ...
                                        bool_119_ = true;
                                        if (control.handb) {
                                            gs.cmsg.setText(new StringBuilder().append(gs.cmsg.getText()).append("").append(pnames[i_116_]).toString());
                                            control.handb = false;
                                        }
                                    }
                                    if (invo) {
                                    ...
                                    rd.setFont(new Font("Arial", 1, 12));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(pnames[i_116_], 127 - ftm.stringWidth(pnames[i_116_]) / 2, 66 + 30 * i_106_ - i_105_);
                                    rd.setFont(new Font("Arial", 0, 10));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(pcarnames[i_116_], 127 - ftm.stringWidth(pcarnames[i_116_]) / 2, 78 + 30 * i_106_ - i_105_);
                                    //}
                                    rd.setColor(color2k(150, 150, 150));
                                    rd.drawLine(70, 82 + 30 * i_106_ - i_105_, 185, 82 + 30 * i_106_ - i_105_);
                                }
                                        ...
                                        if (!bool_126_) {
                                            if (82 + 30 * i_106_ - i_105_ > 50 && 82 + 30 * (i_106_ - 1) - i_105_ < 415) {
                                                ...
                                                if (i > 70 && i < 185 && i_99_ > 52 + 30 * i_106_ - i_105_ && i_99_ < 82 + 30 * i_106_ - i_105_) {
                                                    ...
                                                    bool_129_ = true;
                                                    if (control.handb) {
                                                        gs.cmsg.setText(new StringBuilder().append(gs.cmsg.getText()).append("").append(pnames[i_123_]).toString());
                                                        control.handb = false;
                                                    }
                                                }
                                                if (pgames[im] == -1 && join == -1 && chalngd >= -1) {
                                                ...
                                                rd.setFont(new Font("Arial", 1, 12));
                                                ftm = rd.getFontMetrics();
                                                rd.drawString(pnames[i_123_], 127 - ftm.stringWidth(pnames[i_123_]) / 2, 66 + 30 * i_106_ - i_105_);
                                                rd.setFont(new Font("Arial", 0, 10));
                                                ftm = rd.getFontMetrics();
                                                rd.drawString(pcarnames[i_123_], 127 - ftm.stringWidth(pcarnames[i_123_]) / 2, 78 + 30 * i_106_ - i_105_);
                                                //}
                                                rd.setColor(color2k(150, 150, 150));
                                                rd.drawLine(70, 82 + 30 * i_106_ - i_105_, 185, 82 + 30 * i_106_ - i_105_);
                                            }
                    ...
                    if (ongame == -1) {
                        if (opengame >= 2) {
                            ...
                            if (!xt.lan) {
                                ...
                                if (npo <= 1) {
                                   ...
                                   */ else {
                                    ...
                                    rd.setFont(new Font("Arial", 1, 12));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(new StringBuilder().append("[  ").append(i_106_).append(" Players Connected  ]").toString(), 472 - ftm.stringWidth(new StringBuilder().append("[  ").append(i_106_).append(" Players Connected  ]").toString()) / 2, 295);
                            ...
                            if (chalngd == -1) {
                                ...
                                for (int i_139_ = 0; i_139_ < ngm; i_139_++) {
                                    for (int i_140_ = i_139_ + 1; i_140_ < ngm; i_140_++)
                                        if (wait[i_139_] != wait[i_140_]) {
                                            ...
                                            } else if ((wait[i_139_] > wait[i_140_] || wait[i_139_] <= 0) && wait[i_140_] > 0) {
                                                is[i_139_]++;
                                            } else {
                                                is[i_140_]++;
                                            }
                                ...
                                if (control.down) {
                                    opselect++;
                                    for (boolean bool_141_ = false; 80 + 24 * opselect - i_105_ > 202 && !bool_141_; i_105_ = (int) (spos2 / 82.0F * i_104_ - 2.0F)) {
                                        spos2++;
                                        if (spos2 > 82) {
                                            spos2 = 82;
                                            bool_141_ = true;
                                ...
                                if (control.up) {
                                    opselect--;
                                    for (boolean bool_142_ = false; 80 + 24 * opselect - i_105_ < 80 && !bool_142_; i_105_ = (int) (spos2 / 82.0F * i_104_ - 2.0F)) {
                                        spos2--;
                                        if (spos2 > 82) {
                                            spos2 = 82;
                                            bool_142_ = true;
                                ...
                                for (int i_149_ = 0; i_149_ < ngm; i_149_++)
                                    if (80 + 24 * i_149_ - i_105_ < 224 && 80 + 24 * i_149_ - i_105_ > 56) {
                                        ...
                                        if (!gs.openm) {
                                            if (i > 241 && i < 692 && i_99_ > 92 + 24 * i_149_ - i_105_ && i_99_ < 110 + 24 * i_149_ - i_105_) {
                                                ...
                                                if (bool) {
                                                    ...
                                                    if (clicked == is_137_[i_149_]) {
                                                        ...
                                                        opengame = 0;
                                                        if (i >= 641 && i <= 689 && i_99_ > 92 + 24 * i_149_ - i_105_ && i_99_ < 110 + 24 * i_149_ - i_105_ && wait[is_137_[i_149_]] > 0) {
                                                            boolean bool_152_ = false;
                                                            if (gwarb[is_137_[i_149_]] == 0) {
                                                                if (gplyrs[is_137_[i_149_]].equals("") || gplyrs[is_137_[i_149_]].indexOf(pnames[im]) != -1) {
                                                                    bool_152_ = true;
                                                                }
                                                            } else if (xt.clan.toLowerCase().equals(gaclan[is_137_[i_149_]].toLowerCase()) || xt.clan.toLowerCase().equals(gvclan[is_137_[i_149_]].toLowerCase())) {
                                                                bool_152_ = true;
                                                            }
                                                            if (bool_152_) {
                                                                join = gnum[is_137_[i_149_]];
                                                                msg = "| Joining Game |";
                                                                spos = 0;
                                                            }
                                                        }
                                            ...
                                            if (i >= 641 && i <= 689 && i_99_ > 92 + 24 * i_149_ - i_105_ && i_99_ < 110 + 24 * i_149_ - i_105_ && bool) {
                                                bool_151_ = true;
                                            }
                                        }
                                        if (opselect == i_149_) {
                                        ...
                                        rd.setFont(new Font("Arial", 1, 12));
                                        ftm = rd.getFontMetrics();
                                        rd.drawString(gstages[is_137_[i_149_]], 382 - ftm.stringWidth(gstages[is_137_[i_149_]]) / 2, 105 + 24 * i_149_ - i_105_);
                                        rd.drawString("|", 525, 105 + 24 * i_149_ - i_105_);
                                        rd.drawString("|", 584, 105 + 24 * i_149_ - i_105_);
                                        if (wait[is_137_[i_149_]] > 0) {
                                            rd.drawString(new StringBuilder().append("").append(npls[is_137_[i_149_]]).append(" / ").append(mnpls[is_137_[i_149_]]).append("").toString(), 556 - ftm.stringWidth(new StringBuilder().append("").append(npls[is_137_[i_149_]]).append(" / ").append(mnpls[is_137_[i_149_]]).append("").toString()) / 2, 105 + 24 * i_149_ - i_105_);
                                            ...
                                            if (bool_153_) {
                                                rd.drawString("Join", 665 - ftm.stringWidth("Join") / 2, 105 + 24 * i_149_ - i_105_);
                                            } else {
                                                rd.drawString("View", 665 - ftm.stringWidth("View") / 2, 105 + 24 * i_149_ - i_105_);
                                            }
                                        } else {
                                            rd.drawString(new StringBuilder().append("").append(npls[is_137_[i_149_]]).append("").toString(), 556 - ftm.stringWidth(new StringBuilder().append("").append(npls[is_137_[i_149_]]).append("").toString()) / 2, 105 + 24 * i_149_ - i_105_);
                                            rd.setFont(new Font("Arial", 0, 12));
                                            ftm = rd.getFontMetrics();
                                            if (wait[is_137_[i_149_]] == 0) {
                                ...
                                if (mousonp != -1 && i_143_ != -1) {
                                    ...
                                    final int[] is_156_ = {
                                            i_108_, i_143_, i_143_ + 19, i_108_ + 30
                                    };
                                ...
                                if (chalngd > -1) {
                                    ...
                                    rd.setFont(new Font("Arial", 1, 12));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(new StringBuilder().append("Stage:  ").append(gstages[i_158_]).append(" ,  Laps: ").append(gnlaps[i_158_]).append("").toString(), 472 - ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_]).append(" ,  Laps: ").append(gnlaps[i_158_]).append("").toString()) / 2, 130);
                                    rd.setColor(new Color(62, 98, 0));
                                    rd.drawString(gstages[i_158_], 472 - ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_]).append(" ,  Laps: ").append(gnlaps[i_158_]).append("").toString()) / 2 + ftm.stringWidth("Stage:  "), 130);
                                    rd.drawString(new StringBuilder().append("").append(gnlaps[i_158_]).append("").toString(), 472 - ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_]).append(" ,  Laps: ").append(gnlaps[i_158_]).append("").toString()) / 2 + ftm.stringWidth(new StringBuilder().append("Stage:  ").append(gstages[i_158_]).append(" ,  Laps: ").toString()), 130);
                                    rd.setColor(new Color(0, 0, 0));
                                    rd.drawString(new StringBuilder().append("Players:  ").append(mnpls[i_158_]).append("").toString(), 472 - ftm.stringWidth(new StringBuilder().append("Players:  ").append(mnpls[i_158_]).append("").toString()) / 2, 150);
                                    rd.setColor(new Color(62, 98, 0));
                                    rd.drawString(new StringBuilder().append("").append(mnpls[i_158_]).append("").toString(), 472 - ftm.stringWidth(new StringBuilder().append("Players:  ").append(mnpls[i_158_]).append("").toString()) / 2 + ftm.stringWidth("Players:  "), 150);
                                    ...
                                    if (chalngd == -2) {
                                        final boolean bool_161_ = false;
                                        final boolean bool_162_ = false;
                                    ...
                                    if (chalngd == -4) {
                                        ...
                                        int i_168_ = 472 - (gs.scars.getWidth() + gs.sclass.getWidth() + gs.sfix.getWidth() + 16) / 2;
                                        ...
                                        if (i_169_ > 0) {
                                            ...
                                            for (int i_172_ = 0; i_172_ < 7; i_172_++)
                                                if (!invos[i_172_].equals("")) {
                                                    string = new StringBuilder().append(string).append(invos[i_172_]).toString();
                                                    if (++i_171_ != i_169_)
                                                        if (i_171_ == i_169_ - 1) {
                                        ...
                                        if (i_169_ < gnpls - 1) {
                                            rd.setFont(new Font("Arial", 1, 13));
                                            rd.drawString(new StringBuilder().append("Private Game, only specific players allowed to join?  ").append(i_169_).append("/").append(gnpls - 1).append("").toString(), 330, 180);
                                            ...
                                            rd.setFont(new Font("Arial", 1, 13));
                                            ftm = rd.getFontMetrics();
                                            rd.drawString(new StringBuilder().append("").append(i_169_).append(" Allowed Players Selected").toString(), 472 - ftm.stringWidth(new StringBuilder().append("").append(i_169_).append(" Allowed Players Selected").toString()) / 2, 180);
                                            rd.setFont(new Font("Tahoma", 0, 11));
                                            ftm = rd.getFontMetrics();
                                            rd.drawString(string, 472 - ftm.stringWidth(string) / 2, 203);
                                        }
                        ...
                        if (join > -1 && pgames[im] != join || join == -2) {
                            ...
                            if (gwarb[i_193_] != 0) {
                                ...
                                rd.drawString(new StringBuilder().append("").append(string).append(" between ").append(gaclan[i_193_]).append(" and ").append(gvclan[i_193_]).append("").toString(), 243, 14);
                            }
                            String string = "";
                            String string_197_ = "";
                            String string_198_ = "";
                            if (conon == 1) {
                                if (wait[i_193_] > 0)
                                    if (gwarb[i_193_] == 0) {
                                        ...
                                        if (gfx[i_193_] == 1) {
                                            string_199_ = new StringBuilder().append(string_199_).append(" | 4 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 2) {
                                            string_199_ = new StringBuilder().append(string_199_).append(" | 3 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 3) {
                                            string_199_ = new StringBuilder().append(string_199_).append(" | 2 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 4) {
                                            string_199_ = new StringBuilder().append(string_199_).append(" | 1 Fix").toString();
                                        }
                                        if (gfx[i_193_] == 5) {
                                            string_199_ = new StringBuilder().append(string_199_).append(" | No Fixing").toString();
                                        }
                                        String string_200_ = "";
                                        if (gclss[i_193_] > -2) {
                                            if (gcrs[i_193_] == 1) {
                                            ...
                                            if (!string_200_.equals("") && !string_201_.equals("")) {
                                                string_200_ = new StringBuilder().append(string_200_).append(" | ").append(string_201_).toString();
                                            } else {
                                                string_200_ = new StringBuilder().append(string_200_).append(string_201_).toString();
                                            }
                                        } else {
                                            string_200_ = new StringBuilder().append("").append(cd.names[Math.abs(gclss[i_193_] + 2)]).append("").toString();
                                        }
                                        ...
                                        String string_202_ = new StringBuilder().append("Game #").append(gameturn[i_193_]).append("").toString();
                                        if (gcrs[i_193_] == 1) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Clan Cars").toString();
                                        }
                                        if (gcrs[i_193_] == 2) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Game Cars").toString();
                                        }
                                        if (gclss[i_193_] == 1) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Class C").toString();
                                        }
                                        if (gclss[i_193_] == 2) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Class B & C").toString();
                                        }
                                        if (gclss[i_193_] == 3) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Class B").toString();
                                        }
                                        if (gclss[i_193_] == 4) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Class A & B").toString();
                                        }
                                        if (gclss[i_193_] == 5) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | Class A").toString();
                                        }
                                        if (gfx[i_193_] == 1) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | 4 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 2) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | 3 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 3) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | 2 Fixes").toString();
                                        }
                                        if (gfx[i_193_] == 4) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | 1 Fix").toString();
                                        }
                                        if (gfx[i_193_] == 5) {
                                            string_202_ = new StringBuilder().append(string_202_).append(" | No Fixing").toString();
                                        }
                                        rd.setColor(new Color(80, 128, 0));
                            ...
                            if (gwarb[i_193_] == 0) {
                                ...
                                if (gmaker[i_193_].equals(pnames[im])) {
                                    ...
                                    rd.drawString(gmaker[i_193_], 520, 23);
                                }
                                ...
                                if (wait[i_193_] == -1) {
                                    ...
                                    for (int i_205_ = 0; i_205_ < prnpo; i_205_++) {
                                        for (int i_206_ = 0; i_206_ < npo; i_206_++)
                                            if (prnames[i_205_].equals(pnames[i_206_]) && pgames[i_206_] == gnum[i_193_]) {
                                    ...
                                    if (!string.equals("")) {
                                        if (gwtyp[i_193_] == 2) {
                                            ...
                                            if (!bool_208_) {
                                                string_198_ = new StringBuilder().append("").append(string).append(" should have raced in this game!").toString();
                                                string = "";
                                            }
                                        }
                                        if (gwtyp[i_193_] == 3) {
                                            ...
                                            if (!bool_210_) {
                                                string_198_ = new StringBuilder().append("").append(string).append(" should have wasted in this game!").toString();
                                                string = "";
                                            }
                                        }
                                        if (gwtyp[i_193_] == 4)
                                ...
                                rd.drawString(new StringBuilder().append("").append(gaclan[i_193_]).append(" : ").append(gascore[i_193_] + i_203_).append("     |     ").append(gvclan[i_193_]).append(" : ").append(gvscore[i_193_] + i_204_).append("").toString(), 474 - ftm.stringWidth(new StringBuilder().append("").append(gaclan[i_193_]).append(" : ").append(gascore[i_193_]).append("     |     ").append(gvclan[i_193_]).append(" : ").append(gvscore[i_193_]).append("").toString()) / 2, 28);
                                if (gwarb[i_193_] == 1) {
                                    if (gascore[i_193_] + i_203_ >= 5) {
                                        string_197_ = new StringBuilder().append("").append(gaclan[i_193_]).append(" wins the war!").toString();
                                    }
                                    if (gvscore[i_193_] + i_204_ >= 5) {
                                        string_197_ = new StringBuilder().append("").append(gvclan[i_193_]).append(" wins the war!").toString();
                                    }
                                } else {
                                    if (gascore[i_193_] + i_203_ >= 3) {
                                        string_197_ = new StringBuilder().append("").append(gaclan[i_193_]).append(" wins the battle!").toString();
                                    }
                                    if (gvscore[i_193_] + i_204_ >= 3) {
                                        string_197_ = new StringBuilder().append("").append(gvclan[i_193_]).append(" wins the battle!").toString();
                                    }
                                }
                            }
                            rd.setColor(color2k(200, 200, 200));
                            ...
                            for (int i_222_ = 0; i_222_ < npo; i_222_++)
                                if (pgames[i_222_] == ongame) {
                                    ...
                                    rd.setFont(new Font("Arial", 1, 12));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(pnames[i_222_], 282 - ftm.stringWidth(pnames[i_222_]) / 2, 72 + i_220_ * 42);
                                    rd.setFont(new Font("Arial", 0, 10));
                                    ftm = rd.getFontMetrics();
                                    rd.drawString(pcarnames[i_222_], 282 - ftm.stringWidth(pcarnames[i_222_]) / 2, 84 + i_220_ * 42);
                                    m.crs = true;
                                    m.x = -335;
                                    m.y = 0;
                                    m.z = -50;
                                            ...
                                            for (int i_229_ = 0; i_229_ < contos[pcars[i_222_]].npl; i_229_++) {
                                                for (int i_230_ = 0; i_230_ < contos[pcars[i_222_]].p[i_229_].n; i_230_++) {
                                                    if (contos[pcars[i_222_]].p[i_229_].oz[i_230_] < i_225_) {
                                                        i_225_ = contos[pcars[i_222_]].p[i_229_].oz[i_230_];
                                                    }
                                                    if (contos[pcars[i_222_]].p[i_229_].oz[i_230_] > i_226_) {
                                                        i_226_ = contos[pcars[i_222_]].p[i_229_].oz[i_230_];
                                                    }
                                                    if (contos[pcars[i_222_]].p[i_229_].oy[i_230_] < i_227_) {
                                                        i_227_ = contos[pcars[i_222_]].p[i_229_].oy[i_230_];
                                                    }
                                                    if (contos[pcars[i_222_]].p[i_229_].oy[i_230_] > i_228_) {
                                                        i_228_ = contos[pcars[i_222_]].p[i_229_].oy[i_230_];
                                                    }
                                                }
                                            }
                            ...
                            if (wait[i_193_] > 0) {
                                ...
                                for (int i_236_ = i_220_; i_236_ < mnpls[i_193_]; i_236_++) {
                                    ...
                                    } else if (!xt.clan.toLowerCase().equals(gaclan[i_193_].toLowerCase()) && !xt.clan.toLowerCase().equals(gvclan[i_193_].toLowerCase())) {
                                        bool_237_ = true;
                                    }
                                    if (i > 237 && i < 407 && i_99_ > 54 + i_236_ * 42 && i_99_ < 94 + i_236_ * 42 && !bool_237_) {
                                        ...
                                        rd.setFont(new Font("Arial", 0, 10));
                                        ftm = rd.getFontMetrics();
                                        rd.drawString("Waiting for player...", 322 - ftm.stringWidth("Waiting for player...") / 2, 84 + i_236_ * 42);
                                    } else if (!dinvi[i_235_].equals(invos[i_235_])) {
                                        if (nflk != 0) {
                                            rd.setColor(new Color(0, 0, 0));
                                            rd.setFont(new Font("Arial", 0, 12));
                                            ftm = rd.getFontMetrics();
                                            rd.drawString("Inviting player...", 322 - ftm.stringWidth("Inviting player...") / 2, 79 + i_236_ * 42);
                                        }
                                    } else {
                                        rd.setColor(new Color(0, 0, 0));
                                        rd.setFont(new Font("Arial", 0, 12));
                                        ftm = rd.getFontMetrics();
                                        rd.drawString("Player Invited!", 322 - ftm.stringWidth("Player Invited!") / 2, 71 + i_236_ * 42);
                                        rd.setFont(new Font("Arial", 1, 12));
                                        ftm = rd.getFontMetrics();
                                        rd.drawString(invos[i_235_], 322 - ftm.stringWidth(invos[i_235_]) / 2, 87 + i_236_ * 42);
                                    }
                                    i_235_++;
                                }
                            }
                            if (xt.lan && mnbts[i_193_] != 0) {
                                ...
                                rd.setFont(new Font("Arial", 1, 12));
                                ftm = rd.getFontMetrics();
                                rd.drawString(new StringBuilder().append("Plus ").append(mnbts[i_193_]).append(" MadBots!").toString(), 322 - ftm.stringWidth(new StringBuilder().append("Plus ").append(mnbts[i_193_]).append(" MadBots!").toString()) / 2, 73 + mnpls[i_193_] * 42);
                            }
                            if (dispcar == -1 || conon != 1) {
                                    ...
                                    if (wait[i_193_] > 0) {
                                        ...
                                        if (gwarb[i_193_] == 0) {
                                            if (wait[i_193_] > 30 || npls[i_193_] <= 1) {
                                                ...
                                                rd.drawString(new StringBuilder().append("Waiting for ").append(mnpls[i_193_] - npls[i_193_]).append(" more player").append(string_238_).append(" to join to start.").toString(), 561 - ftm.stringWidth(new StringBuilder().append("Waiting for ").append(mnpls[i_193_] - npls[i_193_]).append(" more player").append(string_238_).append(" to join to start.").toString()) / 2, 98);
                                                rd.setFont(new Font("Arial", 0, 12));
                                                ftm = rd.getFontMetrics();
                                                int i_239_ = 134;
                                                if (!gmaker[i_193_].equals("Coach Insano") && !gmaker[i_193_].equals(pnames[im])) {
                                                    boolean bool_240_ = false;
                                                    for (int i_241_ = 0; i_241_ < npo; i_241_++)
                                                        if (pgames[i_241_] == ongame && gmaker[i_193_].equals(pnames[i_241_])) {
                                                            bool_240_ = true;
                                                        }
                                                    if (bool_240_) {
                                                        i_239_ = 144;
                                                        rd.drawString(new StringBuilder().append("").append(gmaker[i_193_]).append(" can start this game at anytime.").toString(), 561 - ftm.stringWidth(new StringBuilder().append("").append(gmaker[i_193_]).append(" can start this game at anytime.").toString()) / 2, 124);
                                                    }
                                                }
                                                if (npls[i_193_] > 1) {
                                                    String string_242_ = new StringBuilder().append("").append(wait[i_193_]).append(" seconds").toString();
                                                    if (wait[i_193_] > 60) {
                                                        string_242_ = new StringBuilder().append("").append((int) (wait[i_193_] / 60.0F * 100.0F) / 100.0F).append(" minutes").toString();
                                                    }
                                                    rd.drawString(new StringBuilder().append("(Waiting ").append(string_242_).append(" maximum! )").toString(), 561 - ftm.stringWidth(new StringBuilder().append("(Waiting ").append(string_242_).append(" maximum! )").toString()) / 2, i_239_);
                                                }
                                            } else {
                                                final Date date = new Date();
                                                final long l = date.getTime();
                                                ...
                                                if (pgames[im] == ongame || nflk != 0) {
                                                    rd.drawString(new StringBuilder().append("Game starts in ").append(wait[i_193_]).append(" seconds!").toString(), 561 - ftm.stringWidth(new StringBuilder().append("Game starts in ").append(wait[i_193_]).append(" seconds!").toString()) / 2, 124);
                                                    if (pgames[im] != ongame) {
                                                        nflk--;
                                                    }
                                            ...
                                            rd.drawString(new StringBuilder().append("Waiting for ").append(mnpls[i_193_] - npls[i_193_]).append(" clan member").append(string_243_).append(" to join to start.").toString(), 561 - ftm.stringWidth(new StringBuilder().append("Waiting for ").append(mnpls[i_193_] - npls[i_193_]).append(" clan member").append(string_243_).append(" to join to start.").toString()) / 2, 72);
                                            int i_244_ = mnpls[i_193_] / 2;
                                            int i_245_ = mnpls[i_193_] / 2;
                                            for (int i_246_ = 0; i_246_ < npo; i_246_++)
                                                if (pgames[i_246_] == gnum[i_193_]) {
                                                    if (pclan[i_246_].toLowerCase().equals(gaclan[i_193_].toLowerCase()) && --i_244_ < 0) {
                                                        i_244_ = 0;
                                                    }
                                                    if (pclan[i_246_].toLowerCase().equals(gvclan[i_193_].toLowerCase()) && --i_245_ < 0) {
                                                        i_245_ = 0;
                                                    }
                                                }
                                            rd.setFont(new Font("Arial", 0, 12));
                                            ftm = rd.getFontMetrics();
                                            rd.drawString(new StringBuilder().append("(").append(i_244_).append(" of ").append(gaclan[i_193_]).append("  &  ").append(i_245_).append(" of ").append(gvclan[i_193_]).append(" )").toString(), 561 - ftm.stringWidth(new StringBuilder().append("(").append(i_244_).append(" of ").append(gaclan[i_193_]).append("  &  ").append(i_245_).append(" of ").append(gvclan[i_193_]).append(" )").toString()) / 2, 87);
                                            rd.drawString(gaclan[i_193_], 491 - ftm.stringWidth(gaclan[i_193_]) / 2, 125);
                                            rd.drawString(gvclan[i_193_], 631 - ftm.stringWidth(gvclan[i_193_]) / 2, 125);
                                            rd.setFont(new Font("Arial", 1, 12));
                                            ftm = rd.getFontMetrics();
                                            ...
                                            rd.drawString(new StringBuilder().append("").append(string_247_).append(" Score").toString(), 561 - ftm.stringWidth(new StringBuilder().append("").append(string_247_).append(" Score").toString()) / 2, 107);
                                            rd.drawString(new StringBuilder().append("").append(gascore[i_193_]).append("").toString(), 491 - ftm.stringWidth(new StringBuilder().append("").append(gascore[i_193_]).append("").toString()) / 2, 139);
                                            rd.drawString(new StringBuilder().append("").append(gvscore[i_193_]).append("").toString(), 631 - ftm.stringWidth(new StringBuilder().append("").append(gascore[i_193_]).append("").toString()) / 2, 139);
                                            ...
                                            if (pgames[im] != ongame) {
                                                if (xt.clan.toLowerCase().equals(gaclan[i_193_].toLowerCase()) || xt.clan.toLowerCase().equals(gvclan[i_193_].toLowerCase())) {
                                            ...
                                            if (gwtyp[i_193_] == 4) {
                                                ...
                                                rd.drawString(new StringBuilder().append("").append(gaclan[i_193_]).append(" wastes & ").append(gvclan[i_193_]).append(" races.").toString(), 561 - ftm.stringWidth(new StringBuilder().append("").append(gaclan[i_193_]).append(" wastes & ").append(gvclan[i_193_]).append(" races.").toString()) / 2, 176);
                                            }
                                            if (gwtyp[i_193_] == 5) {
                                                if (sflk != 0) {
                                                    sflk--;
                                                ...
                                                rd.drawString("This is Racers VS Wasters game!", 561 - ftm.stringWidth("This is Racers VS Wasters game!") / 2, 161);
                                                rd.drawString(new StringBuilder().append("").append(gaclan[i_193_]).append(" races & ").append(gvclan[i_193_]).append(" wastes.").toString(), 561 - ftm.stringWidth(new StringBuilder().append("").append(gaclan[i_193_]).append(" races & ").append(gvclan[i_193_]).append(" wastes.").toString()) / 2, 176);
                                            }
                                        }
                                    } else if (prevloaded == 1) {
                                        int i_248_ = (int) (80.0 + rerr / 1.243);
                                        if (i_248_ > 255) {
                                            i_248_ = 255;
                                        }
                                        if (i_248_ < 0) {
                                        ...
                                        int i_249_ = (int) (128.0 + rerr / 2.428);
                                        if (i_249_ > 255) {
                                            i_249_ = 255;
                                        }
                                        if (i_249_ < 0) {
                                        ...
                                        for (int i_251_ = 0; i_251_ < prnpo; i_251_++) {
                                            for (int i_252_ = 0; i_252_ < prnpo; i_252_++)
                                                if (ppos[i_252_] == i_251_) {
                                                    ...
                                                    rd.drawString(prnames[i_252_], 455 - ftm.stringWidth(prnames[i_252_]) / 2, 83 + 11 * i_220_);
                                                    if (pdam[i_252_] < 55 && pdam[i_252_] != -17) {
                                                        ...
                                                        rd.drawString(new StringBuilder().append("").append(ppos[i_252_] + 1).append("").append(string_253_).toString(), 515 - ftm.stringWidth(new StringBuilder().append("").append(ppos[i_252_] + 1).append("").append(string_253_).toString()) / 2, 83 + 11 * i_220_);
                                                        rd.setColor(new Color(128, 73, 0));
                                                        if (plap[i_252_] > gnlaps[i_193_] - 1) {
                                                            plap[i_252_] = gnlaps[i_193_] - 1;
                                                        }
                                                        rd.drawString(new StringBuilder().append("").append(plap[i_252_] + 1).append(" / ").append(gnlaps[i_193_]).append("").toString(), 560 - ftm.stringWidth(new StringBuilder().append("").append(plap[i_252_] + 1).append(" / ").append(gnlaps[i_193_]).append("").toString()) / 2, 83 + 11 * i_220_);
                                                        rd.setColor(new Color(0, 128, 255));
                                                        ...
                                                        rd.setColor(new Color(i_248_, i_249_, i_250_));
                                                        if (pdam[i_252_] != -17) {
                                                            rd.drawString("=   =   =   =    W A S T E D    =   =   =   =", 597 - ftm.stringWidth("=   =   =   =    W A S T E D    =   =   =   =") / 2, 84 + 11 * i_220_);
                                                        } else {
                                                            rd.drawString("=   =   =   DISCONNECTED   =   =   =", 597 - ftm.stringWidth("=   =   =   DISCONNECTED   =   =   =") / 2, 84 + 11 * i_220_);
                                                        }
                                                    }
                                                    i_220_++;
                                                }
                                        ...
                                        if (wait[i_193_] == 0) {
                                            ...
                                            if (gwarb[i_193_] == 0) {
                                                ...
                                                if (string_255_.equals("")) {
                                                    rd.drawString("Game Finished!    Nobody Won!", 561 - ftm.stringWidth("Game Finished!    Nobody Won!") / 2, i_254_);
                                                } else {
                                                    rd.drawString(new StringBuilder().append("Game Finished!    Winner:  ").append(string_255_).append("").toString(), 561 - ftm.stringWidth(new StringBuilder().append("Game Finished!    Winner:  ").append(string_255_).append("").toString()) / 2, i_254_);
                                                    if (nflk == 0) {
                                                    ...
                                                    rd.drawString(new StringBuilder().append("").append(string_255_).append("").toString(), 561 - ftm.stringWidth(new StringBuilder().append("Game Finished!    Winner:  ").append(string_255_).append("").toString()) / 2 + ftm.stringWidth("Game Finished!    Winner:  "), i_254_);
                                                }
                                                rd.setColor(new Color(0, 0, 0));
                                                rd.setFont(new Font("Arial", 0, 11));
                                                ftm = rd.getFontMetrics();
                                                ...
                                                int i_258_ = 0;
                                                if (!lapsname.equals("")) {
                                                    string_257_ = new StringBuilder().append(string_257_).append("Fastest lap: ").append(lapsname).append("    ").toString();
                                                    i_258_++;
                                                }
                                                if (!wastename.equals("")) {
                                                    string_257_ = new StringBuilder().append(string_257_).append("Deadliest waster: ").append(wastename).append("    ").toString();
                                                    i_258_++;
                                                }
                                                if (i_258_ == 2) {
                                                    if (!stuntname.equals("")) {
                                                        rd.drawString(string_257_, 561 - ftm.stringWidth(string_257_) / 2, 199);
                                                        ...
                                                        rd.drawString(string_257_, 561 - ftm.stringWidth(string_257_) / 2, 206);
                                                    }
                                                } else {
                                                    if (!stuntname.equals("")) {
                                                        string_257_ = new StringBuilder().append(string_257_).append("Best stunt: ").append(stuntname).append("    ").toString();
                                                    }
                                                    rd.drawString(string_257_, 561 - ftm.stringWidth(string_257_) / 2, 206);
                                                }
                                                ...
                                                if (string.equals("")) {
                                                    ...
                                                    rd.setFont(new Font("Arial", 1, 11));
                                                    ftm = rd.getFontMetrics();
                                                    rd.drawString(string_198_, 561 - ftm.stringWidth(string_198_) / 2, 206);
                                                } else {
                                ...
                                ftm = rd.getFontMetrics();
                                rd.drawString(new StringBuilder().append("Laps: ").append(gnlaps[i_193_]).append("").toString(), 660, 235);
                                    ...
                                    if (updatec != -1) {
                                        ...
                                        for (int i_264_ = 0; i_264_ < 7; i_264_++) {
                                            ...
                                            for (/**/ ; i_265_ < sentn[i_264_].length(); i_265_++) {
                                                final String string_270_ = new StringBuilder().append("").append(sentn[i_264_].charAt(i_265_)).toString();
                                                ...
                                                if (i_269_ <= 1) {
                                                    final StringBuilder stringbuilder = new StringBuilder();
                                                    final String[] strings_271_ = strings;
                                                    final int i_272_ = i_264_;
                                                    strings_271_[i_272_] = stringbuilder.append(strings_271_[i_272_]).append(string_270_).toString();
                                                    i_267_++;
                                        ...
                                        for (int i_275_ = 0; i_275_ < 7; i_275_++)
                                            if (!string_274_.equals(strings_263_[i_275_])) {
                                                rd.drawString(new StringBuilder().append(strings_263_[i_275_]).append(":").toString(), i_261_ + 84 - ftm.stringWidth(new StringBuilder().append(strings_263_[i_275_]).append(":").toString()), 299 + i_275_ * 14);
                                                string_274_ = strings_263_[i_275_];
                                            }
                                        rd.setFont(new Font("Tahoma", 0, 11));
                                        for (int i_276_ = 0; i_276_ < 7; i_276_++) {
                                            if (bools[i_276_] && i_276_ == 0 && strings[i_276_].indexOf(" ") != -1) {
                                                strings[i_276_] = new StringBuilder().append("...").append(strings[i_276_].substring(strings[i_276_].indexOf(" "), strings[i_276_].length())).append("").toString();
                                            }
                                            rd.drawString(strings[i_276_], i_261_ + 88, 299 + i_276_ * 14);
                                        }
                                    } else {
                                        rd.drawString("Loading chat...", i_261_ + i_262_ / 2 - ftm.stringWidth("Loading chat...") / 2, 315);
                                    }
                                    if (conon == 1) {
                                        pre2 = true;
                                    } else {
                                ...
                                if (pcars[dispcar] == forcar && forcar != -1) {
                                    ...
                                    rd.fillRect((int) (97.0F + 156.0F * f) + i_280_, 312 + i_281_, (int) (156.0F * (1.0F - f) + 1.0F), 7);
                                    f = cd.acelf[forcar][1] * cd.acelf[forcar][0] * cd.acelf[forcar][2] * cd.grip[forcar] / 7700.0F;
                                    if (f > 1.0F) {
                                        f = 1.0F;
                                    }
                                    rd.fillRect((int) (97.0F + 156.0F * f) + i_280_, 327 + i_281_, (int) (156.0F * (1.0F - f) + 1.0F), 7);
                                    ...
                                    rd.fillRect((int) (471.0F + 156.0F * f) + i_280_, 312 + i_281_, (int) (156.0F * (1.0F - f) + 1.0F), 7);
                                    final float f_282_ = 0.5F;
                                    f = (cd.moment[forcar] + f_282_) / 2.6F;
                                    if (f > 1.0F) {
                                        f = 1.0F;
                                    }
                                    rd.fillRect((int) (471.0F + 156.0F * f) + i_280_, 327 + i_281_, (int) (156.0F * (1.0F - f) + 1.0F), 7);
                                    f = cd.outdam[forcar];
                                    rd.fillRect((int) (471.0F + 156.0F * f) + i_280_, 342 + i_281_, (int) (156.0F * (1.0F - f) + 1.0F), 7);
                                    ...
                                    if (forcar < 16) {
                                        ...
                                        if (!cd.createdby[forcar - 16].equals(xt.nickname)) {
                                            ...
                                            final int i_285_ = 561 - ftm.stringWidth(new StringBuilder().append("Created by :  ").append(cd.createdby[forcar - 16]).append("").toString()) / 2 + ftm.stringWidth(new StringBuilder().append("Created by :  ").append(cd.createdby[forcar - 16]).append("").toString()) - i_284_;
                                        ...
                                        if (cd.publish[forcar - 16] == 0) {
                                            string_286_ = new StringBuilder().append(string_286_).append("Private Car").toString();
                                        }
                                        if (cd.publish[forcar - 16] == 1) {
                                            string_286_ = new StringBuilder().append(string_286_).append("Public Car").toString();
                                            rd.setColor(new Color(0, 64, 128));
                                        }
                                        if (cd.publish[forcar - 16] == 2) {
                                            string_286_ = new StringBuilder().append(string_286_).append("Super Public Car").toString();
                                            rd.setColor(new Color(0, 64, 128));
                                        }
                                        ...
                                        if (cd.publish[forcar - 16] == 1 || cd.publish[forcar - 16] == 2) {
                                            ...
                                            if (cd.action == 0 && xt.drawcarb(true, null, " Add to My Cars ", 503, 375, i, i_99_, bool))
                                                if (xt.logged) {
                ...
                if (lg.flipo > 10) {
                    rd.drawImage(xt.logomadnes, 97 + (int) (2.0 - Math.random() * 4.0), 36 + (int) (2.0 - Math.random() * 4.0), null);
                } else {
                ...
                rd.drawString("You are allowed 5 multiplayer turns per day to try the game with your trial account.", 135, 85 + i_291_);
                rd.drawString("Upgrade your account to a full account to purchase and play the multiplayer game.", 135, 105 + i_291_);
                drawSbutton(xt.upgrade, 400, 130 + i_291_);
                rd.setColor(new Color(30, 70, 110));
                rd.drawString("You can upgrade your account by just sharing the game & posting about it online!", 135, 165 + i_291_);
                ...
                rd.setColor(color2k(0, 0, 0));
                rd.drawString("For now to preview and try the multiplayer more, with your trial account you can:", 135, 245 + i_291_);
                rd.setColor(new Color(30, 70, 110));
    ...
    public void run() {
        ...
        while (conon == 1) {
            ...
            if (i_43_ != -1) {
                ...
                if (gwarb[i_44_] != 0) {
                    if (xt.clan.toLowerCase().equals(gaclan[i_44_].toLowerCase()) || xt.clan.toLowerCase().equals(gvclan[i_44_].toLowerCase())) {
                        bool_46_ = true;
                    }
                } else {
                    bool_46_ = true;
            ...
            if (!xt.lan) {
                ...
                for (int i_48_ = 1; i_48_ < 6; i_48_++)
                    if (i_48_ != xt.servport - 7070) {
                        ...
                        if (i_49_ != -1) {
                            gs.rooms.sopts[i_47_] = new StringBuilder().append("Room ").append(i_48_).append("  ::  ").append(i_49_).append("").toString();
                            gs.rooms.opts[i_47_] = "";
                ...
                for (int i_50_ = 0; i_50_ < lg.nservers; i_50_++)
                    if (!xt.server.equals(lg.servers[i_50_]) && xt.delays[i_50_] < 300) {
                        gs.rooms.sopts[i_47_] = new StringBuilder().append(":: ").append(lg.snames[i_50_]).append("").toString();
                        gs.rooms.opts[i_47_] = "";
    ...
    public void stageselect(final CheckPoints checkpoints, final Control control, final int i, final int i_293_, final boolean bool) {
        rd.setColor(new Color(0, 0, 0));
        rd.fillRect(0, 0, 65, 450);
        rd.fillRect(735, 0, 65, 450);
        rd.fillRect(65, 0, 670, 25);
                ...
                if (gwarb[i_295_] == 0) {
                    if (wait[i_295_] > 30 || npls[i_295_] <= 1) {
                        ...
                        if (npls[i_295_] > 1) {
                            ...
                            if (wait[i_295_] > 60) {
                                string = new StringBuilder().append(" (waiting ").append((int) (wait[i_295_] / 60.0F * 100.0F) / 100.0F).append(" minutes maximum)").toString();
                            }
                        }
                        rd.drawString(new StringBuilder().append("Waiting for ").append(mnpls[i_295_] - npls[i_295_]).append(" more players to join to start this game").append(string).append("!").toString(), 95, 15);
                        rd.setFont(new Font("Arial", 0, 12));
                        if (!gmaker[i_295_].equals("Coach Insano") && !gmaker[i_295_].equals(pnames[im])) {
                            ...
                            if (bool_297_) {
                                rd.drawString(new StringBuilder().append("").append(gmaker[i_295_]).append(" can start this game at anytime (the game creator)...").toString(), 95, 31);
                            }
                        }
                    } else {
                        final Date date = new Date();
                        ...
                        if (pgames[im] == ongame || nflk != 0) {
                            rd.drawString(new StringBuilder().append("Game starts in ").append(wait[i_295_]).append(" seconds!").toString(), 400 - ftm.stringWidth(new StringBuilder().append("Game starts in ").append(wait[i_295_]).append(" seconds!").toString()) / 2, 23);
                            if (pgames[im] != ongame) {
                                nflk--;
                            }
                        } else if (pgames[im] != ongame) {
                    ...
                    rd.drawString(new StringBuilder().append("Waiting for ").append(mnpls[i_295_] - npls[i_295_]).append(" clan members to join to start this game!").toString(), 95, 23);
                }
                if (pgames[im] != ongame) {
                    ...
                    } else if (xt.clan.toLowerCase().equals(gaclan[i_295_].toLowerCase()) || xt.clan.toLowerCase().equals(gvclan[i_295_].toLowerCase())) {
                        bool_299_ = true;
                    }
                    if (bool_299_) {
