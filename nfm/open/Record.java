...
public class Record {
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_68_ = 0; i_68_ < conto.npl; i_68_++) {
				...
				for (int i_70_ = 0; i_70_ < conto.p[i_68_].n; i_70_++)
					if (conto.p[i_68_].wz == 0 && py(conto.keyx[i], conto.p[i_68_].ox[i_70_], conto.keyz[i],
							conto.p[i_68_].oz[i_70_]) < mad.cd.clrad[mad.cn])
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_71_ = 0; i_71_ < conto.npl; i_71_++) {
				...
				for (int i_73_ = 0; i_73_ < conto.p[i_71_].n; i_73_++)
					if (conto.p[i_71_].wz == 0 && py(conto.keyx[i], conto.p[i_71_].ox[i_73_], conto.keyz[i],
							conto.p[i_71_].oz[i_73_]) < mad.cd.clrad[mad.cn])
	...
	public void rec(final ContO conto, final int i, final int i_18_, final int i_19_, final int i_20_,
			final int i_21_) {
		if (i == i_21_)
			caught++;
		if (cntf == 50) {
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_62_ = 0; i_62_ < conto.npl; i_62_++) {
				...
				for (int i_64_ = 0; i_64_ < conto.p[i_62_].n; i_64_++)
					if (conto.p[i_62_].wz == 0 && py(conto.keyx[i], conto.p[i_62_].ox[i_64_], conto.keyz[i],
							conto.p[i_62_].oz[i_64_]) < mad.cd.clrad[mad.cn]) {
				...
				if (f_63_ != 0.0F) {
					...
					if (!conto.p[i_62_].nocol && conto.p[i_62_].glass != 1) {
						...
						final Color color = Color.getHSBColor(conto.p[i_62_].hsb[0], conto.p[i_62_].hsb[1],
								conto.p[i_62_].hsb[2]);
			...
			if (i_51_ * i_50_ == 0 || bool)
				for (int i_54_ = 0; i_54_ < conto.npl; i_54_++) {
					...
					for (int i_56_ = 0; i_56_ < conto.p[i_54_].n; i_56_++)
						if (conto.p[i_54_].wz == 0 && py(conto.keyx[i], conto.p[i_54_].ox[i_56_], conto.keyz[i],
								conto.p[i_54_].oz[i_56_]) < mad.cd.clrad[mad.cn]) {
					...
					if (f_55_ != 0.0F) {
						...
						if (!conto.p[i_54_].nocol && conto.p[i_54_].glass != 1) {
							...
							final Color color = Color.getHSBColor(conto.p[i_54_].hsb[0], conto.p[i_54_].hsb[1],
									conto.p[i_54_].hsb[2]);
				...
				for (int i_59_ = 0; i_59_ < conto.npl; i_59_++) {
					...
					for (int i_61_ = 0; i_61_ < conto.p[i_59_].n; i_61_++)
						if (conto.p[i_59_].wz == 0) {
							...
							if ((Math
									.abs(conto.p[i_59_].oy[i_61_] - mad.cd.flipy[mad.cn]
											- squash[0][mad.im]) < mad.cd.msquash[mad.cn] * 3
									|| conto.p[i_59_].oy[i_61_] < mad.cd.flipy[mad.cn] + squash[0][mad.im])
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_65_ = 0; i_65_ < conto.npl; i_65_++) {
				...
				for (int i_67_ = 0; i_67_ < conto.p[i_65_].n; i_67_++)
					if (conto.p[i_65_].wz == 0 && py(conto.keyx[i], conto.p[i_65_].ox[i_67_], conto.keyz[i],
							conto.p[i_65_].oz[i_67_]) < mad.cd.clrad[mad.cn]) {
				...
				if (f_66_ != 0.0F) {
					...
					if (!conto.p[i_65_].nocol && conto.p[i_65_].glass != 1) {
						...
						final Color color = Color.getHSBColor(conto.p[i_65_].hsb[0], conto.p[i_65_].hsb[1],
								conto.p[i_65_].hsb[2]);
