package nfm.open;/* nfm.open.StageMaker - Decompiled by JODE extended
 * DragShot Software
        ...
        while (!exwist) {
            ...
            if (tab == 3) {
                ...
                if (logged == 0) {
                    ...
                    rd.setFont(new Font("Arial", 1, 13));
                    ftm = rd.getFontMetrics();
                    rd.drawString("nfm.open.Login to Retrieve your Account Stages",
                            400 - ftm.stringWidth("nfm.open.Login to Retrieve your Account Stages") / 2, 220);
