...
class ContO {
    @Expose int checkpoint;
    @Expose int colok;
    @Expose private int[] dam;
    @Expose boolean decor = false;
    @Expose int disline = 14;
    @Expose int disp = 0;
    @Expose int dist = 0;
    @Expose private final int[] edl;
    @Expose private final int[] edr;
    @Expose private final int[] elc;
    @Expose boolean elec;
    @Expose String err;
    @Expose boolean errd;
    @Expose int fcnt;
    @Expose final int[] fcol;
    @Expose boolean fix;
    @Expose int grat = 0;
    @Expose float grounded = 1.0F;
    @Expose final int[] keyx;
    @Expose final int[] keyz;
    @Expose final Medium m;
    @Expose int maxR = 0;
    @Expose boolean noline = false;
    @Expose private boolean[] notwall;
    @Expose int npl = 0;
    @Expose float[] osmag;
    @Expose final Plane[] p;
    @Expose private boolean[] rbef;
    @Expose float rcx;
    @Expose float rcy;
    @Expose float rcz;
    @Expose int roofat;
    @Expose boolean roted;
    @Expose private int[] rtg;
    @Expose private int[] rx;
    @Expose private int[] ry;
    @Expose private int[] rz;
    @Expose private int[] sav;
    @Expose private float[] sbln;
    @Expose final int[] scol;
    @Expose int[] scx;
    @Expose int[] scz;
    @Expose boolean shadow = false;
    @Expose private int[] skd;
    @Expose private float[][] smag;
    @Expose int sprk;
    @Expose private int sprkat;
    @Expose private int[][] srgb;
    @Expose int srx;
    @Expose int sry;
    @Expose int srz;
    @Expose int[] stg;
    ...
    @Expose int[] sy;
    @Expose int[] sz;
    @Expose final Trackers t;
    @Expose private int[][] tc;
    @Expose int tnt;
    @Expose private int[] tradx;
    @Expose private int[] trady;
    @Expose private int[] tradz;
    @Expose private int[] tx;
    @Expose private int[] txy;
    @Expose private int[] ty;
    @Expose private int[] tz;
    @Expose private int[] tzy;
    @Expose private int ust;
    @Expose private float[] vrx;
    @Expose private float[] vry;
    @Expose private float[] vrz;
    @Expose int wh;
    @Expose int wxz = 0;
    @Expose int wzy = 0;
    @Expose int x = 0;
