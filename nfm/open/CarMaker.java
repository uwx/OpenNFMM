package nfm.open;
/* nfm.open.CarMaker - Decompiled by JODE extended
 * DragShot Software
...
public class CarMaker extends Applet implements Runnable, ActionListener {
    ...
    private final String[] pname = {
            ...
            "Pushes Others", "Gets Pushed", "Aerial Rotation Speed", "Aerial nfm.open.Control/Gliding"
    };
    ...
    private int objvalue(final String string, final int i) {
        ...
        try {
            ...
            if (multf10) {
                i386 = (int) (Float.valueOf(string391) * 10.0F);
            } else {
        ...
        while (!exwist) {
            ...
            if (tab == 1) {
                ...
                if (!mirror) {
                    ...
                    bool9 = !srch.getText().equals("") && !rplc.getText().equals("");
