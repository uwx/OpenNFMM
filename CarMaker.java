...
public class CarMaker extends Applet implements Runnable, ActionListener {
    ...
    public void actionPerformed(final ActionEvent actionevent) {
        ...
        if (string.equals("Paste")) {
            try {
                final String string_399_ = (String) Toolkit.getDefaultToolkit().getSystemClipboard().getData(DataFlavor.stringFlavor);
                if (Madness.textid == 18) {
    ...
    public void ctachm() {
                    ...
                    if (file != null) {
                        ...
                        if (i_188_ == 0) {
                            ...
                            for (int i_195_ = 0; i_195_ < i_191_; i_195_++) {
                                string = new StringBuilder().append(string).append("v ").append(is[i_195_] / 10.0F).append(" ").append(-is_189_[i_195_] / 10.0F).append(" ").append(is_190_[i_195_] / 10.0F).append("\n").toString();
                            }
        ...
        if (tab == 2) {
            ...
            if (dtab == 2) {
                ...
                if (i == 20 && changed2) {
                    final int i_247_ = JOptionPane.showConfirmDialog(null, "Saving now will permanently change the point locations & numbers entered in the code!      \n\nContinue?", "Car Maker", 0);
                    if (i_247_ == 0) {
            ...
            for (int i_316_ = 0; i_316_ < o.npl; i_316_++) {
                ...
                if (f_317_ != 0.0F) {
                    ...
                    if (!o.p[i_316_].nocol && o.p[i_316_].glass != 1) {
                        ...
                        final Color color = Color.getHSBColor(o.p[i_316_].hsb[0], o.p[i_316_].hsb[1], o.p[i_316_].hsb[2]);
            ...
            for (int i_320_ = 0; i_320_ < o.npl; i_320_++) {
                ...
                if (f_321_ != 0.0F) {
                    ...
                    if (!o.p[i_320_].nocol && o.p[i_320_].glass != 1) {
                        ...
                        final Color color = Color.getHSBColor(o.p[i_320_].hsb[0], o.p[i_320_].hsb[1], o.p[i_320_].hsb[2]);
    ...
    public void rencar(final String string) {
        if (string.equals("")) {
            ...
            try {
                final File file = new File(new StringBuilder().append("mycars/").append(carname).append(".rad").toString());
                final File file_303_ = new File(new StringBuilder().append("mycars/").append(string).append(".rad").toString());
            ...
            for (int i_325_ = 0; i_325_ < o.npl; i_325_++) {
                ...
                if (!o.p[i_325_].nocol && o.p[i_325_].glass != 1) {
                    if (f_326_ != 0.0F) {
                        ...
                        final Color color = Color.getHSBColor(o.p[i_325_].hsb[0], o.p[i_325_].hsb[1], o.p[i_325_].hsb[2]);
    ...
    public void rot(final int[] is, final int[] is_331_, final int i, final int i_332_, final int i_333_, final int i_334_) {
        if (i_333_ != 0) {
        ...
        while (!exwist) {
            ...
            if (tab == 2) {
                ...
                if (dtab == 2) {
                    ...
                    rd.drawString(new StringBuilder().append("").append(scale[0] / 100.0F).append("").toString(), 126 - ftm.stringWidth(new StringBuilder().append("").append(scale[0] / 100.0F).append("").toString()) / 2, 450);
                    stringbutton(" + ", 160, 450, 4, false);
                    rd.drawString("Scale Y", 25, 474);
                    stringbutton(" - ", 92, 474, 4, false);
                    rd.drawString(new StringBuilder().append("").append(scale[1] / 100.0F).append("").toString(), 126 - ftm.stringWidth(new StringBuilder().append("").append(scale[1] / 100.0F).append("").toString()) / 2, 474);
                    stringbutton(" + ", 160, 474, 4, false);
                    rd.drawString("Scale Z", 25, 498);
                    stringbutton(" - ", 92, 498, 4, false);
                    rd.drawString(new StringBuilder().append("").append(scale[2] / 100.0F).append("").toString(), 126 - ftm.stringWidth(new StringBuilder().append("").append(scale[2] / 100.0F).append("").toString()) / 2, 498);
                ...
                if (dtab == 3) {
                    if (dtabed != dtab) {
                        ...
                        int i_55_ = 0;
                        final String string_56_ = new StringBuilder().append("").append(editor.getText()).append("\n").toString();
                        int i_57_ = 0;
                ...
                if (dtab == 5) {
                    ...
                    if (pfase == 0) {
                        for (int i_96_ = 0; i_96_ < 4; i_96_++) {
                            ...
                            rd.fillRect(138 + (int) (phys[i_96_] / 1.1111F), 443 - i_98_ + i_96_ * 24, 5, i_98_ * 2 + 1);
                    ...
                    if (pfase == 1) {
                        for (int i_99_ = 0; i_99_ < 4; i_99_++) {
                            ...
                            rd.fillRect(119 + (int) (phys[i_99_ + 5] / 1.1111F), 443 - i_101_ + i_99_ * 24, 5, i_101_ * 2 + 1);
                            rd.setColor(new Color(255, 128, 0));
                        ...
                        for (int i_102_ = 0; i_102_ < 2; i_102_++) {
                            ...
                            rd.fillRect(456 + (int) (phys[i_102_ + 9] / 1.1111F), 443 - i_104_ + i_102_ * 24, 5, i_104_ * 2 + 1);
                            rd.setColor(new Color(255, 128, 0));
            ...
            if (tab == 3) {
                ...
                if (logged == 1) {
                    ...
                    String string = "";
                    try {
                        final URL url = new URL(new StringBuilder().append("http://multiplayer.needformadness.com/cars/lists/").append(tnick.getText()).append(".txt?reqlo=").append((int) (Math.random() * 1000.0)).append("").toString());
                        final DataInputStream datainputstream = new DataInputStream(url.openStream());
                        while ((string = datainputstream.readLine()) != null) {
                            string = new StringBuilder().append("").append(string.trim()).toString();
                        ...
                        final String string_147_ = new StringBuilder().append("").append(exception).toString();
