...
public class xtGraphics extends Panel implements Runnable {
	...
	Graphics2D graphics2d, GameSparker gamesparker) {
		...
		if (securitymanager != null) {
			try {
				...
				if (string.indexOf("access denied") != -1) nofull = true;
			}
		}
		badmac = false;
			...
			zipentry != null; zipentry = zipinputstream.getNextEntry()) {
				...
				for (int i_2_ = 0; i_2_ < 5; i_2_++) {
					for (int i_3_ = 0; i_3_ < 5; i_3_++) {
						if (string.equals(new StringBuilder().append("").append(i_3_).append("").append(i_2_).append(".wav").toString())) engs[i_3_][i_2_] = new soundClip(is);
					}
				}
				for (int i_4_ = 0; i_4_ < 6; i_4_++) {
					if (string.equals(new StringBuilder().append("air").append(i_4_).append(".wav").toString())) air[i_4_] = new soundClip(is);
				}
				for (int i_5_ = 0; i_5_ < 3; i_5_++) {
					if (string.equals(new StringBuilder().append("crash")
						.append(i_5_ + 1).append(".wav").toString())) crash[i_5_] = new soundClip(is);
				}
				for (int i_6_ = 0; i_6_ < 3; i_6_++) {
					if (string.equals(new StringBuilder().append("lowcrash").append(i_6_ + 1).append(".wav").toString())) lowcrash[i_6_] = new soundClip(is);
				}
				for (int i_7_ = 0; i_7_ < 3; i_7_++) {
					if (string.equals(new StringBuilder().append("skid").append(i_7_ + 1).append(".wav").toString())) skid[i_7_] = new soundClip(is);
				}
				for (int i_8_ = 0; i_8_ < 3; i_8_++) {
					if (string.equals(new StringBuilder().append("dustskid").append(i_8_ + 1).append(".wav").toString())) dustskid[i_8_] = new soundClip(is);
				}
				for (int i_9_ = 0; i_9_ < 3; i_9_++) {
					if (string.equals(new StringBuilder().append("scrape")
						...
						if (i_9_ == 2) scrape[3] = new soundClip(is);
					}
				}
				if (string.equals("powerup.wav")) powerup = new soundClip(is);
				if (string.equals("tires.wav")) tires = new soundClip(is);
				if (string.equals("checkpoint.wav")) checkpoint = new soundClip(is);
				if (string.equals("carfixed.wav")) carfixed = new soundClip(is);
				if (string.equals("three.wav")) three = new soundClip(is);
				if (string.equals("two.wav")) two = new soundClip(is);
				if (string.equals("one.wav")) one = new soundClip(is);
				if (string.equals("go.wav")) go = new soundClip(is);
				if (string.equals("wasted.wav")) wastd = new soundClip(is);
				if (string.equals("firewasted.wav")) firewasted = new soundClip(is);
				dnload += 5;
			}
	...
	public void loadimages() {
		...
		try {
			...
			zipentry != null; zipentry = zipinputstream.getNextEntry()) {
				...
				if (string.equals("cars.gif")) carsbg = loadBimage(is, mediatracker, toolkit, 1);
				...
				if (string.equals("1.gif")) orank[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("gameh.gif")) ogameh = loadimage(is, mediatracker, toolkit);
				if (string.equals("wgame.gif")) owgame = loadimage(is, mediatracker, toolkit);
				if (string.equals("gameov.gif")) gameov = loadimage(is, mediatracker, toolkit);
				if (string.equals("lap.gif")) olap = loadimage(is, mediatracker, toolkit);
				if (string.equals("paused.gif")) paused = loadimage(is, mediatracker, toolkit);
				if (string.equals("select.gif")) select = loadimage(is, mediatracker, toolkit);
				if (string.equals("yourwasted.gif")) oyourwasted = loadimage(is, mediatracker, toolkit);
				if (string.equals("disco.gif")) odisco = loadimage(is, mediatracker, toolkit);
				if (string.equals("youwastedem.gif")) oyouwastedem = loadimage(is, mediatracker, toolkit);
				if (string.equals("gamefinished.gif")) ogamefinished = loadimage(is, mediatracker, toolkit);
				if (string.equals("exitgame.gif")) oexitgame = loadimage(is, mediatracker, toolkit);
				if (string.equals("pgate.gif")) pgate = loadimage(is, mediatracker, toolkit);
				if (string.equals("d1.png")) dude[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("d2.png")) dude[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("d3.png")) dude[2] = loadimage(is, mediatracker, toolkit);
				if (string.equals("float.gif")) oflaot = loadimage(is, mediatracker, toolkit);
				if (string.equals("1c.gif")) ocntdn[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("2c.gif")) ocntdn[2] = loadimage(is, mediatracker, toolkit);
				if (string.equals("3c.gif")) ocntdn[3] = loadimage(is, mediatracker, toolkit);
				if (string.equals("2.gif")) orank[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("3.gif")) orank[2] = loadimage(is, mediatracker, toolkit);
				if (string.equals("4.gif")) orank[3] = loadimage(is, mediatracker, toolkit);
				if (string.equals("5.gif")) orank[4] = loadimage(is, mediatracker, toolkit);
				if (string.equals("6.gif")) orank[5] = loadimage(is, mediatracker, toolkit);
				if (string.equals("7.gif")) orank[6] = loadimage(is, mediatracker, toolkit);
				if (string.equals("8.gif")) orank[7] = loadimage(is, mediatracker, toolkit);
				if (string.equals("bgmain.jpg")) bgmain = loadBimage(is, mediatracker, toolkit, 2);
				if (string.equals("br.png")) br = loadimage(is, mediatracker, toolkit);
				if (string.equals("loadingmusic.gif")) oloadingmusic = loadimage(is, mediatracker, toolkit);
				if (string.equals("radicalplay.gif")) radicalplay = loadimage(is, mediatracker, toolkit);
				...
				if (string.equals("rpro.gif")) rpro = loadimage(is, mediatracker, toolkit);
				if (string.equals("selectcar.gif")) selectcar = loadimage(is, mediatracker, toolkit);
				if (string.equals("track.jpg")) {
					trackbg[0] = loadBimage(is, mediatracker, toolkit, 3);
					trackbg[1] = dodgen(trackbg[0]);
				}
				if (string.equals("youlost.gif")) oyoulost = loadimage(is, mediatracker, toolkit);
				if (string.equals("youwon.gif")) oyouwon = loadimage(is, mediatracker, toolkit);
				if (string.equals("0c.gif")) ocntdn[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("damage.gif")) odmg = loadimage(is, mediatracker, toolkit);
				if (string.equals("power.gif")) opwr = loadimage(is, mediatracker, toolkit);
				if (string.equals("position.gif")) opos = loadimage(is, mediatracker, toolkit);
				if (string.equals("speed.gif")) osped = loadimage(is, mediatracker, toolkit);
				if (string.equals("wasted.gif")) owas = loadimage(is, mediatracker, toolkit);
				if (string.equals("start1.gif")) ostar[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("start2.gif")) {
					ostar[1] = loadimage(is, mediatracker, toolkit);
					star[2] = pressed(ostar[1]);
				}
				if (string.equals("congrad.gif")) congrd = loadimage(is, mediatracker, toolkit);
				if (string.equals("statb.gif")) statb = loadimage(is, mediatracker, toolkit);
				if (string.equals("statbo.gif")) statbo = loadimage(is, mediatracker, toolkit);
				if (string.equals("madness.gif")) mdness = loadude(is, mediatracker, toolkit);
				if (string.equals("onfmm.gif")) onfmm = loadude(is, mediatracker, toolkit);
				if (string.equals("fixhoop.png")) fixhoop = loadimage(is, mediatracker, toolkit);
				if (string.equals("arrow.gif")) sarrow = loadimage(is, mediatracker, toolkit);
				if (string.equals("stunts.png")) stunts = loadimage(is, mediatracker, toolkit);
				if (string.equals("racing.gif")) racing = loadimage(is, mediatracker, toolkit);
				if (string.equals("wasting.gif")) wasting = loadimage(is, mediatracker, toolkit);
				if (string.equals("plus.gif")) plus = loadimage(is, mediatracker, toolkit);
				if (string.equals("space.gif")) space = loadimage(is, mediatracker, toolkit);
				if (string.equals("arrows.gif")) arrows = loadimage(is, mediatracker, toolkit);
				if (string.equals("chil.gif")) chil = loadimage(is, mediatracker, toolkit);
				if (string.equals("ory.gif")) ory = loadimage(is, mediatracker, toolkit);
				if (string.equals("kz.gif")) kz = loadimage(is, mediatracker, toolkit);
				if (string.equals("kx.gif")) kx = loadimage(is, mediatracker, toolkit);
				if (string.equals("kv.gif")) kv = loadimage(is, mediatracker, toolkit);
				if (string.equals("km.gif")) km = loadimage(is, mediatracker, toolkit);
				if (string.equals("kn.gif")) kn = loadimage(is, mediatracker, toolkit);
				if (string.equals("ks.gif")) ks = loadimage(is, mediatracker, toolkit);
				if (string.equals("kenter.gif")) kenter = loadimage(is, mediatracker, toolkit);
				if (string.equals("nfm.gif")) nfm = loadimage(is, mediatracker, toolkit);
				if (string.equals("options.png")) opti = loadimage(is, mediatracker, toolkit);
				if (string.equals("options2.png")) opti2 = loadimage(is, mediatracker, toolkit);
				if (string.equals("opback.png")) opback = loadimage(is, mediatracker, toolkit);
				if (string.equals("logocars.png")) logocars = loadimage(is, mediatracker, toolkit);
				if (string.equals("logomad.png")) logomadnes = loadimage(is, mediatracker, toolkit);
				if (string.equals("logomadbg.jpg")) logomadbg = loadimage(is, mediatracker, toolkit);
				if (string.equals("byrd.png")) byrd = loadimage(is, mediatracker, toolkit);
				if (string.equals("bggo.jpg")) bggo = loadimage(is, mediatracker, toolkit);
				if (string.equals("nfmcoms.png")) nfmcoms = loadimage(is, mediatracker, toolkit);
				if (string.equals("nfmcom.gif")) nfmcom = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("brit.gif")) brt = loadimage(is, mediatracker, toolkit);
				if (string.equals("arn.gif")) arn = loadimage(is, mediatracker, toolkit);
				if (string.equals("mload.gif")) mload = loadimage(is, mediatracker, toolkit);
				if (string.equals("login.gif")) login = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("play.gif")) play = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("cancel.gif")) cancel = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("register.gif")) register = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("upgrade.gif")) upgrade = loadimage(is, mediatracker, toolkit);
				if (string.equals("sdets.gif")) sdets = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bob.gif")) bob = loadBimage(is, mediatracker, toolkit, 1);
				if (string.equals("bot.gif")) bot = loadBimage(is, mediatracker, toolkit, 1);
				if (string.equals("bol.gif")) bol = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bolp.gif")) bolp = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bor.gif")) bor = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("borp.gif")) borp = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("logout.gif")) logout = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("change.gif")) change = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("pln.gif")) pln = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bols.gif")) bols = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bolps.gif")) bolps = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bors.gif")) bors = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("borps.gif")) borps = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("games.gif")) games = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("exit.gif")) exit = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("chat.gif")) chat = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("players.gif")) players = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("roomp.gif")) roomp = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("cnmc.gif")) cnmc = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("ready.gif")) redy = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("notreg.gif")) ntrg = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("cgame.gif")) cgame = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("ccar.gif")) ccar = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("lanm.gif")) lanm = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("asu.gif")) asu = loadimage(is, mediatracker, toolkit);
				if (string.equals("asd.gif")) asd = loadimage(is, mediatracker, toolkit);
				if (string.equals("pls.gif")) pls = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("sts.gif")) sts = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("gmc.gif")) gmc = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("stg.gif")) stg = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("crd.gif")) crd = loadBimage(is, mediatracker, toolkit, 0);
				if (string.equals("bcl.gif")) bcl[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("bcr.gif")) bcr[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("bc.gif")) bc[0] = loadimage(is, mediatracker, toolkit);
				if (string.equals("pbcl.gif")) bcl[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("pbcr.gif")) bcr[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("pbc.gif")) bc[1] = loadimage(is, mediatracker, toolkit);
				if (string.equals("cmc.gif")) cmc = loadimage(is, mediatracker, toolkit);
				if (string.equals("myc.gif")) myc = loadimage(is, mediatracker, toolkit);
				if (string.equals("gac.gif")) gac = loadimage(is, mediatracker, toolkit);
				if (string.equals("yac.gif")) yac = loadimage(is, mediatracker, toolkit);
				if (string.equals("ycmc.gif")) ycmc = loadimage(is, mediatracker, toolkit);
				if (string.equals("top20s.gif")) top20s = loadimage(is, mediatracker, toolkit);
				dnload += 2;
			}
			fileinputstream.close();
			zipinputstream.close();
	...
	public void sendwin(CheckPoints checkpoints) {
		if (logged && multion == 1 && winner) {
			if ((checkpoints).wasted == nplayers - 1) runtyp = -167;
			else runtyp = -168;
		} else runtyp = -166;
		runner = new Thread(this);
		runner.start();
	...
	public void loading() {
		...
		rd.drawImage(sign, 362, 35,
		this);
		rd.drawImage(hello, 125, 105,
		this);
		...
		if (shload > (float) kbload) shload = (float) kbload;
		if (dnload == kbload) shload = (float) kbload;
		drawcs(410, new StringBuilder().append("").append((int)((26.0F + (shload / (float) kbload * 200.0F)) / 226.0F * 100.0F))
			.append(" % loaded    |    ").append(kbload - (int) shload)
	...
	public void resetstat(int i) {
		...
		if (fase == 22) {
			for (int i_21_ = 0; i_21_ < 2; i_21_++) {
				...
				if (i_21_ == 0) cnames[i_21_][6] = "Game Chat  ";
				else cnames[i_21_][6] = new StringBuilder().append("").append(clan).append("'s Chat  ").toString();
				updatec[i_21_] = -1;
				movepos[i_21_] = 0;
				pointc[i_21_] = 6;
				floater[i_21_] = 0;
			...
			if (multion == 3) ransay = 4;
			else if (ransay == 0) ransay = 1 + (int)(Math.random() * 3.0);
			else {
				ransay++;
				if (ransay > 3) ransay = 1;
			}
		}
	}
	...
	public void rad(int i) {
		...
		if (pin != 0) rd.drawImage(radicalplay, (radpx + (int)(8.0 * Math.random() - 4.0)),
		135, null);
		else rd.drawImage(radicalplay,
		212, 135, null);
		if (radpx != 212) {
			radpx += 40;
			if (radpx > 735) radpx = -388;
		} else if (pin != 0) pin--;
		if (i == 40) {
			radpx = 213;
			pin = 7;
	...
	public void credits(Control control, int i, int i_23_, int i_24_) {
		...
		if (flipo >= 1 && flipo <= 100) {
			rad(flipo);
			flipo++;
			if (flipo == 100) flipo = 1;
		}
		if (flipo == 101) {
			mainbg(-1);
			rd.drawImage(mdness, 283,
			32, null);
			...
			49, 0, 3);
			rd.drawLine(400 - ((ftm.stringWidth("http://multiplayer.needformadness.com/music.html")) / 2),
			396, ((ftm.stringWidth("http://multiplayer.needformadness.com/music.html")) / 2 + 400),
			396);
	...
	public void trackbg(boolean bool) {
		...
		for (int i_25_ = 0; i_25_ < 2; i_25_++) {
			rd.drawImage(trackbg[i],
			trkx[i_25_],
			25, null);
			trkx[i_25_] -= 10;
			if (trkx[i_25_] <= -605) trkx[i_25_] = 735;
		}
		rd.setColor(new Color(0, 0, 0));
		rd.fillRect(0, 0, 65, 450);
		rd.fillRect(735, 0, 65, 450);
	...
	public void mainbg(int i) {
		...
		if (i == 0) {
			...
			int i_27_ = (int)(255.0F * bgf + 191.0F * (1.0F - bgf));
			int i_28_ = (int)(176.0F * bgf + 184.0F * (1.0F - bgf));
			int i_29_ = (int)(67.0F * bgf + 124.0F * (1.0F - bgf));
			if (!bgup) {
				bgf += 0.02F;
				if (bgf > 0.9F) {
					bgf = 0.9F;
		...
		if (i == 2) {
			...
			if (flipo == 16) {
				int i_30_ = (int)(176.0F * bgf + 191.0F * (1.0F - bgf));
				int i_31_ = (int)(202.0F * bgf + 184.0F * (1.0F - bgf));
				int i_32_ = (int)(255.0F * bgf + 124.0F * (1.0F - bgf));
				rd.setColor(new Color(i_30_, i_31_,
				i_32_));
				bgf += 0.025F;
				if (bgf > 0.85F) bgf = 0.85F;
			} else bgf = 0.2F;
			i_26_ = 2;
		}
		if (i == 3) {
			...
			int i_33_ = (int)(255.0F * bgf + 191.0F * (1.0F - bgf));
			int i_34_ = (int)(176.0F * bgf + 184.0F * (1.0F - bgf));
			int i_35_ = (int)(67.0F * bgf + 124.0F * (1.0F - bgf));
			if (!bgup) {
				bgf += 0.02F;
				if (bgf > 0.9F) {
					bgf = 0.9F;
		...
		if (i != -101) {
			...
			} else rd.fillRect(65, 25, 670, 400);
		}
		if (i == 4) {
			if (i != lmode) {
				bgmy[0] = 0;
			...
			for (int i_37_ = 0; i_37_ < 4; i_37_++) {
				...
				rd.fillOval((int)((double)(65 + ovx[i_37_]) - ((double) ovw[i_37_] * 1.5 / 2.0)), (int)((double)(25 + ovy[i_37_]) - ((double) ovh[i_37_] * 1.5 / 2.0)), (int)((double) ovw[i_37_] * 1.5), (int)((double) ovh[i_37_] * 1.5));
				rd.setColor(new Color(255, 176, 67));
				rd.fillOval((65 + ovx[i_37_] - ovh[i_37_] / 2), (25 + ovy[i_37_] - ovh[i_37_] / 2),
				ovw[i_37_],
				ovh[i_37_]);
				ovx[i_37_] -= ovsx[i_37_];
				if (((double) ovx[i_37_] + (double) ovw[i_37_] * 1.5 / 2.0) < 0.0) {
					ovw[i_37_] = (int)(50.0 + 150.0 * Math.random());
					ovh[i_37_] = (int)(50.0 + 150.0 * Math.random());
					ovy[i_37_] = (int)(400.0 * Math.random());
					ovx[i_37_] = (int)(670.0 + ((double) ovw[i_37_] * 1.5 / 2.0));
		...
		if (i != -101 && i != 4) {
			for (int i_38_ = 0; i_38_ < 2; i_38_++) {
				if (i != 2 || flipo != 16) rd.drawImage(bgmain, 65,
				25 + bgmy[i_38_], null);
				bgmy[i_38_] += i_26_;
				if (bgmy[i_38_] >= 400) bgmy[i_38_] = -400;
			}
		}
		rd.setColor(new Color(0, 0, 0));
		rd.fillRect(0, 0, 65, 450);
		rd.fillRect(735, 0, 65, 450);
		if (i != 4) rd.fillRect(65, 0, 670, 25);
		rd.fillRect(65, 425, 670, 25);
	}
	...
	public void inishstageselect(CheckPoints checkpoints) {
		...
		if ((checkpoints).stage == -2) {
			...
			for (int i = 1; i < (app)
				...
				if ((app).mstgs.getItem(i).equals((checkpoints).name)) bool = true;
			}
			if (!bool)
			(checkpoints).stage = (int)(Math.random() * 27.0) + 1;
		}
	...
	public void loadingstage(int i, boolean bool) {
		...
		if (bool) rd.drawImage(select, 338,
		35, null);
		app.repaint();
		if ((cd).staction != 0) {
	...
	public void cantgo(Control control) {
		...
		ftm = rd.getFontMetrics();
		if (aflk) {
			drawcs(185, new StringBuilder().append("[ Stage ").append((unlocked[gmode - 1]) + 1)
	...
	int i_39_, boolean bool) {
		...
		if (testdrive != 3 && testdrive != 4) {
			if ((checkpoints).stage > 0 && (cd).staction == 0) {
				if ((checkpoints).stage != 1 && ((checkpoints).stage != 11 || gmode != 2)) rd.drawImage((back[(pback)]),
				115, 135, null);
				if ((checkpoints).stage != 27) rd.drawImage((next[(pnext)]),
				625, 135, null);
			}
			if (gmode == 0) {
				...
				if ((cd).staction == 5) {
					...
					logged = true;
					gotlog = true;
					if ((cd).reco == 0) acexp = 0;
					if ((cd).reco > 10) acexp = (cd).reco - 10;
					if ((cd).reco == 3) acexp = -1;
					if ((cd).reco == 111) {
						if (!backlog.toLowerCase().equals(nickname.toLowerCase())) acexp = -3;
						else acexp = 0;
					}
				}
				...
				if ((app).sgame.getSelectedIndex() == 0) i_42_ = 400 - ((app)
					.sgame.getWidth() + 6 + (app)
					.snfm1.getWidth()) / 2;
				if ((app).sgame.getSelectedIndex() == 1) i_42_ = 400 - ((app)
					.sgame.getWidth() + 6 + (app)
					.snfm2.getWidth()) / 2;
				...
				if ((cd).staction == 0 || (cd).staction == 6) {
					if ((checkpoints).stage != -3) {
						...
						if ((checkpoints).stage == -2 && ((cd).staction == 0)) {
							...
							11));
							ftm = rd.getFontMetrics();
							rd.setColor(new Color(255, 176,
							85));
							if ((checkpoints).maker.equals(nickname)) rd.drawString("Created by You", 70, 115);
							else rd.drawString(new StringBuilder().append("Created by :  ").append((checkpoints).maker)
								.append("").toString(),
							70, 115);
							if ((checkpoints).top20 >= 3) rd.drawString(new StringBuilder().append("Added by :  ").append((cd)
				...
				if ((cd).staction == 3) {
					...
					if ((cd).reco == -3 && (tcnt % 3 != 0 || tcnt > 20)) drawcs(171, "Please enter your Nickname!", 0, 0, 0, 3);
					if ((cd).reco == -4 && (tcnt % 3 != 0 || tcnt > 20)) drawcs(171, "Please enter your Password!", 0, 0, 0, 3);
					if (!showtf) {
						(app).tnick.setBackground(new Color(206, 237, 255));
						if ((cd).reco != 1) {
							if ((cd).reco != 2)
							(app)
								.tnick.setText(nickname);
							(app).tnick.setForeground(new Color(0, 0, 0));
						} else(app).tnick.setForeground(new Color(255, 0, 0));
						...
						} else(app).tpass.setForeground(new Color(255, 0, 0));
						if (!(app).tnick.getText().equals("") && (cd).reco != 1)
						(app).tpass.requestFocus();
						showtf = true;
					}
					rd.drawString("Nickname:", (376 - ftm.stringWidth("Nickname:") - 14),
					201);
					rd.drawString("Password:", (376 - ftm.stringWidth("Password:") - 14),
					231);
					app.movefieldd((app).tnick, 376,
					185, 129, 23, true);
					app.movefieldd((app).tpass, 376,
					215, 129, 23, true);
					if (tcnt < 30) {
						tcnt++;
						if (tcnt == 30) {
					...
					if ((cd).reco != -177) {
						...
						247, i, i_39_, bool) || (control).handb || (control).enter) && tcnt > 5) {
							tcnt = 0;
							if (!(app)
								.tnick.getText().equals("") && !(app)
					...
					277, 247, i, i_39_, bool) && cntflock == 0) {
					...
					} else if (cntflock != 0) cntflock--;
				}
				if ((cd).staction == 4) {
					drawdprom(145, 170);
					drawcs(195, "Logging in to your account...", 0, 0, 0, 3);
				}
				if ((checkpoints).stage == -2 && (cd).msloaded == 1 && (checkpoints).top20 < 3 && !(app).openm && drawcarb(true, null, "X", 609, 113, i, i_39_, bool))
				(cd).staction = 6;
				...
				if ((checkpoints).stage != -3 && (cd).staction == 0 && (checkpoints).top20 < 3) rd.drawImage((contin[(pcontin)]),
				355, 360, null);
				else pcontin = 0;
				if ((checkpoints).top20 >= 3 && (cd).staction != 3 && (cd).staction != 4) {
					rd.setFont(new Font("Arial", 1, 11));
					ftm = rd.getFontMetrics();
					if (dnload == 0 && drawcarb(true, null, " Add to My Stages ", 334, 355,
					i, i_39_, bool)) {
						if (logged) {
							(cd).onstage = (checkpoints).name;
							(cd).staction = 2;
					...
					if (dnload == 2) {
						...
						3);
						if ((cd).staction == 0) dnload = 3;
						if ((cd).staction == -2) dnload = 4;
						if ((cd).staction == -3) dnload = 5;
						if ((cd).staction == -1) dnload = 6;
						if (dnload != 2)
						(cd).staction = 0;
					}
					if (dnload == 3) drawcs(370,
						"Stage has been successfully added to your stages!",
					193, 106, 0, 3);
					if (dnload == 4) drawcs(370, "You already have this stage!", 193, 106,
					0, 3);
					if (dnload == 5) drawcs(370,
						"Cannot add more then 20 stages to your account!",
					193, 106, 0, 3);
					if (dnload == 6) drawcs(370,
				...
				if ((checkpoints).stage != -3) rd.drawImage((contin[(pcontin)]),
				355, 360, null);
				else pcontin = 0;
			}
			if ((cd).staction == 0) {
	...
	public void hipnoload(int i, boolean bool) {
		...
		if (multion == 0) {
			...
			if (i < 0 && nplayers != 1 && newparts) i_49_ = 0;
		} else if (ransay == 1 || ransay == 2 || ransay == 3 || ransay == 4 || i == 10) i_49_ = 0;
		if (i_49_ == 0) {
			if (dudo > 0) {
				if (aflk) {
					if (Math.random() > Math.random()) duds = (int)(Math.random() * 3.0);
					else duds = (int)(Math.random() * 2.0);
					aflk = false;
				} else aflk = true;
				dudo--;
			} else duds = 0;
			rd.setComposite(AlphaComposite.getInstance(3, 0.3F));
			rd.drawImage((dude[duds]),
			95, 35, null);
			rd.setComposite(AlphaComposite.getInstance(3, 0.7F));
			rd.drawImage(flaot, 192,
			67, null);
			...
			rd.setFont(new Font("Arial", 1, 13));
			if (multion != 0) {
				if (ransay == 1 && i != 10) rd.drawString("Multiplayer Tip:  Press [ C ] to access chat quickly during the game!",
				262, 92);
				if (ransay == 2 && i != 10) {
					rd.drawString("Multiplayer Tip:  Press [ A ] to make Guidance Arrow point to cars and",
					262, 92);
					rd.drawString("click any of the players listed on the right to lock the Arrow on!",
					262, 112);
				}
				if (ransay == 3 && i != 10) {
					rd.drawString("Multiplayer Tip:  When wasting in multiplayer it's better to aim slightly",
					262, 92);
					rd.drawString("ahead of the other player's car to compensate for internet delay.",
					262, 112);
				}
				if (ransay == 4) {
					rd.drawString("When watching a game, click any player listed on the right of the",
					262, 92);
				...
				if (i == 10 && ransay != 4) {
					if (tflk) {
						rd.setColor(new Color(200, i_47_,
						i_48_));
						tflk = false;
					} else tflk = true;
					rd.drawString("NOTE: Guidance Arrow and opponent status is disabled in this stage!",
					262, 92);
				}
			} else {
				if (i < 0 && nplayers != 1 && newparts) {
					rd.drawString("Please note, the computer car's AI has not yet been trained to handle",
					262, 92);
					rd.drawString("some of the new stage parts such as the 'Rollercoaster Road' and the",
					262, 112);
					rd.drawString("'Tunnel Side Ramp'.",
					262, 132);
					rd.drawString("(Those new parts where mostly designed for the multiplayer game.)",
					262, 152);
					rd.drawString("The AI will be trained and ready in the future releases of the game!",
					262, 172);
				}
				if (i == 1 || i == 11) {
					rd.drawString("Hey!  Don't forget, to complete a lap you must pass through",
					262, 92);
					rd.drawString("all checkpoints in the track!", 262, 112);
				}
				if (i == 2 || i == 12) rd.drawString("Remember, the more power you have the faster your car will be!",
				262, 92);
				if (i == 3) {
					rd.drawString("> Hint: its easier to waste the other cars then to race in this stage!",
					262, 92);
					rd.drawString("Press [ A ] to make the guidance arrow point to cars instead of to",
					262, 112);
					rd.drawString("the track.", 262, 132);
				}
				if (i == 4) rd.drawString("Remember, the better the stunt you perform the more power you get!",
				262, 92);
				if (i == 5) rd.drawString("Remember, the more power you have the stronger your car is!",
				262, 92);
				if (i == 10) {
					if (tflk) {
						rd.setColor(new Color(200, i_47_,
					...
					rd.drawString("NOTE: Guidance Arrow is disabled in this stage!",
					262, 92);
				}
				if (i == 13) {
					rd.drawString("Watch out!  Look out!  The policeman might be out to get you!",
					262, 92);
					rd.drawString("Don't upset him or you'll be arrested!", 262, 112);
					rd.drawString("Better run, run, run.",
					262, 152);
				}
				if (i == 14) {
					rd.drawString("Don't waste your time.  Waste them instead!", 262,
					92);
					rd.drawString("Try a taste of sweet revenge here (if you can)!",
					262, 112);
					rd.drawString("Press [ A ] to make the guidance arrow point to cars instead of to",
					262, 152);
				...
				if (i == 17) {
					...
					rd.drawString("The key word here is 'POWER'.  The more you have of it the faster",
					262, 132);
				...
				if (i == 18) {
					...
					rd.drawString("(To fly longer distances in the air try drifting your car on the ramp",
					262, 152);
					rd.drawString("before take off).", 262,
					172);
				}
				if (i == 19) rd.drawString("It\u2019s good to be the king!", 262, 92);
				if (i == 20) {
					rd.drawString("Remember, forward loops give your car a push forwards in the air",
					262, 92);
					rd.drawString("and help in racing.",
					262, 112);
					rd.drawString("(You may need to do more forward loops here.  Also try keeping",
					262, 152);
					rd.drawString("your power at maximum at all times.  Try not to miss a ramp).",
					262, 172);
				}
				if (i == 22) {
					rd.drawString("Watch out!  Beware!  Take care!", 262, 92);
					rd.drawString("MASHEEN is hiding out there some where, don't get mashed now!",
					262, 112);
				}
				if (i == 23) {
				...
				if (i == 26) {
					rd.drawString("This is it!  This is the toughest stage in the game!",
					262, 92);
					rd.drawString("This track is actually a 4D object projected onto the 3D world.",
					262, 132);
					rd.drawString("It's been broken down, separated and, in many ways, it is also a",
					262, 152);
					rd.drawString("maze!  GOOD LUCK!", 262,
					172);
				}
			}
		}
		...
		if (i_50_ < 0) i_50_ = 32;
		if (!bool) {
			drawcs(340 + i_49_, new StringBuilder().append("").append(sndsize[i_50_]).append(" KB").toString(), 0, 0, 0, 3);
			...
			if (multion != 0) drawcs(380 + i_49_,
			new StringBuilder().append("").append(forstart / 20).toString(),
			0, 0, 0, 3);
		}
	}
	...
	public void loadmusic(int i, String string, int i_51_) {
		...
		if (multion == 0) {
			...
			if (i < 0 && nplayers != 1 && newparts) bool = true;
		} else if (ransay == 1 || ransay == 2 || ransay == 3 || ransay == 4 || i == 10) bool = true;
		if (bool) {
			runtyp = i;
			runner = new Thread(this);
			runner.start();
	...
	public void loadstrack(int i, String string, int i_52_) {
		if (i == 1) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		240, 8400, 135, false, false);
		if (i == 2) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		190, 9000, 145, false, false);
		if (i == 3) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		170, 8500, 145, false, false);
		if (i == 4) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		205, 7500, 125, false, false);
		if (i == 5) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		170, 7900, 125, false, false);
		if (i == 6) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		370, 7900, 125, false, false);
		if (i == 7) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		205, 7500, 125, false, false);
		if (i == 8) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		230, 7900, 125, false, false);
		if (i == 9) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		180, 7900, 125, false, false);
		if (i == 10) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		280, 8100, 145, false, false);
		if (i == 11) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		120, 8000, 125, false, false);
		if (i == 12) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		260, 7200, 125, false, false);
		if (i == 13) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		270, 8000, 125, false, false);
		if (i == 14) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		190, 8000, 125, false, false);
		if (i == 15) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		162, 7800, 125, false, false);
		if (i == 16) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		220, 7600, 125, false, false);
		if (i == 17) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		300, 7500, 125, false, false);
		if (i == 18) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		200, 7900, 125, false, false);
		if (i == 19) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		200, 7900, 125, false, false);
		if (i == 20) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		232, 7300, 125, false, false);
		if (i == 21) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		370, 7900, 125, false, false);
		if (i == 22) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		290, 7900, 125, false, false);
		if (i == 23) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		222, 7600, 125, false, false);
		if (i == 24) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		230, 8000, 125, false, false);
		if (i == 25) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		220, 8000, 125, false, false);
		if (i == 26) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		261, 8000, 125, false, false);
		if (i == 27) {
			if (gmode == 2) strack = new RadicalMod("music/party.zip", 400, 7600, 125, false,
			false);
			else strack = new RadicalMod(new StringBuilder().append("music/stage").append(i).append(".zip").toString(),
			276, 8800, 145, false, false);
		}
		if (i == 28) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		182, 8000, 125, false, false);
		if (i == 29) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		220, 8000, 125, false, false);
		if (i == 30) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		200, 8000, 125, false, false);
		if (i == 31) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		350, 7900, 125, false, false);
		if (i == 32) strack = new RadicalMod(new StringBuilder().append("music/stage")
			.append(i).append(".zip").toString(),
		310, 8000, 125, false, false);
		if (i < 0) {
			if (!string.equals("")) {
				if (i != -2) strack = new RadicalMod(new StringBuilder().append("mystages/mymusic/").append(string).append(".zip").toString(),
				i_52_, 8000, 125, false, false);
				else strack = new RadicalMod(string, i_52_, 8000, 125, false,
				true);
			} else strack = new RadicalMod();
		}
		loadedt = true;
	}
	...
	public void musicomp(int i, Control control) {
		...
		if ((control).handb || (control).enter || forstart == 0) {
			...
			if (Math.random() > Math.random()) dudo = 250;
			else dudo = 428;
			(control).handb = false;
			(control).enter = false;
		}
	...
	public void waitenter() {
		if (forstart < 690) {
			...
			0);
			if (forstart <= 640) drawcs(90,
			new StringBuilder().append("").append((640 - forstart) / 32).append("").toString(),
			0, 0, 0, 0);
	...
	int i_53_, boolean bool, UDPMistro udpmistro) {
		...
		if (fase != -2) {
			if (exitm != 0 && !holdit) {
				if (!lan || im != 0) {
					...
					Color.RGBtoHSB((m).cgrnd[0], (m).cgrnd[1], (m).cgrnd[2],
					fs);
					fs[1] -= 0.15;
				...
				fs[2] += 0.15;
				if (fs[2] > 1.0F) fs[2] = 1.0F;
				rd.setColor(Color.getHSBColor(fs[0], fs[1],
				fs[2]));
				rd.fillRect(357, 369, 39, 10);
				if (!lan || im != 0) rd.fillRect(403, 369, 39, 10);
				fs[1] -= 0.07;
				if (fs[1] < 0.0F) fs[1] = 0.0F;
				fs[2] += 0.07;
				if (fs[2] > 1.0F) fs[2] = 1.0F;
				...
				if (!lan || im != 0) rd.fillRect(403, 362, 39, 7);
				rd.setColor(new Color(0, 0, 0));
				rd.setFont(new Font("Arial", 1, 13));
				ftm = rd.getFontMetrics();
				if (lan && im == 0) drawcs(140,
					"(You cannot exit game.  Your computer is the LAN server... )",
				0, 0, 0, 0);
				...
				if (!lan || im != 0) rd.drawString("No", 416, 375);
				rd.setColor(new Color((m).csky[0] / 2, (m).csky[1] / 2, (m).csky[2] / 2));
				if (!lan || im != 0) rd.drawRoundRect(147, 357, 301, 27, 7,
				20);
				else rd.drawRoundRect(147, 357, 262, 27, 7,
				20);
				rd.drawRect(357, 362, 39, 17);
				if (!lan || im != 0) rd.drawRect(403, 362, 39, 17);
			}
			if (runtyp == -101 && !lan) {
				if (warning == 0 || warning == 210) {
					...
					for (int i_57_ = i_55_; i_57_ >= 0; i_57_--) {
						...
						if (i > 33 && i < 666 && i_53_ > 423 + i_56_ && i_53_ < 446 + i_56_ && lxm != i && i_53_ != lym && lxm != -100) {
						...
						if (bool) {
							...
							if (i_57_ == 0)
							(control).chatup = 0;
						} else if (i_57_ == 0 && mouson != 0) mouson = 0;
						if (bool_59_) {
							String string = "";
							int i_60_ = 0;
							int i_61_ = 1;
							for ( /**/ ;
							(i_60_ < lcmsg[i_57_].length());
							i_60_++) {
								String string_62_ = new StringBuilder().append("").append(lcmsg[i_57_].charAt(i_60_))
									.toString();
							...
							if (!string.equals("")) {
								...
								if ((string.toLowerCase().indexOf((app)
									.tpass.getText().toLowerCase())) != -1) string = " ";
								if (!msgcheck(string) && (updatec[i_57_] > -12)) {
									if (cnames[i_57_]
									[6].equals("Game Chat  ") || (cnames[i_57_][6].equals(new StringBuilder().append("")
										.append(clan)
										.append("'s Chat  ").toString()))) cnames[i_57_][6] = "";
									for (int i_63_ = 0; i_63_ < 6; i_63_++) {
										sentn[i_57_][i_63_] = (sentn[i_57_]
										[i_63_ + 1]);
										cnames[i_57_]
										[i_63_] = (cnames[i_57_][i_63_ + 1]);
									}
									...
									msgflk[i_57_] = 110;
									if (updatec[i_57_] > -11) updatec[i_57_] = -11;
									else updatec[i_57_]--;
								} else warning++;
							}
						}
						...
						if ((control).chatup != i_57_ + 1) {
							...
							if (floater[i_57_] != 0) {
								for (int i_67_ = 6; i_67_ >= 0; i_67_--) {
									if (pointc[i_57_] == i_67_) {
										if (Math.abs(i_64_ + (movepos[i_57_])) > 10) {
											...
											if ((floater[i_57_]) > -5 && (floater[i_57_]) < 0) floater[i_57_] = -5;
											if ((floater[i_57_]) < 10 && (floater[i_57_]) > 0) floater[i_57_] = 10;
									...
									if (pointc[i_57_] >= i_67_) {
										...
										ftm = rd.getFontMetrics();
										rd.drawString(new StringBuilder().append(cnames[i_57_][i_67_])
											.append(": ").toString(),
										39 + i_64_ + (movepos[i_57_]),
										439 + i_56_);
										...
										ftm = rd.getFontMetrics();
										rd.drawString(new StringBuilder().append(sentn[i_57_][i_67_])
											.append("   ").toString(),
										39 + i_64_ + (movepos[i_57_]),
										439 + i_56_);
								...
								0));
								rd.fillRect(0, 423 + i_56_,
								5, 24);
								rd.fillRect(794, 423 + i_56_, 6, 24);
							} else {
								for (int i_68_ = pointc[i_57_];
								i_68_ >= 0; i_68_--) {
									if (i_68_ == 6 && (msgflk[i_57_] != 0)) msgflk[i_57_]--;
									rd.setColor(new Color(0, i_65_, i_66_));
									rd.setFont(new Font("Tahoma", 1, 11));
									ftm = rd.getFontMetrics();
									if ((ftm.stringWidth(new StringBuilder().append(cnames[i_57_][i_68_])
										.append(": ").toString())) + 39 + i_64_ < 775) {
										if (i_68_ != 6 || (msgflk[i_57_]) < 67 || (msgflk[i_57_]) % 3 != 0) rd.drawString(new StringBuilder().append(cnames[i_57_][i_68_])
											.append(": ").toString(),
										39 + i_64_, 439 + i_56_);
										...
										String string = "";
										for (int i_69_ = 0;
										((ftm.stringWidth(string) + 39 + i_64_) < 775 && i_69_ < cnames[i_57_]
										[i_68_].length());
										i_69_++)
										string = new StringBuilder().append(string).append(cnames[i_57_]
										[i_68_].charAt(i_69_))
											.toString();
										string = new StringBuilder().append(string).append("...").toString();
										if (i_68_ != 6 || (msgflk[i_57_]) < 67 || (msgflk[i_57_]) % 3 != 0) rd.drawString(string, 39 + i_64_,
										439 + i_56_);
										break;
									}
									rd.setColor(new Color(0, 0, 0));
									rd.setFont(new Font("Tahoma", 0, 11));
									ftm = rd.getFontMetrics();
									if ((ftm.stringWidth(sentn[i_57_]
									[i_68_])) + 39 + i_64_ < 775) {
										if (i_68_ != 6 || (msgflk[i_57_]) < 67 || (msgflk[i_57_]) % 3 != 0) rd.drawString(new StringBuilder().append(sentn[i_57_][i_68_])
											.append("   ").toString(),
										39 + i_64_, 439 + i_56_);
										...
										String string = "";
										for (int i_70_ = 0;
										((ftm.stringWidth(string) + 39 + i_64_) < 775 && i_70_ < sentn[i_57_]
										[i_68_].length());
										i_70_++)
										string = new StringBuilder().append(string).append(sentn[i_57_][i_68_].charAt(i_70_))
											.toString();
										string = new StringBuilder().append(string).append("...").toString();
										if (i_68_ != 6 || (msgflk[i_57_]) < 67 || (msgflk[i_57_]) % 3 != 0) rd.drawString(string, 39 + i_64_,
										439 + i_56_);
						...
						if (bool_58_ || floater[i_57_] != 0) {
							...
							if (fs[2] > 1.0F) fs[2] = 1.0F;
							rd.setColor(Color.getHSBColor(fs[0], fs[1], fs[2]));
							rd.fillRect(5, 423 + i_56_, 28,
							23);
						}
						if (bool_58_) rd.setColor(new Color(0, 0,
						0));
						else rd.setColor(new Color((int)((float)(
						(m)).cgrnd[0] / 2.0F), (int)((float)(
						(m)).cgrnd[1] / 2.0F), (int)((float)(
						(m)).cgrnd[2] / 2.0F)));
						rd.setFont(new Font("Tahoma", 1,
						11));
						rd.drawString("<<", 10,
						439 + i_56_);
						rd.setColor(new Color(0, 0, 0));
						rd.drawRect(5, 423 + i_56_, 789,
						23);
						rd.drawLine(33, 423 + i_56_, 33,
						446 + i_56_);
						i_56_ += 23;
					}
					if (i > 775 && i < 794 && i_53_ > 409 - i_55_ * 23 && i_53_ < 423 - i_55_ * 23) {
						rd.drawRect(775, 409 - i_55_ * 23,
						19, 14);
			...
			if (((control).arrace && starcnt < 38 && !holdit && (checkpoints).stage != 10) || multion >= 2) {
				...
				if (multion >= 2) {
					...
					if (lan) {
						...
						for (int i_73_ = 0;
						i_73_ < nplayers; i_73_++) {
							if (dested[i_73_] == 0 && plnames[i_73_].indexOf("MadBot") == -1) bool_72_ = false;
						}
						if (bool_72_) exitm = 2;
					}
				}
				...
				for (int i_75_ = 0; i_75_ < i_74_; i_75_++) {
					...
					i_77_++) {
						if ((checkpoints).pos[i_77_] == i_75_ && (checkpoints).dested[i_77_] == 0 && !bool_76_) {
							...
							rd.setColor(new Color(0, 0,
							i_81_));
							if (i_75_ == 0) rd.drawString("1st", 673, 76 + 30 * i_75_);
							if (i_75_ == 1) rd.drawString("2nd", 671, 76 + 30 * i_75_);
							if (i_75_ == 2) rd.drawString("3rd", 671, 76 + 30 * i_75_);
							if (i_75_ >= 3) rd.drawString(new StringBuilder().append("").append(i_75_ + 1).append("th").toString(),
							671, 76 + 30 * i_75_);
							if (clangame != 0) {
								int i_82_;
								int i_83_;
								...
								rd.drawString(plnames[i_77_],
								731 - (ftm.stringWidth(plnames[i_77_])) / 2,
								70 + 30 * i_75_);
							}
							rd.setColor(new Color(0, 0,
							0));
							rd.drawString(plnames[i_77_],
							730 - ((ftm.stringWidth(plnames[i_77_])) / 2),
							70 + 30 * i_75_);
							...
							i_85_ += ((float) i_85_ * ((float)((m)).snap[0] / 100.0F));
							if (i_85_ > 255) i_85_ = 255;
							if (i_85_ < 0) i_85_ = 0;
							i_86_ += ((float) i_86_ * ((float)((m)).snap[1] / 100.0F));
							if (i_86_ > 255) i_86_ = 255;
							if (i_86_ < 0) i_86_ = 0;
							i_81_ += ((float) i_81_ * ((float)((m)).snap[2] / 100.0F));
							if (i_81_ > 255) i_81_ = 255;
							if (i_81_ < 0) i_81_ = 0;
							...
							if ((im != i_77_ || multion >= 2) && i > 661 && i < 775 && i_53_ > 58 + 30 * i_75_ && i_53_ < 83 + 30 * i_75_) {
								bool_87_ = true;
								if (bool) {
									if (!onlock) {
										if ((alocked != i_77_) || (multion >= 2)) {
											alocked = i_77_;
											if (multion >= 2) im = i_77_;
										} else alocked = -1;
									}
									onlock = true;
								} else if (onlock) onlock = false;
							}
							if (alocked == i_77_) {
			...
			if ((udpmistro).go && (udpmistro).runon == 1 && !holdit) {
				int i_88_ = 0;
				int i_89_ = 0;
				for (int i_90_ = 0; i_90_ < nplayers;
				i_90_++) {
				...
				if (i_88_ == i_89_) discon++;
				else if (discon != 0) discon = 0;
				if (discon == 240)
				(udpmistro).runon = 2;
			}
		}
		if (i_54_ != -1) {
			...
			rd.setColor(new Color(0, 0, 0));
			rd.setFont(new Font("Tahoma", 1, 11));
			rd.drawString("Send Message  >", 684,
			439 - i_54_ * 23);
			rd.setColor(new Color((int)((float)((m)
				.cgrnd[0]) / 1.2F), (int)((float)((m)
				.cgrnd[1]) / 1.2F), (int)((float)((m)
				.cgrnd[2]) / 1.2F)));
			...
			if ((app).cmsg.getText()
				.equals(lcmsg[i_54_])) cntchatp[i_54_]++;
			else cntchatp[i_54_] = -200;
			lcmsg[i_54_] = new StringBuilder().append("").append((app).cmsg.getText())
				.toString();
			if (cntchatp[i_54_] == 67)
			(control).chatup = 0;
			if ((app).cmsg.getText().length() > 100) {
				(app).cmsg.setText((app).cmsg.getText()
					.substring(0, 100));
	...
	public void levelhigh(int i, int i_91_, int i_92_, int i_93_, int i_94_) {
		...
		if (i != im) {
			...
			if (discon != 240) drawcs(60, "Wasted!", i_95_, i_96_, i_97_, 0);
	...
	public void inst(Control control) {
		...
		if (flipo == 3 || flipo == 5) {
			if (flipo == 3) {
				...
				rd.drawImage(nfm, 469,
				55, null);
				rd.drawString("In this game there are two ways to complete a stage.",
				262, 107);
				rd.drawString("One is by racing and finishing in first place, the other is by",
				262, 127);
				rd.drawString("wasting and crashing all the other cars in the stage!",
				262, 147);
			} else {
				rd.setColor(new Color(0, 128, 255));
				rd.drawString("While racing, you will need to focus on going fast and passing",
				262, 67);
				rd.drawString("through all the checkpoints in the track. To complete a lap, you",
				262, 87);
				rd.drawString("must not miss a checkpoint.", 262, 107);
				rd.drawString("While wasting, you will just need to chase the other cars and",
				262, 127);
				rd.drawString("crash into them (without worrying about track and checkpoints).",
				262, 147);
			}
			rd.setColor(new Color(0, 0, 0));
			rd.drawImage(racing, 165,
			185, null);
			rd.drawImage(ory, 429, 235,
			null);
			rd.drawImage(wasting, 492,
			185, null);
			rd.setFont(new Font("Arial", 1, 11));
			rd.drawString("Checkpoint", 392, 189);
			rd.setFont(new Font("Arial", 1, 13));
			rd.drawString("Drive your car using the Arrow Keys and Spacebar", 125, 320);
			rd.drawImage(space, 171,
			355, null);
			rd.drawImage(arrows, 505,
			323, null);
			rd.setFont(new Font("Arial", 1, 11));
			rd.drawString("(When your car is on the ground Spacebar is for Handbrake)",
			125, 341);
		...
		if (flipo == 7 || flipo == 9) {
			if (flipo == 7) {
				rd.drawString("Whether you are racing or wasting the other cars you will need",
				262, 67);
				rd.drawString("to power up your car.", 262,
				87);
				rd.drawString("=> More 'Power' makes your car become faster and stronger!",
				262, 107);
				rd.drawString("To power up your car (and keep it powered up) you will need to",
				262, 127);
				rd.drawString("perform stunts!", 262, 147);
				rd.drawImage(chil, 167,
				295, null);
			} else {
				rd.drawString("The better the stunt the more power you get!", 262, 67);
				rd.setColor(new Color(0, 128, 255));
				rd.drawString("Forward looping pushes your car forwards in the air and helps",
				262, 87);
				rd.drawString("when racing. Backward looping pushes your car upwards giving it",
				262, 107);
				rd.drawString("more hang time in the air making it easier to control its landing.",
				262, 127);
				rd.drawString("Left and right rolls shift your car in the air left and right slightly.",
				262, 147);
				if (aflk || dudo < 150) rd.drawImage(chil,
				167, 295, null);
			}
			rd.setColor(new Color(0, 0, 0));
			rd.drawImage(stunts, 105,
			175, null);
			rd.drawImage(opwr, 540,
			253, null);
			rd.setFont(new Font("Arial", 1, 13));
			rd.drawString("To perform stunts. When your car is in the AIR:", 125, 310);
			rd.drawString("Press combo Spacebar + Arrow Keys", 125, 330);
			rd.drawImage(space, 185,
			355, null);
			rd.drawImage(plus, 405,
			358, null);
			rd.drawImage(arrows, 491,
			323, null);
			rd.setFont(new Font("Arial", 1, 11));
			rd.setColor(new Color(0, 0, 0));
		...
		if (flipo == 11 || flipo == 13) {
			if (flipo == 11) {
				rd.drawString("When wasting cars, to help you find the other cars in the stage,",
				262, 67);
				rd.drawString("press [ A ] to toggle the guidance arrow from pointing to the track",
				262, 87);
				rd.drawString("to pointing to the cars.",
				262, 107);
				rd.drawString("When your car is damaged. You fix it (and reset its 'Damage') by",
				262, 127);
				rd.drawString("jumping through the electrified hoop.", 262, 147);
			} else {
				rd.setColor(new Color(0, 128, 255));
				rd.drawString("You will find that in some stages it's easier to waste the other cars",
				262, 67);
				rd.drawString("and in some others it's easier to race and finish in first place.",
				262, 87);
				rd.drawString("It is up to you to decide when to waste and when to race.",
				262, 107);
				rd.drawString("And remember, 'Power' is an important factor in the game. You",
				262, 127);
				rd.drawString("will need it whether you are racing or wasting!", 262,
				147);
			}
			rd.setColor(new Color(0, 0, 0));
			rd.drawImage(fixhoop, 185,
			218, null);
			rd.drawImage(sarrow, 385,
			228, null);
			rd.setFont(new Font("Arial", 1, 11));
			rd.drawString("The Electrified Hoop", 192,
			216);
		...
		if (flipo == 15) {
			...
			rd.drawString("I am Coach Insano, I am the coach and narrator of this game!",
			262, 87);
			rd.drawString("I recommended starting with NFM 1 if it\u2019s your first time to play.",
			262, 127);
			rd.drawString("Good Luck & Have Fun!", 262,
			147);
			rd.setColor(new Color(0, 0, 0));
			rd.drawString("Other Controls :", 155, 205);
			rd.setFont(new Font("Arial", 1, 11));
			rd.drawImage(kz, 169, 229,
			null);
			rd.drawString("OR", 206, 251);
			rd.drawImage(kx, 229, 229,
			null);
			rd.drawString("To look behind you while driving.", 267, 251);
			rd.drawImage(kv, 169, 279,
			null);
			rd.drawString("Change Views", 207, 301);
			rd.drawImage(kenter, 169,
			329, null);
			rd.drawString("Navigate & Pause Game", 275,
			351);
			rd.drawImage(km, 489, 229,
			null);
			rd.drawString("Mute Music", 527, 251);
			rd.drawImage(kn, 489, 279,
			null);
			rd.drawString("Mute Sound Effects", 527, 301);
			rd.drawImage(ks, 489, 329,
			null);
		...
		if (flipo == 1 || flipo == 16) {
			...
			ftm = rd.getFontMetrics();
			rd.setColor(new Color(0, 0, 0));
			if (flipo == 16) rd.drawString("M A I N    C O N T R O L S   -   once again!",
			400 - ((ftm.stringWidth("M A I N    C O N T R O L S   -   once again!")) / 2),
			49);
			else rd.drawString("M A I N    C O N T R O L S",
			400 - ftm.stringWidth("M A I N    C O N T R O L S") / 2,
			49);
			...
			rd.drawImage(stunts, 125,
			285, null);
		}
		if (flipo >= 1 && flipo <= 15) rd.drawImage((next[pnext]),
		665, 395, null);
		if (flipo >= 3 && flipo <= 16) rd.drawImage((back[pback]),
		75, 395, null);
		if (flipo == 16) rd.drawImage((contin[pcontin]),
		565, 395, null);
		if ((control).enter || (control).right) {
			...
			(control).enter = false;
			(control).right = false;
			if (flipo >= 1 && flipo <= 15) flipo++;
		}
		if ((control).left) {
			if (flipo >= 3 && flipo <= 15) flipo -= 3;
			if (flipo == 16) flipo--;
			(control).left = false;
		}
	}
	...
	public void maini(Control control) {
		...
		rd.setComposite(AlphaComposite.getInstance(3,
		0.6F));
		rd.drawImage(logomadbg, 65, 25,
		null);
		rd.setComposite(AlphaComposite.getInstance(3,
		1.0F));
		rd.drawImage(logomadnes, 233,
		186, null);
		float f = (float) flkat / 800.0F;
		if ((double) f > 0.2) f = 0.2F;
		if (flkat > 200) {
			f = (float)(400 - flkat) / 1000.0F;
			if (f < 0.0F) f = 0.0F;
		}
		flkat++;
		if (flkat == 400) flkat = 0;
		...
		movly++;
		if (movly == 2) movly = 0;
		rd.drawImage(logocars, 66, 33,
		null);
		rd.drawImage(opback, 247, 237,
		null);
		if (muhi < 0) {
		...
		if ((control).enter || (control).handb) {
			...
			if (opselect == 3) fase = 8;
			if (opselect == 0) {
				if (unlocked[0] == 11) {
					if (unlocked[1] != 17) opselect = 1;
					else opselect = 2;
				}
				if (firstime) {
					oldfase = 102;
		...
		rd.drawImage(byrd, 72, 410,
		null);
		rd.drawImage(nfmcoms, 567, 410,
		null);
		if (shaded) {
			app.repaint();
			try {
	...
	public void maini2(Control control, int i, int i_98_, int i_99_) {
		...
		if ((control).up) {
			opselect--;
			if (opselect == -1) opselect = 3 - dropf / 15;
			(control).up = false;
		}
		if ((control).down) {
			opselect++;
			if (opselect == 4 - dropf / 15) opselect = 0;
			(control).down = false;
		}
		if (opselect == 0) {
			if (shaded) {
			...
			rd.drawRoundRect(358, (262 + dropf),
			82, 22, 7, 20);
		} else {
			rd.setColor(new Color(0, 0, 0));
			rd.drawRoundRect(358, (262 + dropf),
		...
		if (opselect == 1) {
			...
			rd.drawRoundRect(358, (290 + dropf),
			82, 22, 7, 20);
		} else {
			rd.setColor(new Color(0, 0, 0));
			rd.drawRoundRect(358, (290 + dropf),
		...
		if (opselect == 2) {
			...
			rd.drawRoundRect(333, (318 + dropf),
			132, 22, 7, 20);
		} else {
			rd.setColor(new Color(0, 0, 0));
			rd.drawRoundRect(333, (318 + dropf),
	...
	public void pausedgame(int i, Control control, Record record) {
		...
		if (opselect == 0) {
			...
			if (shaded) rd.setColor(new Color(225, 200, 255));
			else rd.setColor(new Color(0, 89, 223));
	...
	public void inishcarselect(ContO[] contos) {
		...
		if (testdrive != 1 && testdrive != 2) {
			...
			if (gmode == 0) sc[0] = osc;
			if ((cd).lastload != 1 || cfase != 3) onmsc = sc[0];
			if (cfase == 0 && sc[0] > 15) {
				sc[0] = 15;
				if (multion != 0) cfase = -1;
			}
			...
			if (cfase == 11 || cfase == 101) {
				if (sc[0] >= 16 && (cd).lastload == 2 && sc[0] < 36) cfase = 3;
				else cfase = 0;
			}
			if (cfase == 3) {
				...
				if ((cd).lastload == 2) {
					minsl = 16;
					maxsl = (cd).nlocars - 1;
					if (sc[0] < minsl) sc[0] = minsl;
					if (sc[0] > maxsl) sc[0] = maxsl;
					if (onjoin != -1 && multion != 0 && ontyp > 0 && ontyp <= 5) {
						...
						if (!bool) {
							...
							if (sc[0] > maxsl) sc[0] = maxsl;
							if (Math.abs(((cd)
								.cclass[sc[0]]) - (ontyp - 1)) > 1) sc[0] = minsl;
						}
					}
				}
	...
	int i_104_, boolean bool) {
		...
		rd.fillRect(65, 425, 670, 25);
		if (flatrstart == 6) {
			if (multion != 0 || testdrive == 1 || testdrive == 2) rd.drawImage(carsbgc,
			65, 25, null);
			else rd.drawImage(carsbg,
			65, 25, null);
		} else if (flatrstart <= 1) drawSmokeCarsbg();
		else {
			rd.setColor(new Color(255, 255, 255));
			rd.fillRect(65, 25, 670, 400);
			carsbginflex();
		...
		rd.drawImage(selectcar, 321,
		37, null);
		if (cfase == 3 || cfase == 7 || remi) {
			if ((cd).lastload == 1) rd.drawImage(ycmc, 337,
			58, null);
			if ((cd).lastload == 2) rd.drawImage(yac, 323,
			58, null);
		}
		if (cfase == 11) {
			rd.setFont(new Font("Arial", 1, 13));
		...
		if (cfase == 101) {
			...
			ftm = rd.getFontMetrics();
			drawcs(69,
			new StringBuilder().append("").append((cd).viewname).append("'s account cars!").toString(),
			220, 112, 33, 3);
		}
		if (!remi) {
			rd.setRenderingHint((RenderingHints.KEY_ANTIALIASING), (RenderingHints.VALUE_ANTIALIAS_OFF));
		...
		if ((multion != 0 || testdrive == 1 || testdrive == 2) && lsc != sc[0]) {
			...
			for (int i_108_ = 0;
			(i_108_ < (contos[sc[0]]).npl && !bool_107_);
			i_108_++) {
				if ((((contos[sc[0]]).p[i_108_])).colnum == 1) {
					float[] fs = new float[3];
					Color.RGBtoHSB((((contos[sc[0]])
						.p[i_108_])).c[0], (((contos[sc[0]])
						.p[i_108_])).c[1], (((contos[sc[0]])
						.p[i_108_])).c[2],
					fs);
					arnp[0] = fs[0];
					arnp[1] = fs[1];
			...
			bool_107_ = false;
			for (int i_109_ = 0;
			(i_109_ < (contos[sc[0]]).npl && !bool_107_);
			i_109_++) {
				if ((((contos[sc[0]]).p[i_109_])).colnum == 2) {
					float[] fs = new float[3];
					Color.RGBtoHSB((((contos[sc[0]])
						.p[i_109_])).c[0], (((contos[sc[0]])
						.p[i_109_])).c[1], (((contos[sc[0]])
						.p[i_109_])).c[2],
					fs);
					arnp[3] = fs[0];
					arnp[4] = fs[1];
			...
			Color color = Color.getHSBColor(arnp[0],
			arnp[1],
			1.0F - arnp[2]);
			Color color_110_ = Color.getHSBColor(arnp[3],
			arnp[4],
			1.0F - arnp[5]);
			for (int i_111_ = 0;
			i_111_ < (contos[sc[0]]).npl;
			i_111_++) {
		...
		if (flipo == 0) {
			...
			if (!remi && (cfase != 10 || ((cd).action != 0 && ((cd).action < 14)))) {
				if (cfase == 3 && (cd).lastload == 2) {
					...
					((app).mcars)
						.show = false;
					String string = "";
					if (cfase == 11) string = new StringBuilder().append("N#").append(sc[0] - 35).append("  ").toString();
					if (aflk) {
						drawcs(95 + i_115_,
						new StringBuilder().append(string).append((cd).names[sc[0]])
							.toString(),
						240, 240, 240, 3);
						aflk = false;
					} else {
						drawcs(95, new StringBuilder().append(string).append((cd)
							.names[sc[0]])
							.toString(), 176, 176, 176, 3);
						aflk = true;
					}
				}
			} else((app).mcars).show = false;
			(contos[sc[0]]).z = 950;
			if (sc[0] == 13)
			(contos[sc[0]]).z = 1000;
			...
			(contos[sc[0]]).wzy += 30;
			if (!remi) {
				if (sc[0] != minsl) rd.drawImage((back[(pback)]),
				95, 275, null);
				if (sc[0] != maxsl) rd.drawImage((next[(pnext)]),
				645, 275, null);
			}
			if (gmode == 1) {
				if (sc[0] == 5 && unlocked[0] <= 2) i_113_ = 2;
				if (sc[0] == 6 && unlocked[0] <= 4) i_113_ = 4;
				if (sc[0] == 11 && unlocked[0] <= 6) i_113_ = 6;
				if (sc[0] == 14 && unlocked[0] <= 8) i_113_ = 8;
				if (sc[0] == 15 && unlocked[0] <= 10) i_113_ = 10;
			}
			if (gmode == 2 && sc[0] >= 8 && (unlocked[1] <= (sc[0] - 7) * 2)) i_113_ = (sc[0] - 7) * 2;
			if (i_113_ != 0) {
				if (gatey == 300) {
				...
				for (int i_118_ = 0; i_118_ < 9; i_118_++) {
					rd.drawImage(pgate,
					pgatx[i_118_], (pgaty[i_118_] + pgady[i_118_] - gatey),
					null);
					if (flatrstart == 6) {
						if (pgas[i_118_]) {
							...
							if (pgady[i_118_] < -(70 + 100 / (i_118_ + 1))) {
								pgas[i_118_] = false;
								if (i_118_ != 8) pgas[i_118_ + 1] = true;
							}
						} else {
							pgady[i_118_] += (80 + 100 / (i_118_ + 1) - Math.abs(pgady[i_118_])) / 3;
							if (pgady[i_118_] > 0) pgady[i_118_] = 0;
						}
					}
				}
				if (gatey != 0) gatey -= 100;
				if (flatrstart == 6) {
				...
				if (flatrstart == 6) {
					if (cfase == 10) {
						...
						if ((cd).action == 12) {
							...
							if ((cd).nl > 0 && ((cd).nl <= 20)) drawcs(235,
						...
						if ((cd).action == 0 || ((cd).action == 14) || ((cd).action == 15) || ((cd).action == 16) || ((cd).action == 17)) {
							...
							if (((cd).action == 14) || ((cd).action == 15) || ((cd).action == 16) || ((cd).action == 17)) {
								if (!bool && cntflock == 20) cntflock = 0;
								if ((cd).action == 14) drawcs(91, "Weekly Top 20 Cars", 0, 0, 0,
								3);
								if ((cd).action == 15) drawcs(91, "Monthly Top 20 Cars", 0, 0, 0,
								3);
								if ((cd).action == 16) drawcs(91, "Semi-Annual Top 20 Cars", 0, 0,
								0, 3);
								if ((cd).action == 17) drawcs(91, "Annual Top 20 Cars", 0, 0, 0,
								3);
								if (drawcarb(true, null,
									"   All Cars, All Classes   ",
								318, 105, i, i_104_, bool) && cntflock == 0) {
									(cd)
										.loadlist = 1 + ((
									cd).action - 14) * 6;
									(cd).action = 11;
								...
								337, 165, i, i_104_, bool) && cntflock == 0) {
									(cd)
										.loadlist = 3 + ((
									cd).action - 14) * 6;
									(cd).action = 11;
								...
								337, 225, i, i_104_, bool) && cntflock == 0) {
									(cd)
										.loadlist = 5 + ((
									cd).action - 14) * 6;
									(cd).action = 11;
					...
					if (cfase == 100) {
						...
						if ((cd).action == -2) {
							...
							drawcs(225,
							new StringBuilder().append("").append((cd)
								.viewname)
					...
					if (cfase == 0 && testdrive != 1 && testdrive != 2 && gmode == 0) {
						...
						if (multion == 0 && drawcarb(false, cmc, "", 95,
						70, i, i_104_, bool)) {
							if ((cd).lastload != 1) cfase = 1;
							else {
								minsl = 16;
								maxsl = ((cd)
									.nlcars) - 1;
						...
						i_121_, 105 + i_122_, i, i_104_, bool)) {
							if ((cd).lastload != 2) {
								...
								maxsl = ((cd)
									.nlocars) - 1;
								if ((onmsc >= minsl) && (onmsc <= maxsl)) i_112_ = onmsc;
								else i_112_ = 16;
								cfase = 3;
							}
						}
						if ((multion == 0 || onjoin == -1) && drawcarb(false, top20s, "",
					...
					if (cfase == 3 && i_112_ == -1) {
						...
						if (multion == 0) {
							...
							rd.setColor(new Color(0, 0,
							0));
							rd.drawRoundRect(305, 302, 190,
							24, 7, 20);
							app.movefield((app).mycar,
							334, 306, 150, 17);
							if ((app)
								.mycar.getState() != ((cd)
								.include[sc[0] - 16])) {
						...
						if ((cd).lastload == 2) {
							...
							0));
							if (!(cd)
								.createdby[sc[0] - 16].equals(nickname)) bool_114_ = clink(((
							cd)
								.createdby[sc[0] - 16]),
							i, i_104_, bool);
							else rd.drawString("Created by You", 241, 160);
						}
						if (remi) remi = false;
						if (noclass) {
							drawprom(200, 95);
							...
							if (ontyp == 2) string = "Class B or C";
							if (ontyp == 3) string = "Class B";
							if (ontyp == 4) string = "Class A or B";
							if (ontyp == 5) string = "Class A";
					...
					if ((cfase == 11 || cfase == 101) && i_112_ == -1) {
						...
						if ((cd).action == 6) {
							drawprom(145, 95);
							drawcs(195,
							new StringBuilder().append("Adding ").append((cd)
								.names[((cd)
								.ac)])
						...
						if ((cd).action == 0) {
							...
							if (cfase != 101) {
								rd.setFont(new Font("Arial", 1, 11));
								rd.drawString(new StringBuilder().append("Added by :  ").append((cd)
									.adds[sc[0] - 36])
									.append(" Players").toString(),
								241, 180);
							}
					...
					if (cfase == 5) {
						...
						if ((cd).action == 4) {
							...
							drawcs(235,
							new StringBuilder().append("Loading :  ").append((app)
						...
						if ((cd).action == 1) drawcs(195, "Logging in to your account...", 0, 0,
						0, 3);
						if ((cd).action == 0) {
							if ((cd).reco == -5) drawcs(171,
							...
							if ((cd).reco == -3 && (tcnt % 3 != 0 || tcnt > 20)) drawcs(171, "Please enter your Nickname!", 0,
							0, 0, 3);
							if ((cd).reco == -4 && (tcnt % 3 != 0 || tcnt > 20)) drawcs(171, "Please enter your Password!", 0,
							0, 0, 3);
							if (!showtf) {
								(app)
								...
								if (!(app)
									.tnick.getText().equals("") && ((cd)
									.reco) != 1)
								(app)
									.tpass.requestFocus();
								showtf = true;
							}
							rd.drawString("Nickname:",
							376 - ftm.stringWidth("Nickname:") - 14,
							201);
							rd.drawString("Password:",
							376 - ftm.stringWidth("Password:") - 14,
							231);
							app.movefieldd((app).tnick,
							376, 185, 129, 23, true);
							app.movefieldd((app).tpass,
							376, 215, 129, 23, true);
							if (tcnt < 30) {
								tcnt++;
								if (tcnt == 30) {
							...
							284, 247, i, i_104_, bool)) && cntflock == 0) {
								app.editlink(((
								this)
									.nickname),
								true);
					...
					if (cfase == 4) {
						drawprom(145, 150);
						rd.setColor(new Color(0, 0, 0));
						rd.drawString("Failed to find any ready car in your \u2018mycars\u2019 folder!",
						215, 175);
						rd.drawString("Please \u2018Test Drive\u2019 your cars in the Car Maker to make",
						215, 215);
					...
					if (cfase == 1) {
						drawprom(145, 170);
						rd.setColor(new Color(0, 0, 0));
						rd.drawString("The game will now load all the cars that can be loaded",
						215, 170);
						rd.drawString("from your \u2018mycars\u2019 folder.", 215, 190);
						rd.drawString("If a car is not loaded, then it is not ready (not finished).",
						215, 210);
						rd.drawString("Perform a \u2018Test Drive\u2019 on any car to see if it is ready or not.",
						215, 230);
						rd.drawString("The maximum number of cars that can be loaded is  40 !",
						215, 260);
					...
					rd.setColor(new Color(0, 0, 0));
					float f = ((float)(((cd)
						.swits[sc[0]][2]) - 220) / 90.0F);
					if ((double) f < 0.2) f = 0.2F;
					rd.fillRect((int)(162.0F + 156.0F * f),
					...
					if (f > 1.0F) f = 1.0F;
					rd.fillRect((int)(536.0F + 156.0F * f),
					337, (int)(156.0F * (1.0F - f) + 1.0F),
					7);
					float f_127_ = 0.5F;
					...
					if (multion != 0 || testdrive == 1 || testdrive == 2) {
						...
						ftm = rd.getFontMetrics();
						String string = "Class C";
						if (((cd).cclass[sc[0]]) == 1) string = "Class B & C";
						if (((cd).cclass[sc[0]]) == 2) string = "Class B";
						if (((cd).cclass[sc[0]]) == 3) string = "Class A & B";
						if (((cd).cclass[sc[0]]) == 4) string = "Class A";
						if (kbload < 7) {
							rd.setColor(new Color(0, 0,
							0));
							kbload++;
						} else {
							rd.setColor(new Color(176, 41,
							0));
							kbload = 0;
						}
						if (cfase != 10 || (((cd).action != 0) && ((cd).action < 14))) rd.drawString(string,
						549 - ftm.stringWidth(string) / 2,
						95);
						rd.setFont(new Font("Arial", 1,
						12));
						ftm = rd.getFontMetrics();
						rd.setColor(new Color(0, 0, 0));
						rd.drawString("1st Color", 100,
						55);
						rd.drawString("2nd Color", 649,
						55);
						rd.setFont(new Font("Arial", 1,
						10));
						ftm = rd.getFontMetrics();
						...
						rd.drawString("Intensity", 121,
						219);
						rd.drawString("Intensity", 671,
						219);
						rd.drawString("Reset", 110, 257);
						rd.drawString("Reset", 660, 257);
						for (int i_128_ = 0; i_128_ < 161; i_128_++) {
							rd.setColor(Color.getHSBColor((float)((double)(float) i_128_ * 0.00625),
							1.0F, 1.0F));
							rd.drawLine(102, 75 + i_128_,
							110, 75 + i_128_);
							if (i_128_ <= 128) {
								rd.setColor(Color.getHSBColor(1.0F, 0.0F, (float)(1.0 - ((double)(float) i_128_ * 0.00625))));
								rd.drawLine(137,
								75 + i_128_,
								145,
								75 + i_128_);
						...
						for (int i_129_ = 0; i_129_ < 40; i_129_++) {
							rd.setColor(Color.getHSBColor(arnp[0], (float)((double)(float) i_129_ * 0.025),
							1.0F - arnp[2]));
							rd.drawLine(121 + i_129_, 224,
							121 + i_129_, 230);
							rd.setColor(Color.getHSBColor(arnp[3], (float)((double)(float) i_129_ * 0.025),
							1.0F - arnp[5]));
							rd.drawLine(671 + i_129_, 224,
							671 + i_129_, 230);
						}
						rd.drawImage(arn, 110,
						71 + (int)(arnp[0] * 160.0F),
						null);
						rd.drawImage(arn, 145,
						71 + (int)(arnp[2] * 160.0F),
						null);
						rd.drawImage(arn, 660,
						71 + (int)(arnp[3] * 160.0F),
						null);
						rd.drawImage(arn, 695,
						71 + (int)(arnp[5] * 160.0F),
						null);
						rd.setColor(new Color(0, 0, 0));
						rd.fillRect(120 + (int)(arnp[1] * 40.0F),
						222, 3, 3);
						rd.drawLine(121 + (int)(arnp[1] * 40.0F),
						224,
						121 + (int)(arnp[1] * 40.0F),
						230);
						rd.fillRect(120 + (int)(arnp[1] * 40.0F),
						230, 3, 3);
						rd.fillRect(670 + (int)(arnp[4] * 40.0F),
						222, 3, 3);
						rd.drawLine(671 + (int)(arnp[4] * 40.0F),
						224,
						671 + (int)(arnp[4] * 40.0F),
						230);
						rd.fillRect(670 + (int)(arnp[4] * 40.0F),
						230, 3, 3);
						if (bool) {
							if (mouson == -1) {
								...
								mouson = -2;
								if (i > 119 && i < 163 && i_104_ > 222 && i_104_ < 232) mouson = 1;
								if (i > 669 && i < 713 && i_104_ > 222 && i_104_ < 232) mouson = 4;
								if (i > 98 && i < 122 && i_104_ > 69 && i_104_ < 241 && mouson == -2) mouson = 0;
								if (i > 133 && i < 157 && i_104_ > 69 && i_104_ < 209 && mouson == -2) mouson = 2;
								if (i > 648 && i < 672 && i_104_ > 69 && i_104_ < 241 && mouson == -2) mouson = 3;
								if (i > 683 && i < 707 && i_104_ > 69 && i_104_ < 209 && mouson == -2) mouson = 5;
							}
						} else if (mouson != -1) mouson = -1;
						if (mouson == 0 || mouson == 2 || mouson == 3 || mouson == 5) {
							arnp[(mouson)] = (float)((double)((float) i_104_ - 75.0F) * 0.00625);
							if (mouson == 2 || mouson == 5) {
								if ((double)(arnp[mouson]) > 0.8) arnp[mouson] = 0.8F;
							} else if ((arnp[mouson]) > 1.0F) arnp[(mouson)] = 1.0F;
							if ((arnp[mouson]) < 0.0F) arnp[(mouson)] = 0.0F;
						}
						if (mouson == 1) {
							arnp[(mouson)] = (float)((double)((float) i - 121.0F) * 0.025);
							if ((arnp[mouson]) > 1.0F) arnp[(mouson)] = 1.0F;
							if ((arnp[mouson]) < 0.0F) arnp[(mouson)] = 0.0F;
						}
						if (mouson == 4) {
						...
						if (cfase != 10 && cfase != 5 && i_112_ == -1) {
							...
							arnp[1],
							1.0F - arnp[2]));
							Color color_130_ = (Color.getHSBColor(arnp[3],
							arnp[4],
							1.0F - arnp[5]));
							for (int i_131_ = 0;
							i_131_ < (contos[(sc[0])]).npl;
							i_131_++) {
								if ((
								(contos[(sc[0])]).p[i_131_]).colnum == 1) {
									(
				...
				if (!remi && cfase != 10 && cfase != 11 && cfase != 100 && cfase != 101) rd.drawImage((contin[(pcontin)]),
				355, 385, null);
				else {
					if (cfase == 11 && drawcarb(true, null, "Add to My Cars", 345, 385, i,
					i_104_, bool) && (cd).action == 0) {
						(cd).ac = sc[0];
						if (logged) {
							(cd).action = 6;
							cd.sparkactionloader();
		...
		if (cfase == 0 || cfase == 3 || cfase == 11 || cfase == 101) {
			...
			if (cfase != 11 && cfase != 101 && i_113_ == 0 && flipo < 10 && ((control).handb || (control).enter)) {
				...
				if (multion != 0) {
					fase = 1177;
					intertrack.stop();
				} else if (testdrive != 3 && testdrive != 4) fase = 3;
				else fase = -22;
				if (sc[0] < 16 || (cd).lastload == 2) app.setcarcookie(sc[0], ((cd).names[sc[0]]),
				arnp, gmode,
				unlocked,
				mtop);
				if ((cd).haltload != 0) {
		...
		if (bool_114_) {
			...
			intertrack.stop();
			sc[0] = onmsc;
			if ((sc[0] >= 16 && (cd).lastload != 2) || sc[0] >= 36) sc[0] = 15;
			osc = sc[0];
			multion = 1;
			gmode = 0;
			if ((app).mycar.isShowing())
		...
		if (plnames[i].indexOf("MadBot") == -1) {
			for (int i_132_ = 0; i_132_ < (conto).npl; i_132_++) {
				if (((conto).p[i_132_]).colnum == 1) {
					Color color = Color.getHSBColor(allrnp[i][0],
					allrnp[i][1],
					1.0F - (allrnp[i][2]));
				...
				if (((conto).p[i_132_]).colnum == 2) {
					Color color = Color.getHSBColor(allrnp[i][3],
					allrnp[i][4],
					1.0F - (allrnp[i][5]));
					((conto).p[i_132_]).oc[0] = color.getRed();
					((conto).p[i_132_]).oc[1] = color.getGreen();
	...
	public boolean clink(String string, int i, int i_134_, boolean bool) {
		...
		rd.drawString(new StringBuilder().append("Created by :  ").append(string).append("").toString(),
		241, 160);
		int i_136_ = ftm.stringWidth(string);
		int i_137_ = (241 + ftm.stringWidth(new StringBuilder().append("Created by :  ")
	...
	Control control, int i, int i_141_, boolean bool) {
		...
		if (winner && multion == 0 && gmode != 0 && (((checkpoints).stage == ((unlocked[gmode - 1]) + (gmode - 1) * 10)) || (checkpoints).stage == 27)) {
			...
			if ((checkpoints).stage != 27) {
				rd.setFont(new Font("Arial", 1, 13));
				ftm = rd.getFontMetrics();
				if (aflk) drawcs(200 + pin,
				new StringBuilder().append("Stage ").append((checkpoints).stage + 1 - (gmode - 1) * 10)
				...
				255, 247, 165, 3);
				if (i_144_ != 0) {
					if (aflk) drawcs(200, "And:", 196, 176, 0, 3);
					...
					if (aflk) drawcs(320,
					new StringBuilder().append("").append((cd).names[i_144_])
				...
				rd.setFont(new Font("Arial", 1, 11));
				ftm = rd.getFontMetrics();
				drawcs(220 + pin, "GAME SAVED", 230, 167,
				0, 3);
				if (pin == 60) pin = 30;
				else pin = 0;
			} else {
				rd.setFont(new Font("Arial", 1, 13));
				ftm = rd.getFontMetrics();
				if (aflk) drawcs(180, new StringBuilder().append("Woohoooo you finished NFM").append(gmode).append(" !!!").toString(), 144, 167, 255, 3);
				else drawcs(180, new StringBuilder().append("Woohoooo you finished NFM").append(gmode).append(" !!!").toString(), 228, 240, 255, 3);
				if (aflk) drawcs(210, "You're Awesome!", 144, 167, 255, 3);
				else drawcs(212, "You're Awesome!", 228, 240, 255, 3);
				if (aflk) drawcs(240, "You're truly a RADICAL GAMER!", 144, 167, 255,
				3);
				else drawcs(240, "You're truly a RADICAL GAMER!", 255, 100, 100,
				3);
				rd.setColor(new Color(0, 0, 0));
				rd.fillRect(0, 255, 800, 62);
				rd.drawImage((radicalplay), (radpx + (int)(8.0 * Math.random() - 4.0)),
				255, null);
				if (radpx != 212) {
					radpx += 40;
					if (radpx > 800) radpx = -468;
				}
				if (flipo == 40) radpx = 213;
				flipo++;
				if (flipo == 70) flipo = 0;
				if (radpx == 212) {
					rd.setFont(new Font("Arial", 1, 11));
					ftm = rd.getFontMetrics();
					if (aflk) drawcs(309, "A Game by Radicalplay.com", 144, 167, 255,
					3);
					else drawcs(309, "A Game by Radicalplay.com", 228, 240, 255,
					3);
				}
				if (aflk) drawcs(350, "Now get up and dance!", 144, 167, 255, 3);
		...
		if (multion != 0 && (checkpoints).stage == -2 && i_142_ != 0) {
			...
			if ((checkpoints).pubt > 0) {
				...
				if (dnload == 0 && drawcarb(true, null, " Add to My Stages ", 334, 317, i,
				i_141_, bool)) {
					if (logged) {
						(cd).onstage = (checkpoints).name;
						(cd).staction = 2;
				...
				if (dnload == 1) {
					...
					int i_149_ = 400 - ftm.stringWidth(string_148_) / 2;
					int i_150_ = (i_149_ + ftm.stringWidth(string_148_));
					rd.drawString(string_148_, i_149_,
					332);
					if (waitlink != -1) rd.drawLine(i_149_, 334, i_150_,
					334);
					if (i > i_149_ && i < i_150_ && i_141_ > 321 && i_141_ < 334) {
						if (waitlink != -1) app.setCursor(new Cursor(12));
						if (bool && waitlink == 0) {
							app.editlink(nickname, true);
							waitlink = -1;
						}
					} else app.setCursor(new Cursor(0));
					if (waitlink > 0) waitlink--;
				}
				if (dnload == 2) {
				...
				if (dnload == 3) drawcs(332,
					"Stager has been successfully added to your stages!",
				193, 106, 0, 3);
				if (dnload == 4) drawcs(332, "You already have this stage!", 193, 106, 0,
				3);
				if (dnload == 5) drawcs(332,
					"Cannot add more then 20 stages to your account!",
				193, 106, 0, 3);
				if (dnload == 6) drawcs(332,
					"Failed to add stage, unknown error, please try again later.",
				193, 106, 0, 3);
		...
		if ((control).enter || (control).handb) {
			...
			(checkpoints).stage++;
			if (!winner && multion != 0 && (forstart == 700 || discon == 240) && ndisco < 5) ndisco++;
			flipo = 0;
			(control).enter = false;
			(control).handb = false;
		}
		...
		if (i != 0) {
			...
			for (int i_157_ = 1; i_157_ < i_152_; i_157_++) {
				...
				while (!bools[i_157_]) {
					...
					if (sc[i_157_] >= 16) sc[i_157_] -= 16;
					bools[i_157_] = true;
					for (int i_158_ = 0; i_158_ < 7; i_158_++) {
						if (i_157_ != i_158_ && (sc[i_157_] == sc[i_158_])) bools[i_157_] = false;
					}
					if (bool) f = 16.0F;
					float f_159_ = ((float)(15 - sc[i_157_]) / 15.0F * ((float) i / f));
					if ((double) f_159_ > 0.8) f_159_ = 0.8F;
					if (i == 17 && (double) f_159_ > 0.5) f_159_ = 0.5F;
					if ((double) f_159_ > Math.random()) bools[i_157_] = false;
					if (gmode == 1) {
						if (sc[i_157_] >= 7 && sc[i_157_] <= 10) bools[i_157_] = false;
						if (sc[i_157_] == 12 || sc[i_157_] == 13) bools[i_157_] = false;
						if (sc[i_157_] > 5 && unlocked[0] <= 2) bools[i_157_] = false;
						if (sc[i_157_] > 6 && unlocked[0] <= 4) bools[i_157_] = false;
						if (sc[i_157_] > 11 && unlocked[0] <= 6) bools[i_157_] = false;
						if (sc[i_157_] > 14 && unlocked[0] <= 8) bools[i_157_] = false;
					}
					if (gmode == 2) {
						if ((sc[i_157_] - 7) * 2 > unlocked[1]) bools[i_157_] = false;
						if (i == 16 && unlocked[1] == 16 && sc[i_157_] < 9) bools[i_157_] = false;
					}
				}
				if (sc[i_157_] < i_154_) {
					i_154_ = sc[i_157_];
			...
			if (!bool && i == 10) {
				...
				for (int i_161_ = 0; i_161_ < 7; i_161_++) {
					if (sc[i_161_] == 11) bool_160_ = true;
				}
				if (!bool_160_ && (Math.random() > Math.random() || gmode != 0)) sc[i_155_] = 11;
				bool_160_ = false;
				for (int i_162_ = 0; i_162_ < 7; i_162_++) {
					if (sc[i_162_] == 14) bool_160_ = true;
				}
				if (!bool_160_ && (Math.random() > Math.random() || gmode != 0)) sc[i_156_] = 14;
			}
			if (i == 12) {
				boolean bool_163_ = false;
				for (int i_164_ = 0; i_164_ < 7; i_164_++) {
					if (sc[i_164_] == 11) bool_163_ = true;
				}
				if (!bool_163_) sc[i_155_] = 11;
			}
			if (i == 14) {
				boolean bool_165_ = false;
				for (int i_166_ = 0; i_166_ < 7; i_166_++) {
					if (sc[i_166_] == 12) bool_165_ = true;
				}
				if (!bool_165_ && (Math.random() > Math.random() || gmode != 0)) sc[i_155_] = 12;
				bool_165_ = false;
				for (int i_167_ = 0; i_167_ < 7; i_167_++) {
					if (sc[i_167_] == 10) bool_165_ = true;
				}
				if (!bool_165_ && (Math.random() > Math.random() || gmode != 0)) sc[i_156_] = 10;
			}
			if (i == 15) {
				boolean bool_168_ = false;
				for (int i_169_ = 0; i_169_ < 7; i_169_++) {
					if (sc[i_169_] == 11) bool_168_ = true;
				}
				if (!bool_168_ && (Math.random() > Math.random() || gmode != 0)) sc[i_155_] = 11;
				bool_168_ = false;
				for (int i_170_ = 0; i_170_ < 7; i_170_++) {
					if (sc[i_170_] == 13) bool_168_ = true;
				}
				if (!bool_168_ && (Math.random() > Math.random() || gmode != 0)) sc[i_156_] = 13;
			}
			if (i == 16) {
				boolean bool_171_ = false;
				for (int i_172_ = 0; i_172_ < 7; i_172_++) {
					if (sc[i_172_] == 13) bool_171_ = true;
				}
				if (!bool_171_ && (Math.random() > Math.random() || gmode != 0)) sc[i_155_] = 13;
				bool_171_ = false;
				for (int i_173_ = 0; i_173_ < 7; i_173_++) {
					if (sc[i_173_] == 12) bool_171_ = true;
				}
				if (!bool_171_ && (Math.random() > Math.random() || gmode != 0)) sc[i_156_] = 12;
			}
			if ((cd).lastload == 1) {
				int i_174_ = 0;
				for (int i_175_ = 0;
	...
	public void ctachm(int i, int i_182_, int i_183_, Control control) {
		if (fase == 1) {
			if (i_183_ == 1) {
				if (over(next[0], i, i_182_, 625, 135)) pnext = 1;
				if (over(back[0], i, i_182_, 115, 135)) pback = 1;
				if (over(contin[0], i, i_182_, 355, 360)) pcontin = 1;
			}
			if (i_183_ == 2) {
				if (pnext == 1)
				(control).right = true;
		...
		if (fase == 3) {
			if (i_183_ == 1 && over(contin[0], i, i_182_, 355, 350)) pcontin = 1;
		...
		if (fase == 4) {
			if (i_183_ == 1 && over(back[0], i, i_182_, 370, 345)) pback = 1;
			if (i_183_ == 2 && pback == 1) {
				(control).enter = true;
				pback = 0;
			}
		...
		if (fase == 6) {
			if (i_183_ == 1 && (over(star[0], i, i_182_, 359, 385) || over(star[0], i, i_182_, 359, 295))) pstar = 2;
			if (i_183_ == 2 && pstar == 2) {
				(control).enter = true;
				pstar = 1;
			}
		...
		if (fase == 7) {
			if (i_183_ == 1) {
				if (over(next[0], i, i_182_, 645, 275)) pnext = 1;
				if (over(back[0], i, i_182_, 95, 275)) pback = 1;
				if (over(contin[0], i, i_182_, 355, 385) && !(app).openm) pcontin = 1;
			}
			if (i_183_ == 2) {
				if (pnext == 1)
				(control).right = true;
		...
		if (fase == -5) {
			lxm = i;
			lym = i_182_;
			if (i_183_ == 1 && over(contin[0], i, i_182_, 355, 380)) pcontin = 1;
			if (i_183_ == 2 && pcontin == 1) {
				(control).enter = true;
				pcontin = 0;
			}
		...
		if (fase == -7) {
			...
			if (i_183_ == 0 && (i != lxm || i_182_ != lym)) {
				if (overon(329, 45, 137, 22, i, i_182_)) opselect = 0;
				if (overon(320, 73, 155, 22, i, i_182_)) opselect = 1;
				if (overon(303, 99, 190, 22, i, i_182_)) opselect = 2;
				if (overon(341, 125, 109, 22, i, i_182_)) opselect = 3;
				lxm = i;
				lym = i_182_;
			}
		}
		if (fase == 10) {
			...
			if (i_183_ == 0 && (i != lxm || i_182_ != lym)) {
				if (overon(343, 261, 110, 22, i, i_182_)) opselect = 0;
				if (overon(288, 291, 221, 22, i, i_182_)) opselect = 1;
				if (overon(301, 321, 196, 22, i, i_182_)) opselect = 2;
				if (overon(357, 351, 85, 22, i, i_182_)) opselect = 3;
				lxm = i;
				lym = i_182_;
			}
		}
		if (fase == 102) {
			if (i_183_ == 1) {
				if (overon(358, 262 + dropf, 82, 22, i,
				i_182_)) {
					opselect = 0;
					shaded = true;
				}
				if (overon(358, 290 + dropf, 82, 22, i,
				i_182_)) {
					opselect = 1;
					shaded = true;
				}
				if (overon(333, 318 + dropf, 132, 22, i,
				i_182_)) {
					opselect = 2;
					shaded = true;
				}
			...
			if (i_183_ == 0 && (i != lxm || i_182_ != lym)) {
				...
				if (overon(333, 318 + dropf, 132, 22, i,
				i_182_)) opselect = 2;
				if (dropf == 0 && overon(348, 346, 102, 22, i, i_182_)) opselect = 3;
				lxm = i;
				lym = i_182_;
			}
		}
		if (fase == 11) {
			if (flipo >= 1 && flipo <= 15) {
				if (i_183_ == 1 && over(next[0], i, i_182_, 665, 395)) pnext = 1;
				if (i_183_ == 2 && pnext == 1) {
					(control).right = true;
					pnext = 0;
				}
			...
			if (flipo >= 3 && flipo <= 16) {
				if (i_183_ == 1 && over(back[0], i, i_182_, 75, 395)) pback = 1;
				if (i_183_ == 2 && pback == 1) {
					(control).left = true;
					pback = 0;
				}
			...
			if (flipo == 16) {
				if (i_183_ == 1 && over(contin[0], i,
				i_182_, 565, 395)) pcontin = 1;
				if (i_183_ == 2 && pcontin == 1) {
					(control).enter = true;
					pcontin = 0;
				}
		...
		if (fase != -2) {
			...
			if (clangame != 0 && (!(mad).dest || multion >= 2)) {
				...
				for (int i = 0; i < nplayers; i++) {
					if ((checkpoints).dested[i] == 0) {
						if (string.equals("")) string = pclan[i];
			...
			if (clangame > 1) {
				...
				for (int i = 0; i < nplayers; i++) {
					if (((checkpoints).clear[i] == ((checkpoints).nlaps * (checkpoints).nsp)) && (checkpoints).pos[i] == 0) {
						if (clangame == 3) {
							bool_186_ = true;
							string_187_ = new StringBuilder().append("").append(plnames[i]).append(" of clan ").append(pclan[i]).append(" finished first, nobody won becuase this is a wasting only game!")
								.toString();
						}
						if (clangame == 4 && (pclan[i].toLowerCase()
							.equals(gaclan.toLowerCase()))) {
							bool_186_ = true;
							string_187_ = new StringBuilder().append("").append(plnames[i]).append(" of clan ").append(pclan[i]).append(" finished first, nobody won becuase ")
								.append(pclan[i]).append(" should have wasted in this racing vs wasting game!")
								.toString();
						}
						if (clangame == 5 && !(pclan[i].toLowerCase()
							.equals(gaclan.toLowerCase()))) {
							bool_186_ = true;
							string_187_ = new StringBuilder().append("").append(plnames[i]).append(" of clan ").append(pclan[i]).append(" finished first, nobody won becuase ")
								.append(pclan[i]).append(" should have wasted in this racing vs wasting game!")
			...
			if (multion < 2) {
				...
				if (!holdit && (mad).dest && cntwis == 8) {
					if (discon != 240) drawhi(yourwasted, 70);
					else {
						drawhi(disco, 70);
						stopchat();
					}
					...
					if (lan) {
						...
						i++) {
							if (i != im && dested[i] == 0 && plnames[i].indexOf("MadBot") == -1) bool_188_ = false;
						}
					}
					if (fase == 7001 && (nplayers - ((checkpoints).wasted + 1)) >= 2 && discon != 240 && !bool_188_) exitm = 4;
					else {
						if (exitm == 4) exitm = 0;
					...
					for (int i = 0; i < nplayers; i++) {
						if (((checkpoints).clear[i] == ((checkpoints).nlaps * (checkpoints).nsp)) && (checkpoints).pos[i] == 0) {
							...
							if (clangame == 0) {
								...
								if (aflk) {
									drawcs(120,
									new StringBuilder().append("Your clan ").append(pclan[im])
				...
				if (!holdit && (((checkpoints).wasted >= nplayers - 1) || bool_184_)) {
					...
					if (!bool_184_) {
						for (int i = 0; i < nplayers;
						i++) {
							if ((checkpoints).dested[i] == 0) string_189_ = plnames[i];
						}
			...
			if (bool) {
				...
				if (!holdit && fase != -6 && starcnt == 0 && multion < 2 && (checkpoints).stage != 10) {
					...
					if (!arrace) {
						if (auscnt == 45 && (mad).capcnt == 0 && exitm == 0) {
							if ((mad).missedcp > 0) {
								if ((mad).missedcp > 15 && (mad).missedcp < 50) {
									if (flk) drawcs(70, "Checkpoint Missed!", 255,
									0, 0, 0);
								...
								if (Math.abs(ana) > 100) cntan++;
								else if (cntan != 0) cntan--;
								if (cntan > 40) {
									cntovn++;
									cntan = 40;
									if (flk) {
						...
						if (alocked != -1) {
							wasay = true;
							say = new StringBuilder().append(" Arrow Locked on >  ").append(plnames[alocked])
								.append("").toString();
							tcnt = -5;
						} else {
							wasay = true;
				...
				if ((m).darksky) {
					...
					float[] fs = new float[3];
					Color.RGBtoHSB((m).csky[0], (m).csky[1], (m).csky[2],
					fs);
					fs[2] = 0.6F;
				...
				rd.drawImage(dmg, 600,
				7, null);
				rd.drawImage(pwr, 600,
				27, null);
				rd.drawImage(lap, 19,
				7, null);
				rd.setColor(new Color(0, 0, 100));
				rd.drawString(new StringBuilder().append("").append((mad).nlaps + 1).append(" / ").append((checkpoints).nlaps).append("").toString(),
				51, 18);
				rd.drawImage(was, 92,
				7, null);
				rd.setColor(new Color(0, 0, 100));
				rd.drawString(new StringBuilder().append("").append((checkpoints).wasted).append(" / ").append(nplayers - 1).append("").toString(),
				150, 18);
				rd.drawImage(pos, 42,
				27, null);
				rd.drawImage((rank[((checkpoints)
					.pos[(mad).im])]),
				110, 28, null);
			...
			if (!holdit) {
				if (starcnt != 0 && starcnt <= 35) {
					if (starcnt == 35 && !mutes) three.play();
					if (starcnt == 24) {
						gocnt = 2;
						if (!mutes) two.play();
					}
					...
					if (gocnt != 0) rd.drawImage((cntdn[(gocnt)]),
					385, 50, null);
					else rd.drawImage((cntdn[(gocnt)]),
					363, 50, null);
				}
				if (looped != 0 && (mad).loop == 2) looped = 0;
				if ((mad).power < 45.0F) {
					if (tcnt == 30 && auscnt == 45 && (mad).mtouch && (mad).capcnt == 0 && exitm == 0) {
						if (looped != 2) {
							...
							String string_192_ = "";
							if (multion == 0) string_192_ = "  (Press Enter)";
							if (pwflk) {
								drawcs(110,
						...
						if (pwcnt == 300) {
							...
							if (looped != 0) {
								looped++;
								if (looped == 4) looped = 2;
							}
						}
					}
				} else if (pwcnt != 0) pwcnt = 0;
				if ((mad).capcnt == 0) {
					if (tcnt < 30) {
						if (exitm == 0) {
							if (tflk) {
								if (!wasay) drawcs(105, say, 0, 0,
								0, 0);
								else drawcs(105, say, 0, 0,
								0, 0);
								tflk = false;
							} else {
								if (!wasay) drawcs(105, say, 0,
								128, 255, 0);
								else drawcs(105, say, 255,
								128, 0, 0);
								tflk = true;
							}
						}
						tcnt++;
					} else if (wasay) wasay = false;
					if (auscnt < 45) {
						if (exitm == 0) {
							if (aflk) {
								drawcs(85, asay, 98, 176,
								255, 0);
								aflk = false;
							} else {
								drawcs(85, asay, 0, 128,
								255, 0);
								aflk = true;
							}
						}
				...
				if ((mad).trcnt == 10) {
					...
					if (i == 1) loop = "Forward loop";
					if (i == 2) loop = "double Forward";
					if (i == 3) loop = "triple Forward";
					if (i >= 4) loop = "massive Forward looping";
					if (i == -1) loop = "Backloop";
					if (i == -2) loop = "double Back";
					if (i == -3) loop = "triple Back";
					if (i <= -4) loop = "massive Back looping";
					if (i == 0) {
						if ((mad).ftab && (mad).btab) loop = "Tabletop and reversed Tabletop";
						else if ((mad).ftab || (mad).btab) loop = "Tabletop";
					}
					if (i > 0 && (mad).btab) loop = new StringBuilder().append("Hanged ").append(loop).toString();
					if (i < 0 && (mad).ftab) loop = new StringBuilder().append("Hanged ").append(loop).toString();
					if (loop != "") {
						StringBuilder stringbuilder = new StringBuilder();
						xtGraphics var_xtGraphics_193_ = this;
						(var_xtGraphics_193_).asay = stringbuilder.append((var_xtGraphics_193_).asay)
							.append(" ").append(loop).toString();
					}
					i = 0;
					...
					if (i == 0 && (mad).rtab) {
						if (loop == "") spin = "Tabletop";
						else spin = "Flipside";
					}
					if (i == 1) spin = "Rollspin";
					if (i == 2) spin = "double Rollspin";
					if (i == 3) spin = "triple Rollspin";
					if (i >= 4) spin = "massive Roll spinning";
					i = 0;
					...
					if (i != 0) {
						...
						if (loop == "") {
							...
							(var_xtGraphics_204_).asay = stringbuilder.append((var_xtGraphics_204_).asay)
								.append(" by ").append(spin).toString();
						}
					}
					if (asay != "") auscnt -= 15;
					if (loop != "") auscnt -= 25;
					...
					if (i != 0) auscnt -= 25;
					if (auscnt < 45) {
						if (!mutes) powerup.play();
						if (auscnt < -20) auscnt = -20;
						int i_205_ = 0;
						if ((mad).powerup > 20.0F) i_205_ = 1;
						if ((mad).powerup > 40.0F) i_205_ = 2;
						if ((mad).powerup > 150.0F) i_205_ = 3;
						if ((mad).surfer) asay = new StringBuilder().append(" ").append(adj[4]
						[(int)(m.random() * 3.0F)])
							.append(asay).toString();
						if (i_205_ != 3) asay = new StringBuilder().append(adj[i_205_]
						[(int)(m.random() * 3.0F)])
							.append(asay).append(exlm[i_205_])
							.toString();
						else asay = (adj[i_205_]
						[(int)(m.random() * 3.0F)]);
						if (!wasay) {
							tcnt = auscnt;
							if ((mad).power != 98.0F) say = new StringBuilder().append("Power Up ").append((int)(100.0F * (mad).powerup / 98.0F))
								.append("%").toString();
							else say = "Power To The MAX";
							if (skidup) skidup = false;
							else skidup = true;
						}
					}
				}
				...
				for (int i = 0; i < nplayers; i++) {
					if ((dested[i] != (checkpoints).dested[i]) && i != im) {
						...
						if (fase != 7001) {
							if (dested[i] == 1) {
								wasay = true;
								say = new StringBuilder().append("").append((cd)
									.names[sc[i]])
							...
							if (dested[i] == 2) {
								wasay = true;
								say = new StringBuilder().append("You wasted ").append((cd)
									.names[sc[i]])
									.append("!").toString();
								tcnt = -15;
							}
							...
							if (dested[i] == 2) {
								wasay = true;
								if (multion < 2) say = new StringBuilder().append("You wasted ").append(plnames[i])
									.append("!").toString();
								else say = new StringBuilder().append("").append(plnames[im])
									.append(" wasted ").append(plnames[i])
									.append("!").toString();
								tcnt = -15;
							}
							if (dested[i] == 3) {
				...
				if (multion >= 2 && (alocked != lalocked)) {
					if (alocked != -1) {
						wasay = false;
						say = new StringBuilder().append("Now following ")
							.append(plnames[alocked])
							.append("!").toString();
						tcnt = -15;
					}
					lalocked = alocked;
	...
	public void drawstat(int i, int i_206_, boolean bool, float f) {
		...
		if (i_208_ > 70) {
			...
			dmcnt++;
			if ((double) dmcnt > 167.0 - (double) i_208_ * 1.5) dmcnt = 0;
		}
		i_209_ += ((float) i_209_ * ((float)(m).snap[0] / 100.0F));
		if (i_209_ > 255) i_209_ = 255;
		if (i_209_ < 0) i_209_ = 0;
		i_210_ += ((float) i_210_ * ((float)(m).snap[1] / 100.0F));
		if (i_210_ > 255) i_210_ = 255;
		if (i_210_ < 0) i_210_ = 0;
		i_211_ += ((float) i_211_ * ((float)(m).snap[2] / 100.0F));
	...
	public void drawhi(Image image, int i) {
		if ((m).darksky) {
			...
			color = Color.getHSBColor(fs[0], fs[1], fs[2]);
			rd.setColor(color);
			rd.fillRoundRect(390 - image.getWidth(ob) / 2, i - 2,
			image.getWidth(ob) + 20,
			image.getHeight(ob) + 2, 7, 20);
			rd.setColor(new Color((int)((double) color.getRed() / 1.1), (int)((double) color.getGreen() / 1.1), (int)((double) color.getBlue() / 1.1)));
			rd.drawRoundRect(390 - image.getWidth(ob) / 2, i - 2,
			image.getWidth(ob) + 20,
			image.getHeight(ob) + 2, 7, 20);
		}
	...
	int i_214_, int i_215_) {
		if (i_215_ != 3 && i_215_ != 4 && i_215_ != 5) {
			i_212_ += ((float) i_212_ * ((float)(m).snap[0] / 100.0F));
			if (i_212_ > 255) i_212_ = 255;
			if (i_212_ < 0) i_212_ = 0;
			i_213_ += ((float) i_213_ * ((float)(m).snap[1] / 100.0F));
			if (i_213_ > 255) i_213_ = 255;
			if (i_213_ < 0) i_213_ = 0;
			i_214_ += ((float) i_214_ * ((float)(m).snap[2] / 100.0F));
		...
		if (i_215_ == 1) {
			...
			400 - (ftm.stringWidth(string) / 2) + 1,
			i + 1);
		}
		if (i_215_ == 2) {
	...
	boolean bool) {
		...
		if (!bool) {
			int i_225_ = 0;
			if (((checkpoints).x[i] - (checkpoints).opx[im]) >= 0) i_225_ = 180;
			i_224_ = (int)((double)(90 + i_225_) + ((Math.atan((double)((checkpoints).z[i] - ((checkpoints).opz[im])) / (double)((checkpoints).x[i] - ((checkpoints).opx[im])))) / 0.017453292519943295));
		} else {
			int i_226_ = 0;
			if (multion == 0 || alocked == -1) {
				int i_227_ = -1;
				boolean bool_228_ = false;
				for (int i_229_ = 0; i_229_ < nplayers;
				i_229_++) {
					if (i_229_ != im && ((py(((checkpoints).opx[im]) / 100, (checkpoints).opx[i_229_] / 100, ((checkpoints).opz[im]) / 100, (checkpoints).opz[i_229_] / 100) < i_227_) || i_227_ == -1) && (!bool_228_ || ((checkpoints).onscreen[i_229_] != 0)) && (checkpoints).dested[i_229_] == 0) {
						i_226_ = i_229_;
						i_227_ = py(((checkpoints).opx[im]) / 100, (checkpoints).opx[i_229_] / 100, ((checkpoints).opz[im]) / 100, ((checkpoints).opz[i_229_] / 100));
						if ((checkpoints).onscreen[i_229_] != 0) bool_228_ = true;
					}
				}
			} else i_226_ = alocked;
			int i_230_ = 0;
			if (((checkpoints).opx[i_226_] - (checkpoints).opx[im]) >= 0) i_230_ = 180;
			i_224_ = (int)((double)(90 + i_230_) + ((Math.atan((double)((checkpoints).opz[i_226_] - ((checkpoints).opz[im])) / (double)(((checkpoints).opx[i_226_]) - ((checkpoints).opx[im])))) / 0.017453292519943295));
			if (multion == 0) {
				drawcs(13, "[                                ]", 76, 67, 240,
				0);
		...
		if (Math.abs(ana - i_224_) < 180) {
			if (Math.abs(ana - i_224_) < 10) ana = i_224_;
			else if (ana < i_224_) ana += 10;
			else ana -= 10;
		} else {
			if (i_224_ < 0) {
				ana += 15;
		...
		if (!bool) {
			if (i_224_ > 7 || i_216_ > 0 || i_216_ == -2 || cntan != 0) {
				...
				int i_232_ = (int)(190.0F + 190.0F * ((float)((m)).snap[0] / 100.0F));
				if (i_232_ > 255) i_232_ = 255;
				if (i_232_ < 0) i_232_ = 0;
				int i_233_ = (int)(255.0F + 255.0F * ((float)((m)).snap[1] / 100.0F));
				...
				rd.setColor(new Color(i_232_, i_233_,
				i_234_));
				rd.fillPolygon(is, is_217_, 7);
				i_232_ = (int)(115.0F + 115.0F * ((float)((m)).snap[0] / 100.0F));
				if (i_232_ > 255) i_232_ = 255;
				if (i_232_ < 0) i_232_ = 0;
				i_233_ = (int)(170.0F + 170.0F * ((float)((m)).snap[1] / 100.0F));
				if (i_233_ > 255) i_233_ = 255;
				if (i_233_ < 0) i_233_ = 0;
				i_234_ = 0;
				if (i_216_ <= 0) {
			...
			int i_238_ = (int)(159.0F + (159.0F * ((float)(m).snap[0] / 100.0F)));
			if (i_238_ > 255) i_238_ = 255;
			if (i_238_ < 0) i_238_ = 0;
			int i_239_ = (int)(207.0F + (207.0F * ((float)(m).snap[1] / 100.0F)));
			if (i_239_ > 255) i_239_ = 255;
			if (i_239_ < 0) i_239_ = 0;
			int i_240_ = (int)(255.0F + (255.0F * ((float)(m).snap[2] / 100.0F)));
			if (i_240_ > 255) i_240_ = 255;
			if (i_240_ < 0) i_240_ = 0;
			rd.setColor(new Color(i_238_, i_239_, i_240_));
			rd.fillPolygon(is, is_217_, 7);
			i_238_ = (int)(120.0F + (120.0F * ((float)(m).snap[0] / 100.0F)));
			if (i_238_ > 255) i_238_ = 255;
			if (i_238_ < 0) i_238_ = 0;
			i_239_ = (int)(114.0F + (114.0F * ((float)(m).snap[1] / 100.0F)));
			if (i_239_ > 255) i_239_ = 255;
			if (i_239_ < 0) i_239_ = 0;
			i_240_ = (int)(255.0F + (255.0F * ((float)(m).snap[2] / 100.0F)));
			if (i_240_ > 255) i_240_ = 255;
			if (i_240_ < 0) i_240_ = 0;
			rd.setColor(new Color(i_238_, i_239_, i_240_));
			rd.drawPolygon(is, is_217_, 7);
	...
	public void radarstat(Mad mad, ContO conto, CheckPoints checkpoints) {
		...
		for (int i = 0; i < (checkpoints).n; i++) {
			...
			int[] is = {
				(int)(96.0F - ((float)(((checkpoints).opx[im]) - (checkpoints).x[i]) / (checkpoints).prox)), (int)(96.0F - ((float)(((checkpoints).opx[im]) - (checkpoints).x[i_241_]) / (checkpoints).prox))
			};
			int[] is_242_ = {
				(int)(141.0F - ((float)((checkpoints).z[i] - ((checkpoints)
					.opz[im])) / (checkpoints).prox)), (int)(141.0F - ((float)((checkpoints).z[i_241_] - ((checkpoints).opz[im])) / (checkpoints).prox))
			};
			rot(is, is_242_, 96, 141, (mad).cxz, 2);
			rd.drawLine(is[0], is_242_[0], is[1],
			is_242_[1]);
			if (bool) break;
		}
		if (arrace || multion > 1) {
			int[] is = new int[nplayers];
			int[] is_245_ = new int[nplayers];
			for (int i = 0; i < nplayers; i++) {
				is[i] = (int)(96.0F - ((float)(((checkpoints).opx[im]) - (checkpoints).opx[i]) / (checkpoints).prox));
				is_245_[i] = (int)(141.0F - ((float)((checkpoints).opz[i] - ((checkpoints).opz[im])) / (checkpoints).prox));
			}
			rot(is, is_245_, 96, 141, (mad).cxz,
			nplayers);
			int i = 0;
			int i_246_ = (int)(80.0F + (80.0F * ((float)(m).snap[1] / 100.0F)));
			if (i_246_ > 255) i_246_ = 255;
			if (i_246_ < 0) i_246_ = 0;
			int i_247_ = (int)(159.0F + (159.0F * ((float)(m).snap[2] / 100.0F)));
			if (i_247_ > 255) i_247_ = 255;
			if (i_247_ < 0) i_247_ = 0;
			for (int i_248_ = 0; i_248_ < nplayers;
			i_248_++) {
				if (i_248_ != im && (checkpoints).dested[i_248_] == 0) {
					if (clangame != 0) {
						if (pclan[i_248_].toLowerCase()
							.equals(gaclan.toLowerCase())) {
							i = 159;
							i_246_ = 80;
							i_247_ = 0;
						...
						i += ((float) i * ((float)((m).snap[0]) / 100.0F));
						if (i > 255) i = 255;
						if (i < 0) i = 0;
						i_246_ += ((float) i_246_ * ((float)((m)
							.snap[1]) / 100.0F));
						if (i_246_ > 255) i_246_ = 255;
						if (i_246_ < 0) i_246_ = 0;
						i_247_ += ((float) i_247_ * ((float)((m)
							.snap[2]) / 100.0F));
						if (i_247_ > 255) i_247_ = 255;
						if (i_247_ < 0) i_247_ = 0;
					}
					...
					if (alocked == i_248_) {
						i_249_ = 3;
						rd.setColor(new Color(i, i_246_,
						i_247_));
					} else rd.setColor(new Color((i + ((m)
						.csky[0])) / 2, (((m).csky[1]) + i_246_) / 2, (i_247_ + ((m)
						.csky[2])) / 2));
					rd.drawLine(is[i_248_] - i_249_,
					is_245_[i_248_],
					is[i_248_] + i_249_,
					is_245_[i_248_]);
					rd.drawLine(is[i_248_],
					is_245_[i_248_] + i_249_,
					is[i_248_],
					is_245_[i_248_] - i_249_);
					rd.setColor(new Color(i, i_246_,
					i_247_));
					rd.fillRect(is[i_248_] - 1,
					is_245_[i_248_] - 1, 3, 3);
				}
			}
		}
		int i = (int)(159.0F + (159.0F * ((float)(m).snap[0] / 100.0F)));
		if (i > 255) i = 255;
		if (i < 0) i = 0;
		int i_250_ = 0;
		int i_251_ = 0;
		if (clangame != 0) {
			...
			if (i > 255) i = 255;
			if (i < 0) i = 0;
			i_250_ += ((float) i_250_ * ((float)(m).snap[1] / 100.0F));
			if (i_250_ > 255) i_250_ = 255;
			if (i_250_ < 0) i_250_ = 0;
			i_251_ += ((float) i_251_ * ((float)(m).snap[2] / 100.0F));
		...
		rd.setColor(new Color(0, 0, 100));
		rd.drawString(new StringBuilder().append("").append((int) f_255_).toString(),
		62, 245);
		rd.drawString(new StringBuilder().append("").append((int) f_256_).toString(),
		132, 245);
	}
	...
	public void playsounds(Mad mad, Control control, int i) {
		if ((fase == 0 || fase == 7001) && starcnt < 35 && cntwis != 8 && !mutes) {
			...
			if ((mad).cntdest != 0 && cntwis < 7) {
				...
				if (cntwis == 7 && !mutes) firewasted.play();
			}
		} else {
			sparkeng(-2, (mad).cn);
			if (pwastd) {
		...
		if (stopcnt != -20) {
			if (stopcnt == 1) stopairs();
			stopcnt--;
		}
		if (bfcrash != 0) bfcrash--;
		if (bfscrape != 0) bfscrape--;
		if (bfsc1 != 0) bfsc1--;
		if (bfsc2 != 0) bfsc2--;
		if (bfskid != 0) bfskid--;
		if ((mad).newcar) cntwis = 0;
		if (fase == 0 || fase == 7001 || fase == 6 || fase == -1 || fase == -2 || fase == -3 || fase == -4 || fase == -5) {
			if (mutes != (control).mutes) mutes = (control).mutes;
			if ((control).mutem != mutem) {
				mutem = (control).mutem;
				if (mutem) {
					if (loadedt) strack.stop();
				} else if (loadedt) strack.resume();
			}
		}
		if ((mad).cntdest != 0 && cntwis < 7) {
			if ((mad).dest) cntwis++;
		} else {
			if ((mad).cntdest == 0) cntwis = 0;
			if (cntwis == 7) cntwis = 8;
		}
		if ((app).applejava) closesounds();
	}
		...
		if (bfcrash == 0) {
			if (i == 0) {
				if (Math.abs(f) > 25.0F && Math.abs(f) < 170.0F) {
					if (!mutes) lowcrash[crshturn].play();
					bfcrash = 2;
				}
				if (Math.abs(f) >= 170.0F) {
					if (!mutes) crash[crshturn].play();
					bfcrash = 2;
				}
				if (Math.abs(f) > 25.0F) {
					if (crashup) crshturn--;
					else crshturn++;
					if (crshturn == -1) crshturn = 2;
					if (crshturn == 3) crshturn = 0;
				}
			}
			if (i == -1) {
				if (Math.abs(f) > 25.0F && Math.abs(f) < 170.0F) {
					if (!mutes) lowcrash[2].play();
					bfcrash = 2;
				}
				if (Math.abs(f) > 170.0F) {
					if (!mutes) crash[2].play();
					bfcrash = 2;
				}
			}
			if (i == 1) {
	...
	public void skid(int i, float f) {
		if (bfcrash == 0 && bfskid == 0 && f > 150.0F) {
			if (i == 0) {
				if (!mutes) skid[skflg].play();
				if (skidup) skflg++;
				else skflg--;
				if (skflg == 3) skflg = 0;
				if (skflg == -1) skflg = 2;
			} else {
				if (!mutes) dustskid[dskflg].play();
				if (skidup) dskflg++;
				else dskflg--;
				if (dskflg == 3) dskflg = 0;
				if (dskflg == -1) dskflg = 2;
			}
			bfskid = 35;
		}
	}
	...
	public void scrape(int i, int i_266_, int i_267_) {
		if (bfscrape == 0 && (Math.sqrt((double)(i * i + i_266_ * i_266_ + i_267_ * i_267_)) / 10.0) > 10.0) {
			int i_268_ = 0;
			if (m.random() > m.random()) i_268_ = 1;
			if (i_268_ == 0) {
				sturn1 = 0;
				sturn0++;
				if (sturn0 == 3) {
			...
			if (!mutes) scrape[i_268_].play();
			bfscrape = 5;
		}
	}

	public void gscrape(int i, int i_269_, int i_270_) {
		if ((bfsc1 == 0 || bfsc2 == 0) && (Math.sqrt((double)(i * i + i_269_ * i_269_ + i_270_ * i_270_)) / 10.0) > 15.0) {
			if (bfsc1 == 0) {
				if (!mutes) {
					scrape[2].stop();
					scrape[2].play();
	...
	int i_275_) {
		if (i_274_ != 0) {
			for (int i_276_ = 0; i_276_ < i_275_; i_276_++) {
				...
				is[i_276_] = i + (int)(((float)(i_277_ - i) * m.cos(i_274_)) - ((float)(i_278_ - i_273_) * m.sin(i_274_)));
				is_272_[i_276_] = i_273_ + (int)(((float)(i_277_ - i) * m.sin(i_274_)) + ((float)(i_278_ - i_273_) * m.cos(i_274_)));
			}
		}
	}
	...
	int i_296_) {
		int i_297_ = image.getHeight(ob);
		int i_298_ = image.getWidth(ob);
	...
	public void fleximage(Image image, int i, int i_299_) {
		if (!badmac) {
			...
			fleximg = createImage(new MemoryImageSource(800, 450, (flexpix),
			0, 800));
			rd.drawImage(fleximg, 0, 0,
			null);
		} else {
			rd.setColor(new Color(0, 0, 0));
			rd.setComposite(AlphaComposite.getInstance(3, 0.1F));
	...
	private Image loadsnap(Image image) {
		...
		for (int i_317_ = 0; i_317_ < i_316_ * i; i_317_++) {
			...
			if (color_318_.getRed() != color_318_.getGreen() && color_318_.getGreen() != color_318_.getBlue()) {
				int i_319_ = (int)((float) color_318_.getRed() + ((float) color_318_.getRed() * ((float)((m)
					.snap[0]) / 100.0F)));
				if (i_319_ > 255) i_319_ = 255;
				if (i_319_ < 0) i_319_ = 0;
				int i_320_ = (int)((float) color_318_.getGreen() + ((float) color_318_.getGreen() * ((float)((m)
					.snap[1]) / 100.0F)));
				if (i_320_ > 255) i_320_ = 255;
				if (i_320_ < 0) i_320_ = 0;
				int i_321_ = (int)((float) color_318_.getBlue() + ((float) color_318_.getBlue() * ((float)((m)
					.snap[2]) / 100.0F)));
	...
	private Image loadopsnap(Image image, int i, int i_323_) {
		int i_324_ = image.getHeight(ob);
		int i_325_ = image.getWidth(ob);
	...
	public void jflexo() {
		if (!badmac) {
			int[] is = new int[360000];
			PixelGrabber pixelgrabber = new PixelGrabber(((app)
				.offImage),
	...
	Toolkit toolkit, int i) {
		...
		int i_368_ = image.getHeight(ob);
		int i_369_ = image.getWidth(ob);
	...
	private void makecarsbgc(Image image, Image image_386_) {
		...
		PixelGrabber pixelgrabber = new PixelGrabber(carsbg, 0, 0, 670, 400, is,
		0, 670);
		try {
			pixelgrabber.grabPixels();
		} catch (InterruptedException interruptedexception) {
	...
	public void carsbginflex() {
		if (!badmac) {
			...
			PixelGrabber pixelgrabber = new PixelGrabber(carsbg, 0, 0, 670, 400,
			flexpix, 0, 670);
			try {
				pixelgrabber.grabPixels();
			} catch (InterruptedException interruptedexception) {
	...
	public void drawSmokeCarsbg() {
		if (!badmac) {
			if (Math.abs(flyr - flyrdest) > 20) {
				if (flyr > flyrdest) flyr -= 20;
				else flyr += 20;
			} else {
				flyr = flyrdest;
				flyrdest = (int)((float) flyr + m.random() * 160.0F - 80.0F);
			}
			if (flyr > 160) flyr = 160;
			if (flatr > 170) {
				flatrstart++;
				flatr = flatrstart * 3;
				flyr = (int)(m.random() * 160.0F - 80.0F);
			...
			for (int i = 0; i < 466; i++) {
				for (int i_407_ = 0; i_407_ < 202; i_407_++) {
					if (smokey[i + i_407_ * 466] != smokey[0]) {
						float f = pys(i, 233, i_407_, flyr);
						int i_408_ = (int)((float)(i - 233) / f * (float) flatr);
						int i_409_ = (int)((float)(i_407_ - flyr) / f * (float) flatr);
						...
						if (i + i_408_ + 100 < 670 && i + i_408_ + 100 > 0 && i_407_ + i_409_ + 110 < 400 && i_407_ + i_409_ + 110 > 0 && i_410_ < 268000 && i_410_ >= 0) {
							Color color = new Color(flexpix[i_410_]);
							Color color_411_ = new Color(smokey[i + i_407_ * 466]);
							...
							int i_415_ = (int)((((float) color.getRed() * ((float) flang * f_412_)) + ((float) color_411_.getRed() * (1.0F - f_412_))) / (((float) flang * f_412_) + (1.0F - f_412_)));
							int i_416_ = (int)((((float) color.getGreen() * ((float) flang * f_413_)) + ((float) color_411_.getGreen() * (1.0F - f_413_))) / (((float) flang * f_413_) + (1.0F - f_413_)));
							int i_417_ = (int)((((float) color.getBlue() * ((float) flang * f_414_)) + ((float) color_411_.getBlue() * (1.0F - f_414_))) / (((float) flang * f_414_) + (1.0F - f_414_)));
			...
			Image image = createImage(new MemoryImageSource(670, 400, (flexpix),
			0, 670));
			rd.drawImage(image, 65, 25, null);
		} else {
			rd.drawImage(carsbg, 65,
			25, null);
			flatrstart++;
		}
	}
	...
	boolean bool_432_) {
		...
		} else i_435_ = image.getWidth(ob);
		int i_436_ = 0;
		if (i_430_ > i && i_430_ < i + i_435_ + 14 && i_431_ > i_429_ && i_431_ < i_429_ + 28) {
			i_436_ = 1;
			if (bool_432_) bool_433_ = true;
		}
		rd.drawImage(bcl[i_436_], i,
		i_429_, null);
		rd.drawImage(bc[i_436_], i + 4,
		i_429_, i_435_ + 6, 28, null);
		rd.drawImage(bcr[i_436_],
		i + i_435_ + 10, i_429_, null);
		if (!bool && i_435_ == 73) i_429_--;
		if (bool) {
			if (string.equals("X") && i_436_ == 1) rd.setColor(new Color(255, 0, 0));
			else rd.setColor(new Color(0, 0, 0));
			if (string.startsWith("Class")) rd.drawString(string,
			400 - ftm.stringWidth(string) / 2,
			i_429_ + 19);
			else rd.drawString(string, i + 7, i_429_ + 19);
		} else rd.drawImage(image, i + 7, i_429_ + 7, null);
		return bool_433_;
	}
