...
public class xtGraphics extends Panel implements Runnable {
    ...
    public xtGraphics(final Medium medium, final CarDefine cardefine, final Graphics2D graphics2d, final GameSparker gamesparker) {
        m = medium;
        cd = cardefine;
        app = gamesparker;
        rd = graphics2d;
    ...
    public void arrow(final int i, final int i_216_, final CheckPoints checkpoints, final boolean bool) {
        ...
        if (!bool) {
            ...
            i_224_ = (int) (90 + i_225_ + Math.atan((double) (checkpoints.z[i] - checkpoints.opz[im]) / (double) (checkpoints.x[i] - checkpoints.opx[im])) / 0.017453292519943295);
        } else {
            int i_226_ = 0;
            ...
            i_224_ = (int) (90 + i_230_ + Math.atan((double) (checkpoints.opz[i_226_] - checkpoints.opz[im]) / (double) (checkpoints.opx[i_226_] - checkpoints.opx[im])) / 0.017453292519943295);
            if (multion == 0) {
    ...
    public void cantgo(final Control control) {
        ...
        ftm = rd.getFontMetrics();
        drawcs(130, new StringBuilder().append("This stage will be unlocked when stage ").append(unlocked).append(" is complete!").toString(), 177, 177, 177, 3);
        for (int i = 0; i < 9; i++) {
        ...
        ftm = rd.getFontMetrics();
        if (aflk) {
            drawcs(185, new StringBuilder().append("[ Stage ").append(unlocked + 1).append(" Locked ]").toString(), 255, 128, 0, 3);
            aflk = false;
        } else {
            drawcs(185, new StringBuilder().append("[ Stage ").append(unlocked + 1).append(" Locked ]").toString(), 255, 0, 0, 3);
            aflk = true;
        }
    ...
    public void carselect(final Control control, final ContO[] contos, final Mad mad, final int i, final int i_104_, final boolean bool) {
        ...
        if (/*(multion != 0 || testdrive == 1 || testdrive == 2) && */lsc != sc[0]) {
            ...
            for (int i_108_ = 0; i_108_ < contos[sc[0]].npl && !bool_107_; i_108_++)
                if (contos[sc[0]].p[i_108_].colnum == 1) {
                    ...
                    Color.RGBtoHSB(contos[sc[0]].p[i_108_].c[0], contos[sc[0]].p[i_108_].c[1], contos[sc[0]].p[i_108_].c[2], fs);
                    arnp[0] = fs[0];
                    arnp[1] = fs[1];
                    arnp[2] = 1.0F - fs[2];
                    bool_107_ = true;
            ...
            for (int i_109_ = 0; i_109_ < contos[sc[0]].npl && !bool_107_; i_109_++)
                if (contos[sc[0]].p[i_109_].colnum == 2) {
                    final float[] fs = new float[3];
                    Color.RGBtoHSB(contos[sc[0]].p[i_109_].c[0], contos[sc[0]].p[i_109_].c[1], contos[sc[0]].p[i_109_].c[2], fs);
                    arnp[3] = fs[0];
                    arnp[4] = fs[1];
                    arnp[5] = 1.0F - fs[2];
                    bool_107_ = true;
        ...
        if (flipo == 0) {
            ...
            if (!remi && (cfase != 10 || cd.action != 0 && cd.action < 14)) {
                if (cfase == 3 && cd.lastload == 2) {
                    ...
                    if (aflk) {
                        drawcs(95 + i_115_, new StringBuilder().append(string).append(cd.names[sc[0]]).toString(), 240, 240, 240, 3);
                        aflk = false;
                    } else {
            ...
            if (i_113_ != 0) {
                ...
                if (flatrstart == 6) {
                    ...
                    drawcs(375, new StringBuilder().append("This car unlocks when stage ").append(i_113_).append(" is completed...").toString(), 255, 96, 0, 3);
                }
            } else {
                if (flatrstart == 6) {
                    /*if (cfase == 10) {
    ...
    public boolean clink(final String string, final int i, final int i_134_, final boolean bool) {
        ...
        final int i_137_ = 241 + ftm.stringWidth(new StringBuilder().append("Created by :  ").append(string).append("").toString()) - i_136_;
    ...
    public boolean drawcarb(final boolean bool, final Image image, final String string, final int i, int i_429_, final int i_430_, final int i_431_, final boolean bool_432_) {
                ...
                for (int i_407_ = 0; i_407_ < 202; i_407_++)
                    if (smokey[i + i_407_ * 466] != smokey[0]) {
                        ...
                        if (i + i_408_ + 100 < 670 && i + i_408_ + 100 > 0 && i_407_ + i_409_ + 110 < 400 && i_407_ + i_409_ + 110 > 0 && i_410_ < 268000 && i_410_ >= 0) {
                            ...
                            int i_415_ = (int) ((color.getRed() * (flang * f_412_) + color_411_.getRed() * (1.0F - f_412_)) / (flang * f_412_ + (1.0F - f_412_)));
                            int i_416_ = (int) ((color.getGreen() * (flang * f_413_) + color_411_.getGreen() * (1.0F - f_413_)) / (flang * f_413_ + (1.0F - f_413_)));
                            int i_417_ = (int) ((color.getBlue() * (flang * f_414_) + color_411_.getBlue() * (1.0F - f_414_)) / (flang * f_414_ + (1.0F - f_414_)));
                            if (i_415_ > 255) {
                                i_415_ = 255;
                            }
                            if (i_415_ < 0) {
    ...
    public void finish(final CheckPoints checkpoints, final ContO[] contos, final Control control, final int i, final int i_141_, final boolean bool) {
        if (chronostart) {
            chrono.stop();
            chronostart = false;
        }
        ...
        if (checkpoints.stage > 0) {
            final int i_143_ = checkpoints.stage;
            //if (i_143_ > 10)
            //	i_143_ -= 10;
        ...
        if (winner && multion == 0 && gmode != 0 && (checkpoints.stage == unlocked /*+ (gmode - 1) * 10*/ || checkpoints.stage == nTracks)) {
            ...
            if (checkpoints.stage != nTracks) {
                ...
                ftm = rd.getFontMetrics();
                if (aflk) {
                    drawcs(200 + pin, new StringBuilder().append("Stage ").append(checkpoints.stage + 1).append(" is now unlocked!").toString(), 196, 176, 0, 3);
                } else {
                    drawcs(200 + pin, new StringBuilder().append("Stage ").append(checkpoints.stage + 1).append(" is now unlocked!").toString(), 255, 247, 165, 3);
                }
                if (i_144_ != 0) {
                    if (aflk) {
                    ...
                    if (aflk) {
                        drawcs(320, new StringBuilder().append("").append(cd.names[i_144_]).append("").append(string_147_).append(" has been unlocked!").toString(), 196, 176, 0, 3);
                    } else {
                        drawcs(320, new StringBuilder().append("").append(cd.names[i_144_]).append("").append(string_147_).append(" has been unlocked!").toString(), 255, 247, 165, 3);
                    }
                    pin = 140;
                }
                rd.setFont(new Font("Arial", 1, 11));
        ...
        if (multion != 0 && checkpoints.stage == -2 && i_142_ != 0) {
            drawcs(i_142_ + 17, new StringBuilder().append("Created by: ").append(checkpoints.maker).append("").toString(), 255, 161, 85, 3);
    ...
    public Image getImage(final String string) {
        final Image image = Toolkit.getDefaultToolkit().createImage(new StringBuilder().append("").append(Madness.fpath).append("").append(string).append("").toString());
    ...
    public void loadimages() {
        ...
        dnload += 8;
        try {
            final File file = new File(new StringBuilder().append("").append(Madness.fpath).append("data/images.zip").toString());
    ...
    public void loading() {
        ...
        drawcs(410, new StringBuilder().append("").append((int) ((26.0F + shload / kbload * 200.0F) / 226.0F * 100.0F)).append(" % loaded    |    ").append(kbload - (int) shload).append(" KB remaining").toString(), 32, 64, 128, 3);
    ...
    public void loadsounds() {
        dnload += 3;
        try {
            final File file = new File(new StringBuilder().append("").append(Madness.fpath).append("data/sounds.zip").toString());
            final FileInputStream fileinputstream = new FileInputStream(file);
            final ZipInputStream zipinputstream = new ZipInputStream(fileinputstream);
            for (ZipEntry zipentry = zipinputstream.getNextEntry(); zipentry != null; zipentry = zipinputstream.getNextEntry()) {
                int i = (int) zipentry.getSize();
    ...
    public void loadstrack(final int i, final String string, final int i_52_) {
        if (new File("music/stage" + i + ".mid").exists()) {
            ...
            if (i > 32) {
                strack = new RadicalMod(new StringBuilder().append("music/stage").append(i).append(".zip").toString(), 550, 8000, 125, false, false);
            }
        }
        if (i < 0)
            if (!string.equals("")) {
                if (i != -2) {
                    strack = new RadicalMod(new StringBuilder().append("mystages/mymusic/").append(string).append(".zip").toString(), i_52_, 8000, 125, false, false);
                } else {
    ...
    public void mainbg(final int i) {
        ...
        if (i == 4) {
            ...
            for (int i_37_ = 0; i_37_ < 4; i_37_++) {
                ...
                rd.fillOval((int) (65 + ovx[i_37_] - ovw[i_37_] * 1.5 / 2.0), (int) (25 + ovy[i_37_] - ovh[i_37_] * 1.5 / 2.0), (int) (ovw[i_37_] * 1.5), (int) (ovh[i_37_] * 1.5));
                rd.setColor(new Color(255, 176, 67));
    ...
    public boolean msgcheck(String string) {
        ...
        for (bool_422_ = false; i < string.length() && !bool_422_; i++)
            if (!bool_421_) {
                ...
                bool_421_ = false;
                if (!string_420_.equals("") && !string_420_.equals(new StringBuilder().append("").append(string.charAt(i)).toString())) {
                    bool_422_ = true;
                }
        ...
        if (!bool_422_) {
            for (final String string2 : strings)
                if (string_419_.indexOf(string2) != -1) {
                    bool = true;
                }
        }
        string_419_ = "";
    ...
    public void multistat(final Control control, final CheckPoints checkpoints, final int i, final int i_53_, final boolean bool, final UDPMistro udpmistro) {
        int i_54_ = -1;
        if (fase != -2) {
            if (exitm != 0 && !holdit) {
                if (!lan || im != 0) {
                    ...
                    for (int i_57_ = i_55_; i_57_ >= 0; i_57_--) {
                        ...
                        if (bool_59_) {
                            ...
                            for ( /**/ ; i_60_ < lcmsg[i_57_].length(); i_60_++) {
                                final String string_62_ = new StringBuilder().append("").append(lcmsg[i_57_].charAt(i_60_)).toString();
                            ...
                            if (!string.equals("")) {
                                ...
                                if (!msgcheck(string) && updatec[i_57_] > -12) {
                                    if (cnames[i_57_][6].equals("Game Chat  ") || cnames[i_57_][6].equals(new StringBuilder().append("").append(clan).append("'s Chat  ").toString())) {
                                        cnames[i_57_][6] = "";
                                    }
                            ...
                            if (floater[i_57_] != 0) {
                                for (int i_67_ = 6; i_67_ >= 0; i_67_--) {
                                    ...
                                    if (pointc[i_57_] >= i_67_) {
                                        ...
                                        ftm = rd.getFontMetrics();
                                        rd.drawString(new StringBuilder().append(cnames[i_57_][i_67_]).append(": ").toString(), 39 + i_64_ + movepos[i_57_], 439 + i_56_);
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(cnames[i_57_][i_67_]).append(": ").toString());
                                        rd.setColor(new Color(0, 0, 0));
                                        rd.setFont(new Font("Tahoma", 0, 11));
                                        ftm = rd.getFontMetrics();
                                        rd.drawString(new StringBuilder().append(sentn[i_57_][i_67_]).append("   ").toString(), 39 + i_64_ + movepos[i_57_], 439 + i_56_);
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(sentn[i_57_][i_67_]).append("   ").toString());
                                    } else {
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(cnames[i_57_][i_67_]).append(": ").toString());
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(sentn[i_57_][i_67_]).append("   ").toString());
                                    }
                                ...
                                for (int i_68_ = pointc[i_57_]; i_68_ >= 0; i_68_--) {
                                    ...
                                    rd.setFont(new Font("Tahoma", 1, 11));
                                    ftm = rd.getFontMetrics();
                                    if (ftm.stringWidth(new StringBuilder().append(cnames[i_57_][i_68_]).append(": ").toString()) + 39 + i_64_ < 775) {
                                        if (i_68_ != 6 || msgflk[i_57_] < 67 || msgflk[i_57_] % 3 != 0) {
                                            rd.drawString(new StringBuilder().append(cnames[i_57_][i_68_]).append(": ").toString(), 39 + i_64_, 439 + i_56_);
                                        }
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(cnames[i_57_][i_68_]).append(": ").toString());
                                    } else {
                                        String string = "";
                                        for (int i_69_ = 0; ftm.stringWidth(string) + 39 + i_64_ < 775 && i_69_ < cnames[i_57_][i_68_].length(); i_69_++) {
                                            string = new StringBuilder().append(string).append(cnames[i_57_][i_68_].charAt(i_69_)).toString();
                                        }
                                    ...
                                    if (ftm.stringWidth(sentn[i_57_][i_68_]) + 39 + i_64_ < 775) {
                                        if (i_68_ != 6 || msgflk[i_57_] < 67 || msgflk[i_57_] % 3 != 0) {
                                            rd.drawString(new StringBuilder().append(sentn[i_57_][i_68_]).append("   ").toString(), 39 + i_64_, 439 + i_56_);
                                        }
                                        i_64_ += ftm.stringWidth(new StringBuilder().append(sentn[i_57_][i_68_]).append("   ").toString());
                                    } else {
                                        String string = "";
                                        for (int i_70_ = 0; ftm.stringWidth(string) + 39 + i_64_ < 775 && i_70_ < sentn[i_57_][i_68_].length(); i_70_++) {
                                            string = new StringBuilder().append(string).append(sentn[i_57_][i_68_].charAt(i_70_)).toString();
                                        }
                                        string = new StringBuilder().append(string).append("...").toString();
                                        if (i_68_ != 6 || msgflk[i_57_] < 67 || msgflk[i_57_] % 3 != 0) {
                                            rd.drawString(string, 39 + i_64_, 439 + i_56_);
                ...
                for (int i_75_ = 0; i_75_ < i_74_; i_75_++) {
                    ...
                    for (int i_77_ = 0; i_77_ < nplayers; i_77_++)
                        if (checkpoints.pos[i_77_] == i_75_ && checkpoints.dested[i_77_] == 0 && !bool_76_) {
                            ...
                            if (i_75_ >= 3) {
                                rd.drawString(new StringBuilder().append("").append(i_75_ + 1).append("th").toString(), 671, 76 + 30 * i_75_);
                            }
                            if (clangame != 0) {
                                int i_82_;
                                int i_83_;
                                ...
                                rd.drawString(plnames[i_77_], 731 - ftm.stringWidth(plnames[i_77_]) / 2, 70 + 30 * i_75_);
                            }
                            rd.setColor(new Color(0, 0, 0));
                            ...
                            if (alocked == i_77_) {
                                i_85_ = (int) (159.0F + 159.0F * (m.snap[0] / 100.0F));
                                if (i_85_ > 255) {
                                    i_85_ = 255;
                                }
                                if (i_85_ < 0) {
                                ...
                                i_86_ = (int) (207.0F + 207.0F * (m.snap[1] / 100.0F));
                                if (i_86_ > 255) {
                                    i_86_ = 255;
                                }
                                if (i_86_ < 0) {
                                ...
                                i_81_ = (int) (255.0F + 255.0F * (m.snap[2] / 100.0F));
                                if (i_81_ > 255) {
                                    i_81_ = 255;
                                }
                                if (i_81_ < 0) {
                            ...
                            if (bool_87_ && !onlock) {
                                if (alocked == i_77_) {
                                    i_85_ = (int) (120.0F + 120.0F * (m.snap[0] / 100.0F));
                                    if (i_85_ > 255) {
                                        i_85_ = 255;
                                    }
                                    if (i_85_ < 0) {
                                    ...
                                    i_86_ = (int) (114.0F + 114.0F * (m.snap[1] / 100.0F));
                                    if (i_86_ > 255) {
                                        i_86_ = 255;
                                    }
                                    if (i_86_ < 0) {
                                    ...
                                    i_85_ = (int) (140.0F + 140.0F * (m.snap[0] / 100.0F));
                                    if (i_85_ > 255) {
                                        i_85_ = 255;
                                    }
                                    if (i_85_ < 0) {
                                    ...
                                    i_86_ = (int) (160.0F + 160.0F * (m.snap[1] / 100.0F));
                                    if (i_86_ > 255) {
                                        i_86_ = 255;
                                    }
                                    if (i_86_ < 0) {
    ...
    public boolean overon(final int i, final int i_289_, final int i_290_, final int i_291_, final int i_292_, final int i_293_) {
    ...
    public void pingstat() {
        ...
        try {
            final URL url = new URL(new StringBuilder().append("http://c.statcounter.com/9994681/0/14bb645e/1/?reco=").append(i).append("").toString());
                    ...
                    if (!bool_257_) {
                        if (mad.power != 98.0F) {
                            ...
                            if (Math.abs(mad.speed) > cd.swits[mad.cn][0] && Math.abs(mad.speed) <= cd.swits[mad.cn][1]) {
                                int i_260_ = (int) (3.0F * (Math.abs(mad.speed) - cd.swits[mad.cn][0]) / (cd.swits[mad.cn][1] - cd.swits[mad.cn][0]));
                                if (i_260_ == 2) {
                                    if (pwait == 0) {
                                        i_260_ = 0;
                                    } else {
                            ...
                            if (Math.abs(mad.speed) > cd.swits[mad.cn][1] && Math.abs(mad.speed) <= cd.swits[mad.cn][2]) {
                                final int i_261_ = (int) (3.0F * (Math.abs(mad.speed) - cd.swits[mad.cn][1]) / (cd.swits[mad.cn][2] - cd.swits[mad.cn][1]));
    ...
    public void rot(final int[] is, final int[] is_272_, final int i, final int i_273_, final int i_274_, final int i_275_) {
        if (i_274_ != 0) {
                    ...
                    if (updatec[i_16_] != i_17_ && updatec[i_16_] >= -2 && pointc[i_16_] == 6) {
                        ...
                        if (cnames[i_16_][6].equals(""))
                            if (i_16_ == 0) {
                                ...
                                cnames[i_16_][6] = new StringBuilder().append("").append(clan).append("'s Chat  ").toString();
                            }
                        if (updatec[i_16_] != -2) {
                            floater[i_16_] = 1;
                            if (bools[i_16_]) {
        ...
        if (i != 0) {
            ...
            for (int i_157_ = 1; i_157_ < i_152_; i_157_++) {
                ...
                while (!bools[i_157_]) {
                    ...
                    float f_159_ = (nCars - 1 - sc[i_157_]) / (float) nCars * (i / f);
                    if (f_159_ > 0.8) {
                        f_159_ = 0.8F;
                    }
                    if (i == nTracks && f_159_ > 0.5) {
                        f_159_ = 0.5F;
                    }
            ...
            if (cd.lastload == 1) {
                ...
                for (int i_175_ = 0; i_175_ < cd.nlcars - 16; i_175_++) {
                    ...
                    if (cd.include[i_175_] && sc[0] != i_175_ + 16) {
                        int i_177_;
                        for (i_177_ = (int) (1.0 + Math.random() * (i_152_ - 1)); bools[i_177_]; i_177_ = (int) (1.0 + Math.random() * (i_152_ - 1))) {
                            /* empty */
                        }
                        bools[i_177_] = true;
                        sc[i_177_] = i_175_ + 16;
            ...
            if (cd.lastload == 2) {
                ...
                for (int i_179_ = 0; i_179_ < cd.nlocars - 16; i_179_++) {
                    ...
                    if (cd.include[i_179_] && sc[0] != i_179_ + 16) {
                        int i_181_;
                        for (i_181_ = (int) (1.0 + Math.random() * (i_152_ - 1)); bools[i_181_]; i_181_ = (int) (1.0 + Math.random() * (i_152_ - 1))) {
                            /* empty */
                        }
                        bools[i_181_] = true;
                        sc[i_181_] = i_179_ + 16;
    ...
    public void stageselect(final CheckPoints checkpoints, final Control control, final int i, final int i_39_, final boolean bool) {
        //rd.drawImage(br, 65, 25, null);
        rd.drawImage(select, 338, 35, null);
        if (testdrive != 3 && testdrive != 4) {
            ...
            if (gmode == 0) {
                ...
                if (cd.staction == 3) {
                    ...
                    if (cd.reco != -177) {
                        if ((drawcarb(true, null, "       Login       ", 347, 247, i, i_39_, bool) || control.handb || control.enter) && tcnt > 5) {
                            tcnt = 0;
                            if (!app.tnick.getText().equals("") && !app.tpass.getText().equals("")) {
                                autolog = false;
                                app.tnick.setVisible(false);
                    ...
                    } else if (drawcarb(true, null, "  Upgrade to have your own stages!  ", 277, 247, i, i_39_, bool) && cntflock == 0) {
                        app.editlink(nickname, true);
                        cntflock = 100;
                    }
                ...
                ftm = rd.getFontMetrics();
                if (checkpoints.stage != nTracks) {
                    final int i_44_ = checkpoints.stage;
                    //if (i_44_ > 10)
                    //	i_44_ -= 10;
    ...
    public void stat(final Mad mad, final ContO conto, final CheckPoints checkpoints, final Control control, final boolean bool) {
        if (!chronostart) {
            if (starcnt == 0) {
        ...
        if (fase != -2) {
            ...
            if (clangame > 1) {
                ...
                if (bool_184_) {
                    ...
                    if (clangame == 2) {
                        bool_186_ = true;
                        string_187_ = new StringBuilder().append("Clan ").append(string_185_).append(" wasted, nobody won becuase this is a racing only game!").toString();
                    }
                    if (clangame == 4 && !string.toLowerCase().equals(gaclan.toLowerCase())) {
                        bool_186_ = true;
                        string_187_ = new StringBuilder().append("Clan ").append(string_185_).append(" wasted, nobody won becuase ").append(string).append(" should have raced in this racing vs wasting game!").toString();
                    }
                ...
                for (int i = 0; i < nplayers; i++)
                    if (checkpoints.clear[i] == checkpoints.nlaps * checkpoints.nsp && checkpoints.pos[i] == 0) {
                        if (clangame == 3) {
                            bool_186_ = true;
                            string_187_ = new StringBuilder().append("").append(plnames[i]).append(" of clan ").append(pclan[i]).append(" finished first, nobody won becuase this is a wasting only game!").toString();
                        }
                        if (clangame == 4 && pclan[i].toLowerCase().equals(gaclan.toLowerCase())) {
                            bool_186_ = true;
                            string_187_ = new StringBuilder().append("").append(plnames[i]).append(" of clan ").append(pclan[i]).append(" finished first, nobody won becuase ").append(pclan[i]).append(" should have wasted in this racing vs wasting game!").toString();
                        }
            ...
            if (multion < 2) {
                ...
                if (!holdit && (checkpoints.wasted >= nplayers - 1 || bool_184_)) {
                    ...
                    drawhi(gamefinished, 70);
                    if (aflk) {
                        drawcs(120, new StringBuilder().append("").append(string_189_).append(" has wasted all the cars!").toString(), 0, 0, 0, 0);
                        aflk = false;
                    } else {
                        drawcs(120, new StringBuilder().append("").append(string_189_).append(" has wasted all the cars!").toString(), 0, 128, 255, 0);
                        aflk = true;
                    }
                    drawcs(350, "Press  [ Enter ]  to continue", 0, 0, 0, 0);
                    checkpoints.haltall = true;
            ...
            if (!holdit) {
                ...
                if (mad.power < 45.0F) {
                    if (tcnt == 30 && auscnt == 45 && mad.mtouch && mad.capcnt == 0 && exitm == 0) {
                        if (looped != 2) {
                            ...
                            if (pwflk) {
                                drawcs(110, new StringBuilder().append("Please read the Game Instructions!").append(string_192_).append("").toString(), 0, 0, 200, 0);
                                pwflk = false;
                            } else {
                                drawcs(110, new StringBuilder().append("Please read the Game Instructions!").append(string_192_).append("").toString(), 255, 100, 0, 0);
                                pwflk = true;
                            }
                        }
                        pwcnt++;
                ...
                if (mad.trcnt == 10) {
                    ...
                    if (loop != "") {
                        ...
                        var_xtGraphics_193_.asay = stringbuilder.append(var_xtGraphics_193_.asay).append(" ").append(loop).toString();
                    }
                    i = 0;
                    ...
                    if (i != 0) {
                        if (loop == "" && spin == "") {
                            ...
                            var_xtGraphics_195_.asay = stringbuilder.append(var_xtGraphics_195_.asay).append(" ").append(i).toString();
                            if (bool_194_) {
                                final StringBuilder stringbuilder_196_ = new StringBuilder();
                                final xtGraphics var_xtGraphics_197_ = this;
                                var_xtGraphics_197_.asay = stringbuilder_196_.append(var_xtGraphics_197_.asay).append(" and beyond").toString();
                            }
                        } else {
                            if (spin != "")
                                if (loop == "") {
                                    ...
                                    var_xtGraphics_198_.asay = stringbuilder.append(var_xtGraphics_198_.asay).append(" ").append(spin).toString();
                                } else {
                                    final StringBuilder stringbuilder = new StringBuilder();
                                    final xtGraphics var_xtGraphics_199_ = this;
                                    var_xtGraphics_199_.asay = stringbuilder.append(var_xtGraphics_199_.asay).append(" with ").append(spin).toString();
                                }
                            final StringBuilder stringbuilder = new StringBuilder();
                            final xtGraphics var_xtGraphics_200_ = this;
                            var_xtGraphics_200_.asay = stringbuilder.append(var_xtGraphics_200_.asay).append(" by ").append(i).toString();
                            if (bool_194_) {
                                final StringBuilder stringbuilder_201_ = new StringBuilder();
                                final xtGraphics var_xtGraphics_202_ = this;
                                var_xtGraphics_202_.asay = stringbuilder_201_.append(var_xtGraphics_202_.asay).append(" and beyond").toString();
                            }
                        }
                    } else if (spin != "")
                        if (loop == "") {
                            ...
                            var_xtGraphics_203_.asay = stringbuilder.append(var_xtGraphics_203_.asay).append(" ").append(spin).toString();
                        } else {
                            final StringBuilder stringbuilder = new StringBuilder();
                            final xtGraphics var_xtGraphics_204_ = this;
                            var_xtGraphics_204_.asay = stringbuilder.append(var_xtGraphics_204_.asay).append(" by ").append(spin).toString();
                        }
                    if (asay != "") {
                        auscnt -= 15;
                    }
                    ...
                    if (auscnt < 45) {
                        ...
                        if (i_205_ != 3) {
                            asay = new StringBuilder().append(adj[i_205_][(int) (m.random() * 3.0F)]).append(asay).append(exlm[i_205_]).toString();
                        } else {
