...
public class xtGraphics extends Panel implements Runnable
{
    ...
    boolean pwflk = false;
    String[][] adj
	= { { "Cool", "Alright", "Nice" }, { "Wicked", "Amazing", "Super" },
    ...
    int auscnt = 45;
    boolean aflk = false;
    int[] sndsize = { 39, 128, 23, 58, 106, 140, 81, 135, 38, 141, 106, 76, 56,
	...
	try {
		...
		for (int i_2_ = 0; i_2_ < 5; i_2_++) {
			...
			if (string.equals(new StringBuilder().append("").append
					      (i_3_).append
					      ("").append
					      (i_2_).append
					      (".wav").toString()))
		...
		for (int i_4_ = 0; i_4_ < 6; i_4_++) {
		    if (string.equals(new StringBuilder().append("air").append
					  (i_4_).append
					  (".wav").toString()))
		...
		for (int i_6_ = 0; i_6_ < 3; i_6_++) {
		    if (string.equals(new StringBuilder().append
					  ("lowcrash").append
					  (i_6_ + 1).append
					  (".wav").toString()))
		...
		for (int i_7_ = 0; i_7_ < 3; i_7_++) {
		    if (string.equals(new StringBuilder().append("skid").append
					  (i_7_ + 1).append
					  (".wav").toString()))
	...
	try {
		...
		if (string.equals("cars.gif"))
		    this.carsbg
			= loadBimage(is, mediatracker, toolkit, 1);
		...
		if (string.equals("1.gif"))
		    this.orank[0]
			= loadimage(is, mediatracker, toolkit);
		...
		if (string.equals("bgmain.jpg"))
		    this.bgmain
			= loadBimage(is, mediatracker, toolkit, 2);
		...
		if (string.equals("track.jpg")) {
		    this.trackbg[0]
			= loadBimage(is, mediatracker, toolkit, 3);
		    this.trackbg[1]
			= dodgen(this.trackbg[0]);
		}
		...
		if (string.equals("madness.gif"))
		    this.mdness
			= loadude(is, mediatracker, toolkit);
		...
		if (string.equals("nfmcom.gif"))
		    this.nfmcom
			= loadBimage(is, mediatracker, toolkit, 0);
	...
	while ((this.runtyp == -101
		|| this.sendstat == 1)
	       && !this.lan) {
	    String string = new StringBuilder().append("3|").append
				(this.playingame).append
				("|").append
				(this.updatec[0]).append
				("|").toString();
	    if (this.clanchat)
		string = new StringBuilder().append(string).append("").append
			     (this.updatec[1]).append
			     ("|").append
			     (this.clan).append
			     ("|").append
			     (this.clankey).append
		...
		for (int i = 0; i < -this.updatec[0] - 10; i++)
			...
			= new StringBuilder().append(string).append("").append
			      (this.cnames[0][6 - i]).append
			      ("|").append
			      (this.sentn[0][6 - i]).append
			      ("|").toString();
		this.updatec[0] = -2;
	    }
	    if (this.clanchat
		...
		for (int i = 0; i < -this.updatec[1] - 10; i++)
		    string
			= new StringBuilder().append(string).append("").append
			      (this.cnames[1][6 - i]).append
			      ("|").append
			      (this.sentn[1][6 - i]).append
			      ("|").toString();
		this.updatec[1] = -2;
	    }
	    if (this.sendstat == 1) {
		string = new StringBuilder().append("5|").append
			     (this.playingame).append
			     ("|").append
			     (this.im).append
			     ("|").append
			     (this.beststunt).append
			     ("|").append
			     (this.fastestlap).append
			     ("|").toString();
		for (int i = 0; i < this.nplayers; i++)
		    string
			= new StringBuilder().append(string).append("").append
			      (this.dcrashes[i]).append
			      ("|").toString();
		this.sendstat = 2;
	    }
		...
		for (int i_16_ = 0; i_16_ < i_15_; i_16_++) {
		    ...
		    if (this.updatec[i_16_] != i_17_
			&& this.updatec[i_16_] >= -2
			&& this.pointc[i_16_] == 6) {
			for (int i_18_ = 0; i_18_ < 7; i_18_++) {
			    this.cnames[i_16_][i_18_]
				= getSvalue(string_14_, i);
			    i++;
			    this.sentn[i_16_][i_18_]
				= getSvalue(string_14_, i);
			    i++;
			}
	...
	if (this.runtyp == -167
		...
		this.dout
		    = new PrintWriter(this.socket
				      ...
				      true);
		this.dout.println
		    (new StringBuilder().append("101|").append
			 (this.runtyp + 174).append
			 ("|").append
			 ((this.app).tnick
			      .getText())
			 .append
	...
	drawcs(410, new StringBuilder().append("").append
			...
			(this.kbload
			 - (int) this.shload)
			.append
			(" KB remaining").toString(), 32, 64, 128, 3);
	...
	if (this.pin != 0)
	    this.rd.drawImage(this.radicalplay,
					     (this.radpx
					      + (int) (8.0 * Math.random()
						       - 4.0)),
					     135, null);
	...
	if (this.flipo == 101) {
		...
		(400 - ((this.ftm.stringWidth
			 ("http://multiplayer.needformadness.com/music.html"))
			/ 2),
		 396,
		 ((this.ftm.stringWidth
		   ("http://multiplayer.needformadness.com/music.html")) / 2
		  + 400),
		 396);
	...
	if (i == 0) {
	    ...
	    int i_27_ = (int) (255.0F * this.bgf
			       + 191.0F * (1.0F - this.bgf));
	    int i_28_ = (int) (176.0F * this.bgf
			       + 184.0F * (1.0F - this.bgf));
	    int i_29_ = (int) (67.0F * this.bgf
			       + 124.0F * (1.0F - this.bgf));
	    if (!this.bgup) {
		this.bgf += 0.02F;
		if (this.bgf > 0.9F) {
		    this.bgf = 0.9F;
	...
	if (i == 3) {
	    ...
	    int i_33_ = (int) (255.0F * this.bgf
			       + 191.0F * (1.0F - this.bgf));
	    int i_34_ = (int) (176.0F * this.bgf
			       + 184.0F * (1.0F - this.bgf));
	    int i_35_ = (int) (67.0F * this.bgf
			       + 124.0F * (1.0F - this.bgf));
	    if (!this.bgup) {
		this.bgf += 0.02F;
		if (this.bgf > 0.9F) {
	...
	if (i == 4) {
		...
		for (int i_36_ = 0; i_36_ < 4; i_36_++) {
		    this.ovw[i_36_]
			= (int) (50.0 + 150.0 * Math.random());
		    this.ovh[i_36_]
			= (int) (50.0 + 150.0 * Math.random());
		    this.ovy[i_36_]
			= (int) (400.0 * Math.random());
		    this.ovx[i_36_]
			= (int) (Math.random() * 670.0);
		    this.ovsx[i_36_]
			= (int) (5.0 + Math.random() * 10.0);
		}
		this.lmode = i;
	    }
		...
		this.rd.fillOval
		    ((int) ((double) (65 + this.ovx[i_37_])
			    - ((double) this.ovw[i_37_] * 1.5
			       / 2.0)),
		     (int) ((double) (25 + this.ovy[i_37_])
			    - ((double) this.ovh[i_37_] * 1.5
			       / 2.0)),
		     (int) ((double) this.ovw[i_37_] * 1.5),
		     (int) ((double) this.ovh[i_37_] * 1.5));
		this.rd.setColor(new Color(255, 176, 67));
		this.rd.fillOval
		    ((65 + this.ovx[i_37_]
		      - this.ovh[i_37_] / 2),
		...
		this.ovx[i_37_]
		    -= this.ovsx[i_37_];
		if (((double) this.ovx[i_37_]
		     + (double) this.ovw[i_37_] * 1.5 / 2.0)
		    < 0.0) {
		    this.ovw[i_37_]
			= (int) (50.0 + 150.0 * Math.random());
		    this.ovh[i_37_]
	...
	if ((checkpoints).stage == -2) {
		...
		if ((this.app).mstgs.getItem
			(i).equals((checkpoints).name))
		    bool = true;
	    }
	    if (!bool)
		(checkpoints).stage
	...
	if (this.gmode == 1) {
		...
		(checkpoints).stage
		    = (int) (Math.random() * 11.0) + 1;
	    if ((checkpoints).stage == 11)
		(checkpoints).stage = 27;
	}
	if (this.gmode == 2) {
	    if (this.unlocked[0] != 17
		|| this.justwon2)
		(checkpoints).stage
		    = this.unlocked[1] + 10;
	    else if (this.winner
		     || (checkpoints).stage < 11)
		(checkpoints).stage
		    = (int) (Math.random() * 17.0) + 11;
	}
	(this.app).sgame
	    .setBackground(new Color(0, 0, 0));
	(this.app).sgame
	    .setForeground(new Color(47, 179, 255));
	(this.app).snfm1
	    .setBackground(new Color(0, 0, 0));
	(this.app).snfm1
	    .setForeground(new Color(47, 179, 255));
	...
	(this.app).mstgs
	    .setForeground(new Color(47, 179, 255));
	(this.app).gmode
	    .setBackground(new Color(49, 49, 0));
	(this.app).gmode
	    .setForeground(new Color(148, 167, 0));
	...
	(this.app).sgame
	    .add(this.rd, " NFM 2     ");
	(this.app).sgame
	    .add(this.rd, " My Stages ");
	(this.app).sgame
	    .add(this.rd, " Weekly Top20 ");
	(this.app).sgame
	    .add(this.rd, " Monthly Top20 ");
	(this.app).sgame
	    .add(this.rd, " Stage Maker ");
	...
	if (bool)
	    this.rd.drawImage(this.select, 338,
					     35, null);
	this.app.repaint();
	...
	this.rd.setFont(new Font("Arial", 1, 13));
	this.ftm = this.rd.getFontMetrics();
	drawcs(130, new StringBuilder().append
			("This stage will be unlocked when stage ").append
			(this.unlocked
			 [this.gmode - 1])
			.append
			(" is complete!").toString(), 177, 177, 177, 3);
	for (int i = 0; i < 9; i++)
	...
	this.ftm = this.rd.getFontMetrics();
	if (this.aflk) {
	    drawcs(185, new StringBuilder().append("[ Stage ").append
			    ((this.unlocked
			      [this.gmode - 1]) + 1)
			    .append
			    (" Locked ]").toString(), 255, 128, 0, 3);
	    this.aflk = false;
	} else {
	    drawcs(185, new StringBuilder().append("[ Stage ").append
			    ((this.unlocked
			      [this.gmode - 1]) + 1)
			    .append
			    (" Locked ]").toString(), 255, 0, 0, 3);
	    this.aflk = true;
	}
	this.rd.drawImage((this.back
					  [this.pback]),
					 370, 345, null);
	this.lockcnt--;
	if (this.lockcnt == 0 || (control).enter
	    || (control).handb || (control).left) {
	    (control).left = false;
	    (control).handb = false;
	    (control).enter = false;
	    this.fase = 1;
	...
	if (this.testdrive != 3
		...
		if ((this.cd).staction == 5) {
			...
			this.acexp = -1;
		    if ((this.cd).reco == 111) {
			if (!this.backlog.toLowerCase().equals
		...
		if ((this.cd).staction == 0
			...
			if ((checkpoints).stage == -2
			    ...
			    this.rd.setColor(new Color(255, 176,
								      85));
			    if ((checkpoints).maker
				    .equals(this.nickname))
				this.rd
				    .drawString("Created by You", 70, 115);
			    else
				this.rd.drawString
			...
			if (this.nfmtab == 1
				...
				(this.app)
				    .snfm1
				    .select(1 + (int) (Math.random() * 10.0));
			    if (this.nfmtab == 1)
				(this.app)
				    .snfm2
				    .select(1 + (int) (Math.random() * 17.0));
			}
		    }
		}
		if ((this.cd).staction == 3) {
		    ...
		    if (!this.showtf) {
			(this.app).tnick
			    .setBackground(new Color(206, 237, 255));
			if ((this.cd).reco != 1) {
			    if ((this.cd).reco != 2)
				(this.app)
				    .tnick
			...
			("Nickname:",
			 (376
			  - this.ftm.stringWidth("Nickname:")
			  - 14),
			 201);
		    this.rd.drawString
			("Password:",
			 (376
			  - this.ftm.stringWidth("Password:")
			  - 14),
			 231);
		    this.app.movefieldd
			((this.app).tnick, 376,
			...
			if ((drawcarb(true, null, "       Login       ", 347,
				...
				if ((this.app)
					...
					277, 247, i, i_39_, bool)
			       && this.cntflock == 0) {
			this.app
			    .editlink(this.nickname, true);
			this.cntflock = 100;
		    }
		...
		if ((checkpoints).top20 >= 3
			...
			= this.rd.getFontMetrics();
		    if (this.dnload == 0
			&& drawcarb(true, null, " Add to My Stages ", 334, 355,
				    i, i_39_, bool)) {
			if (this.logged) {
			    (this.cd).onstage
				= (checkpoints).name;
			...
			drawcs
			    (370,
			     ...
			     193, 106, 0, 3);
		    if (this.dnload == 4)
			drawcs(370, "You already have this stage!", 193, 106,
			       0, 3);
		    if (this.dnload == 5)
			drawcs
			    (370,
		...
		if (this.nfmtab == 3
			...
			string = (this.app)
				     ...
				     ().substring(i_43_);
		    if (!string.equals("")
			&& !string.equals((checkpoints).name)
			&& (this.app).mstgs
			       .getSelectedIndex() != 0) {
			(checkpoints).stage = -2;
		...
		if ((checkpoints).stage != 27) {
		    ...
		    if (i_44_ > 10)
			i_44_ -= 10;
		    drawcs(80, new StringBuilder().append("Stage ").append
				   (i_44_).append
				   ("  >").toString(), 255, 128, 0, 3);
		} else
		    drawcs(80, "Final Party Stage  >", 255, 128, 0, 3);
		if (this.aflk) {
		    drawcs(100, new StringBuilder().append("| ").append
				    ((checkpoints).name).append
				    (" |").toString(), 240, 240, 240, 3);
		    this.aflk = false;
		} else {
		    drawcs(100, new StringBuilder().append("| ").append
				    ((checkpoints).name).append
	...
	if (this.multion == 0) {
		...
		i_49_ = 0;
	    if (i == 11 || i == 12 || i == 13 || i == 14 || i == 17 || i == 18
		|| i == 19 || i == 20 || i == 22 || i == 23 || i == 26)
		i_49_ = 0;
	    if (i < 0 && this.nplayers != 1
		&& this.newparts)
		i_49_ = 0;
	} else if (this.ransay == 1
		   || this.ransay == 2
		   || this.ransay == 3
		   || this.ransay == 4 || i == 10)
	    i_49_ = 0;
	if (i_49_ == 0) {
		...
		this.duds = 0;
	    this.rd
		.setComposite(AlphaComposite.getInstance(3, 0.3F));
	    this.rd.drawImage((this.dude
					      [this.duds]),
					     95, 35, null);
	    this.rd
		...
		if (this.ransay == 1 && i != 10)
		    this.rd.drawString
			("Multiplayer Tip:  Press [ C ] to access chat quickly during the game!",
			 262, 92);
		if (this.ransay == 2 && i != 10) {
		    this.rd.drawString
			("Multiplayer Tip:  Press [ A ] to make Guidance Arrow point to cars and",
			 262, 92);
		    this.rd.drawString
			("click any of the players listed on the right to lock the Arrow on!",
			 262, 112);
		}
		if (this.ransay == 3 && i != 10) {
		    this.rd.drawString
			("Multiplayer Tip:  When wasting in multiplayer it's better to aim slightly",
			 262, 92);
		    this.rd.drawString
			("ahead of the other player's car to compensate for internet delay.",
			 262, 112);
		}
		if (this.ransay == 4) {
		    this.rd.drawString
			("When watching a game, click any player listed on the right of the",
			 262, 92);
		    this.rd
			.drawString("screen to follow and watch.", 262, 112);
		    this.rd.drawString
			("Press [ V ] to change the viewing mode!", 262, 132);
		}
		if (i == 10 && this.ransay != 4) {
			...
			this.tflk = true;
		    this.rd.drawString
			("NOTE: Guidance Arrow and opponent status is disabled in this stage!",
			 262, 92);
		}
	    } else {
		if (i < 0 && this.nplayers != 1
		    && this.newparts) {
		    this.rd.drawString
			("Please note, the computer car's AI has not yet been trained to handle",
			 262, 92);
		    this.rd.drawString
			("some of the new stage parts such as the 'Rollercoaster Road' and the",
			 262, 112);
		    this.rd.drawString("'Tunnel Side Ramp'.",
						      262, 132);
		    this.rd.drawString
			("(Those new parts where mostly designed for the multiplayer game.)",
			 262, 152);
		    this.rd.drawString
			("The AI will be trained and ready in the future releases of the game!",
			 262, 172);
		}
		if (i == 1 || i == 11) {
		    this.rd.drawString
			("Hey!  Don't forget, to complete a lap you must pass through",
			 262, 92);
		    this.rd
			.drawString("all checkpoints in the track!", 262, 112);
		}
		if (i == 2 || i == 12)
		    this.rd.drawString
			("Remember, the more power you have the faster your car will be!",
			 262, 92);
		if (i == 3) {
		    this.rd.drawString
			("> Hint: its easier to waste the other cars then to race in this stage!",
			 262, 92);
		    this.rd.drawString
			("Press [ A ] to make the guidance arrow point to cars instead of to",
			 262, 112);
		    this.rd.drawString("the track.", 262, 132);
		}
		if (i == 4)
		    this.rd.drawString
			("Remember, the better the stunt you perform the more power you get!",
			 262, 92);
		if (i == 5)
		    this.rd.drawString
			("Remember, the more power you have the stronger your car is!",
			 262, 92);
		if (i == 10) {
		    if (this.tflk) {
			this.rd.setColor(new Color(200, i_47_,
			...
			this.tflk = true;
		    this.rd.drawString
			("NOTE: Guidance Arrow is disabled in this stage!",
			 262, 92);
		}
		if (i == 13) {
		    this.rd.drawString
			("Watch out!  Look out!  The policeman might be out to get you!",
			 262, 92);
		    this.rd.drawString
			("Don't upset him or you'll be arrested!", 262, 112);
		    this.rd.drawString("Better run, run, run.",
						      262, 152);
		}
		if (i == 14) {
		    this.rd.drawString
			("Don't waste your time.  Waste them instead!", 262,
			 92);
		    this.rd.drawString
			("Try a taste of sweet revenge here (if you can)!",
			 262, 112);
		    this.rd.drawString
			("Press [ A ] to make the guidance arrow point to cars instead of to",
			 262, 152);
		...
		if (i == 17) {
		    this.rd.drawString
			("Welcome to the realm of the king...", 262, 92);
		    this.rd.drawString
			("The key word here is 'POWER'.  The more you have of it the faster",
			 262, 132);
		    this.rd
			.drawString("and STRONGER you car will be!", 262, 152);
		}
		if (i == 18) {
		    this.rd.drawString
			("Watch out, EL KING is out to get you now!", 262, 92);
		    this.rd.drawString
			("He seems to be seeking revenge?", 262, 112);
		    this.rd.drawString
			("(To fly longer distances in the air try drifting your car on the ramp",
			 262, 152);
		...
		if (i == 19)
		    this.rd
			.drawString("It\u2019s good to be the king!", 262, 92);
		if (i == 20) {
		    this.rd.drawString
			("Remember, forward loops give your car a push forwards in the air",
			 262, 92);
		...
		if (i == 22) {
		    this.rd.drawString
			("Watch out!  Beware!  Take care!", 262, 92);
		    this.rd.drawString
			("MASHEEN is hiding out there some where, don't get mashed now!",
			 262, 112);
		}
		if (i == 23) {
		    this.rd
			.drawString("Anyone for a game of Digger?!", 262, 92);
		    this.rd.drawString
			("You can have fun using MASHEEN here!", 262, 112);
		}
		if (i == 26) {
		    this.rd.drawString
			("This is it!  This is the toughest stage in the game!",
			 262, 92);
		    this.rd.drawString
			("This track is actually a 4D object projected onto the 3D world.",
			 262, 132);
		    this.rd.drawString
			("It's been broken down, separated and, in many ways, it is also a",
			 262, 152);
	...
	if (i_50_ < 0)
	    i_50_ = 32;
	if (!bool) {
	    drawcs(340 + i_49_, new StringBuilder().append("").append
				    (this.sndsize[i_50_]).append
				    (" KB").toString(), 0, 0, 0, 3);
	    ...
	    drawcs(365 + i_49_, "Loading complete!  Press Start to begin...",
		   0, 0, 0, 3);
	    this.rd
		.setComposite(AlphaComposite.getInstance(3, 0.5F));
	    this.rd.drawImage((this.star
					      [this.pstar]),
					     359, 385 + i_49_, null);
	    this.rd
		.setComposite(AlphaComposite.getInstance(3, 1.0F));
	...
	if (i == 1)
	    this.strack
		= new RadicalMod(new StringBuilder().append("music/stage")
				     .append
				     (i).append
				     (".zip").toString(),
	...
	if (i == 27) {
	    if (this.gmode == 2)
		this.strack
		    = new RadicalMod("music/party.zip", 400, 7600, 125, false,
				     false);
	    else
		this.strack
		    = new RadicalMod(new StringBuilder().append
					 ("music/stage").append
					 (i).append
					 (".zip").toString(),
	...
	if (i < 0) {
		...
		if (i != -2)
		    this.strack
			= new RadicalMod(new StringBuilder().append
					     ("mystages/mymusic/").append
					     (string).append
					     (".zip").toString(),
					 i_52_, 8000, 125, false, false);
		else
		    this.strack
			= new RadicalMod(string, i_52_, 8000, 125, false,
					 true);
	    } else
	...
	if (this.forstart < 690) {
		...
		drawcs(90,
		       new StringBuilder().append("").append
			   ((640 - this.forstart) / 32).append
			   ("").toString(),
		       0, 0, 0, 0);
	    else
		drawcs(90, "Your connection to game may have been lost...", 0,
		       0, 0, 0);
	    this.rd.setFont(new Font("Arial", 1, 11));
	    this.ftm = this.rd.getFontMetrics();
	    if (this.tflk) {
	...
	if (this.fase != -2) {
		...
		if (!this.lan || this.im != 0) {
			...
			fs[2] = 1.0F;
		    this.rd
			.setColor(Color.getHSBColor(fs[0], fs[1], fs[2]));
		...
		if (bool) {
		    ...
		    if ((!this.lan
			 || this.im != 0)
			&& i > 403 && i < 442 && i_53_ > 362 && i_53_ < 379) {
			this.holdcnt = 600;
			this.exitm = 0;
			(control).chatup = 0;
		    }
		...
		if (this.lan && this.im == 0)
			...
			(140,
			 ...
			 0, 0, 0, 0);
		this.rd
		    .drawString("Continue watching this game?", 155, 375);
		if (i > 357 && i < 396 && i_53_ > 362 && i_53_ < 379) {
		    this.rd.setColor
			(new Color((this.m).csky[0],
				   (this.m).csky[1],
		...
		this.rd.setColor
		    (new Color((this.m).csky[0] / 2,
			       (this.m).csky[1] / 2,
			       (this.m).csky[2] / 2));
		if (!this.lan || this.im != 0)
		    this.rd.drawRoundRect(147, 357, 301, 27, 7,
							 20);
		else
		    this.rd.drawRoundRect(147, 357, 262, 27, 7,
							 20);
		...
		if (this.warning == 0
			...
			if (bool) {
			    if (this.mouson == 0) {
				if (i > 676 && i < 785 && i_53_ > 426 + i_56_
				    && i_53_ < 443 + i_56_
				    && ((control).chatup
					== i_57_ + 1)) {
				    bool_59_ = true;
			...
			if (bool_59_) {
				...
				if (!msgcheck(string)
				    ...
				    this.cnames[i_57_][6]
					= this.nickname;
				    if (this.pointc[i_57_]
					!= 6) {
					this.pointc[i_57_] = 6;
					this.floater[i_57_] = 1;
				    }
				    this.msgflk[i_57_] = 110;
				    if (this.updatec[i_57_]
					> -11)
					this.updatec[i_57_]
					    = -11;
				    else
			...
			if (bool_58_ || this.floater[i_57_] != 0
				...
				fs[2] = 1.0F;
			    this.rd.setColor
				(Color.getHSBColor(fs[0], fs[1], fs[2]));
			...
			if ((control).chatup != i_57_ + 1) {
				...
				for (int i_68_
					...
					this.msgflk[i_57_]--;
				    this.rd
					.setColor(new Color(0, i_65_, i_66_));
				    this.rd
					.setFont(new Font("Tahoma", 1, 11));
				    this.ftm
					= this.rd
					      .getFontMetrics();
				    if ((this.ftm.stringWidth
					 (new StringBuilder().append
					      (this.cnames
					       [i_57_][i_68_])
					      .append
		    ...
		    if (i > 775 && i < 794 && i_53_ > 409 - i_55_ * 23
			&& i_53_ < 423 - i_55_ * 23) {
	    ...
	    if (((control).arrace && this.starcnt < 38
		 && !this.holdit
		 && (checkpoints).stage != 10)
		|| this.multion >= 2) {
		if (this.alocked != -1
		...
		if (this.multion >= 2) {
			...
			if (this.cntflock == 100) {
			    for (int i_71_ = 0;
				 ...
				 i_71_++) {
				if (this.holdit) {
				    if ((checkpoints).pos[i_71_]
					== 0) {
					this.alocked = i_71_;
					this.im = i_71_;
				    }
				} else if (((checkpoints).dested
					    [i_71_])
					   == 0) {
				    this.alocked = i_71_;
				    this.im = i_71_;
		...
		for (int i_75_ = 0; i_75_ < i_74_; i_75_++) {
		    ...
		    for (int i_77_ = 0; i_77_ < this.nplayers;
			 i_77_++) {
			if ((checkpoints).pos[i_77_] == i_75_
			    && (checkpoints).dested[i_77_] == 0
			    && !bool_76_) {
			    ...
			    if (i_75_ == 0)
				this.rd
				    .drawString("1st", 673, 76 + 30 * i_75_);
			    if (i_75_ == 1)
				this.rd
				    .drawString("2nd", 671, 76 + 30 * i_75_);
			    if (i_75_ == 2)
				this.rd
				    .drawString("3rd", 671, 76 + 30 * i_75_);
			    if (i_75_ >= 3)
				this.rd.drawString
				    (new StringBuilder().append("").append
					 (i_75_ + 1).append
				...
				if (i_81_ < 0)
				    i_81_ = 0;
				this.rd
				    .setColor(new Color(i_82_, i_83_, i_81_));
				this.rd.drawString
				    (this.plnames[i_77_],
				     731 - (this.ftm.stringWidth
					    (this.plnames
					     [i_77_])) / 2,
				     70 + 30 * i_75_);
			    }
			    ...
			    this.rd.drawString
				(this.plnames[i_77_],
				 730 - ((this.ftm.stringWidth
					 (this.plnames[i_77_]))
					/ 2),
				 70 + 30 * i_75_);
			    int i_84_
				= (int) (60.0F * ((checkpoints)
						  .magperc[i_77_]));
			    int i_85_ = 244;
			    int i_86_ = 244;
			    i_81_ = 11;
				...
				i_81_ = 0;
			    this.rd
				.setColor(new Color(i_85_, i_86_, i_81_));
			    this.rd
				.fillRect(700, 74 + 30 * i_75_, i_84_, 5);
			    this.rd.setColor(new Color(0, 0,
								      0));
			    this.rd
				.drawRect(700, 74 + 30 * i_75_, 60, 5);
				...
				this.rd
				    .setColor(new Color(i_85_, i_86_, i_81_));
				this.rd
				    .drawRect(661, 58 + 30 * i_75_, 114, 25);
				this.rd
				    .drawRect(662, 59 + 30 * i_75_, 112, 23);
			    }
				...
				this.rd
				    .setColor(new Color(i_85_, i_86_, i_81_));
				this.rd
				    .drawRect(660, 57 + 30 * i_75_, 116, 27);
			    }
			    bool_76_ = true;
			}
		    }
		...
		for (int i_90_ = 0; i_90_ < this.nplayers;
			...
			i_89_++;
			if (((udpmistro).lframe[i_90_]
			     == (udpmistro).lcframe[i_90_])
			    || (udpmistro).force[i_90_] == 7)
			    i_88_++;
			else
			    (udpmistro).lcframe[i_90_]
				= (udpmistro).lframe[i_90_];
		    }
		}
		if (i_88_ == i_89_)
		    this.discon++;
	...
	if (i_54_ != -1) {
	    ...
	    if ((this.app).cmsg.getText()
		    .equals(this.lcmsg[i_54_]))
		this.cntchatp[i_54_]++;
	    else
		this.cntchatp[i_54_] = -200;
	    this.lcmsg[i_54_]
		= new StringBuilder().append("").append
		      ((this.app).cmsg.getText())
		      .toString();
	    if (this.cntchatp[i_54_] == 67)
		(control).chatup = 0;
	    if ((this.app).cmsg.getText().length()
		> 100) {
		(this.app).cmsg.setText
		    ((this.app).cmsg.getText()
			 .substring(0, 100));
	...
	if (i != this.im) {
		...
		drawcs(60, "Close Finish!  Almost got it!", i_95_, i_96_,
		       i_97_, 0);
	} else if (i_91_ == 229) {
	    if (this.discon != 240)
	...
	if (this.flipo == 3 || this.flipo == 5) {
	    if (this.flipo == 3) {
		this.rd
		    .drawString("Hello!  Welcome to the world of", 262, 67);
		this.rd.drawString("!", 657, 67);
		this.rd.drawImage(this.nfm, 469,
						 55, null);
		this.rd.drawString
		    ("In this game there are two ways to complete a stage.",
		     262, 107);
		this.rd.drawString
		    ("One is by racing and finishing in first place, the other is by",
		     262, 127);
		this.rd.drawString
		    ("wasting and crashing all the other cars in the stage!",
		     262, 147);
	    } else {
		this.rd.setColor(new Color(0, 128, 255));
		this.rd.drawString
		    ("While racing, you will need to focus on going fast and passing",
		     262, 67);
		this.rd.drawString
		    ("through all the checkpoints in the track. To complete a lap, you",
		     262, 87);
		this.rd
		    .drawString("must not miss a checkpoint.", 262, 107);
		this.rd.drawString
		    ("While wasting, you will just need to chase the other cars and",
		     262, 127);
		this.rd.drawString
		    ("crash into them (without worrying about track and checkpoints).",
		     262, 147);
	    }
	    this.rd.setColor(new Color(0, 0, 0));
	    ...
	    this.rd.setFont(new Font("Arial", 1, 13));
	    this.rd.drawString
		("Drive your car using the Arrow Keys and Spacebar", 125, 320);
	    ...
	    this.rd.setFont(new Font("Arial", 1, 11));
	    this.rd.drawString
		("(When your car is on the ground Spacebar is for Handbrake)",
		 125, 341);
	...
	if (this.flipo == 7 || this.flipo == 9) {
	    if (this.flipo == 7) {
		this.rd.drawString
		    ("Whether you are racing or wasting the other cars you will need",
		     262, 67);
		this.rd.drawString("to power up your car.", 262,
						  87);
		this.rd.drawString
		    ("=> More 'Power' makes your car become faster and stronger!",
		     262, 107);
		this.rd.drawString
		    ("To power up your car (and keep it powered up) you will need to",
		     262, 127);
		...
		this.rd.drawString
		    ("The better the stunt the more power you get!", 262, 67);
		this.rd.setColor(new Color(0, 128, 255));
		this.rd.drawString
		    ("Forward looping pushes your car forwards in the air and helps",
		     262, 87);
		this.rd.drawString
		    ("when racing. Backward looping pushes your car upwards giving it",
		     262, 107);
		this.rd.drawString
		    ("more hang time in the air making it easier to control its landing.",
		     262, 127);
		this.rd.drawString
		    ("Left and right rolls shift your car in the air left and right slightly.",
		     262, 147);
		if (this.aflk || this.dudo < 150)
		    this.rd.drawImage(this.chil,
						     167, 295, null);
	    }
	    this.rd.setColor(new Color(0, 0, 0));
	    ...
	    this.rd.setFont(new Font("Arial", 1, 13));
	    this.rd.drawString
		("To perform stunts. When your car is in the AIR:", 125, 310);
	    this.rd
		.drawString("Press combo Spacebar + Arrow Keys", 125, 330);
	...
	if (this.flipo == 11
	    ...
	    if (this.flipo == 11) {
		this.rd.drawString
		    ("When wasting cars, to help you find the other cars in the stage,",
		     262, 67);
		this.rd.drawString
		    ("press [ A ] to toggle the guidance arrow from pointing to the track",
		     262, 87);
		this.rd.drawString("to pointing to the cars.",
						  262, 107);
		this.rd.drawString
		    ("When your car is damaged. You fix it (and reset its 'Damage') by",
		     262, 127);
		this.rd.drawString
		    ("jumping through the electrified hoop.", 262, 147);
	    } else {
		this.rd.setColor(new Color(0, 128, 255));
		this.rd.drawString
		    ("You will find that in some stages it's easier to waste the other cars",
		     262, 67);
		this.rd.drawString
		    ("and in some others it's easier to race and finish in first place.",
		     262, 87);
		this.rd.drawString
		    ("It is up to you to decide when to waste and when to race.",
		     262, 107);
		this.rd.drawString
		    ("And remember, 'Power' is an important factor in the game. You",
		     262, 127);
		this.rd.drawString
		    ("will need it whether you are racing or wasting!", 262,
		     147);
	    }
	    this.rd.setColor(new Color(0, 0, 0));
	    ...
	    this.rd.drawString("The Electrified Hoop", 192,
					      216);
	    this.rd
		.drawString("Jumping through it fixes your car.", 158, 338);
	    this.rd
		.drawString("Make guidance arrow point to cars.", 385, 216);
	}
	if (this.flipo == 15) {
	    this.rd
		.drawString("And if you don\u2019t know who I am,", 262, 67);
	    this.rd.drawString
		("I am Coach Insano, I am the coach and narrator of this game!",
		 262, 87);
	    this.rd.drawString
		("I recommended starting with NFM 1 if it\u2019s your first time to play.",
		 262, 127);
	    ...
	    this.rd.drawImage(this.kx, 229, 229,
					     null);
	    this.rd
		.drawString("To look behind you while driving.", 267, 251);
	...
	if (this.flipo == 1
	    ...
	    if (this.flipo == 16)
		this.rd.drawString
		    ("M A I N    C O N T R O L S   -   once again!",
		     400 - ((this.ftm.stringWidth
			     ("M A I N    C O N T R O L S   -   once again!"))
			    / 2),
		     49);
		...
		this.rd.drawString
		    ("M A I N    C O N T R O L S",
		     400 - this.ftm
			       .stringWidth("M A I N    C O N T R O L S") / 2,
		     49);
	    this.rd
		.drawString("Drive your car using the Arrow Keys:", 125, 80);
	    this.rd.drawString
		("On the GROUND Spacebar is for Handbrake", 125, 101);
	    this.rd.drawImage(this.space, 171,
					     115, null);
	    this.rd.drawImage(this.arrows, 505,
					     83, null);
	    ...
	    this.rd.drawString
		("In the AIR press combo Spacebar + Arrow Keys", 125, 220);
	    this.rd.drawImage(this.space, 185,
					     245, null);
	    this.rd.drawImage(this.plus, 405,
					     248, null);
	...
	if (this.opselect == 0) {
		...
		this.rd.setColor(new Color(140, 70, 0));
		this.rd
		    .fillRect(358, 262 + this.dropf, 82, 22);
		this.aflk = false;
	    }
	    if (this.aflk) {
	...
	if (this.opselect == 1) {
		...
		this.rd.setColor(new Color(140, 70, 0));
		this.rd
		    .fillRect(358, 290 + this.dropf, 82, 22);
		this.aflk = false;
	    }
	    if (this.aflk) {
		this.rd.setColor(new Color(200, 64, 0));
	...
	if (this.opselect == 2) {
		...
		this.rd.setColor(new Color(140, 70, 0));
		this.rd
		    .fillRect(333, 318 + this.dropf, 132, 22);
		this.aflk = false;
	    }
	    if (this.aflk) {
	...
	if (this.multion == 0) {
	    (this.app).mycar
		.setLabel(" Include in this game.");
	    (this.app).mycar
		.setBackground(new Color(198, 179, 129));
	    (this.app).mycar
		.setForeground(new Color(0, 0, 0));
	    int i = 16;
	    if ((this.cd).lastload == 2)
		...
		float[] fs = new float[3];
		Color.RGBtoHSB((contos[i_100_]).fcol[0],
			       (contos[i_100_]).fcol[1],
			       (contos[i_100_]).fcol[2], fs);
		for (int i_101_ = 0; i_101_ < (contos[i_100_]).npl;
		     i_101_++) {
		    if (((contos[i_100_]).p[i_101_]).colnum
			== 1) {
			((contos[i_100_]).p[i_101_]).hsb[0]
			    = fs[0];
			((contos[i_100_]).p[i_101_]).hsb[1]
			    = fs[1];
			((contos[i_100_]).p[i_101_]).hsb[2]
			    = fs[2];
			((contos[i_100_]).p[i_101_]).oc[0]
			    = (contos[i_100_]).fcol[0];
			((contos[i_100_]).p[i_101_]).oc[1]
			    = (contos[i_100_]).fcol[1];
			((contos[i_100_]).p[i_101_]).oc[2]
			    = (contos[i_100_]).fcol[2];
		    }
		}
		Color.RGBtoHSB((contos[i_100_]).scol[0],
			       (contos[i_100_]).scol[1],
			       (contos[i_100_]).scol[2], fs);
		for (int i_102_ = 0; i_102_ < (contos[i_100_]).npl;
		     i_102_++) {
		    if (((contos[i_100_]).p[i_102_]).colnum
			== 2) {
			((contos[i_100_]).p[i_102_]).hsb[0]
			    = fs[0];
			((contos[i_100_]).p[i_102_]).hsb[1]
			    = fs[1];
			((contos[i_100_]).p[i_102_]).hsb[2]
			    = fs[2];
			((contos[i_100_]).p[i_102_]).oc[0]
			    = (contos[i_100_]).scol[0];
			((contos[i_100_]).p[i_102_]).oc[1]
			    = (contos[i_100_]).scol[1];
			((contos[i_100_]).p[i_102_]).oc[2]
			    = (contos[i_100_]).scol[2];
		    }
		}
		(contos[i_100_]).xy = 0;
	    }
	...
	if (this.flatrstart == 6) {
		...
		|| this.testdrive == 1
		|| this.testdrive == 2)
		this.rd.drawImage(this.carsbgc,
						 65, 25, null);
	    else
		this.rd.drawImage(this.carsbg,
						 65, 25, null);
	...
	this.rd.drawImage(this.selectcar, 321,
					 37, null);
	if (this.cfase == 3 || this.cfase == 7
	    || this.remi) {
	    if ((this.cd).lastload == 1)
		this.rd.drawImage(this.ycmc, 337,
						 58, null);
	    if ((this.cd).lastload == 2)
		this.rd.drawImage(this.yac, 323,
						 58, null);
	}
	if (this.cfase == 11) {
	    this.rd.setFont(new Font("Arial", 1, 13));
	    ...
	    if (i_105_ == 1)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Cars").toString();
	    if (i_105_ == 2)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Class A Cars").toString();
	    if (i_105_ == 3)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Class A & B Cars").toString();
	    if (i_105_ == 4)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Class B Cars").toString();
	    if (i_105_ == 5)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Class B & C Cars").toString();
	    if (i_105_ == 6)
		string
		    = new StringBuilder().append("").append(string_106_).append
			  (" Top 20 Class C Cars").toString();
	...
	if (this.cfase == 101) {
	    ...
	    drawcs(69,
		   new StringBuilder().append("").append
		       ((this.cd).viewname).append
		       ("'s account cars!").toString(),
		   220, 112, 33, 3);
	}
	if (!this.remi) {
	    this.rd.setRenderingHint((RenderingHints
	...
	if ((this.multion != 0
	    ...
	    for (int i_108_ = 0;
		 (i_108_ < (contos[this.sc[0]]).npl
		  && !bool_107_);
		 i_108_++) {
		if ((((contos[this.sc[0]]).p
			      [i_108_])).colnum
		    == 1) {
		    float[] fs = new float[3];
		    Color.RGBtoHSB
	    ...
	    Color color
		= Color.getHSBColor(this.arnp[0],
				    this.arnp[1],
				    1.0F - this.arnp[2]);
	    Color color_110_
		= Color.getHSBColor(this.arnp[3],
				    this.arnp[4],
				    1.0F - this.arnp[5]);
	    for (int i_111_ = 0;
	...
	if (this.flipo == 0) {
		...
		if (this.cfase == 3
		    ...
		    String string = "";
		    if (this.cfase == 11)
			string = new StringBuilder().append("N#").append
				     (this.sc[0] - 35).append
				     ("  ").toString();
		    if (this.aflk) {
			drawcs(95 + i_115_,
			...
			drawcs(95, new StringBuilder().append(string).append
				       ((this.cd)
					.names[this.sc[0]])
				       .toString(), 176, 176, 176, 3);
			this.aflk = true;
		...
		if (this.flatrstart == 6) {
		    ...
		    drawcs(375,
			   new StringBuilder().append
			       ("This car unlocks when stage ").append
			       (i_113_).append
		...
		if (this.flatrstart == 6) {
			...
			if ((this.cd).action
				...
				string
				    = new StringBuilder().append("").append
					  ...
					  (" Top 20 Class C Cars").toString();
			    drawprom(145, 170);
			    drawcs(195, new StringBuilder().append
					    ("[  Loading ").append
					    (string).append
					    ("  ]").toString(), 0, 0, 0, 3);
			    if ((this.cd).nl > 0
			...
			if ((this.cd).action == 0
				...
				if ((this.cd).action
				    == 14)
				    drawcs(91, "Weekly Top 20 Cars", 0, 0, 0,
					   3);
				if ((this.cd).action
				    == 15)
				    drawcs(91, "Monthly Top 20 Cars", 0, 0, 0,
					   3);
				if ((this.cd).action
				    == 16)
				    drawcs(91, "Semi-Annual Top 20 Cars", 0, 0,
					   0, 3);
				if ((this.cd).action
				    == 17)
				    drawcs(91, "Annual Top 20 Cars", 0, 0, 0,
					   3);
				if (drawcarb(true, null,
					     "   All Cars, All Classes   ",
					     318, 105, i, i_104_, bool)
				    && this.cntflock == 0) {
				    (this.cd)
					.loadlist
					= 1 + ((
			...
			if ((this.multion == 0
			     || this.onjoin == -1)
			    && drawcarb(false, this.top20s, "",
					i_121_,
					(i_121_ - 95) / 7 + 25 + i_122_, i,
					i_104_, bool)) {
			    (this.cd).action = 0;
			    this.cfase = 10;
			}
			...
			if ((this.cd).lastload
				...
				this.rd
				    .drawString("Created by You", 241, 160);
			}
			if (this.remi)
			    this.remi = false;
			if (this.noclass) {
			    ...
			    if (this.ontyp == 5)
				string = "Class A";
			    drawcs(230, new StringBuilder().append
					    ("You do not have a ").append
					    (string).append
					    (" car in your account cars.")
					    .toString(), 0, 0, 0, 3);
			...
			if ((this.cd).action == 1)
			    drawcs(195, "Logging in to your account...", 0, 0,
				   0, 3);
			if ((this.cd).action == 0) {
			    if ((this.cd).reco
				== -5)
				...
				&& (this.tcnt % 3 != 0
				    || this.tcnt > 20))
				drawcs(171, "Please enter your Nickname!", 0,
				       0, 0, 3);
			    if ((this.cd).reco == -4
				&& (this.tcnt % 3 != 0
				    || this.tcnt > 20))
				drawcs(171, "Please enter your Password!", 0,
				       0, 0, 3);
			    if (!this.showtf) {
				(this.app)
				    .tnick.show();
				...
				("Nickname:",
				 376 - this.ftm
					   .stringWidth("Nickname:") - 14,
				 201);
			    this.rd.drawString
				("Password:",
				 376 - this.ftm
					   .stringWidth("Password:") - 14,
				 231);
			    this.app.movefieldd
				((this.app).tnick,
				 376, 185, 129, 23, true);
			...
			this.rd.setColor(new Color(0, 0, 0));
			this.rd.drawString
			    ("Failed to find any ready car in your \u2018mycars\u2019 folder!",
			     215, 175);
			this.rd.drawString
			    ("Please \u2018Test Drive\u2019 your cars in the Car Maker to make",
			     215, 215);
			this.rd
			    .drawString("sure they are ready.", 215, 235);
			if (drawcarb(true, null, "   OK   ", 371, 255, i,
				     i_104_, bool))
			    this.cfase = 0;
		    }
			...
			this.rd.setColor(new Color(0, 0, 0));
			this.rd.drawString
			    ("The game will now load all the cars that can be loaded",
			     215, 170);
			this.rd.drawString
			    ("from your \u2018mycars\u2019 folder.", 215, 190);
			this.rd.drawString
			    ("If a car is not loaded, then it is not ready (not finished).",
			     215, 210);
			this.rd.drawString
			    ("Perform a \u2018Test Drive\u2019 on any car to see if it is ready or not.",
			     215, 230);
			this.rd.drawString
			    ("The maximum number of cars that can be loaded is  40 !",
			     215, 260);
		    ...
		    this.rd.fillRect((int) (536.0F
						    ...
						    7);
		    this.rd
			.drawImage(this.statbo, 162, 337, null);
		    this.rd
			.drawImage(this.statbo, 162, 352, null);
		    this.rd
			.drawImage(this.statbo, 162, 367, null);
		    this.rd
			.drawImage(this.statbo, 536, 337, null);
		    this.rd
			.drawImage(this.statbo, 536, 352, null);
		    this.rd
			.drawImage(this.statbo, 536, 367, null);
		    if (this.multion != 0
			|| this.testdrive == 1
			|| this.testdrive == 2) {
			this.rd.setFont(new Font("Arial", 1,
			...
			this.rd
			    .drawImage(this.brt, 137, 63, null);
			this.rd.drawString("Hue  | ", 647, 70);
			this.rd
			    .drawImage(this.brt, 687, 63, null);
			...
			for (int i_128_ = 0; i_128_ < 161; i_128_++) {
			    this.rd.setColor
				(Color.getHSBColor
				 ((float) ((double) (float) i_128_ * 0.00625),
				  1.0F, 1.0F));
			...
			for (int i_129_ = 0; i_129_ < 40; i_129_++) {
				...
				(Color.getHSBColor
				 (this.arnp[0],
				  (float) ((double) (float) i_129_ * 0.025),
				  1.0F - this.arnp[2]));
			...
			if (bool) {
				...
				this.mouson = -2;
				if (i > 119 && i < 163 && i_104_ > 222
				    && i_104_ < 232)
				    this.mouson = 1;
				if (i > 669 && i < 713 && i_104_ > 222
				    && i_104_ < 232)
				    this.mouson = 4;
				if (i > 98 && i < 122 && i_104_ > 69
				    && i_104_ < 241
				    && this.mouson == -2)
				    this.mouson = 0;
				if (i > 133 && i < 157 && i_104_ > 69
				    && i_104_ < 209
				    && this.mouson == -2)
				    this.mouson = 2;
				if (i > 648 && i < 672 && i_104_ > 69
				    && i_104_ < 241
				    && this.mouson == -2)
				    this.mouson = 3;
				if (i > 683 && i < 707 && i_104_ > 69
				    && i_104_ < 209
				    && this.mouson == -2)
				    this.mouson = 5;
			    }
			...
			if (this.mouson == 0
			    ...
			    this.arnp[(this
						      .mouson)]
				= (float) ((double) ((float) i_104_ - 75.0F)
					   * 0.00625);
			    if (this.mouson == 2
				|| this.mouson == 5) {
				if ((double) (this.arnp
		...
		if (!this.remi
		    ...
		    if (this.cfase == 11
			&& drawcarb(true, null, "Add to My Cars", 345, 385, i,
				    i_104_, bool)
			&& (this.cd).action == 0) {
			(this.cd).ac
			    = this.sc[0];
		...
		if (this.flipo == 10) {
		    ...
		    if (this.cfase == 3
			&& (this.cd).lastload == 2)
			(this.app).mcars.select
			    ((this.cd).names
			     [this.sc[0]]);
		    (contos[this.sc[0]]).z = 950;
		    (contos[this.sc[0]]).y
			= (-34
			   - (contos[this.sc[0]]).grat
			   - 1100);
		    (contos[this.sc[0]]).x = 0;
		    (contos[this.sc[0]]).zy = 0;
		}
	...
	if (this.cfase == 0 || this.cfase == 3
	    ...
	    if (this.cfase != 11
		&& this.cfase != 101 && i_113_ == 0
		&& this.flipo < 10
		&& ((control).handb || (control).enter)) {
		(this.m).crs = false;
		((this.app).mcars).show
		    = false;
		if (this.multion != 0) {
		...
		&& (control).enter) {
		this.tcnt = 0;
		if (!(this.app).tnick.getText
			 ().equals("")
		    && !(this.app).tpass.getText
			    ().equals("")) {
		    (this.app).tnick.hide();
		    (this.app).tpass.hide();
		    this.app.requestFocus();
	...
	if (this.plnames[i].indexOf("MadBot") == -1) {
		...
		if (((conto).p[i_132_]).colnum == 1) {
		    Color color
			= Color.getHSBColor(this.allrnp[i][0],
					    this.allrnp[i][1],
					    1.0F - (this.allrnp
						    [i][2]));
		...
		if (((conto).p[i_132_]).colnum == 2) {
		    Color color
			= Color.getHSBColor(this.allrnp[i][3],
					    this.allrnp[i][4],
					    1.0F - (this.allrnp
						    [i][5]));
		    ((conto).p[i_132_]).oc[0] = color.getRed();
	...
	int i_137_
	    = (241
	       + this.ftm.stringWidth(new StringBuilder().append
							 ("Created by :  ")
							 .append
							 (string).append
							 ("").toString())
	...
	if (i > i_137_ - 2 && i < i_137_ + i_136_ && i_134_ > 147
	    && i_134_ < 164) {
	    if (bool)
		bool_135_ = true;
	    if (this.waitlink != 1) {
	...
	if ((checkpoints).stage > 0) {
	    ...
	    if (i_143_ > 10)
		i_143_ -= 10;
	    string = new StringBuilder().append(" ").append(i_143_).append
			 ("!").toString();
	}
	if (this.multion < 3) {
	    if (this.winner) {
		this.rd.drawImage(this.congrd,
						 265, 87, null);
		drawcs(137,
		       new StringBuilder().append("You Won!  At Stage").append
			   (string).append
			   ("").toString(),
		       255, 161, 85, 3);
		drawcs(154, new StringBuilder().append("").append
				((checkpoints).name).append
				("").toString(), 255, 115, 0, 3);
		i_142_ = 154;
	    } else {
		...
		if (this.multion != 0
		    ...
		    drawcs(167, new StringBuilder().append
				    ("You Lost!  At Stage").append
				    (string).append
				    ("").toString(), 255, 161, 85, 3);
		    drawcs(184, new StringBuilder().append("").append
				    ((checkpoints).name).append
				    ("").toString(), 255, 115, 0, 3);
		    i_142_ = 184;
		}
	    ...
	    this.rd.drawImage(this.gameov, 315,
					     117, null);
	    drawcs(167, new StringBuilder().append
			    ("Finished Watching Game!  At Stage").append
			    (string).append
			    ("").toString(), 255, 161, 85, 3);
	    drawcs(184, new StringBuilder().append("").append
			    ((checkpoints).name).append
	...
	if (this.winner && this.multion == 0
		...
		if (this.aflk)
		    drawcs(200 + this.pin,
			   new StringBuilder().append("Stage ").append
			       ((checkpoints).stage + 1
				- (this.gmode - 1) * 10)
			       .append
			       (" is now unlocked!").toString(),
			   196, 176, 0, 3);
		else
		    drawcs(200 + this.pin,
			   new StringBuilder().append("Stage ").append
		...
		this.ftm
		    = this.rd.getFontMetrics();
		if (this.aflk)
		    drawcs(180, new StringBuilder().append
				    ("Woohoooo you finished NFM").append
				    (this.gmode).append
		...
		if (this.aflk)
		    drawcs(240, "You're truly a RADICAL GAMER!", 144, 167, 255,
			   3);
		else
		    drawcs(240, "You're truly a RADICAL GAMER!", 255, 100, 100,
			   3);
		this.rd.setColor(new Color(0, 0, 0));
		...
		if (this.radpx == 212) {
			...
			= this.rd.getFontMetrics();
		    if (this.aflk)
			drawcs(309, "A Game by Radicalplay.com", 144, 167, 255,
			       3);
		    else
			drawcs(309, "A Game by Radicalplay.com", 228, 240, 255,
			       3);
		}
		if (this.aflk)
	...
	if (this.multion != 0
	    && (checkpoints).stage == -2 && i_142_ != 0) {
	    drawcs(i_142_ + 17,
		   new StringBuilder().append("Created by: ").append
		       ((checkpoints).maker).append
		       ("").toString(),
		   255, 161, 85, 3);
		...
		if (this.dnload == 0
		    && drawcarb(true, null, " Add to My Stages ", 334, 317, i,
				i_141_, bool)) {
		    if (this.logged) {
			(this.cd).onstage
			    = (checkpoints).name;
		...
		if (this.dnload == 1) {
		    ...
		    int i_149_ = 400 - this.ftm
					   .stringWidth(string_148_) / 2;
		    int i_150_
			= (i_149_
			   + this.ftm.stringWidth(string_148_));
		    this.rd.drawString(string_148_, i_149_,
						      332);
		    if (this.waitlink != -1)
			this.rd.drawLine(i_149_, 334, i_150_,
							334);
		    if (i > i_149_ && i < i_150_ && i_141_ > 321
			&& i_141_ < 334) {
			if (this.waitlink != -1)
			    this.app.setCursor(new Cursor(12));
		...
		if (this.dnload == 3)
			...
			(332,
			 ...
			 193, 106, 0, 3);
		if (this.dnload == 4)
		    drawcs(332, "You already have this stage!", 193, 106, 0,
			   3);
		if (this.dnload == 5)
		    drawcs(332,
			   "Cannot add more then 20 stages to your account!",
	...
	if (i != 0) {
		...
		while (!bools[i_157_]) {
		    ...
		    this.sc[i_157_]
			= (int) (Math.random()
				 * (double) (24.0F + 8.0F * ((float) i / f)));
		    if (this.sc[i_157_] >= 16)
			this.sc[i_157_] -= 16;
		    bools[i_157_] = true;
			...
			f = 16.0F;
		    float f_159_
			= ((float) (15 - this.sc[i_157_])
			   / 15.0F * ((float) i / f));
		    if ((double) f_159_ > 0.8)
			f_159_ = 0.8F;
		    if (i == 17 && (double) f_159_ > 0.5)
			f_159_ = 0.5F;
		    if ((double) f_159_ > Math.random())
			bools[i_157_] = false;
		    if (this.gmode == 1) {
			if (this.sc[i_157_] >= 7
			    && this.sc[i_157_] <= 10)
			    bools[i_157_] = false;
			if (this.sc[i_157_] == 12
			    || this.sc[i_157_] == 13)
			    bools[i_157_] = false;
			if (this.sc[i_157_] > 5
			    && this.unlocked[0] <= 2)
			...
			if (this.sc[i_157_] > 6
			    && this.unlocked[0] <= 4)
			    bools[i_157_] = false;
			if (this.sc[i_157_] > 11
			    && this.unlocked[0] <= 6)
			    bools[i_157_] = false;
			if (this.sc[i_157_] > 14
			    && this.unlocked[0] <= 8)
			    bools[i_157_] = false;
		    }
		    if (this.gmode == 2) {
			if ((this.sc[i_157_] - 7) * 2
			    > this.unlocked[1])
			    bools[i_157_] = false;
			if (i == 16 && this.unlocked[1] == 16
			    && this.sc[i_157_] < 9)
			    bools[i_157_] = false;
		    }
		}
		...
		for (int i_161_ = 0; i_161_ < 7; i_161_++) {
		    if (this.sc[i_161_] == 11)
			bool_160_ = true;
		}
		if (!bool_160_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		    this.sc[i_155_] = 11;
		bool_160_ = false;
		for (int i_162_ = 0; i_162_ < 7; i_162_++) {
		    if (this.sc[i_162_] == 14)
			bool_160_ = true;
		}
		if (!bool_160_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		...
		for (int i_166_ = 0; i_166_ < 7; i_166_++) {
		    if (this.sc[i_166_] == 12)
			bool_165_ = true;
		}
		if (!bool_165_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		    this.sc[i_155_] = 12;
		bool_165_ = false;
		for (int i_167_ = 0; i_167_ < 7; i_167_++) {
		    if (this.sc[i_167_] == 10)
			bool_165_ = true;
		}
		if (!bool_165_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		...
		for (int i_169_ = 0; i_169_ < 7; i_169_++) {
		    if (this.sc[i_169_] == 11)
			bool_168_ = true;
		}
		if (!bool_168_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		    this.sc[i_155_] = 11;
		bool_168_ = false;
		for (int i_170_ = 0; i_170_ < 7; i_170_++) {
		    if (this.sc[i_170_] == 13)
			bool_168_ = true;
		}
		if (!bool_168_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		...
		for (int i_172_ = 0; i_172_ < 7; i_172_++) {
		    if (this.sc[i_172_] == 13)
			bool_171_ = true;
		}
		if (!bool_171_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		    this.sc[i_155_] = 13;
		bool_171_ = false;
		for (int i_173_ = 0; i_173_ < 7; i_173_++) {
		    if (this.sc[i_173_] == 12)
			bool_171_ = true;
		}
		if (!bool_171_ && (Math.random() > Math.random()
				   || this.gmode != 0))
		...
		for (int i_175_ = 0;
		    ...
		    if ((this.cd).include[i_175_]
			&& this.sc[0] != i_175_ + 16) {
			int i_177_;
			for (i_177_ = (int) (1.0
					     + Math.random() * (double) (i_152_
									 - 1));
			     bools[i_177_];
			     i_177_
				 = (int) (1.0
	...
	if (this.fase == 1) {
	    if (i_183_ == 1) {
		if (over(this.next[0], i, i_182_, 625, 135))
		    this.pnext = 1;
		if (over(this.back[0], i, i_182_, 115, 135))
		    this.pback = 1;
		if (over(this.contin[0], i, i_182_, 355, 360))
		    this.pcontin = 1;
	    }
	    if (i_183_ == 2) {
		if (this.pnext == 1)
	...
	if (this.fase == 3) {
	    if (i_183_ == 1
		&& over(this.contin[0], i, i_182_, 355, 350))
		this.pcontin = 1;
	...
	if (this.fase == 4) {
	    if (i_183_ == 1
		&& over(this.back[0], i, i_182_, 370, 345))
		this.pback = 1;
	...
	if (this.fase == 6) {
	    if (i_183_ == 1
		&& (over(this.star[0], i, i_182_, 359, 385)
		    || over(this.star[0], i, i_182_, 359, 295)))
		this.pstar = 2;
	...
	if (this.fase == 7) {
	    if (i_183_ == 1) {
		if (over(this.next[0], i, i_182_, 645, 275))
		    this.pnext = 1;
		if (over(this.back[0], i, i_182_, 95, 275))
		    this.pback = 1;
		if (over(this.contin[0], i, i_182_, 355, 385)
		    && !(this.app).openm)
		    this.pcontin = 1;
	    }
	    if (i_183_ == 2) {
	...
	if (this.fase == -5) {
	    ...
	    this.lym = i_182_;
	    if (i_183_ == 1
		&& over(this.contin[0], i, i_182_, 355, 380))
		this.pcontin = 1;
	    if (i_183_ == 2 && this.pcontin == 1) {
		(control).enter = true;
		this.pcontin = 0;
	...
	if (this.fase == 102) {
		...
		if (this.dropf == 0
		    && overon(348, 346, 102, 22, i, i_182_)) {
		    this.opselect = 3;
		    this.shaded = true;
		}
	    }
	...
	if (this.fase == 11) {
		...
		&& this.flipo <= 15) {
		if (i_183_ == 1
		    && over(this.next[0], i, i_182_, 665, 395))
		    this.pnext = 1;
		...
		&& this.flipo <= 16) {
		if (i_183_ == 1
		    && over(this.back[0], i, i_182_, 75, 395))
		    this.pback = 1;
		if (i_183_ == 2 && this.pback == 1) {
		    (control).left = true;
		    this.pback = 0;
	...
	if (this.fase != -2) {
		...
		if (bool_184_) {
		    ...
		    if (this.clangame == 4
			&& !string.toLowerCase().equals(this
							    .gaclan
							    .toLowerCase())) {
			bool_186_ = true;
			string_187_
			    = new StringBuilder().append("Clan ").append
				  (string_185_).append
				  (" wasted, nobody won becuase ").append
				  (string).append
		...
		for (int i = 0; i < this.nplayers; i++) {
			...
			if (this.clangame == 3) {
			    ...
			    string_187_
				= new StringBuilder().append("").append
				      (this.plnames[i]).append
				      (" of clan ").append
				      (this.pclan[i]).append
				      (" finished first, nobody won becuase this is a wasting only game!")
				      .toString();
			}
			if (this.clangame == 4
			    && (this.pclan[i].toLowerCase()
				    .equals
				(this.gaclan.toLowerCase()))) {
			    bool_186_ = true;
			    string_187_
				= new StringBuilder().append("").append
				      (this.plnames[i]).append
		...
		if (!this.holdit
			...
			drawcs(120,
			       new StringBuilder().append("Your clan ").append
				   (string).append
				   (" has wasted all the cars!").toString(),
			       0, 0, 0, 0);
			this.aflk = false;
		    } else {
			drawcs(120,
		...
		if (!this.holdit && (mad).dest
		    ...
		    if (this.fase == 7001
			&& (this.nplayers
			    - ((checkpoints).wasted + 1)) >= 2
			&& this.discon != 240 && !bool_188_)
			this.exitm = 4;
		    else {
			if (this.exitm == 4)
			    this.exitm = 0;
		...
		if (!this.holdit) {
			...
			if (((checkpoints).clear[i]
			    ...
			    } else if (this.pclan[i].toLowerCase
					   ().equals
				       (this.pclan
					    [this.im]
					    .toLowerCase())) {
		...
		if (!this.holdit) {
			...
			if (((checkpoints).clear[i]
				...
				drawcs(120, new StringBuilder().append
						("Clan ").append
						(this.pclan[i])
						.append
						(" finished first, race over!")
		...
		if (!this.holdit) {
			...
			if (!this.lan)
			    ...
			    drawcs(412, "Press [V] to change view.", 0, 0, 0,
				   0);
		    }
		}
	    }
		...
		if ((checkpoints).stage != 10
			...
			this.wasay = true;
			this.say
			    = " Arrow now pointing at >  CARS";
			if (this.multion == 1) {
			    StringBuilder stringbuilder = new StringBuilder();
			    xtGraphics var_xtGraphics_190_ = this;
			    (var_xtGraphics_190_).say
				= stringbuilder.append
				      ((var_xtGraphics_190_).say)
				      .append
				      ("    Press [S] to toggle Radar!")
				      .toString();
			}
			this.tcnt = -5;
		    }
			...
			this.wasay = false;
			this.say
			    = " Arrow now pointing at >  TRACK";
			if (this.multion == 1) {
			    StringBuilder stringbuilder = new StringBuilder();
			    xtGraphics var_xtGraphics_191_ = this;
			    (var_xtGraphics_191_).say
				= stringbuilder.append
				      ((var_xtGraphics_191_).say)
				      .append
				      ("    Press [S] to toggle Radar!")
		...
		if (!this.holdit
			...
			if (this.auscnt == 45
				...
				if ((mad).missedcp > 15
				    && (mad).missedcp < 50) {
				    if (this.flk)
					drawcs(70, "Checkpoint Missed!", 255,
					       0, 0, 0);
				    else
					drawcs(70, "Checkpoint Missed!", 255,
					       150, 0, 2);
		    ...
		    } else if (this.alocked
			       != this.lalocked) {
			if (this.alocked != -1) {
			    this.wasay = true;
			    this.say
				= new StringBuilder().append
				      (" Arrow Locked on >  ").append
				      (this.plnames
				       [this.alocked])
				      .append
				      ("").toString();
		...
		this.rd.drawString
		    (new StringBuilder().append("").append
			 ((checkpoints).wasted).append
			 (" / ").append
			 (this.nplayers - 1).append
			 ("").toString(),
		     150, 18);
		this.rd.drawImage(this.pos, 42,
						 27, null);
		this.rd.drawImage((this.rank
						  [((checkpoints)
						    .pos[(mad).im])]),
						 110, 28, null);
		drawstat(((this.cd).maxmag
			  [(mad).cn]),
			 (mad).hitmag, (mad).newcar,
			 (mad).power);
		if ((control).radar
		    && (checkpoints).stage != 10)
		...
		if ((mad).power < 45.0F) {
			...
			if (this.looped != 2) {
				...
				drawcs
				    (110,
				     new StringBuilder().append
					 ("Please read the Game Instructions!")
					 .append
					 (string_192_).append
					 ("").toString(),
				     0, 0, 200, 0);
		...
		if ((mad).capcnt == 0) {
			...
			if (this.exitm == 0) {
				...
				if (!this.wasay)
				    drawcs(105, this.say, 0,
					   128, 255, 0);
				else
				    drawcs(105, this.say, 255,
					   128, 0, 0);
				this.tflk = true;
			    }
			}
		...
		if ((mad).trcnt == 10) {
			...
			if ((mad).ftab && (mad).btab)
			    this.loop
				= "Tabletop and reversed Tabletop";
			else if ((mad).ftab || (mad).btab)
			    this.loop = "Tabletop";
		    }
		    if (i > 0 && (mad).btab)
			this.loop
			    = new StringBuilder().append("Hanged ").append
				  (this.loop).toString();
		    if (i < 0 && (mad).ftab)
			this.loop
			    = new StringBuilder().append("Hanged ").append
			...
			if (this.loop == ""
				...
				= stringbuilder.append
				      ...
				      (i).toString();
			    if (bool_194_) {
				StringBuilder stringbuilder_196_
				    = new StringBuilder();
				xtGraphics var_xtGraphics_197_ = this;
				(var_xtGraphics_197_).asay
				    = stringbuilder_196_.append
					  ((var_xtGraphics_197_)
					   .asay)
					  .append
					  (" and beyond").toString();
				...
				= stringbuilder.append
				      ...
				      (i).toString();
			    if (bool_194_) {
				StringBuilder stringbuilder_201_
				    = new StringBuilder();
				xtGraphics var_xtGraphics_202_ = this;
				(var_xtGraphics_202_).asay
				    = stringbuilder_201_.append
					  ((var_xtGraphics_202_)
					   .asay)
					  .append
					  (" and beyond").toString();
		...
		if (this.multion >= 2
			...
			this.wasay = false;
			this.say
			    = new StringBuilder().append("Now following ")
				  .append
				  (this.plnames
				   [this.alocked])
				  .append
	...
	int i_211_ = 11;
	if (i_208_ > 33)
	    i_210_ = (int) (244.0F - 233.0F * ((float) (i_208_ - 33) / 65.0F));
	if (i_208_ > 70) {
	    if (this.dmcnt < 10) {
		if (this.dmflk) {
		    i_210_ = 170;
	    ...
	    this.dmcnt++;
	    if ((double) this.dmcnt
		> 167.0 - (double) i_208_ * 1.5)
		this.dmcnt = 0;
	}
	i_209_
	    += ((float) i_209_
		* ((float) (this.m).snap[0] / 100.0F));
	if (i_209_ > 255)
	    i_209_ = 255;
	if (i_209_ < 0)
	    i_209_ = 0;
	...
	if ((this.m).darksky) {
	    Color color = new Color((this.m).csky[0],
				    (this.m).csky[1],
				    (this.m).csky[2]);
	    float[] fs = new float[3];
	    Color.RGBtoHSB((this.m).csky[0],
	    ...
	    color = Color.getHSBColor(fs[0], fs[1], fs[2]);
	    this.rd.setColor(color);
	    this.rd.fillRoundRect
		(390 - image.getWidth(this.ob) / 2, i - 2,
		 image.getWidth(this.ob) + 20,
		 image.getHeight(this.ob) + 2, 7, 20);
	    this.rd.setColor
		(new Color((int) ((double) color.getRed() / 1.1),
			   (int) ((double) color.getGreen() / 1.1),
			   (int) ((double) color.getBlue() / 1.1)));
	    this.rd.drawRoundRect
		(390 - image.getWidth(this.ob) / 2, i - 2,
		 image.getWidth(this.ob) + 20,
		 image.getHeight(this.ob) + 2, 7, 20);
	}
	this.rd.drawImage
	    (image, 400 - image.getWidth(this.ob) / 2, i, null);
    }
	...
	if (!bool) {
	    int i_225_ = 0;
	    if (((checkpoints).x[i]
		 - (checkpoints).opx[this.im])
		>= 0)
		i_225_ = 180;
	    i_224_ = (int) ((double) (90 + i_225_)
			    + ((Math.atan
				((double) ((checkpoints).z[i]
					   - ((checkpoints).opz
					      [this.im]))
				 / (double) ((checkpoints).x[i]
					     - ((checkpoints).opx
						[this.im]))))
		...
		for (int i_229_ = 0; i_229_ < this.nplayers;
			...
			&& ((py(((checkpoints).opx
			    ...
			    || i_227_ == -1)
			&& (!bool_228_
			    || ((checkpoints).onscreen[i_229_]
				!= 0))
			&& (checkpoints).dested[i_229_] == 0) {
			i_226_ = i_229_;
			i_227_
			    = py(((checkpoints).opx
				  [this.im]) / 100,
		...
		i_226_ = this.alocked;
	    int i_230_ = 0;
	    if (((checkpoints).opx[i_226_]
		 - (checkpoints).opx[this.im])
		>= 0)
		i_230_ = 180;
	    i_224_
		= (int) ((double) (90 + i_230_)
			 + ((Math.atan
			     ((double) ((checkpoints).opz[i_226_]
					- ((checkpoints).opz
					   [this.im]))
			      / (double) (((checkpoints).opx
					   [i_226_])
					  - ((checkpoints).opx
					     [this.im]))))
			    / 0.017453292519943295));
		...
		drawcs(13, "[                                ]", 76, 67, 240,
		       0);
		drawcs(13, ((this.cd).names
			    [this.sc[i_226_]]), 0, 0, 0, 0);
	    } else {
		this.rd.setFont(new Font("Arial", 1, 12));
		this.ftm
		    = this.rd.getFontMetrics();
	...
	if (Math.abs(this.ana - i_224_) < 180) {
	    if (Math.abs(this.ana - i_224_) < 10)
		this.ana = i_224_;
	    else if (this.ana < i_224_)
		this.ana += 10;
	    else
		this.ana -= 10;
	} else {
	...
	if (!bool) {
		...
		int i_234_ = 0;
		if (i_216_ <= 0) {
		    if (i_224_ <= 45 && i_216_ != -2
			&& this.cntan == 0) {
			i_232_ = (i_232_ * i_224_
				  + ((this.m).csky[0]
				     * (45 - i_224_))) / 45;
			i_233_ = (i_233_ * i_224_
				  + ((this.m).csky[1]
				     * (45 - i_224_))) / 45;
			i_234_ = (i_234_ * i_224_
				  + ((this.m).csky[2]
				     * (45 - i_224_))) / 45;
		    }
		    if (i_224_ >= 90) {
		...
		is_217_[i_237_]
		    = ys(is_217_[i_237_], is_218_[i_237_]) + i_236_;
	    }
	    int i_238_
		= (int) (159.0F
			 + (159.0F
	...
	for (int i = 0; i < (checkpoints).n; i++) {
		...
		= { (int) (96.0F
		    ...
		    (int) (96.0F
			   - ((float) (((checkpoints).opx
					[this.im])
				       - (checkpoints).x[i_241_])
			      / (checkpoints).prox)) };
	    int[] is_242_
		= { (int) (141.0F - ((float) ((checkpoints).z[i]
					      - ((checkpoints)
						 .opz[this.im]))
				     / (checkpoints).prox)),
		    (int) (141.0F
			   - ((float) ((checkpoints).z[i_241_]
				       - ((checkpoints).opz
					  [this.im]))
			      / (checkpoints).prox)) };
	...
	int i_251_ = 0;
	if (this.clangame != 0) {
	    if (this.pclan[this.im].toLowerCase
	...
	this.rd.setColor
	    (new Color((i + (this.m).csky[0]) / 2,
		       ((this.m).csky[1] + i_250_) / 2,
		       ((i_251_ + (this.m).csky[2])
			/ 2)));
	...
	this.lcarz = (conto).z;
	float f
	    = (float) Math.sqrt((double) (i_252_ * i_252_ + i_254_ * i_254_));
	...
	if ((this.fase == 0 || this.fase == 7001)
	    && this.starcnt < 35
	    && this.cntwis != 8 && !this.mutes) {
	    boolean bool
		= ((control).up && (mad).speed > 0.0F
		   || (control).down && (mad).speed < 10.0F);
	    boolean bool_257_
		= ((mad).skid == 1 && (control).handb
		   || Math.abs((mad).scz[0]
			       - (((mad).scz[1] + (mad).scz[0]
				   + (mad).scz[2] + (mad).scz[3])
				  / 4.0F)) > 1.0F
		...
		this.pwait = 15;
		if (!(mad).mtouch && !this.grrd
		    && (double) this.m.random() > 0.4) {
		    this.air
			[(int) (this.m.random() * 4.0F)].loop();
		    this.stopcnt = 5;
		    this.grrd = true;
		}
	...
	if ((mad).newcar)
	    this.cntwis = 0;
	if (this.fase == 0 || this.fase == 7001
	    || this.fase == 6 || this.fase == -1
	    || this.fase == -2 || this.fase == -3
	    || this.fase == -4
	    || this.fase == -5) {
	...
	if (this.bfcrash == 0 && this.bfskid == 0
	    && f > 150.0F) {
	    if (i == 0) {
		if (!this.mutes)
	...
	if (this.bfscrape == 0
	    && (Math.sqrt((double) (i * i + i_266_ * i_266_ + i_267_ * i_267_))
		/ 10.0) > 10.0) {
	    int i_268_ = 0;
	    if (this.m.random()
		> this.m.random())
	...
	if ((this.bfsc1 == 0 || this.bfsc2 == 0)
	    && (Math.sqrt((double) (i * i + i_269_ * i_269_ + i_270_ * i_270_))
		/ 10.0) > 15.0) {
	    if (this.bfsc1 == 0) {
		if (!this.mutes) {
		    this.scrape[2].stop();
	...
	if (i_279_ < 50)
	    i_279_ = 50;
	return (((i_279_ - (this.m).focus_point)
		 * ((this.m).cx - i) / i_279_)
		+ i);
    }
	...
	if (i_280_ < 50)
	    i_280_ = 50;
	return (((i_280_ - (this.m).focus_point)
		 * ((this.m).cy - i) / i_280_)
		+ i);
    }
    
    public int py(int i, int i_281_, int i_282_, int i_283_) {
	return ((i - i_281_) * (i - i_281_)
		+ (i_282_ - i_283_) * (i_282_ - i_283_));
    }
    
    public float pys(int i, int i_284_, int i_285_, int i_286_) {
	return (float) Math.sqrt((double) ((i - i_284_) * (i - i_284_)
					   + (i_285_ - i_286_) * (i_285_
								  - i_286_)));
    }
	...
	for (int i_287_ = 0; i_287_ < 8; i_287_++)
	    this.rank[i_287_]
		= loadsnap(this.orank[i_287_]);
	for (int i_288_ = 0; i_288_ < 4; i_288_++)
	    this.cntdn[i_288_]
		= loadsnap(this.ocntdn[i_288_]);
	if (this.multion != 0) {
	    this.wgame = loadsnap(this.owgame);
	    this.exitgame
		= loadsnap(this.oexitgame);
	    this.gamefinished
		= loadsnap(this.ogamefinished);
	    this.disco = loadsnap(this.odisco);
	}
	this.yourwasted
	    = loadsnap(this.oyourwasted);
	this.youlost = loadsnap(this.oyoulost);
	this.youwon = loadsnap(this.oyouwon);
	this.youwastedem
	    = loadsnap(this.oyouwastedem);
	this.gameh = loadsnap(this.ogameh);
	this.loadingmusic
	    = loadopsnap(this.oloadingmusic, i, 76);
	this.star[0]
	    = loadopsnap(this.ostar[0], i, 0);
	this.star[1]
	    = loadopsnap(this.ostar[1], i, 0);
	this.flaot
	    = loadopsnap(this.oflaot, i, 1);
    }
    
    public boolean overon(int i, int i_289_, int i_290_, int i_291_,
			  int i_292_, int i_293_) {
	return (i_292_ > i && i_292_ < i + i_290_ && i_293_ > i_289_
	...
	return (i > i_295_ - 5 && i < i_295_ + i_298_ + 5
		&& i_294_ > i_296_ - 5 && i_294_ < i_296_ + i_297_ + 5);
    }
	...
	if (!this.badmac) {
		...
		PixelGrabber pixelgrabber
		    = new PixelGrabber(image, 0, 0, 800, 450,
				       this.flexpix, 0, 800);
		try {
		...
		if (i_300_ == 0) {
		    ...
		    i_309_ = (int) (((float) color.getRed()
				     + (float) i_301_ * 0.38F * (float) i)
				    / (1.0F + 0.38F * (float) i));
		    i_301_ = i_309_;
		    i_310_ = (int) (((float) color.getGreen()
				     + (float) i_302_ * 0.38F * (float) i)
				    / (1.0F + 0.38F * (float) i));
		    i_302_ = i_310_;
		    i_311_ = (int) (((float) color.getBlue()
				     + (float) i_303_ * 0.38F * (float) i)
				    / (1.0F + 0.38F * (float) i));
		    i_303_ = i_311_;
		}
		if (++i_300_ == 800)
		    i_300_ = 0;
		int i_312_
		    = (int) ((float) (i_309_ * 17 + i_310_ + i_311_ + i_304_)
			     / 21.0F);
		int i_313_
		    = (int) ((float) (i_310_ * 17 + i_309_ + i_311_ + i_304_)
			     / 22.0F);
		int i_314_
		    = (int) ((float) (i_311_ * 17 + i_309_ + i_310_ + i_304_)
			     / 24.0F);
		if (--i_305_ == 0) {
	    ...
	    this.fleximg
		= createImage(new MemoryImageSource(800, 450,
						    (this
						     .flexpix),
						    0, 800));
	    this.rd.drawImage(this.fleximg, 0, 0,
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_316_, i, is, 0, i_316_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	for (int i_317_ = 0; i_317_ < i_316_ * i; i_317_++) {
	    ...
	    if (color_318_.getRed() != color_318_.getGreen()
		&& color_318_.getGreen() != color_318_.getBlue()) {
		int i_319_
		    = (int) ((float) color_318_.getRed()
			     + ((float) color_318_.getRed()
				* ((float) ((this.m)
					    .snap[0])
				   / 100.0F)));
		if (i_319_ > 255)
		...
		if (i_319_ < 0)
		    i_319_ = 0;
		int i_320_
		    = (int) ((float) color_318_.getGreen()
			     + ((float) color_318_.getGreen()
				* ((float) ((this.m)
					    .snap[1])
				   / 100.0F)));
		if (i_320_ > 255)
		...
		if (i_320_ < 0)
		    i_320_ = 0;
		int i_321_
		    = (int) ((float) color_318_.getBlue()
			     + ((float) color_318_.getBlue()
				* ((float) ((this.m)
					    .snap[2])
				   / 100.0F)));
		if (i_321_ > 255)
		...
		int i_322_
		    = (int) ((float) (color.getRed() - color_318_.getRed())
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_325_, i_324_, is, 0, i_325_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	for (int i_329_ = 0; i_329_ < i_325_ * i_324_; i_329_++) {
		...
		if (i_323_ == 1 && is[i_329_] == i_326_) {
		    i_332_ = (int) (237.0F
				    - 237.0F * ((float) is_327_[0] / 150.0F));
		    if (i_332_ > 255)
			i_332_ = 255;
		    if (i_332_ < 0)
			i_332_ = 0;
		    i_333_ = (int) (237.0F
				    - 237.0F * ((float) is_327_[1] / 150.0F));
		    if (i_333_ > 255)
			i_333_ = 255;
		    if (i_333_ < 0)
			i_333_ = 0;
		    i_334_ = (int) (237.0F
				    - 237.0F * ((float) is_327_[2] / 150.0F));
		    if (i_334_ > 255)
			i_334_ = 255;
		    if (i_334_ < 0)
			i_334_ = 0;
			...
			= (int) ((float) color.getRed()
				 - (float) color.getRed() * ((float) is_327_[0]
							     / 100.0F));
		    if (i_332_ > 255)
			i_332_ = 255;
		    if (i_332_ < 0)
			i_332_ = 0;
		    i_333_ = (int) ((float) color.getGreen()
				    - ((float) color.getGreen()
				       * ((float) is_327_[1] / 100.0F)));
		    if (i_333_ > 255)
			i_333_ = 255;
		    if (i_333_ < 0)
			i_333_ = 0;
		    i_334_ = (int) ((float) color.getBlue()
				    - ((float) color.getBlue()
				       * ((float) is_327_[2] / 100.0F)));
		    if (i_334_ > 255)
			i_334_ = 255;
		    if (i_334_ < 0)
			i_334_ = 0;
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_337_, i, is, 0, i_337_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	Image image_339_
	    = createImage(new MemoryImageSource(i_337_, i, is, 0, i_337_));
	return image_339_;
    }
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_340_, i, is, 0, i_340_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	Image image_342_
	    = createImage(new MemoryImageSource(i_340_, i, is, 0, i_340_));
	return image_342_;
    }
	...
	if (!this.badmac) {
	    ...
	    PixelGrabber pixelgrabber
		= new PixelGrabber(image, 0, 0, 800, 450, is, 0, 800);
	    try {
		pixelgrabber.grabPixels();
	    } catch (InterruptedException interruptedexception) {
		/* empty */
		...
		int i_347_;
		if (i_345_ == 0) {
		    i_347_ = (color.getRed() + color.getGreen()
			      + color.getBlue()) / 3;
		    i_344_ = i_347_;
		} else {
		    i_347_ = (color.getRed() + color.getGreen()
			      + color.getBlue() + i_344_ * 30) / 33;
		    i_344_ = i_347_;
		}
		if (++i_345_ == 800)
		    i_345_ = 0;
	    ...
	    this.fleximg
		= createImage(new MemoryImageSource(800, 450, is, 0, 800));
	    this.rd.drawImage(this.fleximg, 0, 0,
					     null);
	} else {
	    this.rd.setColor(new Color(0, 0, 0));
	...
	try {
		...
		= (new URL
		   (new StringBuilder().append
			("http://c.statcounter.com/9994681/0/14bb645e/1/?reco=")
			.append
			(i).append
			("").toString()));
	...
	Image image
	    = Toolkit.getDefaultToolkit().createImage(new StringBuilder()
							  .append
							  ("").append
							  (Madness.fpath)
							  .append
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_364_, i, is_365_, 0, i_364_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	for (int i_366_ = 0; i_366_ < i_364_ * i; i_366_++) {
	    ...
	    if (color.getGreen() > color.getRed() + 5
		&& color.getGreen() > color.getBlue() + 5) {
		int i_367_ = (int) (255.0F - (float) (color.getGreen()
						      - ((color.getRed()
							  + color.getBlue())
							 / 2)) * 1.5F);
		if (i_367_ > 255)
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_369_, i_368_, is_370_, 0,
			       i_369_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	...
	if (i == 2) {
	    ...
	    int i_373_ = (0x40000000 | color.getRed() << 16
			  | color.getGreen() << 8 | color.getBlue());
	    color = new Color(is_370_[1]);
	    int i_374_ = (~0x7fffffff | color.getRed() << 16
			  | color.getGreen() << 8 | color.getBlue());
	...
	if (i == 2) {
	    ...
	    image_376_
		= createImage(new MemoryImageSource(i_369_, i_368_, is_370_, 0,
						    i_369_));
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, i_378_, i, is, 0, i_378_);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	    /* empty */
	...
	Image image_384_
	    = createImage(new MemoryImageSource(i_378_, i, is, 0, i_378_));
	return image_384_;
    }
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(image, 0, 0, 466, 202,
			       this.smokey, 0, 466);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	...
	PixelGrabber pixelgrabber
	    = new PixelGrabber(this.carsbg, 0, 0, 670, 400, is,
			       0, 670);
	try {
	    pixelgrabber.grabPixels();
	} catch (InterruptedException interruptedexception) {
	...
	PixelGrabber pixelgrabber_388_
	    = new PixelGrabber(image, 0, 0, 92, 225, is_387_, 0, 92);
	try {
	...
	PixelGrabber pixelgrabber_390_
	    = new PixelGrabber(image_386_, 0, 0, 88, 24, is_389_, 0, 88);
	try {
	...
	for (int i = 0; i < 670; i++) {
		...
		if (i > 14 && i < 106 && i_391_ > 11 && i_391_ < 236
		    ...
		    Color color_392_
			= new Color(is_387_[i - 14 + (i_391_ - 11) * 92]);
		    int i_393_ = (int) ((double) color.getRed() * 0.33
					+ (double) color_392_.getRed() * 0.67);
		    if (i_393_ > 255)
			i_393_ = 255;
		    if (i_393_ < 0)
			i_393_ = 0;
		    int i_394_
			= (int) ((double) color.getGreen() * 0.33
				 + (double) color_392_.getGreen() * 0.67);
		    if (i_394_ > 255)
			i_394_ = 255;
		    if (i_394_ < 0)
			i_394_ = 0;
		    int i_395_
			= (int) ((double) color.getBlue() * 0.33
				 + (double) color_392_.getBlue() * 0.67);
		    if (i_395_ > 255)
			i_395_ = 255;
		    if (i_395_ < 0)
			i_395_ = 0;
		...
		if (i > 564 && i < 656 && i_391_ > 11 && i_391_ < 236
		    ...
		    Color color = new Color(is[i + i_391_ * 670]);
		    Color color_397_
			= new Color(is_387_[i - 564 + (i_391_ - 11) * 92]);
		    int i_398_ = (int) ((double) color.getRed() * 0.33
					+ (double) color_397_.getRed() * 0.67);
		    if (i_398_ > 255)
			i_398_ = 255;
		    if (i_398_ < 0)
			i_398_ = 0;
		    int i_399_
			= (int) ((double) color.getGreen() * 0.33
				 + (double) color_397_.getGreen() * 0.67);
		    if (i_399_ > 255)
			i_399_ = 255;
		    if (i_399_ < 0)
			i_399_ = 0;
		    int i_400_
			= (int) ((double) color.getBlue() * 0.33
				 + (double) color_397_.getBlue() * 0.67);
		    if (i_400_ > 255)
			i_400_ = 255;
		    if (i_400_ < 0)
			i_400_ = 0;
		...
		if (i > 440 && i < 528 && i_391_ > 53 && i_391_ < 77
		    ...
		    Color color = new Color(is[i + i_391_ * 670]);
		    Color color_402_
			= new Color(is_389_[i - 440 + (i_391_ - 53) * 88]);
		    int i_403_ = (int) ((double) color.getRed() * 0.33
					+ (double) color_402_.getRed() * 0.67);
		    if (i_403_ > 255)
			i_403_ = 255;
		    if (i_403_ < 0)
			i_403_ = 0;
		    int i_404_
			= (int) ((double) color.getGreen() * 0.33
				 + (double) color_402_.getGreen() * 0.67);
		    if (i_404_ > 255)
			i_404_ = 255;
		    if (i_404_ < 0)
			i_404_ = 0;
		    int i_405_
			= (int) ((double) color.getBlue() * 0.33
				 + (double) color_402_.getBlue() * 0.67);
		    if (i_405_ > 255)
			i_405_ = 255;
		    if (i_405_ < 0)
			i_405_ = 0;
	...
	this.carsbgc
	    = createImage(new MemoryImageSource(670, 400, is, 0, 670));
    }
	...
	if (!this.badmac) {
	    this.flatr = 0;
	    this.flyr
		= (int) (this.m.random() * 160.0F - 80.0F);
	    this.flyrdest
		= (int) ((float) this.flyr
			 + this.m.random() * 160.0F - 80.0F);
	    this.flang = 1;
	    this.flexpix = new int[268000];
	    PixelGrabber pixelgrabber
		= new PixelGrabber(this.carsbg, 0, 0, 670, 400,
				   this.flexpix, 0, 670);
	    try {
		pixelgrabber.grabPixels();
	    } catch (InterruptedException interruptedexception) {
	...
	if (!this.badmac) {
		...
		for (int i_407_ = 0; i_407_ < 202; i_407_++) {
		    if (this.smokey[i + i_407_ * 466]
			!= this.smokey[0]) {
			float f
			    = pys(i, 233, i_407_, this.flyr);
			int i_408_
			    = (int) ((float) (i - 233) / f
				     * (float) this.flatr);
			int i_409_
			    = (int) ((float) (i_407_
				     ...
				     / f * (float) this.flatr);
			int i_410_
			    = i + i_408_ + 100 + (i_407_ + i_409_ + 110) * 670;
			if (i + i_408_ + 100 < 670 && i + i_408_ + 100 > 0
			    && i_407_ + i_409_ + 110 < 400
			    && i_407_ + i_409_ + 110 > 0 && i_410_ < 268000
			    && i_410_ >= 0) {
			    Color color = new Color(this.flexpix
						    [i_410_]);
			    Color color_411_
				= new Color(this.smokey
					    [i + i_407_ * 466]);
			    float f_412_
				= ((255.0F - (float) color_411_.getRed())
				   / 255.0F);
			    float f_413_
				= ((255.0F - (float) color_411_.getGreen())
				   / 255.0F);
			    float f_414_
				= ((255.0F - (float) color_411_.getBlue())
				   / 255.0F);
			    int i_415_
				= (int) ((((float) color.getRed()
					   * ((float) this.flang
					      * f_412_))
					  + ((float) color_411_.getRed()
					     * (1.0F - f_412_)))
					 / (((float) this.flang
					     * f_412_)
					    + (1.0F - f_412_)));
				...
				i_417_ = 0;
			    Color color_418_
				= new Color(i_415_, i_416_, i_417_);
			    this.flexpix[i_410_]
				= color_418_.getRGB();
			}
		    }
	    ...
	    this.flang += 2;
	    this.flatr
		+= 10 + this.flatrstart * 2;
	    Image image
		= createImage(new MemoryImageSource(670, 400,
						    (this
						     .flexpix),
						    0, 670));
	...
	for (bool_422_ = false; i < string.length() && !bool_422_; i++) {
	    if (!bool_421_) {
		string_419_
		    = new StringBuilder().append(string_419_).append("").append
			  (string.charAt(i)).toString();
		bool_421_ = true;
	    } else {
		bool_421_ = false;
		if (!string_420_.equals("")
		    && !string_420_.equals(new StringBuilder().append("")
					       .append
					       (string.charAt(i)).toString()))
		    bool_422_ = true;
		string_420_ = new StringBuilder().append("").append
				  (string.charAt(i)).toString();
	    }
	}
	if (!bool_422_) {
	...
	if (bool) {
	    ...
	    i_435_ = image.getWidth(this.ob);
	int i_436_ = 0;
	if (i_430_ > i && i_430_ < i + i_435_ + 14 && i_431_ > i_429_
	    && i_431_ < i_429_ + 28) {
	    i_436_ = 1;
	    if (bool_432_)
		bool_433_ = true;
	...
	if (bool) {
		...
		this.rd.drawString(string, i + 7, i_429_ + 19);
	} else
	    this.rd.drawImage(image, i + 7, i_429_ + 7, null);
	return bool_433_;
    }
	...
	try {
		...
		string_441_ = new StringBuilder().append("").append
				  (string.charAt(i_438_)).toString();
		if (string_441_.equals("|")) {
		    ...
		    string_442_
			= new StringBuilder().append(string_442_).append
			      (string_441_).toString();
		    i_440_ = 1;
		}
	    }
	...
	try {
		...
		string_447_ = new StringBuilder().append("").append
				  (string.charAt(i_444_)).toString();
		if (string_447_.equals("|")) {
		    ...
		    string_448_
			= new StringBuilder().append(string_448_).append
			      (string_447_).toString();
		    i_446_ = 1;
		}
	    }
