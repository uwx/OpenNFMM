...
public class GameSparker extends JPanel implements KeyListener, MouseListener, MouseMotionListener, ActionListener {
    ...
    public void cropit(final Graphics2D graphics2d, final int i, final int i_98_) {
        ...
        if (i != 0)
            if (i < 0) {
                ...
                graphics2d.fillRect(apx + (int) (800.0F * apmult), apy - (int) (25.0F * apmult), i, (int) (500.0F * apmult));
            }
        if (i_98_ != 0)
            if (i_98_ < 0) {
                graphics2d.fillRect(apx - (int) (25.0F * apmult), apy + i_98_, (int) (850.0F * apmult), Math.abs(i_98_));
            } else {
                graphics2d.fillRect(apx - (int) (25.0F * apmult), apy + (int) (450.0F * apmult), (int) (850.0F * apmult), i_98_);
            }
    }
    ...
    public void loadbase(final ContO[] contos, final Medium medium, final Trackers trackers, final xtGraphics var_xtGraphics, final boolean bool) {
    ...
    public void loadstage(final ContO[] contos, final ContO[] contos_108_, final Medium medium, final Trackers trackers, final CheckPoints checkpoints, final xtGraphics var_xtGraphics, final Mad[] mads, final Record record) {
        ...
        try {
            ...
            if (var_xtGraphics.multion == 0 && checkpoints.stage != -2) {
                ...
                if (checkpoints.stage == -1) {
                    string_112_ = new StringBuilder().append("mystages/").append(checkpoints.name).append("").toString();
                }
                final File file = new File(new StringBuilder().append("").append(Madness.fpath).append("").append(string_112_).append(".txt").toString());
                ...
                String string_113_ = new StringBuilder().append("http://multiplayer.needformadness.com/tracks/").append(checkpoints.name).append(".radq").toString();
            ...
            while ((string_123_ = datainputstream.readLine()) != null) {
                ...
                if (string.startsWith("set")) {
                    ...
                    if (bool) {
                        ...
                        i_124_ += partskips - 10;
                        contos[nob] = new ContO(contos_108_[i_124_], getint("set", string, 1), medium.ground - contos_108_[i_124_].grat, getint("set", string, 2), getint("set", string, 3));
                ...
                if (string.startsWith("chk")) {
                    ...
                    contos[nob] = new ContO(contos_108_[i_125_], getint("chk", string, 1), i_126_, getint("chk", string, 2), getint("chk", string, 3));
                ...
                if (checkpoints.nfix != 5 && string.startsWith("fix")) {
                    ...
                    i_127_ += partskips - 10;
                    contos[nob] = new ContO(contos_108_[i_127_], getint("fix", string, 1), getint("fix", string, 3), getint("fix", string, 2), getint("fix", string, 4));
                ...
                if (string.startsWith("maxl")) {
                    ...
                    for (int i_135_ = 0; i_135_ < i_132_; i_135_++) {
                        contos[nob] = new ContO(contos_108_[29 + partskips], i_133_, medium.ground - contos_108_[29 + partskips].grat, i_135_ * 4800 + i_134_, 180);
                        nob++;
                    }
                    trackers.y[trackers.nt] = -5000;
                    trackers.rady[trackers.nt] = 7100;
                ...
                if (string.startsWith("maxt")) {
                    ...
                    for (int i_139_ = 0; i_139_ < i_136_; i_139_++) {
                        contos[nob] = new ContO(contos_108_[29 + partskips], i_139_ * 4800 + i_138_, medium.ground - contos_108_[29 + partskips].grat, i_137_, 90);
                        nob++;
                    }
                    trackers.y[trackers.nt] = -5000;
                    trackers.rady[trackers.nt] = 7100;
                ...
                if (string.startsWith("maxb")) {
                    ...
                    for (int i_143_ = 0; i_143_ < i_140_; i_143_++) {
                        contos[nob] = new ContO(contos_108_[29 + partskips], i_143_ * 4800 + i_142_, medium.ground - contos_108_[29 + partskips].grat, i_141_, -90);
                        nob++;
                    }
                    trackers.y[trackers.nt] = -5000;
                    trackers.rady[trackers.nt] = 7100;
        ...
        if (checkpoints.stage != -3) {
            ...
            for (int i_145_ = 0; i_145_ < var_xtGraphics.nplayers; i_145_++) {
                ...
                contos[i_145_] = new ContO(contos_108_[var_xtGraphics.sc[i_145_]], var_xtGraphics.xstart[i_145_], 250 - contos_108_[var_xtGraphics.sc[i_145_]].grat, var_xtGraphics.zstart[i_145_], 0);
            ...
            if (checkpoints.stage > 0) {
                ...
                var_xtGraphics.asay = new StringBuilder().append("Stage ").append(i_146_).append(":  ").append(checkpoints.name).append(" ").toString();
            } else {
    ...
    public boolean loadstagePreview(final int i, final String string, final ContO[] contos, final ContO[] contos_147_, final Medium medium, final CheckPoints checkpoints) {
        boolean bool = true;
        if (i < 100) {
            checkpoints.stage = i;
            if (checkpoints.stage < 0) {
        ...
        try {
            ...
            if (checkpoints.stage > 0) {
                ...
                String string_154_ = new StringBuilder().append("http://multiplayer.needformadness.com/tracks/").append(checkpoints.name).append(".radq").toString();
            ...
            while ((string_164_ = datainputstream.readLine()) != null) {
                ...
                if (string_153_.startsWith("snap")) {
                    medium.setsnap(getint("snap", string_153_, 0), getint("snap", string_153_, 1), getint("snap", string_153_, 2));
                }
                if (string_153_.startsWith("sky")) {
                    medium.setsky(getint("sky", string_153_, 0), getint("sky", string_153_, 1), getint("sky", string_153_, 2));
                }
                if (string_153_.startsWith("ground")) {
                    medium.setgrnd(getint("ground", string_153_, 0), getint("ground", string_153_, 1), getint("ground", string_153_, 2));
                }
                if (string_153_.startsWith("polys")) {
                    medium.setpolys(getint("polys", string_153_, 0), getint("polys", string_153_, 1), getint("polys", string_153_, 2));
                }
                if (string_153_.startsWith("fog")) {
                    medium.setfade(getint("fog", string_153_, 0), getint("fog", string_153_, 1), getint("fog", string_153_, 2));
                }
                if (string_153_.startsWith("texture")) {
                    medium.setexture(getint("texture", string_153_, 0), getint("texture", string_153_, 1), getint("texture", string_153_, 2), getint("texture", string_153_, 3));
                }
                if (string_153_.startsWith("clouds")) {
                    medium.setcloads(getint("clouds", string_153_, 0), getint("clouds", string_153_, 1), getint("clouds", string_153_, 2), getint("clouds", string_153_, 3), getint("clouds", string_153_, 4));
                }
                ...
                if (string_153_.startsWith("set")) {
                    ...
                    i_165_ += partskips - 10;
                    contos[nob] = new ContO(contos_147_[i_165_], getint("set", string_153_, 1), medium.ground - contos_147_[i_165_].grat, getint("set", string_153_, 2), getint("set", string_153_, 3));
                    contos[nob].t.nt = 0;
                ...
                if (string_153_.startsWith("chk")) {
                    ...
                    contos[nob] = new ContO(contos_147_[i_166_], getint("chk", string_153_, 1), i_167_, getint("chk", string_153_, 2), getint("chk", string_153_, 3));
                    checkpoints.x[checkpoints.n] = getint("chk", string_153_, 1);
                    checkpoints.z[checkpoints.n] = getint("chk", string_153_, 2);
                ...
                if (string_153_.startsWith("fix")) {
                    ...
                    i_168_ += partskips - 10;
                    contos[nob] = new ContO(contos_147_[i_168_], getint("fix", string_153_, 1), getint("fix", string_153_, 3), getint("fix", string_153_, 2), getint("fix", string_153_, 4));
    ...
    public void movefieldd(final JTextField JTextField, int i, int i_102_, final int i_103_, final int i_104_, final boolean bool) {
        if (applejava) {
            if (bool)
                if (xm > i && xm < i + i_103_ && ym > i_102_ && ym < i_102_ + i_104_ || !JTextField.getText().equals("")) {
        ...
        try {
            ...
            if (strings[1].startsWith("lastcar")) {
                ...
                if (i_198_ == 6 && var_xtGraphics.osc >= 0 && var_xtGraphics.osc <= 15) {
                    final Color color = Color.getHSBColor(var_xtGraphics.arnp[0], var_xtGraphics.arnp[1], 1.0F - var_xtGraphics.arnp[2]);
                    final Color color_200_ = Color.getHSBColor(var_xtGraphics.arnp[3], var_xtGraphics.arnp[4], 1.0F - var_xtGraphics.arnp[5]);
    ...
    public void gameTick() {
            ...
            if (var_xtGraphics.starcnt < 38) {
                if (var_xtGraphics.multion == 1) {
                    ...
                    if (view == 0) {
                        ...
                        var_xtGraphics.stat(mads[var_xtGraphics.im], contos_0_[var_xtGraphics.im], checkpoints, u[0], true);
                    ...
                    if (view == 1) {
                        ...
                        var_xtGraphics.stat(mads[var_xtGraphics.im], contos_0_[var_xtGraphics.im], checkpoints, u[0], false);
                        mvect = 80;
                    }
                    if (view == 2) {
        ...
        if (var_xtGraphics.fase == -4) {
            if (i_6_ == 0) {
                ...
                if (var_xtGraphics.winner && var_xtGraphics.multion == 0 && var_xtGraphics.gmode != 0 && checkpoints.stage != xtGraphics.nTracks && checkpoints.stage == var_xtGraphics.unlocked) {
                    var_xtGraphics.unlocked++;
                    setcarcookie(var_xtGraphics.sc[0], cardefine.names[var_xtGraphics.sc[0]], var_xtGraphics.arnp, var_xtGraphics.gmode, var_xtGraphics.unlocked, false);
                    var_xtGraphics.unlocked--;
                }
            }
            if (i_6_ <= 0) {
    ...
    public void setcarcookie(final int i, final String string, final float[] fs, final int i_191_, final int is, final boolean bool) {
        try {
            final File file = new File(new StringBuilder().append("").append(Madness.fpath).append("data/user.data").toString());
            final String[] strings = {
                    "", "", "", "", ""
            ...
            if (i_191_ == 0) {
                strings[1] = new StringBuilder().append("lastcar(").append(i).append(",").append((int) (fs[0] * 100.0F)).append(",").append((int) (fs[1] * 100.0F)).append(",").append((int) (fs[2] * 100.0F)).append(",").append((int) (fs[3] * 100.0F)).append(",").append((int) (fs[4] * 100.0F)).append(",").append((int) (fs[5] * 100.0F)).append(",").append(string).append(")").toString();
            }
