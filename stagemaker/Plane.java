...
public class Plane
{
    ...
    public Plane(Medium medium, Trackers trackers, int[] is, int[] is_0_, int[] is_1_, int i, int[] is_2_, int i_3_, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_, boolean bool, int i_11_, boolean bool_12_) {
        ...
        if (i_4_ == -15) {
            ...
            for (int i_19_ = 0; i_19_ < n; i_19_++) {
                if (Math.random() > Math.random())
                    ox[i_19_] += (int) (8.0 * Math.random() - 4.0);
                if (Math.random() > Math.random())
                    oy[i_19_] += (int) (8.0 * Math.random() - 4.0);
                if (Math.random() > Math.random())
                    oz[i_19_] += (int) (8.0 * Math.random() - 4.0);
            }
        }
        ...
        if (i_3_ == 0) {
            for (int i_20_ = 0; i_20_ < 3; i_20_++) {
                c[i_20_] = (int) ((float) is_2_[i_20_] + (float) is_2_[i_20_] * ((float) (m).snap[i_20_] / 100.0F));
                if (c[i_20_] > 255)
                    c[i_20_] = 255;
                if (c[i_20_] < 0)
                    c[i_20_] = 0;
        ...
        if (i_3_ == 2) {
            for (int i_22_ = 0; i_22_ < 3; i_22_++)
                c[i_22_] = (int) ((float) (m).crgrnd[i_22_] * 0.925F);
        }
        if (i_3_ == 3) {
        ...
        if (!nocol && glass != 1) {
            if (bfase > 20 && (double) hsb[1] > 0.25)
                hsb[1] = 0.25F;
            if (bfase > 25 && (double) hsb[2] > 0.7)
                hsb[2] = 0.7F;
            if (bfase > 30 && (double) hsb[1] > 0.15)
                hsb[1] = 0.15F;
            if (bfase > 35 && (double) hsb[2] > 0.6)
                hsb[2] = 0.6F;
            if (bfase > 40)
                hsb[0] = 0.075F;
            if (bfase > 50 && (double) hsb[2] > 0.5)
                hsb[2] = 0.5F;
            if (bfase > 60)
                hsb[0] = 0.05F;
        }
    ...
    public void deltafntyp() {
        ...
        for (int i_26_ = 0; i_26_ < 3; i_26_++) {
            for (int i_27_ = 0; i_27_ < 3; i_27_++) {
                if (i_27_ != i_26_)
                    deltaf *= (float) (Math.sqrt((double) ((ox[i_27_] - ox[i_26_]) * (ox[i_27_] - ox[i_26_]) + (oy[i_27_] - oy[i_26_]) * (oy[i_27_] - oy[i_26_]) + (oz[i_27_] - oz[i_26_]) * (oz[i_27_] - oz[i_26_]))) / 100.0);
            }
        }
        deltaf = deltaf / 3.0F;
    }
    ...
    public void loadprojf() {
        ...
        for (int i = 0; i < 3; i++) {
            for (int i_28_ = 0; i_28_ < 3; i_28_++) {
                if (i_28_ != i)
                    projf *= (float) (Math.sqrt((double) ((ox[i] - ox[i_28_]) * (ox[i] - ox[i_28_]) + (oz[i] - oz[i_28_]) * (oz[i] - oz[i_28_]))) / 100.0);
            }
        }
        projf = projf / 3.0F;
    }
    ...
    public void d(Graphics2D graphics2d, int i, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, boolean bool, int i_36_) {
        ...
        if (embos == 0) {
            ...
            if (embos <= 11 && (double) m.random() > 0.5 && glass != 1) {
                for (int i_41_ = 0; i_41_ < n; i_41_++) {
                    is[i_41_] = (int) ((float) (ox[i_41_] + i) + (15.0F - m.random() * 30.0F));
                    is_38_[i_41_] = (int) ((float) (oy[i_41_] + i_29_) + (15.0F - m.random() * 30.0F));
                    is_37_[i_41_] = (int) ((float) (oz[i_41_] + i_30_) + (15.0F - m.random() * 30.0F));
                }
            ...
            if (embos >= 16) {
                ...
                int i_51_ = (int) ((double) (Math.abs(is[0] - is[1]) / 3) * (0.5 - (double) m.random()));
                int i_52_ = (int) ((double) (Math.abs(is_37_[0] - is_37_[1]) / 3) * (0.5 - (double) m.random()));
                is[2] = (is[0] + is[1]) / 2 + i_51_;
                is_37_[2] = (is_37_[0] + is_37_[1]) / 2 + i_52_;
                int i_53_ = (int) ((double) (Math.abs(is[0] - is[1]) + Math.abs(is_37_[0] - is_37_[1])) / 1.5 * ((double) (m.random() / 2.0F) + 0.5));
                ...
                int i_55_ = (int) (255.0F + 255.0F * ((float) (m).snap[0] / 400.0F));
                if (i_55_ > 255)
                    i_55_ = 255;
                if (i_55_ < 0)
                    i_55_ = 0;
                int i_56_ = (int) (169.0F + 169.0F * ((float) (m).snap[1] / 300.0F));
                if (i_56_ > 255)
                    i_56_ = 255;
                if (i_56_ < 0)
                    i_56_ = 0;
                int i_57_ = (int) (89.0F + 89.0F * ((float) (m).snap[2] / 200.0F));
                if (i_57_ > 255)
                    i_57_ = 255;
                if (i_57_ < 0)
                    i_57_ = 0;
                ...
                i_55_ = (int) (255.0F + 255.0F * ((float) (m).snap[0] / 400.0F));
                if (i_55_ > 255)
                    i_55_ = 255;
                if (i_55_ < 0)
                    i_55_ = 0;
                i_56_ = (int) (207.0F + 207.0F * ((float) (m).snap[1] / 300.0F));
                if (i_56_ > 255)
                    i_56_ = 255;
                if (i_56_ < 0)
                    i_56_ = 0;
                i_57_ = (int) (136.0F + 136.0F * ((float) (m).snap[2] / 200.0F));
                if (i_57_ > 255)
                    i_57_ = 255;
                if (i_57_ < 0)
                    i_57_ = 0;
            ...
            for (int i_59_ = 0; i_59_ < n; i_59_++) {
                if (typ == 1)
                    is[i_59_] = (int) ((float) ox[i_59_] * f + (float) i);
                else
                    is[i_59_] = ox[i_59_] + i;
                if (typ == 2)
                    is_38_[i_59_] = (int) ((float) oy[i_59_] * f + (float) i_29_);
                else
                    is_38_[i_59_] = oy[i_59_] + i_29_;
                if (typ == 3)
                    is_37_[i_59_] = (int) ((float) oz[i_59_] * f + (float) i_30_);
                else
        ...
        if (wz != 0)
            rot(is_38_, is_37_, wy + i_29_, wz + i_30_, i_35_, n);
        if (wx != 0)
            rot(is, is_37_, wx + i, wz + i_30_, i_34_, n);
        if (chip == 1 && ((double) m.random() > 0.6 || bfase == 0)) {
            chip = 0;
            if (bfase == 0 && nocol)
                bfase = 1;
        }
        if (chip != 0) {
            if (chip == 1) {
                ...
                cxy = i_32_;
                czy = i_33_;
                int i_60_ = (int) (m.random() * (float) n);
                cox[0] = ox[i_60_];
                coz[0] = oz[i_60_];
                coy[0] = oy[i_60_];
                if (ctmag > 3.0F)
                ...
                if (ctmag < -3.0F)
                    ctmag = -3.0F;
                cox[1] = (int) ((float) cox[0] + ctmag * (10.0F - m.random() * 20.0F));
                cox[2] = (int) ((float) cox[0] + ctmag * (10.0F - m.random() * 20.0F));
                coy[1] = (int) ((float) coy[0] + ctmag * (10.0F - m.random() * 20.0F));
                coy[2] = (int) ((float) coy[0] + ctmag * (10.0F - m.random() * 20.0F));
                coz[1] = (int) ((float) coz[0] + ctmag * (10.0F - m.random() * 20.0F));
                coz[2] = (int) ((float) coz[0] + ctmag * (10.0F - m.random() * 20.0F));
                dx = 0;
                dy = 0;
                dz = 0;
                if (bfase != -7) {
        ...
        if ((i_32_ != 0 || i_33_ != 0 || i_31_ != 0) && (m).trk != 2) {
            ...
            for (int i_70_ = 0; i_70_ < 3; i_70_++) {
                for (int i_71_ = 0; i_71_ < 3; i_71_++) {
                    if (i_71_ != i_70_)
                        projf *= (float) (Math.sqrt((double) ((is[i_70_] - is[i_71_]) * (is[i_70_] - is[i_71_]) + (is_37_[i_70_] - is_37_[i_71_]) * (is_37_[i_70_] - is_37_[i_71_]))) / 100.0);
                }
            }
            projf = projf / 3.0F;
        }
        ...
        if (i_89_ == n || i_87_ == n || i_88_ == n || i_90_ == n)
            bool_84_ = false;
        if ((m).trk == 1 && (i_89_ != 0 || i_87_ != 0 || i_88_ != 0 || i_90_ != 0))
            bool_84_ = false;
        if (i_91_ != 0)
            bool = true;
        if (bool_84_ && i_36_ != -1) {
            ...
            if (i_93_ == 0 || i_94_ == 0)
                bool_84_ = false;
            else if (i_93_ < 3 && i_94_ < 3 && (i_36_ / i_93_ > 15 && i_36_ / i_94_ > 15 || bool) && (!(m).lightson || light == 0))
                bool_84_ = false;
        }
        if (bool_84_) {
            int i_97_ = 1;
            ...
            av = (int) Math.sqrt((double) (((m).cy - i_110_) * ((m).cy - i_110_) + ((m).cx - i_111_) * ((m).cx - i_111_) + i_112_ * i_112_ + i_98_ * i_98_ * i_98_));
            ...
            if (master == 2 && av > 1500 && !(m).crs)
                bool_84_ = false;
            if ((gr == -14 || gr == -15 || gr == -12) && (av > 11000 || bool_72_ || i_97_ == -111 || (m).resdown == 2) && (m).trk != 2 && (m).trk != 3)
                bool_84_ = false;
            if (gr == -11 && av > 11000 && (m).trk != 2 && (m).trk != 3)
                bool_84_ = false;
            if (glass == 2 && ((m).trk != 0 || av > 6700))
                bool_84_ = false;
            if (flx != 0 && (double) m.random() > 0.3 && flx != 77)
                bool_84_ = false;
        }
        if (bool_84_) {
            float f = (float) ((double) (projf / deltaf) + 0.3);
            if (bool && !solo) {
            ...
            if (!bool) {
                if (flx == 0) {
                    ...
                    if (flx == 1) {
                        i_114_ = 0;
                        i_115_ = (int) (223.0F + 223.0F * ((float) (m).snap[1] / 100.0F));
                        if (i_115_ > 255)
                            i_115_ = 255;
                        if (i_115_ < 0)
                            i_115_ = 0;
                        i_116_ = (int) (255.0F + 255.0F * ((float) (m).snap[2] / 100.0F));
                        if (i_116_ > 255)
                            i_116_ = 255;
                        if (i_116_ < 0)
                            i_116_ = 0;
                    ...
                    if (flx == 3) {
                        i_114_ = 0;
                        i_115_ = (int) (255.0F + 255.0F * ((float) (m).snap[1] / 100.0F));
                        if (i_115_ > 255)
                            i_115_ = 255;
                        if (i_115_ < 0)
                            i_115_ = 0;
                        i_116_ = (int) (223.0F + 223.0F * ((float) (m).snap[2] / 100.0F));
                        if (i_116_ > 255)
                            i_116_ = 255;
                        if (i_116_ < 0)
                            i_116_ = 0;
    ...
    public void s(Graphics2D graphics2d, int i, int i_120_, int i_121_, int i_122_, int i_123_, int i_124_, int i_125_) {
        ...
        int i_129_ = (int) ((double) (float) (m).crgrnd[0] / 1.5);
        int i_130_ = (int) ((double) (float) (m).crgrnd[1] / 1.5);
        int i_131_ = (int) ((double) (float) (m).crgrnd[2] / 1.5);
        ...
        if (i_125_ == 0) {
            ...
            for (int i_147_ = (t).sect[i_145_][i_146_].length - 1; i_147_ >= 0; i_147_--) {
                int i_148_ = (t).sect[i_145_][i_146_][i_147_];
                int i_149_ = 0;
                if (Math.abs((t).zy[i_148_]) != 90 && Math.abs((t).xy[i_148_]) != 90 && (t).rady[i_148_] != 801 && Math.abs(i_143_ - ((t).x[i_148_] - (m).x)) < (t).radx[i_148_] && Math.abs(i_144_ - ((t).z[i_148_] - (m).z)) < (t).radz[i_148_] && (!(t).decor[i_148_] || (m).resdown != 2))
                    i_149_++;
                if (i_149_ != 0) {
                    for (int i_150_ = 0; i_150_ < n; i_150_++) {
                        is_127_[i_150_] = (t).y[i_148_] - (m).y;
                        if ((t).zy[i_148_] != 0)
                            is_127_[i_150_] += (float) (is_126_[i_150_] - ((t).z[i_148_] - (m).z - (t).radz[i_148_])) * m.sin((t).zy[i_148_]) / m.sin(90 - (t).zy[i_148_]) - (float) (t).radz[i_148_] * m.sin((t).zy[i_148_]) / m.sin(90 - (t).zy[i_148_]);
                        if ((t).xy[i_148_] != 0)
                            is_127_[i_150_] += (float) (is[i_150_] - ((t).x[i_148_] - (m).x - (t).radx[i_148_])) * m.sin((t).xy[i_148_]) / m.sin(90 - (t).xy[i_148_]) - (float) (t).radx[i_148_] * m.sin((t).xy[i_148_]) / m.sin(90 - (t).xy[i_148_]);
                    }
                    i_129_ = (int) ((double) (float) (t).c[i_148_][0] / 1.5);
                    i_130_ = (int) ((double) (float) (t).c[i_148_][1] / 1.5);
                    i_131_ = (int) ((double) (float) (t).c[i_148_][2] / 1.5);
                    break;
                }
            }
        }
        ...
        if (i_125_ == 2) {
            ...
            for (int i_153_ = 0; i_153_ < (m).nsp; i_153_++) {
                for (int i_154_ = 0; i_154_ < n; i_154_++) {
                    if (Math.abs(is[i_154_] - (m).spx[i_153_]) < (m).sprad[i_153_] && Math.abs(is_126_[i_154_] - (m).spz[i_153_]) < (m).sprad[i_153_])
                        bool = false;
                }
            }
        }
    ...
    public void rot(int[] is, int[] is_163_, int i, int i_164_, int i_165_, int i_166_) {
        if (i_165_ != 0) {
            for (int i_167_ = 0; i_167_ < i_166_; i_167_++) {
                ...
                is[i_167_] = i + (int) ((float) (i_168_ - i) * m.cos(i_165_) - (float) (i_169_ - i_164_) * m.sin(i_165_));
                is_163_[i_167_] = i_164_ + (int) ((float) (i_168_ - i) * m.sin(i_165_) + (float) (i_169_ - i_164_) * m.cos(i_165_));
            }
        }
    }
    
    public int spy(int i, int i_170_) {
        return (int) Math.sqrt((double) ((i - (m).cx) * (i - (m).cx) + i_170_ * i_170_));
    }
}
