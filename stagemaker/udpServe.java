            ...
            for (;;) {
                ...
                for (int i_11_ = 0; i_11_ < (um).nplayers; i_11_++) {
                    if (i_11_ != im) {
                        ...
                        String string_15_ = new StringBuilder().append("").append(string_0_).append("|").append(i_11_).append("|").append((um).frame[i_11_][i_12_]).append("|").append((um).info[i_11_][i_12_]).append("|").toString();
