...
/* udpServe - Decompiled by JODE extended
 * DragShot Software
...
public class udpServe implements Runnable
{
    ...
    public void run() {
        try {
            ...
            for (;;) {
                DatagramPacket datagrampacket = new DatagramPacket(is, is.length);
                ...
                if (i == this.im && this.im < (this.um).nplayers && (this.um).out[i] != 76) {
                    int i_1_ = getvalue(string, 2);
                    int i_2_ = 0;
                    for (int i_3_ = 0; i_3_ < 3; i_3_++) {
                        if (i_1_ != (this.um).frame[i][i_3_])
                            i_2_++;
                    }
                    if (i_2_ == 3) {
                        for (int i_4_ = 0; i_4_ < 3; i_4_++) {
                            if (i_1_ > (this.um).frame[i][i_4_]) {
                                for (int i_5_ = 2; i_5_ >= i_4_ + 1; i_5_--) {
                                    (this.um).frame[i][i_5_] = (this.um).frame[i][i_5_ - 1];
                                    (this.um).info[i][i_5_] = (this.um).info[i][i_5_ - 1];
                                }
                                (this.um).frame[i][i_4_] = i_1_;
                                (this.um).info[i][i_4_] = getSvalue(string, 3);
                                i_4_ = 3;
                            }
                        }
                    }
                    if ((this.um).gocnt[i] != 0) {
                        int i_6_ = 0;
                        for (int i_7_ = 0; i_7_ < (this.um).nplayers; i_7_++) {
                            if ((this.um).frame[i_7_][0] >= 0)
                                i_6_++;
                        }
                        if (i_6_ == (this.um).nplayers) {
                            string_0_ = "1111111";
                            (this.um).gocnt[i]--;
                        }
                    }
                    if (!(this.um).go) {
                        int i_8_ = 0;
                        for (int i_9_ = 0; i_9_ < (this.um).nplayers; i_9_++) {
                            if ((this.um).frame[i_9_][0] >= 0)
                                i_8_++;
                        }
                        if (i_8_ == (this.um).nplayers)
                            (this.um).gocnt[0]--;
                ...
                for (int i_11_ = 0; i_11_ < (this.um).nplayers; i_11_++) {
                    if (i_11_ != this.im) {
                        int i_12_ = -1;
                        for (int i_13_ = 0; i_13_ < 3; i_13_++) {
                            if ((this.um).frame[i_11_][i_13_] == this.lsframe[i_11_] + 1)
                                i_12_ = i_13_;
                        }
                        if (i_12_ == -1) {
                            for (int i_14_ = 0; i_14_ < 3; i_14_++) {
                                if ((this.um).frame[i_11_][i_14_] > this.lsframe[i_11_])
                                    i_12_ = i_14_;
                            }
                        }
                        if (i_12_ == -1)
                            i_12_ = 0;
                        this.lsframe[i_11_] = (this.um).frame[i_11_][i_12_];
                        String string_15_ = new StringBuilder().append("").append(string_0_).append("|").append(i_11_).append("|").append((this.um).frame[i_11_][i_12_]).append("|").append((this.um).info[i_11_][i_12_]).append("|").toString();
                        byte[] is_16_ = string_15_.getBytes();
                        DatagramPacket datagrampacket_17_ = new DatagramPacket(is_16_, is_16_.length, inetaddress, i_10_);
