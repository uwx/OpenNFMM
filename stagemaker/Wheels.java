...
public class Wheels
{
    ...
    public void make(Medium medium, Trackers trackers, Plane[] planes, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        ...
        is_11_[13] = (int) ((double) i_5_ + 8.66 * (double) this.size);
        is_12_[13] = (int) ((float) i_6_ + 5.0F * this.size);
        is_11_[14] = (int) ((double) i_5_ + 8.66 * (double) this.size);
        is_12_[14] = (int) ((float) i_6_ - 5.0F * this.size);
        is_11_[15] = i_5_;
        is_12_[15] = (int) ((float) i_6_ - 10.0F * this.size);
        is_11_[16] = (int) ((double) i_5_ - 8.66 * (double) this.size);
        is_12_[16] = (int) ((float) i_6_ - 5.0F * this.size);
        is_11_[17] = (int) ((double) i_5_ - 8.66 * (double) this.size);
        ...
        is_11_[2] = i_5_;
        is_12_[2] = i_6_;
        int i_18_ = (int) ((float) i_10_ - this.depth / this.size * 4.0F);
        if (i_18_ < -16)
            i_18_ = -16;
        is_11_[0] = i_5_;
        is_12_[0] = (int) ((float) i_6_ + 10.0F * this.size);
        is_11_[1] = (int) ((double) i_5_ + 8.66 * (double) this.size);
        is_12_[1] = (int) ((float) i_6_ + 5.0F * this.size);
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3, this.rc, 0, i_18_, 0, i_14_, i_5_, i_6_, 7, 0, false, 0, false);
        if (this.depth / this.size < 7.0F)
            (planes[i]).master = 2;
        i++;
        is_11_[0] = (int) ((double) i_5_ + 8.66 * (double) this.size);
