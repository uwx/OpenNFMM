...
/* Wheels - Decompiled by JODE extended
 * DragShot Software
...
public class Wheels
{
    ...
    public void make(Medium medium, Trackers trackers, Plane[] planes, int i, int i_4_, int i_5_, int i_6_, int i_7_, int i_8_, int i_9_, int i_10_) {
        int[] is = new int[20];
        ...
        is_11_[13] = (int) ((double) i_5_ + 8.66 * (double) size);
        is_12_[13] = (int) ((float) i_6_ + 5.0F * size);
        is_11_[14] = (int) ((double) i_5_ + 8.66 * (double) size);
        is_12_[14] = (int) ((float) i_6_ - 5.0F * size);
        is_11_[15] = i_5_;
        is_12_[15] = (int) ((float) i_6_ - 10.0F * size);
        is_11_[16] = (int) ((double) i_5_ - 8.66 * (double) size);
        is_12_[16] = (int) ((float) i_6_ - 5.0F * size);
        is_11_[17] = (int) ((double) i_5_ - 8.66 * (double) size);
        ...
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 20, is_13_, 0, i_10_, 0, i_14_, i_5_, i_6_, 7, 0, false, 0, false);
        (planes[i]).master = 1;
        i++;
        is[2] = (int) ((float) i_4_ - depth * f);
        is_11_[2] = i_5_;
        is_12_[2] = i_6_;
        int i_18_ = (int) ((float) i_10_ - depth / size * 4.0F);
        if (i_18_ < -16)
            i_18_ = -16;
        is_11_[0] = i_5_;
        is_12_[0] = (int) ((float) i_6_ + 10.0F * size);
        is_11_[1] = (int) ((double) i_5_ + 8.66 * (double) size);
        is_12_[1] = (int) ((float) i_6_ + 5.0F * size);
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 3, rc, 0, i_18_, 0, i_14_, i_5_, i_6_, 7, 0, false, 0, false);
        if (depth / size < 7.0F)
            (planes[i]).master = 2;
        i++;
        is_11_[0] = (int) ((double) i_5_ + 8.66 * (double) size);
        ...
        planes[i] = new Plane(medium, trackers, is, is_12_, is_11_, 4, is_13_, 0, i_10_, -1 * i_16_, i_14_, i_5_, i_6_, 7, 0, false, 0, true);
        i++;
        is[0] = (int) ((float) i_4_ - 4.0F * f);
        is_11_[0] = (int) ((float) i_5_ - 9.1923F * f_15_);
        is_12_[0] = (int) ((float) i_6_ - 9.1923F * f_15_);
