...
{
    int[] x = new int[670000];
    int[] y = new int[670000];
    int[] z = new int[670000];
    int[] xy = new int[670000];
    int[] zy = new int[670000];
    int[] skd = new int[670000];
    int[] dam = new int[670000];
    boolean[] notwall = new boolean[670000];
    boolean[] decor = new boolean[670000];
    int[][] c = new int[670000][3];
    int[] radx = new int[670000];
    int[] radz = new int[670000];
    int[] rady = new int[670000];
    int nt = 0;
    int sx = 0;
    int sz = 0;
    int ncx = 0;
