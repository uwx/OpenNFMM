...
/*  9 */     numRows = numRows;
/* 10 */     data = new byte[numChannels * numRows * 5];
/*    */   }
/*    */   
/*    */   public void getNote(int index, Note note) {
/* 14 */     int offset = index * 5;
/* 15 */     note.key = (data[offset] & 0xFF);
/* 16 */     note.instrument = (data[(offset + 1)] & 0xFF);
/* 17 */     note.volume = (data[(offset + 2)] & 0xFF);
/* 18 */     note.effect = (data[(offset + 3)] & 0xFF);
/* 19 */     note.param = (data[(offset + 4)] & 0xFF);
/*    */   }
/*    */   
