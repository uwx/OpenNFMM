...
public class Smenu {
    ...
    public boolean draw(final Graphics2D graphics2d, final int i, final int i_4_, final boolean bool, final int i_5_, boolean bool_6_) {
                ...
                if (!bool_6_) {
                    ...
                    for (int i_15_ = 0; i_15_ < no; i_15_++)
                        if (Math.abs(scro) < (i_15_ + 1) * (ftm.getHeight() + 2)) {
                            graphics2d.setColor(fcol);
                            if (i > x && i < x + w && i_4_ > y + 25 + scro + i_15_ * (ftm.getHeight() + 2) && i_4_ < y + 25 + scro + (i_15_ + 1) * (ftm.getHeight() + 2)) {
                                if (bool_9_) {
                                    graphics2d.setColor(new Color((fcol.getRed() + bcol.getRed()) / 2, (fcol.getGreen() + bcol.getGreen()) / 2, (fcol.getBlue() + bcol.getBlue()) / 2));
                                } else {
                                    graphics2d.setColor(fcol);
                                }
                                graphics2d.fillRect(x + 1, y + 25 + scro + i_15_ * (ftm.getHeight() + 2), w - 1 + i_12_, ftm.getHeight() + 2);
                                graphics2d.setColor(bcol);
                                if (bool_8_) {
                    ...
                    for (int i_19_ = 0; i_19_ < no; i_19_++)
                        if (Math.abs(scro) < (i_19_ + 1) * (ftm.getHeight() + 2)) {
                            graphics2d.setColor(fcol);
                            if (i > x && i < x + w && i_4_ < y - 18 + scro - (i_19_ - 1) * (ftm.getHeight() + 2) && i_4_ > y - 18 + scro - i_19_ * (ftm.getHeight() + 2)) {
                                if (bool_9_) {
                                    graphics2d.setColor(new Color((fcol.getRed() + bcol.getRed()) / 2, (fcol.getGreen() + bcol.getGreen()) / 2, (fcol.getBlue() + bcol.getBlue()) / 2));
                                } else {
                                    graphics2d.setColor(fcol);
                                }
                                graphics2d.fillRect(x + 1, y - 18 + scro - i_19_ * (ftm.getHeight() + 2), w - 1 + i_16_, ftm.getHeight() + 2);
                                graphics2d.setColor(bcol);
                                if (bool_8_) {
                                    sel = i_19_;
                                    open = false;
