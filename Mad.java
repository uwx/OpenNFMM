...
public class Mad {
	...
	public void reseto(final int i, final ContO conto, final CheckPoints checkpoints) {
		...
		forca = (((float) Math.sqrt(((conto).keyz[0] * (conto).keyz[0]) + ((conto).keyx[0] * (conto).keyx[0]))
				...
				/ 10000.0F * (float) (((cd).bounce[cn]) - 0.3));
		mtouch = false;
		wtouch = false;
		txz = 0;
		fxz = 0;
	...
	public void drive(final Control control, final ContO conto, final Trackers trackers,
		...
		if (mtouch) {
			...
			for (int i_41_ = 0; i_41_ < 4; i_41_++) {
					...
					if ((dcnt > 40.0F * f_35_ / ((cd).grip[cn])) || capsized) {
						...
						if (m.random() > 0.65) {
							...
							if ((im == (xt).im) && !capsized)
								xt.skid(i_32_, (float) (Math
										.sqrt(((scx[i_41_]) * (scx[i_41_])) + ((scz[i_41_]) * (scz[i_41_])))));
						}
					} else {
				...
				if (i_32_ == 3) {
					...
					scy[i_43_] = (float) (-100.0F * m.random() * (speed / ((cd).swits[cn][2]))
							* (((cd).bounce[cn]) - 0.3));
				}
				if (i_32_ == 4) {
					final int i_44_ = (int) (m.random() * 4.0F);
					scy[i_44_] = (float) (-150.0F * m.random() * (speed / ((cd).swits[cn][2]))
							* (((cd).bounce[cn]) - 0.3));
				}
				f_39_ += scx[i_41_];
				f_40_ += scz[i_41_];
			...
			for (int i_58_ = 0; i_58_ < 4; i_58_++) {
				...
				if (!bools[i_58_] && (fs[i_58_] > (trackers).x[i_55_] - (trackers).radx[i_55_])
					...
					if ((trackers).zy[i_55_] != 0 && (trackers).zy[i_55_] != 90 && (trackers).zy[i_55_] != -90) {
						...
						if (f_70_ < 1.0F)
							f_70_ = 1.0F;
						final float f_71_ = ((trackers).y[i_55_]
								+ (((fs_23_[i_58_] - (trackers).y[i_55_]) * m.cos(i_69_))
					...
					if ((trackers).xy[i_55_] != 0 && (trackers).xy[i_55_] != 90 && (trackers).xy[i_55_] != -90) {
						...
						if (f_75_ < 1.0F)
							f_75_ = 1.0F;
						final float f_76_ = ((trackers).y[i_55_]
								+ (((fs_23_[i_58_] - (trackers).y[i_55_]) * m.cos(i_74_))
		...
		if (scy[2] != scy[0]) {
			if (scy[2] < scy[0])
				...
				i = 1;
			d = (Math
					.sqrt((fs_22_[0] - fs_22_[2]) * (fs_22_[0] - fs_22_[2])
		...
		if (scy[3] != scy[1]) {
			if (scy[3] < scy[1])
				...
				i = 1;
			d = (Math
					.sqrt((fs_22_[1] - fs_22_[3]) * (fs_22_[1] - fs_22_[3])
		...
		if (scy[1] != scy[0]) {
			if (scy[1] < scy[0])
				...
				i = 1;
			d = (Math
					.sqrt((fs_22_[0] - fs_22_[1]) * (fs_22_[0] - fs_22_[1])
		...
		if (scy[3] != scy[2]) {
			if (scy[3] < scy[2])
				...
				i = 1;
			d = (Math
					.sqrt((fs_22_[2] - fs_22_[3]) * (fs_22_[2] - fs_22_[3])
		...
		if (bool)
			...
			i = 1;
		(conto).x = (int) ((fs[0] - ((conto).keyx[0] * m.cos((conto).xz)) + (i * (conto).keyz[0] * m.sin((conto).xz))
				+ fs[1] - ((conto).keyx[1] * m.cos((conto).xz)) + (i * (conto).keyz[1] * m.sin((conto).xz)) + fs[2]
		...
		(conto).z = (int) ((fs_22_[0] - (i * (conto).keyz[0] * m.cos((conto).xz))
				- ((conto).keyx[0] * m.sin((conto).xz)) + fs_22_[1] - (i * (conto).keyz[1] * m.cos((conto).xz))
				- ((conto).keyx[1] * m.sin((conto).xz)) + fs_22_[2] - (i * (conto).keyz[2] * m.cos((conto).xz))
				- ((conto).keyx[2] * m.sin((conto).xz)) + fs_22_[3] - (i * (conto).keyz[3] * m.cos((conto).xz))
				- ((conto).keyx[3] * m.sin((conto).xz))) / 4.0F + (i_10_ * m.sin(pxy) * m.sin((conto).xz))
				- (i_10_ * m.sin(pzy) * m.cos((conto).xz)) + f_11_);
		...
		if (wtouch && !capsized) {
			...
			tilt = 0.0F;
		if (wtouch && i_32_ == 2) {
			(conto).zy += (int) (((m.random() * 6.0F * speed / ((cd).swits[cn][2]))
					- (3.0F * speed / ((cd).swits[cn][2]))) * (((cd).bounce[cn]) - 0.3));
			(conto).xy += (int) (((m.random() * 6.0F * speed / ((cd).swits[cn][2]))
					- (3.0F * speed / ((cd).swits[cn][2]))) * (((cd).bounce[cn]) - 0.3));
		}
		if (wtouch && i_32_ == 1) {
			(conto).zy += (int) (((m.random() * 4.0F * speed / ((cd).swits[cn][2]))
					- (2.0F * speed / ((cd).swits[cn][2]))) * (((cd).bounce[cn]) - 0.3));
			(conto).xy += (int) (((m.random() * 4.0F * speed / ((cd).swits[cn][2]))
					- (2.0F * speed / ((cd).swits[cn][2]))) * (((cd).bounce[cn]) - 0.3));
		}
		...
		for (int i_92_ = 0; i_92_ < (checkpoints).n; i_92_++) {
			...
			if (py((conto).x / 100, (checkpoints).x[i_92_] / 100, (conto).z / 100, (checkpoints).z[i_92_] / 100)
					* i_4_ < i_90_ || i_90_ == 0) {
				i_89_ = i_92_;
				i_90_ = py((conto).x / 100, (checkpoints).x[i_92_] / 100, (conto).z / 100, (checkpoints).z[i_92_] / 100)
						* i_4_;
			}
		}
		if (clear == i_91_ + nlaps * (checkpoints).nsp) {
		...
		if (focus == -1) {
			...
			i_89_ = focus;
			if (im == (xt).im) {
				if (missedcp == 0 && mtouch && (Math.sqrt(py((conto).x / 10, ((checkpoints).x[focus]) / 10,
						(conto).z / 10, ((checkpoints).z[focus]) / 10)) > 800.0))
					missedcp = 1;
				if (missedcp == -2 && (Math.sqrt(py((conto).x / 10, ((checkpoints).x[focus]) / 10, (conto).z / 10,
						((checkpoints).z[focus]) / 10)) < 400.0))
					missedcp = 0;
				if (missedcp != 0 && mtouch && (Math.sqrt(py((conto).x / 10, ((checkpoints).x[focus]) / 10,
						(conto).z / 10, ((checkpoints).z[focus]) / 10)) < 250.0))
					missedcp = 68;
			} else
				missedcp = 1;
			if (nofocus) {
			...
			if (i_99_ * i_98_ == 0 || mtouch)
				for (int i_102_ = 0; i_102_ < (conto).npl; i_102_++) {
					...
					for (int i_104_ = 0; i_104_ < ((conto).p[i_102_]).n; i_104_++)
						if (((conto).p[i_102_]).wz == 0 && (py((conto).keyx[i], (((conto).p[i_102_]).ox[i_104_]),
								(conto).keyz[i], (((conto).p[i_102_]).oz[i_104_])) < ((cd).clrad[cn]))) {
					...
					if (f_103_ != 0.0F) {
						...
						if (!((conto).p[i_102_]).nocol && (((conto).p[i_102_]).glass != 1)) {
							...
							final Color color = (Color.getHSBColor(((conto).p[i_102_]).hsb[0],
									((conto).p[i_102_]).hsb[1], (((conto).p[i_102_]).hsb[2])));
					...
					for (int i_107_ = 0; i_107_ < (conto).npl; i_107_++) {
						...
						for (int i_109_ = 0; i_109_ < ((conto).p[i_107_]).n; i_109_++)
							if (((conto).p[i_107_]).wz == 0) {
								...
								if (((Math.abs((((conto).p[i_107_])).oy[i_109_] - ((cd).flipy[cn])
										- squash) < ((cd).msquash[cn]) * 3)
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_111_ = 0; i_111_ < (conto).npl; i_111_++) {
				...
				for (int i_113_ = 0; i_113_ < ((conto).p[i_111_]).n; i_113_++)
					if (((conto).p[i_111_]).wz == 0 && (py((conto).keyx[i], ((conto).p[i_111_]).ox[i_113_],
							(conto).keyz[i], ((conto).p[i_111_]).oz[i_113_]) < ((cd).clrad[cn]))) {
		...
		if (Math.abs(f) > 100.0F) {
			...
			for (int i_115_ = 0; i_115_ < (conto).npl; i_115_++) {
				...
				for (int i_117_ = 0; i_117_ < ((conto).p[i_115_]).n; i_117_++)
					if (((conto).p[i_115_]).wz == 0 && (py((conto).keyx[i], ((conto).p[i_115_]).ox[i_117_],
							(conto).keyz[i], ((conto).p[i_115_]).oz[i_117_]) < ((cd).clrad[cn]))) {
	...
	public void colide(final ContO conto, final Mad mad_118_, final ContO conto_119_) {
		...
		if (dominate[(mad_118_).im]) {
			final int i_126_ = (int) ((((scz[0] - (mad_118_).scz[0] + scz[1] - (mad_118_).scz[1] + scz[2]
					- (mad_118_).scz[2] + scz[3] - (mad_118_).scz[3])
					* (scz[0] - (mad_118_).scz[0] + scz[1] - (mad_118_).scz[1] + scz[2] - (mad_118_).scz[2] + scz[3]
					...
					+ ((scx[0] - (mad_118_).scx[0] + scx[1] - (mad_118_).scx[1] + scx[2] - (mad_118_).scx[2] + scx[3]
							- (mad_118_).scx[3])
							* (scx[0] - (mad_118_).scx[0] + scx[1] - (mad_118_).scx[1] + scx[2] - (mad_118_).scx[2]
			...
			for (int i_128_ = 0; i_128_ < 4; i_128_++)
				for (int i_129_ = 0; i_129_ < 4; i_129_++)
					if (rpy(fs[i_128_], fs_122_[i_129_], fs_120_[i_128_], fs_123_[i_129_], fs_121_[i_128_],
							fs_124_[i_129_]) < ((i_126_ + i_127_)
									* (((cd).comprad[(mad_118_).cn]) + ((cd).comprad[cn])))) {
