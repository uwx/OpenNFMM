...
public class Mad {
    ...
    public Mad(final CarDefine cardefine, final Medium medium, final Record record, final xtGraphics var_xtGraphics, final int i) {
        cd = cardefine;
        m = medium;
        rpd = record;
        xt = var_xtGraphics;
    ...
    public void colide(final ContO conto, final Mad mad_118_, final ContO conto_119_) {
        ...
        if (rpy(conto.x, conto_119_.x, conto.y, conto_119_.y, conto.z, conto_119_.z) < (conto.maxR * conto.maxR + conto_119_.maxR * conto_119_.maxR) * 1.5) {
            if (!caught[mad_118_.im] && (speed != 0.0F || mad_118_.speed != 0.0F)) {
                if (Math.abs(power * speed * cd.moment[cn]) != Math.abs(mad_118_.power * mad_118_.speed * cd.moment[mad_118_.cn])) {
                    if (Math.abs(power * speed * cd.moment[cn]) > Math.abs(mad_118_.power * mad_118_.speed * cd.moment[mad_118_.cn])) {
        ...
        if (dominate[mad_118_.im]) {
            final int i_126_ = (int) (((scz[0] - mad_118_.scz[0] + scz[1] - mad_118_.scz[1] + scz[2] - mad_118_.scz[2] + scz[3] - mad_118_.scz[3]) * (scz[0] - mad_118_.scz[0] + scz[1] - mad_118_.scz[1] + scz[2] - mad_118_.scz[2] + scz[3] - mad_118_.scz[3]) + (scx[0] - mad_118_.scx[0] + scx[1] - mad_118_.scx[1] + scx[2] - mad_118_.scx[2] + scx[3] - mad_118_.scx[3]) * (scx[0] - mad_118_.scx[0] + scx[1] - mad_118_.scx[1] + scx[2] - mad_118_.scx[2] + scx[3] - mad_118_.scx[3])) / 16.0F);
            int i_127_ = 7000;
            float f = 1.0F;
            if (xt.multion != 0) {
                i_127_ = 28000;
            ...
            for (int i_128_ = 0; i_128_ < 4; i_128_++) {
                for (int i_129_ = 0; i_129_ < 4; i_129_++)
                    if (rpy(fs[i_128_], fs_122_[i_129_], fs_120_[i_128_], fs_123_[i_129_], fs_121_[i_128_], fs_124_[i_129_]) < (i_126_ + i_127_) * (cd.comprad[mad_118_.cn] + cd.comprad[cn])) {
                        if (Math.abs(scx[i_128_] * cd.moment[cn]) > Math.abs(mad_118_.scx[i_129_] * cd.moment[mad_118_.cn])) {
                            ...
                            if (m.random() > m.random()) {
                                conto_119_.sprk((fs[i_128_] + fs_122_[i_129_]) / 2.0F, (fs_120_[i_128_] + fs_123_[i_129_]) / 2.0F, (fs_121_[i_128_] + fs_124_[i_129_]) / 2.0F, (mad_118_.scx[i_129_] + scx[i_128_]) / 4.0F, (mad_118_.scy[i_129_] + scy[i_128_]) / 4.0F, (mad_118_.scz[i_129_] + scz[i_128_]) / 4.0F, 2);
                            }
                        }
                        if (Math.abs(scz[i_128_] * cd.moment[cn]) > Math.abs(mad_118_.scz[i_129_] * cd.moment[mad_118_.cn])) {
    ...
    public void drive(final Control control, final ContO conto, final Trackers trackers, final CheckPoints checkpoints) {
        ...
        for (int i_54_ = 0; i_54_ < trackers.sect[i_30_][i_31_].length; i_54_++) {
            ...
            for (int i_58_ = 0; i_58_ < 4; i_58_++) {
                if (bools_46_[i_58_] && (trackers.skd[i_55_] == 0 || trackers.skd[i_55_] == 1) && fs[i_58_] > trackers.x[i_55_] - trackers.radx[i_55_] && fs[i_58_] < trackers.x[i_55_] + trackers.radx[i_55_] && fs_22_[i_58_] > trackers.z[i_55_] - trackers.radz[i_55_] && fs_22_[i_58_] < trackers.z[i_55_] + trackers.radz[i_55_]) {
                ...
                if (!bools[i_58_] && fs[i_58_] > trackers.x[i_55_] - trackers.radx[i_55_] && fs[i_58_] < trackers.x[i_55_] + trackers.radx[i_55_] && fs_22_[i_58_] > trackers.z[i_55_] - trackers.radz[i_55_] && fs_22_[i_58_] < trackers.z[i_55_] + trackers.radz[i_55_] && fs_23_[i_58_] > trackers.y[i_55_] - trackers.rady[i_55_] && fs_23_[i_58_] < trackers.y[i_55_] + trackers.rady[i_55_] && (!trackers.decor[i_55_] || m.resdown != 2 || xt.multion != 0)) {
                    if (trackers.xy[i_55_] == 0 && trackers.zy[i_55_] == 0 && trackers.y[i_55_] != 250 && fs_23_[i_58_] > trackers.y[i_55_] - 5) {
                        i_57_++;
                        wtouch = true;
                        gtouch = true;
                    ...
                    if (trackers.zy[i_55_] == -90 && fs_22_[i_58_] < trackers.z[i_55_] + trackers.radz[i_55_] && (scz[i_58_] < 0.0F || trackers.radz[i_55_] == 287)) {
                    ...
                    if (trackers.xy[i_55_] == -90 && fs[i_58_] < trackers.x[i_55_] + trackers.radx[i_55_] && (scx[i_58_] < 0.0F || trackers.radx[i_55_] == 287)) {
                    ...
                    if (trackers.zy[i_55_] != 0 && trackers.zy[i_55_] != 90 && trackers.zy[i_55_] != -90) {
                        ...
                        final float f_71_ = trackers.y[i_55_] + ((fs_23_[i_58_] - trackers.y[i_55_]) * m.cos(i_69_) - (fs_22_[i_58_] - trackers.z[i_55_]) * m.sin(i_69_));
                        float f_72_ = trackers.z[i_55_] + ((fs_23_[i_58_] - trackers.y[i_55_]) * m.sin(i_69_) + (fs_22_[i_58_] - trackers.z[i_55_]) * m.cos(i_69_));
                        ...
                        fs_23_[i_58_] = trackers.y[i_55_] + ((f_71_ - trackers.y[i_55_]) * m.cos(-i_69_) - (f_72_ - trackers.z[i_55_]) * m.sin(-i_69_));
                        fs_22_[i_58_] = trackers.z[i_55_] + ((f_71_ - trackers.y[i_55_]) * m.sin(-i_69_) + (f_72_ - trackers.z[i_55_]) * m.cos(-i_69_));
                        bools[i_58_] = true;
                    }
                    if (trackers.xy[i_55_] != 0 && trackers.xy[i_55_] != 90 && trackers.xy[i_55_] != -90) {
                        ...
                        final float f_76_ = trackers.y[i_55_] + ((fs_23_[i_58_] - trackers.y[i_55_]) * m.cos(i_74_) - (fs[i_58_] - trackers.x[i_55_]) * m.sin(i_74_));
                        float f_77_ = trackers.x[i_55_] + ((fs_23_[i_58_] - trackers.y[i_55_]) * m.sin(i_74_) + (fs[i_58_] - trackers.x[i_55_]) * m.cos(i_74_));
                        ...
                        fs_23_[i_58_] = trackers.y[i_55_] + ((f_76_ - trackers.y[i_55_]) * m.cos(-i_74_) - (f_77_ - trackers.x[i_55_]) * m.sin(-i_74_));
                        fs[i_58_] = trackers.x[i_55_] + ((f_76_ - trackers.y[i_55_]) * m.sin(-i_74_) + (f_77_ - trackers.x[i_55_]) * m.cos(-i_74_));
                        bools[i_58_] = true;
                    }
                }
            }
        ...
        if (scy[2] != scy[0]) {
            ...
            d = Math.sqrt((fs_22_[0] - fs_22_[2]) * (fs_22_[0] - fs_22_[2]) + (fs_23_[0] - fs_23_[2]) * (fs_23_[0] - fs_23_[2]) + (fs[0] - fs[2]) * (fs[0] - fs[2])) / (Math.abs(conto.keyz[0]) + Math.abs(conto.keyz[2]));
            if (d >= 0.9998) {
                i_81_ = i;
            } else {
        ...
        if (scy[3] != scy[1]) {
            ...
            d = Math.sqrt((fs_22_[1] - fs_22_[3]) * (fs_22_[1] - fs_22_[3]) + (fs_23_[1] - fs_23_[3]) * (fs_23_[1] - fs_23_[3]) + (fs[1] - fs[3]) * (fs[1] - fs[3])) / (Math.abs(conto.keyz[1]) + Math.abs(conto.keyz[3]));
            if (d >= 0.9998) {
                i_82_ = i;
            } else {
        ...
        if (scy[1] != scy[0]) {
            ...
            d = Math.sqrt((fs_22_[0] - fs_22_[1]) * (fs_22_[0] - fs_22_[1]) + (fs_23_[0] - fs_23_[1]) * (fs_23_[0] - fs_23_[1]) + (fs[0] - fs[1]) * (fs[0] - fs[1])) / (Math.abs(conto.keyx[0]) + Math.abs(conto.keyx[1]));
            if (d >= 0.9998) {
                i_83_ = i;
            } else {
        ...
        if (scy[3] != scy[2]) {
            ...
            d = Math.sqrt((fs_22_[2] - fs_22_[3]) * (fs_22_[2] - fs_22_[3]) + (fs_23_[2] - fs_23_[3]) * (fs_23_[2] - fs_23_[3]) + (fs[2] - fs[3]) * (fs[2] - fs[3])) / (Math.abs(conto.keyx[2]) + Math.abs(conto.keyx[3]));
            if (d >= 0.9998) {
                i_84_ = i;
            } else {
        ...
        conto.y = (int) ((fs_23_[0] + fs_23_[1] + fs_23_[2] + fs_23_[3]) / 4.0F - i_10_ * m.cos(pzy) * m.cos(pxy) + f_12_);
        if (bool) {
            i = -1;
        } else {
            i = 1;
        }
        conto.x = (int) ((fs[0] - conto.keyx[0] * m.cos(conto.xz) + i * conto.keyz[0] * m.sin(conto.xz) + fs[1] - conto.keyx[1] * m.cos(conto.xz) + i * conto.keyz[1] * m.sin(conto.xz) + fs[2] - conto.keyx[2] * m.cos(conto.xz) + i * conto.keyz[2] * m.sin(conto.xz) + fs[3] - conto.keyx[3] * m.cos(conto.xz) + i * conto.keyz[3] * m.sin(conto.xz)) / 4.0F + i_10_ * m.sin(pxy) * m.cos(conto.xz) - i_10_ * m.sin(pzy) * m.sin(conto.xz) + f);
        conto.z = (int) ((fs_22_[0] - i * conto.keyz[0] * m.cos(conto.xz) - conto.keyx[0] * m.sin(conto.xz) + fs_22_[1] - i * conto.keyz[1] * m.cos(conto.xz) - conto.keyx[1] * m.sin(conto.xz) + fs_22_[2] - i * conto.keyz[2] * m.cos(conto.xz) - conto.keyx[2] * m.sin(conto.xz) + fs_22_[3] - i * conto.keyz[3] * m.cos(conto.xz) - conto.keyx[3] * m.sin(conto.xz)) / 4.0F + i_10_ * m.sin(pxy) * m.sin(conto.xz) - i_10_ * m.sin(pzy) * m.cos(conto.xz) + f_11_);
        ...
        for (int i_92_ = 0; i_92_ < checkpoints.n; i_92_++) {
            if (checkpoints.typ[i_92_] > 0) {
                ...
                if (checkpoints.typ[i_92_] == 1) {
                    ...
                    if (Math.abs(conto.z - checkpoints.z[i_92_]) < 60.0F + Math.abs(scz[0] + scz[1] + scz[2] + scz[3]) / 4.0F && Math.abs(conto.x - checkpoints.x[i_92_]) < 700 && Math.abs(conto.y - checkpoints.y[i_92_] + 350) < 450 && clear == i_91_ + nlaps * checkpoints.nsp - 1) {
                ...
                if (checkpoints.typ[i_92_] == 2) {
                    ...
                    if (Math.abs(conto.x - checkpoints.x[i_92_]) < 60.0F + Math.abs(scx[0] + scx[1] + scx[2] + scx[3]) / 4.0F && Math.abs(conto.z - checkpoints.z[i_92_]) < 700 && Math.abs(conto.y - checkpoints.y[i_92_] + 350) < 450 && clear == i_91_ + nlaps * checkpoints.nsp - 1) {
                        clear = i_91_ + nlaps * checkpoints.nsp;
                        pcleared = i_92_;
                        focus = -1;
                    }
        ...
        if (fixes != 0) {
            ...
            for (int i_94_ = 0; i_94_ < checkpoints.fn; i_94_++)
                if (rpy(conto.x / 100, checkpoints.fx[i_94_] / 100, conto.y / 100, checkpoints.fy[i_94_] / 100, conto.z / 100, checkpoints.fz[i_94_] / 100) < 760) {
                    m.noelec = 2;
                }
        }
        ...
        if (Math.abs(f) > 100.0F) {
            ...
            for (int i_111_ = 0; i_111_ < conto.npl; i_111_++) {
                ...
                for (int i_113_ = 0; i_113_ < conto.p[i_111_].n; i_113_++)
                    if (conto.p[i_111_].wz == 0 && py(conto.keyx[i], conto.p[i_111_].ox[i_113_], conto.keyz[i], conto.p[i_111_].oz[i_113_]) < cd.clrad[cn]) {
                ...
                if (f_112_ != 0.0F) {
                    ...
                    if (!conto.p[i_111_].nocol && conto.p[i_111_].glass != 1) {
                        ...
                        final Color color = Color.getHSBColor(conto.p[i_111_].hsb[0], conto.p[i_111_].hsb[1], conto.p[i_111_].hsb[2]);
            ...
            if (i_99_ * i_98_ == 0 || mtouch) {
                for (int i_102_ = 0; i_102_ < conto.npl; i_102_++) {
                    ...
                    for (int i_104_ = 0; i_104_ < conto.p[i_102_].n; i_104_++)
                        if (conto.p[i_102_].wz == 0 && py(conto.keyx[i], conto.p[i_102_].ox[i_104_], conto.keyz[i], conto.p[i_102_].oz[i_104_]) < cd.clrad[cn]) {
                    ...
                    if (f_103_ != 0.0F) {
                        ...
                        if (!conto.p[i_102_].nocol && conto.p[i_102_].glass != 1) {
                            ...
                            final Color color = Color.getHSBColor(conto.p[i_102_].hsb[0], conto.p[i_102_].hsb[1], conto.p[i_102_].hsb[2]);
                    ...
                    for (int i_107_ = 0; i_107_ < conto.npl; i_107_++) {
                        ...
                        for (int i_109_ = 0; i_109_ < conto.p[i_107_].n; i_109_++)
                            if (conto.p[i_107_].wz == 0) {
                                ...
                                if ((Math.abs(conto.p[i_107_].oy[i_109_] - cd.flipy[cn] - squash) < cd.msquash[cn] * 3 || conto.p[i_107_].oy[i_109_] < cd.flipy[cn] + squash) && squash < cd.msquash[cn]) {
        ...
        if (Math.abs(f) > 100.0F) {
            ...
            for (int i_115_ = 0; i_115_ < conto.npl; i_115_++) {
                ...
                for (int i_117_ = 0; i_117_ < conto.p[i_115_].n; i_117_++)
                    if (conto.p[i_115_].wz == 0 && py(conto.keyx[i], conto.p[i_115_].ox[i_117_], conto.keyz[i], conto.p[i_115_].oz[i_117_]) < cd.clrad[cn]) {
                ...
                if (f_116_ != 0.0F) {
                    ...
                    if (!conto.p[i_115_].nocol && conto.p[i_115_].glass != 1) {
                        ...
                        final Color color = Color.getHSBColor(conto.p[i_115_].hsb[0], conto.p[i_115_].hsb[1], conto.p[i_115_].hsb[2]);
    ...
    public void rot(final float[] fs, final float[] fs_134_, final int i, final int i_135_, final int i_136_, final int i_137_) {
        if (i_136_ != 0) {
    ...
    public int rpy(final float f, final float f_140_, final float f_141_, final float f_142_, final float f_143_, final float f_144_) {
        return (int) ((f - f_140_) * (f - f_140_) + (f_141_ - f_142_) * (f_141_ - f_142_) + (f_143_ - f_144_) * (f_143_ - f_144_));
    }
}
