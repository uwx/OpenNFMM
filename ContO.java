...
public class ContO {
			...
			for (int i_27_ = 0; i_27_ < npl; i_27_++) {
				...
				if (is_0_[i_27_] == 1) {
					...
					for (int i_38_ = 0; i_38_ < (p[i_27_]).n; i_38_++) {
						...
						if (i_28_ == 1) {
							int i_41_ = (Math
									.abs((int) ((Math.atan((double) (((p[i_27_])).oz[i_38_] - ((p[i_27_])).oz[i_39_])
											/ (double) (((p[i_27_])).oy[i_38_] - (((p[i_27_])).oy[i_39_]))))
									/ 0.017453292519943295)));
							int i_42_ = (Math
									.abs((int) ((Math.atan((double) (((p[i_27_])).oz[i_40_] - ((p[i_27_])).oz[i_39_])
						...
						if (i_28_ == 3) {
							int i_45_ = (Math
									.abs((int) ((Math.atan((double) (((p[i_27_])).oy[i_38_] - ((p[i_27_])).oy[i_39_])
											/ (double) (((p[i_27_])).ox[i_38_] - (((p[i_27_])).ox[i_39_]))))
									/ 0.017453292519943295)));
							int i_46_ = (Math
									.abs((int) ((Math.atan((double) (((p[i_27_])).oy[i_40_] - ((p[i_27_])).oy[i_39_])
											/ (double) (((p[i_27_])).ox[i_40_] - (((p[i_27_])).ox[i_39_]))))
									/ 0.017453292519943295)));
							if (i_45_ > 45)
								i_45_ = 90 - i_45_;
					...
					if (i_28_ == 1)
						if (Math.abs((p[i_27_]).oz[0] - (p[i_27_]).oz[1]) > Math
								.abs((p[i_27_]).oy[0] - ((p[i_27_]).oy[1]))) {
					...
					if (i_28_ == 2)
						if (Math.abs((p[i_27_]).oz[0] - (p[i_27_]).oz[1]) > Math
							...
							(p[i_27_]).fs = 1;
					if (i_28_ == 3)
						if (Math.abs((p[i_27_]).oy[0] - (p[i_27_]).oy[1]) > Math
								.abs((p[i_27_]).ox[0] - ((p[i_27_]).ox[1]))) {
	...
	public ContO(final ContO conto_78_, final int i, final int i_79_, final int i_80_, final int i_81_) {
		...
		for (int i_82_ = 0; i_82_ < npl; i_82_++) {
			...
			p[i_82_] = new Plane(m, t, ((conto_78_).p[i_82_]).ox, ((conto_78_).p[i_82_]).oz, ((conto_78_).p[i_82_]).oy,
					((conto_78_).p[i_82_]).n, ((conto_78_).p[i_82_]).oc, ((conto_78_).p[i_82_]).glass,
					((conto_78_).p[i_82_]).gr, ((conto_78_).p[i_82_]).fs, ((conto_78_).p[i_82_]).wx,
					((conto_78_).p[i_82_]).wy, ((conto_78_).p[i_82_]).wz, (conto_78_).disline,
					((conto_78_).p[i_82_]).bfase, ((conto_78_).p[i_82_]).road, ((conto_78_).p[i_82_]).light,
		...
		if ((conto_78_).tnt != 0)
			for (int i_84_ = 0; i_84_ < (conto_78_).tnt; i_84_++) {
				(t).xy[((t).nt)] = (int) (((conto_78_).txy[i_84_] * m.cos(i_81_))
						- ((conto_78_).tzy[i_84_] * m.sin(i_81_)));
				(t).zy[((t).nt)] = (int) (((conto_78_).tzy[i_84_] * m.cos(i_81_))
						+ ((conto_78_).txy[i_84_] * m.sin(i_81_)));
				...
				(t).x[((t).nt)] = (int) (x + ((conto_78_).tx[i_84_] * m.cos(i_81_))
						- ((conto_78_).tz[i_84_] * m.sin(i_81_)));
				(t).z[((t).nt)] = (int) (z + ((conto_78_).tz[i_84_] * m.cos(i_81_))
						+ ((conto_78_).tx[i_84_] * m.sin(i_81_)));
	...
	public ContO(final int i, final int i_90_, final int i_91_, final Medium medium, final Trackers trackers,
		...
		for (int i_119_ = 0; i_119_ < 4; i_119_++) {
			...
			if (i_119_ == 0) {
				...
				(t).zy[((t).nt)] = (int) ((Math.atan((double) ((t).rady[(t).nt]) / (double) ((t).radz[((t).nt)])))
						/ 0.017453292519943295);
				if (((t).zy[(t).nt]) > 40)
					(t).zy[(t).nt] = 40;
				(t).xy[((t).nt)] = 0;
			...
			if (i_119_ == 1) {
				...
				(t).xy[((t).nt)] = (int) ((Math.atan((double) ((t).rady[(t).nt]) / (double) ((t).radx[((t).nt)])))
						/ 0.017453292519943295);
				if (((t).xy[(t).nt]) > 40)
					(t).xy[(t).nt] = 40;
				(t).zy[((t).nt)] = 0;
	...
	public void d(final Graphics2D graphics2d) {
		if (dist != 0)
			dist = 0;
		final int i = ((m).cx
				+ (int) (((x - (m).x - (m).cx) * m.cos((m).xz)) - ((z - (m).z - (m).cz) * m.sin((m).xz))));
		final int i_124_ = ((m).cz
				+ (int) (((x - (m).x - (m).cx) * m.sin((m).xz)) + ((z - (m).z - (m).cz) * m.cos((m).xz))));
		final int i_125_ = ((m).cz
				+ (int) (((y - (m).y - (m).cy) * m.sin((m).zy)) + ((i_124_ - (m).cz) * m.cos((m).zy))));
		...
		if ((xs(i + maxR * 2, i_125_) > (m).iw) && (xs(i - maxR * 2, i_125_) < (m).w) && i_125_ > -maxR
				...
				if (!(m).crs) {
					if (i_125_ < 2000) {
						...
						if (bool)
							...
							final int i_132_ = ((m).cy + (int) ((((m).ground - (m).cy) * m.cos(((this).m).zy))
									- ((i_124_ - ((m).cz)) * (m.sin((m).zy)))));
							final int i_133_ = ((m).cz + (int) ((((m).ground - (m).cy) * m.sin(((this).m).zy))
									+ ((i_124_ - ((m).cz)) * (m.cos((m).zy)))));
			...
			final int i_136_ = ((m).cy
					+ (int) (((y - (m).y - (m).cy) * m.cos((m).zy)) - ((i_124_ - (m).cz) * m.sin((m).zy))));
			if ((ys(i_136_ + maxR, i_125_) > (m).ih) && (ys(i_136_ - maxR, i_125_) < (m).h)) {
				...
				if (checkpoint != 0 && (checkpoint - 1 == (m).checkpoint))
					i_126_ = -1;
				if (shadow) {
					dist = (int) (Math.sqrt((((m).x + (m).cx - x) * ((m).x + ((m).cx) - x))
							+ (((m).z - z) * ((m).z - z)) + (((m).y + ((m).cy) - y) * ((m).y + (m).cy - y))));
				...
				for (int i_142_ = 0; i_142_ < npl; i_142_++)
					p[is_138_[i_142_]].d(graphics2d, x - (m).x, y - (m).y, z - (m).z, xz, xy, zy, wxz, wzy, noline,
							i_126_);
				if (shadow) {
				...
				dist = (int) ((Math.sqrt((int) Math.sqrt(
						(((m).x + ((m)).cx - x) * (((m)).x + ((m)).cx - (x))) + ((((m)).z - (z)) * (((m)).z - (this).z))
								+ ((((m)).y + ((m)).cy - (y)) * (((m)).y + ((this).m).cy - (this).y)))))
						* grounded);
			}
		}
		if (shadow && dist == 0) {
			...
			for (int i_156_ = ((t).sect[i_154_][i_155_]).length - 1; i_156_ >= 0; i_156_--) {
				...
				if (i_158_ > 2) {
					for (int i_160_ = 0; i_160_ < 4; i_160_++) {
						...
						if ((t).xy[i_157_] != 0)
							is_146_[i_160_] += (((is[i_160_] - (((t).x[i_157_]) - ((m).x) - ((t).radx[i_157_])))
									* m.sin((t).xy[i_157_]) / m.sin(90 - (((t)).xy[i_157_])))
	...
	public void fixit(final Graphics2D graphics2d) {
		...
		if ((fcnt == 1 || fcnt > 2) && fcnt != 9) {
			...
			if (i_172_ < i_173_)
				i_172_ = i_173_;
			final int i_176_ = ((m).cx
					+ (int) (((x - (m).x - (m).cx) * m.cos((m).xz)) - ((z - (m).z - (m).cz) * m.sin((m).xz))));
			int i_177_ = ((m).cz
					+ (int) (((x - (m).x - (m).cx) * m.sin((m).xz)) + ((z - (m).z - (m).cz) * m.cos((m).xz))));
			final int i_178_ = ((m).cy
					+ (int) (((y - (m).y - (m).cy) * m.cos((m).zy)) - ((i_177_ - (m).cz) * m.sin((m).zy))));
	...
	public void pdust(final int i, final Graphics2D graphics2d, final boolean bool) {
		...
		if (bool && sav[i] > dist || !bool && sav[i] <= dist) {
			...
			final int i_220_ = ((m).cx
					+ (int) (((sx[i] - (m).x - (m).cx) * m.cos((m).xz)) - ((sz[i] - (m).z - (m).cz) * m.sin((m).xz))));
			int i_221_ = ((m).cz
					+ (int) (((sx[i] - (m).x - (m).cx) * m.sin((m).xz)) + ((sz[i] - (m).z - (m).cz) * m.cos((m).xz))));
			final int i_222_ = ((m).cy + (int) (((sy[i] - (m).y - (m).cy - smag[i][7]) * m.cos((m).zy))
					- ((i_221_ - (m).cz) * m.sin((m).zy))));
			i_221_ = ((m).cz + (int) (((sy[i] - (m).y - (m).cy - smag[i][7]) * m.sin((m).zy))
					+ ((i_221_ - (m).cz) * m.cos((m).zy))));
			sx[i] += scx[i] / (stg[i] + 1);
			sz[i] += scz[i] / (stg[i] + 1);
			final int[] is = new int[8];
	...
	public void dsprk(final Graphics2D graphics2d, final boolean bool) {
		if (bool && sprk != 0) {
			...
			if (i > 5) {
				...
				if (dist < Math.sqrt((((m).x + (m).cx - srx) * ((m).x + (m).cx - srx))
						+ (((m).y + (m).cy - sry) * ((m).y + ((m).cy) - sry)) + (((m).z - srz) * ((m).z - srz))))
					bool_240_ = true;
				if (i > 33)
					i = 33;
				int i_241_ = 0;
		...
		for (int i = 0; i < 100; i++)
			if (rtg[i] != 0 && (rbef[i] && bool || !rbef[i] && !bool)) {
				...
				ry[i] += vry[i];
				rz[i] += vrz[i];
				final int i_246_ = ((m).cx + (int) (((rx[i] - (m).x - (m).cx) * m.cos((m).xz))
						- ((rz[i] - (m).z - (m).cz) * m.sin((m).xz))));
				int i_247_ = ((m).cz + (int) (((rx[i] - (m).x - (m).cx) * m.sin((m).xz))
						+ ((rz[i] - (m).z - (m).cz) * m.cos((m).xz))));
				final int i_248_ = ((m).cy
						+ (int) (((ry[i] - (m).y - (m).cy) * m.cos((m).zy)) - ((i_247_ - (m).cz) * m.sin((m).zy))));
				i_247_ = ((m).cz
						+ (int) (((ry[i] - (m).y - (m).cy) * m.sin((m).zy)) + ((i_247_ - (m).cz) * m.cos((m).zy))));
				...
				final int i_251_ = ((m).cy + (int) (((ry[i] - (m).y - (m).cy + vry[i]) * m.cos((m).zy))
						- ((i_250_ - (m).cz) * m.sin((m).zy))));
				i_250_ = ((m).cz + (int) (((ry[i] - (m).y - (m).cy + vry[i]) * m.sin((m).zy))
						+ ((i_250_ - (m).cz) * m.cos((m).zy))));
