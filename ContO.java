...
public class ContO {
    ...
    public ContO(final byte[] is, final Medium medium, final Trackers trackers) {
        ...
        try {
            ...
            while ((string_17_ = datainputstream.readLine()) != null) {
                ...
                if (npl < 10000 /* 210 */) {
                    ...
                    if (bool) {
                        ...
                        if (string.startsWith("p(")) {
                            ...
                            final int i_18_ = (int) Math.sqrt(is_3_[i] * is_3_[i] + is_4_[i] * is_4_[i] + is_5_[i] * is_5_[i]);
                            if (i_18_ > maxR) {
                                maxR = i_18_;
                            }
                            i++;
                    ...
                    if (string.startsWith("</p>")) {
                        p[npl] = new Plane(m, t, is_3_, is_5_, is_4_, i, is_6_, i_14_, i_10_, i_11_, 0, 0, 0, disline, 0, bool_7_, i_13_, bool_15_, randomcolor, randoutline, customstroke, strokewidth, strokecap, strokejoin, strokemtlimit);
                ...
                if (string.startsWith("w(") && i_9_ < 4) {
                    ...
                    wheels.make(m, t, p, npl, (int) (getvalue("w", string, 0) * f * f_2_ * fs[0]), (int) (getvalue("w", string, 1) * f * fs[1]), (int) (getvalue("w", string, 2) * f * fs[2]), getvalue("w", string, 3), (int) (getvalue("w", string, 4) * f * f_2_), (int) (getvalue("w", string, 5) * f), i_12_);
                    npl += 19;
                    if (m.loadnew) {
                        ...
                        if (wheels.ground > 140) {
                            ...
                            err = new StringBuilder().append("Wheels Error:\n").append(string_19_).append(" Wheels floor is too far below the center of Y Axis of the car!    \n\nPlease decrease the Y value of the ").append(string_19_).append(" Wheels or decrease its height.     \n \n").toString();
                            errd = true;
                            keyz[i_9_] = 0;
                            keyx[i_9_] = 0;
                        }
                        if (wheels.ground < -100) {
                            ...
                            err = new StringBuilder().append("Wheels Error:\n").append(string_20_).append(" Wheels floor is too far above the center of Y Axis of the car!    \n\nPlease increase the Y value of the ").append(string_20_).append(" Wheels or increase its height.     \n \n").toString();
                            errd = true;
                            keyz[i_9_] = 0;
                            keyx[i_9_] = 0;
                        }
                        if (Math.abs(keyx[i_9_]) > 400) {
                            ...
                            err = new StringBuilder().append("Wheels Error:\n").append(string_21_).append(" Wheels are too far apart!    \n\nPlease decrease the \u00b1X value of the ").append(string_21_).append(" Wheels.     \n \n").toString();
                            errd = true;
                            keyz[i_9_] = 0;
                            keyx[i_9_] = 0;
                        }
                        ...
                        if ((int) (getvalue("w", string, 4) * f * f_2_) > 300) {
                            ...
                            err = new StringBuilder().append("Wheels Error:\nWidth of the ").append(string_22_).append(" Wheels is too large!    \n\nPlease decrease the width of the ").append(string_22_).append(" Wheels.     \n \n").toString();
                            errd = true;
                            keyz[i_9_] = 0;
                            keyx[i_9_] = 0;
                        }
        ...
        if (m.loadnew) {
            ...
            for (int i_27_ = 0; i_27_ < npl; i_27_++) {
                ...
                if (Math.abs(i_29_ - i_30_) <= Math.abs(i_31_ - i_32_) && Math.abs(i_29_ - i_30_) <= Math.abs(i_33_ - i_34_)) {
                    i_28_ = 1;
                }
                if (Math.abs(i_31_ - i_32_) <= Math.abs(i_29_ - i_30_) && Math.abs(i_31_ - i_32_) <= Math.abs(i_33_ - i_34_)) {
                    i_28_ = 2;
                }
                if (Math.abs(i_33_ - i_34_) <= Math.abs(i_29_ - i_30_) && Math.abs(i_33_ - i_34_) <= Math.abs(i_31_ - i_32_)) {
                    i_28_ = 3;
                }
                ...
                if (is_0_[i_27_] == 1) {
                    ...
                    for (int i_38_ = 0; i_38_ < p[i_27_].n; i_38_++) {
                        ...
                        if (i_28_ == 1) {
                            int i_41_ = Math.abs((int) (Math.atan((double) (p[i_27_].oz[i_38_] - p[i_27_].oz[i_39_]) / (double) (p[i_27_].oy[i_38_] - p[i_27_].oy[i_39_])) / 0.017453292519943295));
                            int i_42_ = Math.abs((int) (Math.atan((double) (p[i_27_].oz[i_40_] - p[i_27_].oz[i_39_]) / (double) (p[i_27_].oy[i_40_] - p[i_27_].oy[i_39_])) / 0.017453292519943295));
                            if (i_41_ > 45) {
                                i_41_ = 90 - i_41_;
                            } else {
                                i_42_ = 90 - i_42_;
                        ...
                        if (i_28_ == 2) {
                            int i_43_ = Math.abs((int) (Math.atan((double) (p[i_27_].oz[i_38_] - p[i_27_].oz[i_39_]) / (double) (p[i_27_].ox[i_38_] - p[i_27_].ox[i_39_])) / 0.017453292519943295));
                            int i_44_ = Math.abs((int) (Math.atan((double) (p[i_27_].oz[i_40_] - p[i_27_].oz[i_39_]) / (double) (p[i_27_].ox[i_40_] - p[i_27_].ox[i_39_])) / 0.017453292519943295));
                            if (i_43_ > 45) {
                                i_43_ = 90 - i_43_;
                            } else {
                                i_44_ = 90 - i_44_;
                        ...
                        if (i_28_ == 3) {
                            int i_45_ = Math.abs((int) (Math.atan((double) (p[i_27_].oy[i_38_] - p[i_27_].oy[i_39_]) / (double) (p[i_27_].ox[i_38_] - p[i_27_].ox[i_39_])) / 0.017453292519943295));
                            int i_46_ = Math.abs((int) (Math.atan((double) (p[i_27_].oy[i_40_] - p[i_27_].oy[i_39_]) / (double) (p[i_27_].ox[i_40_] - p[i_27_].ox[i_39_])) / 0.017453292519943295));
                            if (i_45_ > 45) {
                                i_45_ = 90 - i_45_;
                            } else {
                                i_46_ = 90 - i_46_;
                    ...
                    for (int i_55_ = 0; i_55_ < npl; i_55_++) {
                        if (i_55_ != i_27_ && is_0_[i_55_] != 0) {
                            ...
                            if (i_28_ == 1 && (i_65_ <= i_31_ && i_65_ >= i_32_ && i_66_ <= i_33_ && i_66_ >= i_34_ || i_68_ <= i_59_ && i_68_ >= i_60_ && i_69_ <= i_61_ && i_69_ >= i_62_)) {
                                if (i_57_ < i_30_) {
                                    bool_53_ = true;
                                }
                                if (i_58_ > i_29_) {
                            ...
                            if (i_28_ == 2 && (i_64_ <= i_29_ && i_64_ >= i_30_ && i_66_ <= i_33_ && i_66_ >= i_34_ || i_67_ <= i_57_ && i_67_ >= i_58_ && i_69_ <= i_61_ && i_69_ >= i_62_)) {
                                if (i_59_ < i_32_) {
                                    bool_53_ = true;
                                }
                                if (i_60_ > i_31_) {
                            ...
                            if (i_28_ == 3 && (i_64_ <= i_29_ && i_64_ >= i_30_ && i_65_ <= i_31_ && i_65_ >= i_32_ || i_67_ <= i_57_ && i_67_ >= i_58_ && i_68_ <= i_59_ && i_68_ >= i_60_)) {
                                if (i_61_ < i_34_) {
                                    bool_53_ = true;
                                }
                                if (i_62_ > i_33_) {
                            ...
                            if (i_73_ != i_27_) {
                                ...
                                for (int i_75_ = 0; i_75_ < p[i_73_].n; i_75_++) {
                                    ...
                                    for (int i_76_ = 0; i_76_ < p[i_27_].n; i_76_++)
                                        if (p[i_27_].ox[i_76_] == p[i_73_].ox[i_75_] && p[i_27_].oy[i_76_] == p[i_73_].oy[i_75_] && p[i_27_].oz[i_76_] == p[i_73_].oz[i_75_]) {
                                            bools[i_75_] = true;
                                            bool_74_ = true;
                                        }
                                }
    ...
    public ContO(final ContO conto_78_, final int i, final int i_79_, final int i_80_, final int i_81_) {
        ...
        for (int i_82_ = 0; i_82_ < npl; i_82_++) {
            ...
            p[i_82_] = new Plane(m, t, conto_78_.p[i_82_].ox, conto_78_.p[i_82_].oz, conto_78_.p[i_82_].oy, conto_78_.p[i_82_].n, conto_78_.p[i_82_].oc, conto_78_.p[i_82_].glass, conto_78_.p[i_82_].gr, conto_78_.p[i_82_].fs, conto_78_.p[i_82_].wx, conto_78_.p[i_82_].wy, conto_78_.p[i_82_].wz, conto_78_.disline, conto_78_.p[i_82_].bfase, conto_78_.p[i_82_].road, conto_78_.p[i_82_].light, conto_78_.p[i_82_].solo, conto_78_.p[i_82_].randomcolor, conto_78_.p[i_82_].randoutline, conto_78_.p[i_82_].customstroke, conto_78_.p[i_82_].strokewidth, conto_78_.p[i_82_].strokecap, conto_78_.p[i_82_].strokejoin, conto_78_.p[i_82_].strokemtlimit);
        }
        x = i;
        y = i_79_;
        z = i_80_;
        ...
        if (conto_78_.tnt != 0) {
            for (int i_84_ = 0; i_84_ < conto_78_.tnt; i_84_++) {
                ...
                for (int i_85_ = 0; i_85_ < 3; i_85_++) {
                    t.c[t.nt][i_85_] = (int) (conto_78_.tc[i_84_][i_85_] + conto_78_.tc[i_84_][i_85_] * (m.snap[i_85_] / 100.0F));
                ...
                t.radx[t.nt] = (int) Math.abs(conto_78_.tradx[i_84_] * m.cos(i_86_) + conto_78_.tradz[i_84_] * m.sin(i_86_));
                t.radz[t.nt] = (int) Math.abs(conto_78_.tradx[i_84_] * m.sin(i_86_) + conto_78_.tradz[i_84_] * m.cos(i_86_));
    ...
    public ContO(final int i, final int i_90_, final int i_91_, final Medium medium, final Trackers trackers, final int i_92_, final int i_93_, final int i_94_) {
        keyx = new int[4];
        keyz = new int[4];
        sprkat = 0;
        tnt = 0;
        ...
        for (int i_102_ = 0; i_102_ < 8; i_102_++) {
            ...
            i_105_ = (int) Math.sqrt(is_96_[i_102_] * is_96_[i_102_] + is_98_[i_102_] * is_98_[i_102_] + is_97_[i_102_] * is_97_[i_102_]);
            if (i_105_ > maxR) {
                maxR = i_105_;
            }
        }
        ...
        for (int i_109_ = 0; i_109_ < 4; i_109_++) {
            ...
            for (f_100_ = (float) ((0.17 - f_108_) * random.nextDouble()); Math.abs(f_107_ - f_100_) < 0.03 - f_108_ * 0.176F; f_100_ = (float) ((0.17 - f_108_) * random.nextDouble())) {
                /* empty */
            }
            f_107_ = f_100_;
            ...
            p[i_109_] = new Plane(m, t, is_112_, is_114_, is_113_, 6, is_106_, 3, -8, 0, 0, 0, 0, disline, 0, true, 0, false, false, false, false, 1, 0, 0, 10);
        }
    ...
    public void d(final Graphics2D graphics2d) {
        ...
        if (xs(i + maxR * 2, i_125_) > m.iw && xs(i - maxR * 2, i_125_) < m.w && i_125_ > -maxR && (i_125_ < m.fade[disline] + maxR || m.trk != 0) && (i_126_ > disp || m.trk != 0) && (!decor || m.resdown != 2 && m.trk != 1)) {
            if (shadow)
                if (!m.crs) {
                    if (i_125_ < 2000) {
                        boolean bool = false;
                        if (t.ncx != 0 || t.ncz != 0) {
                            ...
                            for (int i_129_ = t.sect[i_127_][i_128_].length - 1; i_129_ >= 0; i_129_--) {
                                ...
                                if (Math.abs(t.zy[i_130_]) != 90 && Math.abs(t.xy[i_130_]) != 90 && Math.abs(x - t.x[i_130_]) < t.radx[i_130_] + maxR && Math.abs(z - t.z[i_130_]) < t.radz[i_130_] + maxR && (!t.decor[i_130_] || m.resdown != 2)) {
                                    bool = true;
                                    break;
                                }
                            }
                        ...
                        if (bool) {
                            ...
                            final int i_132_ = m.cy + (int) ((m.ground - m.cy) * m.cos(m.zy) - (i_124_ - m.cz) * m.sin(m.zy));
                            final int i_133_ = m.cz + (int) ((m.ground - m.cy) * m.sin(m.zy) + (i_124_ - m.cz) * m.cos(m.zy));
    ...
    public void dsprk(final Graphics2D graphics2d, final boolean bool) {
        ...
        for (int i = 0; i < 100; i++)
            if (rtg[i] != 0 && (rbef[i] && bool || !rbef[i] && !bool)) {
                ...
                ry[i] += vry[i];
                rz[i] += vrz[i];
                final int i_246_ = m.cx + (int) ((rx[i] - m.x - m.cx) * m.cos(m.xz) - (rz[i] - m.z - m.cz) * m.sin(m.xz));
                ...
                final int i_249_ = m.cx + (int) ((rx[i] - m.x - m.cx + vrx[i]) * m.cos(m.xz) - (rz[i] - m.z - m.cz + vrz[i]) * m.sin(m.xz));
                int i_250_ = m.cz + (int) ((rx[i] - m.x - m.cx + vrx[i]) * m.sin(m.xz) + (rz[i] - m.z - m.cz + vrz[i]) * m.cos(m.xz));
                final int i_251_ = m.cy + (int) ((ry[i] - m.y - m.cy + vry[i]) * m.cos(m.zy) - (i_250_ - m.cz) * m.sin(m.zy));
    ...
    public void dust(final int i, final float f, final float f_199_, final float f_200_, final int i_201_, final int i_202_, final float f_203_, final int i_204_, final boolean bool) {
    ...
    public int getpy(final int i, final int i_267_, final int i_268_) {
        return (i - x) / 10 * ((i - x) / 10) + (i_267_ - y) / 10 * ((i_267_ - y) / 10) + (i_268_ - z) / 10 * ((i_268_ - z) / 10);
    }
        ...
        if (t.ncx != 0 || t.ncz != 0) {
            ...
            for (int i_156_ = t.sect[i_154_][i_155_].length - 1; i_156_ >= 0; i_156_--) {
                ...
                for (int i_159_ = 0; i_159_ < 4; i_159_++)
                    if (Math.abs(t.zy[i_157_]) != 90 && Math.abs(t.xy[i_157_]) != 90 && t.rady[i_157_] != 801 && Math.abs(is[i_159_] - (t.x[i_157_] - m.x)) < t.radx[i_157_] && Math.abs(is_147_[i_159_] - (t.z[i_157_] - m.z)) < t.radz[i_157_] && (!t.decor[i_157_] || m.resdown != 2)) {
                        i_158_++;
                    }
                if (i_158_ > 2) {
                    for (int i_160_ = 0; i_160_ < 4; i_160_++) {
                        ...
                        if (t.zy[i_157_] != 0) {
                            is_146_[i_160_] += (is_147_[i_160_] - (t.z[i_157_] - m.z - t.radz[i_157_])) * m.sin(t.zy[i_157_]) / m.sin(90 - t.zy[i_157_]) - t.radz[i_157_] * m.sin(t.zy[i_157_]) / m.sin(90 - t.zy[i_157_]);
                        }
                        if (t.xy[i_157_] != 0) {
                            is_146_[i_160_] += (is[i_160_] - (t.x[i_157_] - m.x - t.radx[i_157_])) * m.sin(t.xy[i_157_]) / m.sin(90 - t.xy[i_157_]) - t.radx[i_157_] * m.sin(t.xy[i_157_]) / m.sin(90 - t.xy[i_157_]);
                        }
                    }
        ...
        if (bool && sav[i] > dist || !bool && sav[i] <= dist) {
            if (stg[i] == 1) {
                ...
                for (int i_212_ = 0; i_212_ < t.sect[i_210_][i_211_].length; i_212_++) {
                    ...
                    if (Math.abs(t.zy[i_213_]) != 90 && Math.abs(t.xy[i_213_]) != 90 && Math.abs(sx[i] - t.x[i_213_]) < t.radx[i_213_] && Math.abs(sz[i] - t.z[i_213_]) < t.radz[i_213_]) {
                        if (t.skd[i_213_] == 0) {
                            sbln[i] = 0.2F;
                        }
                        if (t.skd[i_213_] == 1) {
            ...
            final int i_222_ = m.cy + (int) ((sy[i] - m.y - m.cy - smag[i][7]) * m.cos(m.zy) - (i_221_ - m.cz) * m.sin(m.zy));
    ...
    public void sprk(final float f, final float f_235_, final float f_236_, final float f_237_, final float f_238_, final float f_239_, final int i) {
        if (i != 1) {
