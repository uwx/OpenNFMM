...
class udpOnline implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            final String string2 = new StringBuilder().append("").append(string).append("|").append(um.im).append("|").append(um.frame[um.im][0]).append("|").append(um.info[um.im][0]).append("|").toString();
